...
const nuclideFeatures = require('./nuclideFeatures');
...
const UPLoader = {
  ...
  activate() {
    ...
    // No more Nuclide events will be fired. Dispose the Emitter to release memory and to inform
    // future callers that they're attempting to listen to events that will never fire again.
