...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _FeatureLoader;
function _load_FeatureLoader() {return _FeatureLoader = _interopRequireDefault(require('nuclide-commons-atom/FeatureLoader'));}var _featureConfig;
...
function _load_semver() {return _semver = _interopRequireDefault(require('semver'));}var _installErrorReporter;
...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('nuclide-commons/UniversalDisposable'));}var _featureGroups;
function _load_featureGroups() {return _featureGroups = _interopRequireDefault(require('./featureGroups.json'));}var _dompurify;
function _load_dompurify() {return _dompurify = _interopRequireDefault(require('dompurify'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // eslint-disable-next-line rulesdir/prefer-nuclide-uri
...
(0, (_nuclideLogging || _load_nuclideLogging()).initializeLogging)();const { remote } = _electron.default;if (!(remote != null)) {throw new Error('Invariant violation: "remote != null"');}const baseConfig = { installRecommendedPackages: {
    default: false,
    description:
