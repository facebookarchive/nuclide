...
var _shouldUseLocalRpc = typeof _useLocalRpc === 'undefined' ? config.useLocalRpc.default : _useLocalRpc;
...
function activate() {
  ...
  window.localStorage.removeItem(atom.packages.getLoadedPackage('nuclide').getCanDeferMainModuleRequireStorageKey());
