...
function _load_promise() {return _promise = require('nuclide-commons/promise');}var _FeatureLoader;
...
let featureGroups = (_featureGroups || _load_featureGroups()).default; // eslint-disable-next-line rulesdir/prefer-nuclide-uri
/**
