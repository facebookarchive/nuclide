...
_fs.default.readdirSync(MODULES_DIR).filter(name => name.startsWith('atom-ide-debugger-') || name.startsWith('nuclide-adb')).forEach(name => addFeature(MODULES_DIR, name));
