...
installErrorReporter;var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('nuclide-commons/UniversalDisposable'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                  * 
                                                                                                                                                                                                                                                                                                                                                                  * @format
                                                                                                                                                                                                                                                                                                                                                                  */let disposable;function installErrorReporter() {if (disposable != null) {throw new Error('installErrorReporter was called multiple times.');}window.addEventListener('unhandledrejection', onUnhandledRejection);disposable = new (_UniversalDisposable || _load_UniversalDisposable()).default(atom.onWillThrowError(onUnhandledException), atom.notifications.onDidAddNotification(handleAtomNotification), () => {
...
function onUnhandledException(event) {
  try {
    (0, (_log4js || _load_log4js()).getLogger)('installErrorReporter').error(
...
function handleAtomNotification(notification) {
  ...
  if (isNuclideInCallStack(error.getRawStack())) {
