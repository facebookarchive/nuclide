...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _yargs;
function _load_yargs() {return _yargs = _interopRequireDefault(require('yargs'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                 ...
                                                                                                                                                                                 * 
                                                                                                                                                                                 * @format
                                                                                                                                                                                 */ /* eslint-disable no-console */exports.default = (() => {var _ref = (0, _asyncToGenerator.default)(function* (args) {const argv = yield new Promise(function (resolve, reject) {resolve((_yargs || _load_yargs()).default.usage(`Usage: atom-script ${__dirname}/markdown.js -o <output file> <input file>`).
    ...
    markdownPreviewPackage) {throw new Error('Invariant violation: "markdownPreviewPackage"');}
    ...
    const MarkdownPreviewView = require((_nuclideUri || _load_nuclideUri()).default.join(
...
function resolvePath(fileName) {
  if (!(_nuclideUri || _load_nuclideUri()).default.isAbsolute(fileName)) {
    ...
    if (!pwd) {throw new Error('Invariant violation: "pwd"');}
