...
var outputConsole = new (_console || _load_console()).Console({ /* stdout */
...
exports.default = _asyncToGenerator(function* (params) {
  ...
  try {
    ...
    (0, (_assert || _load_assert()).default)(typeof process.env.FILE_ATOM_SCRIPT === 'string');
    var fileAtomScript = process.env.FILE_ATOM_SCRIPT;

    (0, (_assert || _load_assert()).default)(typeof process.env.ARGS_ATOM_SCRIPT === 'string');
    var argsAtomScript = process.env.ARGS_ATOM_SCRIPT;

    var scriptPath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.resolve(fileAtomScript);
    var scriptArgs = argsAtomScript === "''" ? [] : (0, (_commonsNodeString || _load_commonsNodeString()).shellParse)(argsAtomScript);
