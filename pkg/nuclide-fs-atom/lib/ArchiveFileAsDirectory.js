'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ArchiveFileAsDirectory = undefined;
...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _common;
...
/**
                                                                                                                                                              ...
                                                                                                                                                              */ /**
                                                                                                                                                                  ...
                                                                                                                                                                  *  strict-local
                                                                                                                                                                  * @format
                                                                                                                                                                  */class ArchiveFileAsDirectory {constructor(path, fs) {this._fs = fs;
    this._path = path;
    this._file = (_nuclideUri || _load_nuclideUri()).default.isInArchive(path) ?
...

  {
    ...
    readdir(this._path).
    then(entries =>
    entries.map(x => (0, (_common || _load_common()).fromEntry)(this._fs, this._path, false, x))).
  ...
  contains(path) {
    return (
      ...
      path.charAt(this._path.length) === (_nuclideUri || _load_nuclideUri()).default.ARCHIVE_SEPARATOR);
