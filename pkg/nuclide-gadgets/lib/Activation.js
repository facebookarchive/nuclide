...
var Activation = (function () {
  function Activation(initialState) {
    ...
    (0, (_commonsAtomSyncAtomCommands2 || _commonsAtomSyncAtomCommands()).default)(
    ...
    new (_commonsNodeStream2 || _commonsNodeStream()).DisposableSubscription((_rxjs2 || _rxjs()).default.Observable.fromEventPattern(function (handler) {
