...
var Commands = (function () {
  ...
  _createClass(Commands, [{
    ...
    value: function deactivate() {
      ...
      this._getState().get('gadgets').forEach(function (gadget, gadgetId) {
        _this.destroyGadget(gadgetId);
      });
    ...
    key: 'registerGadget',
    value: function registerGadget(gadget_) {
      var gadget = gadget_;
    ...
    value: function renderPaneItems() {
      ...
      atom.workspace.getPanes().forEach(function (pane) {
        ...
        for (var index = items.length - 1; index >= 0; index--) {
          ...
          // next item.
          if (_this2.replacePlaceholder(item, pane, index) != null) {
            continue;
          }
