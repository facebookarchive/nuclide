...
function blurPanel() {
  ...
  var child = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(panelComponent.getChildComponent());
...
function focusPanel() {
  ...
  if (!(_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(child).contains(document.activeElement)) {
    (0, (_assert || _load_assert()).default)(child instanceof (_SideBarPanelComponent || _load_SideBarPanelComponent()).default);
    child.focus();
  }
}
...
function renderPanelSync(renderState, onDidRender) {
  ...
  var component = (_reactForAtom || _load_reactForAtom()).ReactDOM.render((_reactForAtom || _load_reactForAtom()).React.createElement(
    ...
    (_reactForAtom || _load_reactForAtom()).React.createElement(
      ...
      activeViewInstance == null ? (_reactForAtom || _load_reactForAtom()).React.createElement('div', null) : (_reactForAtom || _load_reactForAtom()).React.createElement(activeViewInstance.view.getComponent(), { hidden: hidden })
    )
  ), panel.getItem(), onDidRender);
  (0, (_assert || _load_assert()).default)(component instanceof (_nuclideUiPanelComponent || _load_nuclideUiPanelComponent()).PanelComponent);
  panelComponent = component;
}
var renderPanel = (0, (_commonsNodeDebounce || _load_commonsNodeDebounce()).default)(renderPanelSync, 50);
