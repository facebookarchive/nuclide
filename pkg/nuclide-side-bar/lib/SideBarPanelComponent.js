...
function _nuclideUiTabs() {
  return _nuclideUiTabs2 = _interopRequireDefault(require('../../nuclide-ui/Tabs'));
}
  ...
  _createClass(SideBarPanelComponent, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiTabs2 || _nuclideUiTabs()).default, {
