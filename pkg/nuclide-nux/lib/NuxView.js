...
var NuxView = (function () {
  ...
  function NuxView(tourId, selectorString, selectorFunction, position, content, completePredicate, indexInTour) {
  ...
  _createClass(NuxView, [{
    ...
    value: function _createDisposableTooltip() {
      ...
      var dismissElementClickListener = this._onNuxComplete.bind(this, false);
    ...
    value: function _track(message, error) {
      (0, (_nuclideAnalytics2 || _nuclideAnalytics()).track)('nux-view-action', {
        tourId: this._tourId,
        message: '' + message,
