...
function _load_commonsNodePassesGK() {
  return _commonsNodePassesGK = require('../../commons-node/passesGK');
}
...
var NuxManager = (function () {
  ...
  _createClass(NuxManager, [{
    ...
    value: function _handleNewNux(nuxTourModel) {
      ...
      var nuxViews = (0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayCompact)(nuxTourModel.nuxList.map(function (model, index, arr) {
        try {
      ...
      var nuxTour = new (_NuxTour || _load_NuxTour()).NuxTour(nuxTourModel.id, nuxTourModel.name, nuxViews, nuxTourModel.trigger, nuxTourModel.gatekeeperID);
    ...
    value: function _canTriggerNux(gkID) {
      ...
      return new Promise(function (resolve, reject) {
        var cleanupDisposable = new (_atom || _load_atom()).Disposable(function () {
          gkDisposable.dispose();
          reject(new Error('NuxManager was disposed while waiting on GKs.'));
        });
        var gkDisposable = (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).onceGkInitialized)(function () {
          ...
          var shouldShowNuxes = (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).isGkEnabled)('cpe_nuclide') ? (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).isGkEnabled)('nuclide_all_nuxes') && (gkID == null || (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).isGkEnabled)(gkID)) : true;
