...
let initializeLsp = exports.initializeLsp = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (command, args, projectFileNames, fileExtensions, logLevel, fileNotifier, host, initializationOptions) {
...
let initialize = exports.initialize = (() => {
  ...
  return function initialize(_x9, _x10, _x11) {
