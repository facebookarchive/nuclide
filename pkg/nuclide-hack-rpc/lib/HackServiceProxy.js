    ...
    apply() {
      return _client.marshalArguments(Array.from(arguments), []).then(args => {
        return _client.marshal(this, {
          ...
          return _client.callRemoteMethod(id, "apply", "promise", args);
        });
      }).then(value => {
        return _client.unmarshal(value, {
          kind: "void"
    ...
    getTitle() {
      return _client.marshalArguments(Array.from(arguments), []).then(args => {
        return _client.marshal(this, {
          ...
          return _client.callRemoteMethod(id, "getTitle", "promise", args);
        });
      }).then(value => {
        return _client.unmarshal(value, {
          kind: "string"
    ...
    getCodeActions(arg0, arg1, arg2) {
      return _client.marshalArguments(Array.from(arguments), [{
        ...
        return _client.marshal(this, {
          ...
          return _client.callRemoteMethod(id, "getCodeActions", "promise", args);
        });
      }).then(value => {
        return _client.unmarshal(value, {
          kind: "array",
    ...
    setTitle(arg0) {
      return _client.marshalArguments(Array.from(arguments), [{
        ...
        return _client.marshal(this, {
          ...
          return _client.callRemoteMethod(id, "setTitle", "void", args);
        });
      });
    }
    ...
    showProgress(arg0, arg1) {
      return _client.marshalArguments(Array.from(arguments), [{
        ...
        return _client.marshal(this, {
          ...
          return _client.callRemoteMethod(id, "showProgress", "promise", args);
        });
      }).then(value => {
        return _client.unmarshal(value, {
          kind: "named",
    ...
    showActionRequired(arg0, arg1) {
      return Observable.fromPromise(_client.marshalArguments(Array.from(arguments), [{
        ...
        return _client.marshal(this, {
          ...
          return _client.callRemoteMethod(id, "showActionRequired", "observable", args);
        });
      })).concatMap(id => id).concatMap(value => {
        return _client.unmarshal(value, {
          kind: "void"
