...
module.exports = _client => {
  ...
  remoteModule.LanguageService = class {
    getDiagnostics(arg0) {
      return trackOperationTiming("LanguageService.getDiagnostics", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    getAutocompleteSuggestions(arg0, arg1, arg2) {
      return trackOperationTiming("LanguageService.getAutocompleteSuggestions", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    getDefinition(arg0, arg1) {
      return trackOperationTiming("LanguageService.getDefinition", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    getDefinitionById(arg0, arg1) {
      return trackOperationTiming("LanguageService.getDefinitionById", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "file",
          type: {
            location: {
    ...
    findReferences(arg0, arg1) {
      return trackOperationTiming("LanguageService.findReferences", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    executeQuery(arg0, arg1) {
      return trackOperationTiming("LanguageService.executeQuery", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "rootDirectory",
          type: {
            location: {
    ...
    getCoverage(arg0) {
      return trackOperationTiming("LanguageService.getCoverage", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "filePath",
          type: {
            location: {
    ...
    getOutline(arg0) {
      return trackOperationTiming("LanguageService.getOutline", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    typeHint(arg0, arg1) {
      return trackOperationTiming("LanguageService.typeHint", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    highlight(arg0, arg1) {
      return trackOperationTiming("LanguageService.highlight", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    formatSource(arg0, arg1) {
      return trackOperationTiming("LanguageService.formatSource", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileVersion",
          type: {
            location: {
    ...
    getProjectRoot(arg0) {
      return trackOperationTiming("LanguageService.getProjectRoot", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileUri",
          type: {
            location: {
    ...
    isFileInProject(arg0) {
      return trackOperationTiming("LanguageService.isFileInProject", () => {
        return _client.marshalArguments(Array.from(arguments), [{
          name: "fileUri",
          type: {
            location: {
