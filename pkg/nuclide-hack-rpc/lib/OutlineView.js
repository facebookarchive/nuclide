...
outlineFromHackIdeOutline = outlineFromHackIdeOutline;var _tokenizedText;function _load_tokenizedText() {return _tokenizedText = require('nuclide-commons/tokenized-text');}var _HackHelpers;function _load_HackHelpers() {return _HackHelpers = require('./HackHelpers');} // Note that all line/column values are 1-based.
