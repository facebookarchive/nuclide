...
var findHackCommand = _asyncToGenerator(function* () {
  ...
  return (yield (0, (_commonsNodeProcess || _load_commonsNodeProcess()).asyncExecute)('which', [PATH_TO_HH_CLIENT])).stdout.trim();
});
...
var logger = (0, (_nuclideLogging || _load_nuclideLogging()).getCategoryLogger)(HACK_LOGGER_CATEGORY);
...
function findHackConfigDir(localFile) {
  return (_commonsNodeFsPromise || _load_commonsNodeFsPromise()).default.findNearestFile(HACK_CONFIG_FILE_NAME, localFile);
}
