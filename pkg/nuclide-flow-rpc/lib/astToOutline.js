...
function functionExpressionOutline(varDeclaration) {
  // If there are multiple var declarations in one line, just take the first.
  var decl = varDeclaration.declarations[0];
  if (decl.init == null || decl.init.type !== 'FunctionExpression' && decl.init.type !== 'ArrowFunctionExpression') {
    return null;
  }
