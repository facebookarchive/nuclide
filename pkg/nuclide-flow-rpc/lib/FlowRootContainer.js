...
class FlowRootContainer {
  ...
  getRootForPath(path) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      if (!instance) {
        instance = new (_FlowSingleProjectLanguageService || _load_FlowSingleProjectLanguageService()).FlowSingleProjectLanguageService(rootPath, _this._execInfoContainer);
