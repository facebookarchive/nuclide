...
var canFindFlow = _asyncToGenerator(function* (flowPath) {
  return (yield (0, (_commonsNodeWhich || _load_commonsNodeWhich()).default)(flowPath)) != null;
}
...
var _commonsNodeWhich;

function _load_commonsNodeWhich() {
  return _commonsNodeWhich = _interopRequireDefault(require('../../commons-node/which'));
}
...
var FlowExecInfoContainer = (function () {
  function FlowExecInfoContainer() {
    ...
    this._flowConfigDirCache = (0, (_lruCache || _load_lruCache()).default)({
      max: 10,
      maxAge: 1000 * 30 });
  ...
  _createClass(FlowExecInfoContainer, [{
    ...
    value: _asyncToGenerator(function* (root) {
      ...
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(root, 'node_modules/.bin/flow');
    })
  }, {
    key: 'findFlowConfigDir',
    value: _asyncToGenerator(function* (localFile) {
      if (!this._flowConfigDirCache.has(localFile)) {
        var flowConfigDir = yield (_commonsNodeFsPromise || _load_commonsNodeFsPromise()).default.findNearestFile('.flowconfig', (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.dirname(localFile));
