...
let getFlowVersionInformation = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (flowPath) {
    try {
      const result = yield (0, (_process || _load_process()).checkOutput)(flowPath, ['version', '--json']);
  ...
  return function getFlowVersionInformation(_x) {
...
let canFindFlow = (() => {
  ...
  return function canFindFlow(_x2) {
...
let FlowExecInfoContainer = exports.FlowExecInfoContainer = class FlowExecInfoContainer {
  ...
  _computeFlowExecInfo(root) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const versionInfo = yield getFlowVersionInformation(flowPath);
      if (versionInfo == null) {
        return null;
      }
      return {
