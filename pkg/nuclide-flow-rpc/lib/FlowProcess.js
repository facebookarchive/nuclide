...
var FlowProcess = (function () {
  ...
  _createClass(FlowProcess, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      // ChildProcess object.
      // eslint-disable-next-line babel/no-await-in-loop
      var serverProcess = yield (0, (_commonsNodeProcess2 || _commonsNodeProcess()).safeSpawn)(flowExecInfo.pathToFlow, ['server', '--from', 'nuclide', '--max-workers', this._getMaxWorkers().toString(), this._root], flowExecInfo.execOptions);
