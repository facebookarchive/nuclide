'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.FlowIDEConnection = undefined;
...
function _load_vscodeJsonrpc() {return _vscodeJsonrpc = _interopRequireWildcard(require('vscode-jsonrpc'));}var _through;
function _load_through() {return _through = _interopRequireDefault(require('through'));}var _UniversalDisposable;

function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _SafeStreamMessageReader;
...
function _load_log4js() {return _log4js = require('log4js');}var _nuclideOpenFilesRpc;

function _load_nuclideOpenFilesRpc() {return _nuclideOpenFilesRpc = require('../../nuclide-open-files-rpc');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}
...
class FlowIDEConnection {
  ...
  constructor(process, fileCache) {
    ...
    (0, (_through || _load_through()).default)(msg => {
    ...
    this._connection = (_vscodeJsonrpc || _load_vscodeJsonrpc()).createMessageConnection(
    new (_SafeStreamMessageReader || _load_SafeStreamMessageReader()).default(this._ideProcess.stdout),
    new (_vscodeJsonrpc || _load_vscodeJsonrpc()).StreamMessageWriter(this._ideProcess.stdin),
    (0, (_log4js || _load_log4js()).getLogger)('FlowIDEConnection-jsonrpc'));
    ...
    const diagnostics = _rxjsBundlesRxMinJs.Observable.fromEventPattern(
    handler => {
    ...
    this._recheckBookends = _rxjsBundlesRxMinJs.Observable.fromEventPattern(
    handler => {
  ...
  observeDiagnostics() {
    ...
    const retrySubscription = _rxjsBundlesRxMinJs.Observable.interval(SUBSCRIBE_RETRY_INTERVAL).
