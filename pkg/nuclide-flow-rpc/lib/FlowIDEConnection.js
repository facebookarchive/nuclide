...
class FlowIDEConnection {
  ...
  constructor(process, fileCache) {
    ...
    this._connection = (_vscodeJsonrpc || _load_vscodeJsonrpc()).createMessageConnection(new (_SafeStreamMessageReader || _load_SafeStreamMessageReader()).default(this._ideProcess.stdout), new (_vscodeJsonrpc || _load_vscodeJsonrpc()).StreamMessageWriter(this._ideProcess.stdin), (0, (_log4js || _load_log4js()).getLogger)('FlowIDEConnection-jsonrpc'));
