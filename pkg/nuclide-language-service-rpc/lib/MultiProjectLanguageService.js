...
class MultiProjectLanguageService {
  ...
  getCodeLens(fileVersion) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this11._getLanguageServiceForFile(fileVersion.filePath)).getCodeLens(fileVersion);
    })();
  }
  ...
  resolveCodeLens(filePath, codeLens) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this12._getLanguageServiceForFile(filePath)).resolveCodeLens(filePath, codeLens);
    })();
  }
  ...
  getAdditionalLogFiles(deadline) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const roots = Array.from(_this13._processes.keys());

      const results = yield Promise.all(roots.map((() => {
        var _ref2 = (0, _asyncToGenerator.default)(function* (root) {
          try {
            const service = yield (0, (_promise || _load_promise()).timeoutAfterDeadline)(deadline, _this13._processes.get(root));
            if (service == null) {
  ...
  getCodeActions(fileVersion, range, diagnostics) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this14._getLanguageServiceForFile(fileVersion.filePath)).getCodeActions(fileVersion, range, diagnostics);
    })();
  }
  ...
  typeHint(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this15._getLanguageServiceForFile(fileVersion.filePath)).typeHint(fileVersion, position);
    })();
  }
  ...
  highlight(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this16._getLanguageServiceForFile(fileVersion.filePath)).highlight(fileVersion, position);
    })();
  }
  ...
  formatSource(fileVersion, range, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this17._getLanguageServiceForFile(fileVersion.filePath)).formatSource(fileVersion, range, options);
    })();
  }
  ...
  formatEntireFile(fileVersion, range, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this18._getLanguageServiceForFile(fileVersion.filePath)).formatEntireFile(fileVersion, range, options);
    })();
  }
  ...
  formatAtPosition(fileVersion, position, triggerCharacter, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this19._getLanguageServiceForFile(fileVersion.filePath)).formatAtPosition(fileVersion, position, triggerCharacter, options);
    })();
  }
  ...
  getEvaluationExpression(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this20._getLanguageServiceForFile(fileVersion.filePath)).getEvaluationExpression(fileVersion, position);
    })();
  }
  ...
  supportsSymbolSearch(directories) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const serviceDirectories = yield _this21._getLanguageServicesForFiles(directories);
  ...
  getProjectRoot(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this23._getLanguageServiceForFile(filePath)).getProjectRoot(filePath);
    })();
  }
  ...
  isFileInProject(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this24._getLanguageServiceForFile(filePath)).isFileInProject(filePath);
    })();
  }
  ...
  getExpandedSelectionRange(fileVersion, currentSelection) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this25._getLanguageServiceForFile(fileVersion.filePath)).getExpandedSelectionRange(fileVersion, currentSelection);
    })();
  }
  ...
  getCollapsedSelectionRange(fileVersion, currentSelection, originalCursorPosition) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this26._getLanguageServiceForFile(fileVersion.filePath)).getCollapsedSelectionRange(fileVersion, currentSelection, originalCursorPosition);
    })();
  }
