...
class MultiProjectLanguageService {
  ...
  resolveAutocompleteSuggestion(suggestion) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const languageService = yield _this7._getLanguageServiceForFile(suggestion.remoteUri);
  ...
  getDefinition(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this8._getLanguageServiceForFile(fileVersion.filePath)).getDefinition(fileVersion, position);
    })();
  }
  ...
  onToggleCoverage(set) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      yield Promise.all((yield _this10.getAllLanguageServices()).map((() => {
        var _ref2 = (0, _asyncToGenerator.default)(function* (languageService) {
  ...
  getOutline(fileVersion) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this11._getLanguageServiceForFile(fileVersion.filePath)).getOutline(fileVersion);
    })();
  }
  ...
  getCodeLens(fileVersion) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this12._getLanguageServiceForFile(fileVersion.filePath)).getCodeLens(fileVersion);
    })();
  }
  ...
  resolveCodeLens(filePath, codeLens) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this13._getLanguageServiceForFile(filePath)).resolveCodeLens(filePath, codeLens);
    })();
  }
  ...
  getAdditionalLogFiles(deadline) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const results = yield Promise.all(roots.map((() => {
        var _ref3 = (0, _asyncToGenerator.default)(function* (root) {
          try {
            const service = yield (0, (_promise || _load_promise()).timeoutAfterDeadline)(deadline, _this14._processes.get(root));
            if (service == null) {
  ...
  getCodeActions(fileVersion, range, diagnostics) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this15._getLanguageServiceForFile(fileVersion.filePath)).getCodeActions(fileVersion, range, diagnostics);
    })();
  }
  ...
  typeHint(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this16._getLanguageServiceForFile(fileVersion.filePath)).typeHint(fileVersion, position);
    })();
  }
  ...
  highlight(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this17._getLanguageServiceForFile(fileVersion.filePath)).highlight(fileVersion, position);
    })();
  }
  ...
  formatSource(fileVersion, range, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this18._getLanguageServiceForFile(fileVersion.filePath)).formatSource(fileVersion, range, options);
    })();
  }
  ...
  formatEntireFile(fileVersion, range, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this19._getLanguageServiceForFile(fileVersion.filePath)).formatEntireFile(fileVersion, range, options);
    })();
  }
  ...
  formatAtPosition(fileVersion, position, triggerCharacter, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this20._getLanguageServiceForFile(fileVersion.filePath)).formatAtPosition(fileVersion, position, triggerCharacter, options);
    })();
  }
  ...
  signatureHelp(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this21._getLanguageServiceForFile(fileVersion.filePath)).signatureHelp(fileVersion, position);
    })();
  }
  ...
  supportsSymbolSearch(directories) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const serviceDirectories = yield _this22._getLanguageServicesForFiles(directories);
  ...
  symbolSearch(query, directories) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const serviceDirectories = yield _this23._getLanguageServicesForFiles(directories);
  ...
  getProjectRoot(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this24._getLanguageServiceForFile(filePath)).getProjectRoot(filePath);
    })();
  }
  ...
  isFileInProject(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this25._getLanguageServiceForFile(filePath)).isFileInProject(filePath);
    })();
  }
  ...
  getExpandedSelectionRange(fileVersion, currentSelection) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this26._getLanguageServiceForFile(fileVersion.filePath)).getExpandedSelectionRange(fileVersion, currentSelection);
    })();
  }
  ...
  getCollapsedSelectionRange(fileVersion, currentSelection, originalCursorPosition) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this27._getLanguageServiceForFile(fileVersion.filePath)).getCollapsedSelectionRange(fileVersion, currentSelection, originalCursorPosition);
    })();
  }
