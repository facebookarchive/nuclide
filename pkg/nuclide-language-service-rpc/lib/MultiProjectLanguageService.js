...
class MultiProjectLanguageService {
  ...
  getLanguageServiceForFile(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const projectDir = yield _this2.findProjectDir(filePath);
      if (projectDir == null) {
        return null;
      }

      const process = _this2._processes.get(projectDir);
      process.then(function (result) {
        // If we fail to connect, then retry on next request.
        if (result == null) {
          _this2._processes.delete(projectDir);
        }
      });
      return process;
    })();
  ...
  getDiagnostics(fileVersion) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this3._getLanguageServiceForFile(fileVersion.filePath)).getDiagnostics(fileVersion);
    })();
  }
  ...
  getAutocompleteSuggestions(fileVersion, position, activatedManually, prefix) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this4._getLanguageServiceForFile(fileVersion.filePath)).getAutocompleteSuggestions(fileVersion, position, activatedManually, prefix);
    })();
  }
  ...
  getDefinition(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this5._getLanguageServiceForFile(fileVersion.filePath)).getDefinition(fileVersion, position);
    })();
  }
  ...
  getDefinitionById(file, id) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this6._getLanguageServiceForFile(file)).getDefinitionById(file, id);
    })();
  }
  ...
  findReferences(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this7._getLanguageServiceForFile(fileVersion.filePath)).findReferences(fileVersion, position);
    })();
  }
  ...
  typeHint(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this10._getLanguageServiceForFile(fileVersion.filePath)).typeHint(fileVersion, position);
    })();
  }
  ...
  highlight(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this11._getLanguageServiceForFile(fileVersion.filePath)).highlight(fileVersion, position);
    })();
  }
  ...
  formatSource(fileVersion, range) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this12._getLanguageServiceForFile(fileVersion.filePath)).formatSource(fileVersion, range);
    })();
  }
  ...
  formatEntireFile(fileVersion, range) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this13._getLanguageServiceForFile(fileVersion.filePath)).formatEntireFile(fileVersion, range);
    })();
  }
  ...
  getEvaluationExpression(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this14._getLanguageServiceForFile(fileVersion.filePath)).getEvaluationExpression(fileVersion, position);
    })();
  }
  ...
  getProjectRoot(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this15._getLanguageServiceForFile(filePath)).getProjectRoot(filePath);
    })();
  }
  ...
  isFileInProject(filePath) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return (yield _this16._getLanguageServiceForFile(filePath)).isFileInProject(filePath);
    })();
  }
