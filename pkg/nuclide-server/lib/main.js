'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let getServerCredentials = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  function* (args) {
    ...
    if (key && cert && ca) {
      ...
      yield Promise.all([
      (_fsPromise || _load_fsPromise()).default.readFile(key),
      (_fsPromise || _load_fsPromise()).default.readFile(cert),
      (_fsPromise || _load_fsPromise()).default.readFile(ca)]);

      return { serverKey, serverCertificate, certificateAuthorityCertificate };
    }
    return null;
  });return function getServerCredentials(_x) {return _ref.apply(this, arguments);};})();let main = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  function* (args) {
    ...
    try {
      ...
      const server = new (_NuclideServer || _load_NuclideServer()).default(Object.assign({
        ...
        port },
      serverCredentials, {
        trackEventLoop: true }), (_servicesConfig || _load_servicesConfig()).default);
...
var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nuclideLogging;function _load_nuclideLogging() {return _nuclideLogging = require('../../nuclide-logging');}var _nuclideAnalytics;function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _NuclideServer;function _load_NuclideServer() {return _NuclideServer = _interopRequireDefault(require('./NuclideServer'));}var _servicesConfig;function _load_servicesConfig() {return _servicesConfig = _interopRequireDefault(require('./servicesConfig'));}var _yargs;function _load_yargs() {return _yargs = _interopRequireDefault(require('yargs'));}var _log4js;function _load_log4js() {return _log4js = require('log4js');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const DEFAULT_PORT = 9090; /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */const logger = (0, (_log4js || _load_log4js()).getLogger)('nuclide-server');process.stderr.on('error', error => {throw new Error('Can not write to stderr! :' + error);});process.on('uncaughtException', err => {// Log the error and continue the server crash.
  ...
  (0, (_nuclideLogging || _load_nuclideLogging()).flushLogsAndAbort)();}); // This works in io.js as of v2.4.0 (possibly earlier versions, as well). Support for this was
