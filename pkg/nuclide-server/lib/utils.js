...
function asyncRequest(options) {
  return new Promise(function (resolve, reject) {
    ...
    (0, (_request || _load_request()).default)(options, function (error, response, body) {
      if (error) {
        reject(error);
...
function getQueryParameters(requestUrl) {
  var components = (_url || _load_url()).default.parse(requestUrl, true);
  (0, (_assert || _load_assert()).default)(components != null);
