...
class NuclideServer {
  ...
  _onConnection(socket) {
    ...
    socket.once('message', clientId => {
      ...
      if (client == null) {
        client = (_nuclideRpc || _load_nuclideRpc()).RpcConnection.createServer(this._rpcServiceRegistry, new (_QueuedAckTransport || _load_QueuedAckTransport()).QueuedAckTransport(clientId, transport), {}, clientId, (_utils || _load_utils()).protocolLogger);
