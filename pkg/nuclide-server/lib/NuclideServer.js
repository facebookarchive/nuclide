...
var NuclideServer = (function () {
  function NuclideServer(options, services) {
    ...
    this._rpcServiceRegistry = new (_nuclideRpc2 || _nuclideRpc()).ServiceRegistry((_nuclideMarshalersCommon2 || _nuclideMarshalersCommon()).getServerSideMarshalers, services);
  }
