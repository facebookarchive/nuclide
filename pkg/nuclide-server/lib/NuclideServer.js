...
let NuclideServer = class NuclideServer {
  ...
  constructor(options, services) {
    ...
    const serverCertificate = options.serverCertificate;
    const port = options.port;
    const certificateAuthorityCertificate = options.certificateAuthorityCertificate;
    const trackEventLoop = options.trackEventLoop;
