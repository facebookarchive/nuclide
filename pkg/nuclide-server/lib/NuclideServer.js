...
var NuclideServer = (function () {
  function NuclideServer(options, services) {
    ...
    this._rpcServiceRegistry = new (_nuclideRpc2 || _nuclideRpc()).ServiceRegistry([(_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.localMarshallers], services);
  }
