...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _blocked;

function _load_blocked() {return _blocked = _interopRequireDefault(require('./blocked'));}var _QueuedAckTransport;
function _load_QueuedAckTransport() {return _QueuedAckTransport = require('../../../modules/big-dig/src/socket/QueuedAckTransport');}var _utils;
...
function _load_WebSocketTransport() {return _WebSocketTransport = require('../../../modules/big-dig/src/socket/WebSocketTransport');}var _nuclideMarshalersCommon;
...
class NuclideServer {
  ...
  }}exports.default = NuclideServer;NuclideServer._shutdownCallbacks = new Set();