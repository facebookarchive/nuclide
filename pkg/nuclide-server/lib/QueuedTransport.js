...
var QueuedTransport = (function () {
  ...
  _createClass(QueuedTransport, [{
    ...
    value: function _connect(transport) {
      ...
      (0, (_assert || _load_assert()).default)(!transport.isClosed());
    ...
    value: function reconnect(transport) {
      ...
      (0, (_assert || _load_assert()).default)(!transport.isClosed());
      (0, (_assert || _load_assert()).default)(!this._isClosed);
    ...
    value: _asyncToGenerator(function* (message) {
      (0, (_assert || _load_assert()).default)(!this._isClosed, 'Attempt to send socket message after connection closed');
