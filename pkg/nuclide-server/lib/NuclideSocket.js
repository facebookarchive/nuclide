...
class NuclideSocket {
  ...
  constructor(serverUri, options) {
    ...
    this._transport = new (_QueuedAckTransport || _load_QueuedAckTransport()).QueuedAckTransport(this.id);
    ...
    this._heartbeat = new (_XhrConnectionHeartbeat || _load_XhrConnectionHeartbeat()).XhrConnectionHeartbeat(serverUri, (_NuclideServer || _load_NuclideServer()).HEARTBEAT_CHANNEL, options);
