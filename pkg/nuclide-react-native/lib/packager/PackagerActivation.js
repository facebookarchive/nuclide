...
function getPackagerObservable() {
  var stdout = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise((0, (_nuclideReactNativeCommon2 || _nuclideReactNativeCommon()).getCommandInfo)()).switchMap(function (commandInfo) {
