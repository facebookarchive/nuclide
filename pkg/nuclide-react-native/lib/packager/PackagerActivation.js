...
var PackagerActivation = (function () {
  ...
  _createClass(PackagerActivation, [{
    ...
    value: function _restart() {
      ...
      this._connectionDisposables = new (_atom2 || _atom()).CompositeDisposable(new (_commonsNodeStream2 || _commonsNodeStream()).DisposableSubscription((_rxjs2 || _rxjs()).default.Observable.fromPromise((0, (_getCommandInfo2 || _getCommandInfo()).getCommandInfo)()).subscribe(function (commandInfo) {
        if (commandInfo == null) {
