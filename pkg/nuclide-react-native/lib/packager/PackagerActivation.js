...
function getPackagerObservable() {
  var stdout = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise((0, (_nuclideReactNativeBase2 || _nuclideReactNativeBase()).getCommandInfo)()).switchMap(function (commandInfo) {
