...
var _nuclideDebuggerNodeLibSession2;

function _nuclideDebuggerNodeLibSession() {
  return _nuclideDebuggerNodeLibSession2 = require('../../../nuclide-debugger-node/lib/Session');
}
...
function createSessionStream(ws, debugPort) {
  ...
  return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.create(function (observer) {
    ...
    var session = new (_nuclideDebuggerNodeLibSession2 || _nuclideDebuggerNodeLibSession()).Session(config, debugPort, ws);
