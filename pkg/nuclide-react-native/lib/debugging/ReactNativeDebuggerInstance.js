...
var _nuclideDebuggerNodeRpcLibSession2;

function _nuclideDebuggerNodeRpcLibSession() {
  return _nuclideDebuggerNodeRpcLibSession2 = require('../../../nuclide-debugger-node-rpc/lib/Session');
}
...
var pid$ = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.using(function () {
 ...
 */
// $FlowFixMe(matthewwithanm): Type this.
var uiConnection$ = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.using(function () {
  // TODO(natthu): Assign random port instead.
  ...
  return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.merge((_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromEvent(server, 'error').flatMap((_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.throw), (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromEvent(server, 'connection')).takeUntil((_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromEvent(server, 'close'));
}).publish();
...
function createSessionStream(ws, debugPort) {
  ...
  return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.create(function (observer) {
    ...
    var session = new (_nuclideDebuggerNodeRpcLibSession2 || _nuclideDebuggerNodeRpcLibSession()).Session(config, debugPort, ws);
