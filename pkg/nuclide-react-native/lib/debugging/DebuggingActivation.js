...
var DebuggingActivation = (function () {
  ...
  _createClass(DebuggingActivation, [{
    ...
    value: function _startDebugging() {
      ...
      var debuggerServiceStream = (_rxjs2 || _rxjs()).default.Observable.fromPromise((0, (_commonsAtomConsumeFirstProvider2 || _commonsAtomConsumeFirstProvider()).default)('nuclide-debugger.remote'));
