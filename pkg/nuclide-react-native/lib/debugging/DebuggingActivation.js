...
var DebuggingActivation = (function () {
  ...
  _createClass(DebuggingActivation, [{
    ...
    value: function _startDebugging() {
      ...
      var debuggerServiceStream = (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.fromPromise((0, (_commonsAtomConsumeFirstProvider || _load_commonsAtomConsumeFirstProvider()).default)('nuclide-debugger.remote'));
      var processInfoLists = (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.fromPromise(getProcessInfoList());
