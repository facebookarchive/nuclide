...
var DebuggingActivation = (function () {
  ...
  _createClass(DebuggingActivation, [{
    ...
    value: function _startDebugging() {
      ...
      var debuggerServiceStream = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise((0, (_commonsAtomConsumeFirstProvider2 || _commonsAtomConsumeFirstProvider()).default)('nuclide-debugger.remote'));
      var processInfoLists = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise(getProcessInfoList());
