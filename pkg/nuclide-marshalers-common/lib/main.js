...
var localNuclideUriMarshalers = {
  ...
  marshaller: function marshaller(uri) {
    (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.validate(uri, false);
    return uri;
  },
  unmarshaller: function unmarshaller(remotePath) {
    (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.validate(remotePath, false);
    return remotePath;
  }
};
