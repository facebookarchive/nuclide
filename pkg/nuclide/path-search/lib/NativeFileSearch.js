...
import {NativePathSet} from './NativePathSet';
import {getPaths} from './PathSetFactory';
import PathSetUpdater from './PathSetUpdater';

const logger = getLogger();

class NativeFileSearch {
  _originalUri: string;
  _pathSet: NativePathSet;

  constructor(fullUri: string, pathSet: NativePathSet) {
...
export async function fileSearchForDirectory(
  ...
  const pathSet = new NativePathSet(Object.keys(paths));
