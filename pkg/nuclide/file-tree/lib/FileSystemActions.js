...
var FileSystemActions = {
  ...
  openRenameDialog: function openRenameDialog() {
    ...
    this._openDialog({
      ...
      message: node.isContainer ? _reactForAtom2['default'].createElement(
        'span',
        null,
  ...
  openDuplicateDialog: function openDuplicateDialog(onDidConfirm) {
    ...
    this._openDialog({
      ...
      message: _reactForAtom2['default'].createElement(
        'span',
        null,
  ...
  _openAddDialog: function _openAddDialog(entryType, path, onConfirm) {
    this._openDialog({
      ...
      message: _reactForAtom2['default'].createElement(
        ...
        entryType,
        ' in the root:',
        _reactForAtom2['default'].createElement('br', null),
        path
      ),
      onConfirm: onConfirm,
      onClose: this._closeDialog
  ...
  _openDialog: function _openDialog(props) {
    ...
    dialogComponent = _reactForAtom2['default'].render(_reactForAtom2['default'].createElement(_componentsFileDialogComponent2['default'], props), dialogHostElement);
  },

  _closeDialog: function _closeDialog() {
    if (dialogComponent != null) {
      _reactForAtom2['default'].unmountComponentAtNode(dialogHostElement);
