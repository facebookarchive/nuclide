...
class ConsoleDomain(HandlerDomain):
    ...
    def flush_messages(self):
        ...
        for message in self.messages:
            if self.last_message and self.last_message['text'] is message['text']:
                ...
                self.socket.send_notification('Console.messageRepeatCountUpdated', params)
            else:
                self.socket.send_notification('Console.messageAdded', {'message': message} )
    ...
    def clear_messages(self, params):
        self.messages = []
        self.socket.send_notification('Console.messagesCleared')
