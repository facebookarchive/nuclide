...
var MarkerTracker = (function () {
  ...
  _createClass(MarkerTracker, [{
    ...
    value: function getCurrentRange(message) {
      ...
      (0, _assert2['default'])(marker != null, 'Internal error: Marker is missing for ' + message.filePath);
