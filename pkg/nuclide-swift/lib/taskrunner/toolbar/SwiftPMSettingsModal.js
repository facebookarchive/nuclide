...
function _load_Dropdown() {return _Dropdown = require('../../../../../modules/nuclide-commons-ui/Dropdown');}var _Modal;
function _load_Modal() {return _Modal = require('../../../../../modules/nuclide-commons-ui/Modal');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
    ...
    return (
      _react.createElement((_Modal || _load_Modal()).Modal, { onDismiss: this.props.onDismiss },
        _react.createElement('div', { className: 'block' },
          _react.createElement('label', null, 'Build configuration:'),
          _react.createElement('div', { className: 'block' },
          ...
          _react.createElement('label', null, 'C compiler flags:'),
          _react.createElement('div', { className: 'block' },
          ...
          _react.createElement('label', null, 'Linker flags:'),
          _react.createElement('div', { className: 'block' },
            _react.createElement((_AtomInput || _load_AtomInput()).AtomInput, {
          ...
          _react.createElement('label', null, 'Swift compiler flags:'),
          _react.createElement('div', { className: 'block' },
            _react.createElement((_AtomInput || _load_AtomInput()).AtomInput, {
          ...
          _react.createElement('label', null, 'Build path:'),
          _react.createElement('div', { className: 'block' },
            _react.createElement((_AtomInput || _load_AtomInput()).AtomInput, {
