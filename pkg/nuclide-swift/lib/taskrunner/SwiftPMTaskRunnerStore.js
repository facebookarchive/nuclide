...
var SwiftPMTaskRunnerStore = (function () {
  function SwiftPMTaskRunnerStore(dispatcher, initialState) {
    ...
    if (initialState) {
      ...
      this._compileCommands = initialState.compileCommands ? new Map((0, (_commonsNodeCollection || _load_commonsNodeCollection()).objectEntries)(initialState.compileCommands)) : new Map();
    } else {
      this._chdir = '';
  ...
  _createClass(SwiftPMTaskRunnerStore, [{
    ...
    value: function serialize() {
      return {
        ...
        compileCommands: (0, (_commonsNodeCollection || _load_commonsNodeCollection()).objectFromMap)(this.getCompileCommands()),
