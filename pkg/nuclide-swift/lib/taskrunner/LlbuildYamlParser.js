'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.readCompileCommands = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
/**
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   */let readCompileCommands = exports.readCompileCommands = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (
  path)
  {
  ...
  });return function readCompileCommands(_x) {return _ref.apply(this, arguments);};})();
...
/**
                                                                                          ...
                                                                                          */ /**
                                                                                              ...
                                                                                              * 
                                                                                              * @format
                                                                                              */exports.llbuildYamlPath = llbuildYamlPath;var _jsYaml;function _load_jsYaml() {return _jsYaml = _interopRequireDefault(require('js-yaml'));}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../../modules/nuclide-commons/nuclideUri'));}var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('../../../../modules/nuclide-commons/fsPromise'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function llbuildYamlPath(chdir, configuration, buildPath) {const yamlFileName = `${configuration}.yaml`;if (buildPath.length > 0) {return (_nuclideUri || _load_nuclideUri()).default.join(buildPath, yamlFileName);} else {
