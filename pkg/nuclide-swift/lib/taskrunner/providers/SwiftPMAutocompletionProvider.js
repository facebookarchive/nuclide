...
var SwiftPMAutocompletionProvider = (function () {
  ...
  _createClass(SwiftPMAutocompletionProvider, [{
    ...
    value: _asyncToGenerator(function* (request) {
      ...
      var result = yield (0, (_sourcekittenSourceKitten2 || _sourcekittenSourceKitten()).asyncExecuteSourceKitten)('complete', ['--text', request.editor.getText(), '--offset', String(offset), '--', compilerArgs ? compilerArgs : '']);
