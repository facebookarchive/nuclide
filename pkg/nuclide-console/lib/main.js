    ...
    value: function provideRegisterExecutor() {
      ...
      if (this._registerExecutorFunction == null) {
        (function () {
          // Create a local, nullable reference so that the service consumers don't keep the store
          // instance in memory.
          var store = _this4._getStore();
          _this4._disposables.add(new (_atom2 || _atom()).Disposable(function () {
            store = null;
          }));

          _this4._registerExecutorFunction = function (executor) {
