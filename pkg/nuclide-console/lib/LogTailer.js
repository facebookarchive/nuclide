...
var LogTailer = (function () {
  function LogTailer(options) {
    ...
    this._messages = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.merge(options.messages, this._ready == null ? (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.empty() : this._ready.ignoreElements()). // For the errors.
    do({
