  ...
  _createClass(OutputTable, [{
    ...
    value: function _handleTextEditor(component) {
      ...
      if (component) {
        ...
        this._keySubscription = new (_commonsNodeStream2 || _commonsNodeStream()).DisposableSubscription((_rxjs2 || _rxjs()).default.Observable.fromEvent(el, 'keydown').subscribe(this._handleKeyDown));
      }
    }
  }, {
    key: '_handleKeyDown',
