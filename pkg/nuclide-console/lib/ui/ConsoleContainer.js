...
let ConsoleContainer = exports.ConsoleContainer = class ConsoleContainer extends _reactForAtom.React.Component {
  ...
  constructor(props) {
    ...
    const initialEnableRegExpFilter = props.initialEnableRegExpFilter;
    const initialUnselectedSourceIds = props.initialUnselectedSourceIds;
  ...
  render() {
    ...
    const isValid = _getFilterPattern.isValid;
