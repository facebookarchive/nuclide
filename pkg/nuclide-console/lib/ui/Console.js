...
var Console = (function (_React$Component) {
  ...
  _createClass(Console, [{
    ...
    value: function render() {
      ...
      var selectedSourceIds = this.props.sources.map(function (source) {
        return source.id;
      }).filter(function (sourceId) {
        return _this.state.unselectedSourceIds.indexOf(sourceId) === -1;
      });

      var records = filterRecords(this.props.records, selectedSourceIds, pattern, this.props.sources.length !== selectedSourceIds.length);
    ...
    value: function _selectSources(selectedSourceIds) {
      var sourceIds = this.props.sources.map(function (source) {
        return source.id;
      });
