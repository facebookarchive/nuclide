...
var _commonsNodeHasher2;

function _commonsNodeHasher() {
  return _commonsNodeHasher2 = _interopRequireDefault(require('../../../commons-node/Hasher'));
}
...
var OutputTable = (function (_React$Component) {
  ...
  function OutputTable(props) {
    ...
    this._hasher = new (_commonsNodeHasher2 || _commonsNodeHasher()).default();
  ...
  _createClass(OutputTable, [{
    ...
    value: function _renderRow(record, index) {
      return (_reactForAtom2 || _reactForAtom()).React.createElement((_RecordView2 || _RecordView()).default, {
