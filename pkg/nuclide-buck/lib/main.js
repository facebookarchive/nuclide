...
function getBuildSystem() {
  if (buildSystem == null) {
    ...
    buildSystem = new (_BuckBuildSystem || _load_BuckBuildSystem()).BuckBuildSystem(initialState, getPlatformService());
...
function getPlatformService() {
  if (platformService == null) {
    platformService = new (_PlatformService || _load_PlatformService()).PlatformService();
  }
