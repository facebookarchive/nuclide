...
var _BuckCompilationDatabaseProvider;

function _load_BuckCompilationDatabaseProvider() {
  return _BuckCompilationDatabaseProvider = require('./BuckCompilationDatabaseProvider');
}
