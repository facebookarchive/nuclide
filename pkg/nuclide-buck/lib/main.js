...
function activate(rawState) {
  ...
  (0, (_nuclideAtomHelpers2 || _nuclideAtomHelpers()).registerGrammarForFileExtension)('source.python', 'BUCK');
  (0, (_nuclideAtomHelpers2 || _nuclideAtomHelpers()).registerGrammarForFileExtension)('source.json', 'BUCK.autodeps');
  (0, (_nuclideAtomHelpers2 || _nuclideAtomHelpers()).registerGrammarForFileExtension)('source.ini', '.buckconfig');
}
