...
var _commonsNodeObservableToTaskInfo2;

function _commonsNodeObservableToTaskInfo() {
  return _commonsNodeObservableToTaskInfo2 = require('../../commons-node/observableToTaskInfo');
}
...
var _nuclideReactNativeCommon2;

function _nuclideReactNativeCommon() {
  return _nuclideReactNativeCommon2 = require('../../nuclide-react-native-common');
}
...
var BuckBuildSystem = (function () {
  ...
  _createClass(BuckBuildSystem, [{
    ...
    value: function runTask(taskType) {
      ...
      var taskInfo = (0, (_commonsNodeObservableToTaskInfo2 || _commonsNodeObservableToTaskInfo()).observableToTaskInfo)(resultStream);
    ...
    value: function _runBuckCommand(buckProject, buildTarget, subcommand, args, debug) {
      ...
      if (subcommand === 'install') {
        ...
        if (isReactNativeServerMode) {
          rnObservable = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.concat((_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise((0, (_nuclideReactNativeCommon2 || _nuclideReactNativeCommon()).startPackager)()), (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.defer(function () {
