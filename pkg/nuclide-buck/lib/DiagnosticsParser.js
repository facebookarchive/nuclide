'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.INDEFINITE_END_COLUMN = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
const TEST_FAILURE_START_REGEX = /^FAILURE.*: (.*):([0-9]+): (.*)$/gm;const TEST_FAILURE_CONTINUED_REGEX = /^([^:]+):([0-9]+): (.*)$/gm; // Buck output for OCaml errors looks somthing like this:
...
/**
   ...
   */
class DiagnosticsParser {constructor() {this.
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (promises.length === 0) {
        const regexp = _this.testFailuresHaveStarted ?
