...
var BuckToolbar = (function (_React$Component) {
  ...
  function BuckToolbar(props) {
    ...
    this._disposables.add((_nuclideAtomHelpers2 || _nuclideAtomHelpers()).atomEventDebounce.onWorkspaceDidStopChangingActivePaneItem(this._onActivePaneItemChanged.bind(this)));
