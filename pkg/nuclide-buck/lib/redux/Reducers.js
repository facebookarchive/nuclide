...
accumulateState;var _Actions;function _load_Actions() {return _Actions = _interopRequireWildcard(require('./Actions'));}var _DeploymentTarget;function _load_DeploymentTarget() {return _DeploymentTarget = require('../DeploymentTarget');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              *  strict-local
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */function accumulateState(state, action) {switch (action.type) {case (_Actions || _load_Actions()).SET_PROJECT_ROOT:return Object.assign({}, state, { projectRoot: action.projectRoot, buckversionFileContents: null,
    ...
    case (_Actions || _load_Actions()).SET_BUCKVERSION_FILE_CONTENTS:
      return Object.assign({},
      state, {
    ...
    case (_Actions || _load_Actions()).SET_PLATFORM_GROUPS:
      ...
      const selectedDeploymentTarget = (0, (_DeploymentTarget || _load_DeploymentTarget()).selectValidDeploymentTarget)(
      (0, (_DeploymentTarget || _load_DeploymentTarget()).getDeploymentTargetPreference)(state),
      platformGroups);
      ...
      state, {
        ...
        platformProviderUi: (0, (_DeploymentTarget || _load_DeploymentTarget()).getPlatformProviderUiForDeploymentTarget)(
        selectedDeploymentTarget),
