...
let readBuckversionFile = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (buckRoot) {
    ...
    try {
      const data = yield fileSystemService.readFile((_nuclideUri || _load_nuclideUri()).default.join(buckRoot, '.buckversion'));
      return String(data);
    } catch (error) {
  ...
  return function readBuckversionFile(_x) {
