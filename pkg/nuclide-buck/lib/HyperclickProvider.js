'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.resolveLoadTargetPath = exports.getSuggestion = exports.findTargetLocation = exports.parseTarget = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
/**
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                */let parseTarget = exports.parseTarget = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (
  match,
  filePath,
  buckRoot)
  {
    ...
    return { path, name };
  });return function parseTarget(_x, _x2, _x3) {return _ref.apply(this, arguments);};})();
...
/**
                                                                                            ...
                                                                                            */ /**
                                                                                                ...
                                                                                                * 
                                                                                                * @format
                                                                                                */let findTargetLocation = exports.findTargetLocation = (() => {var _ref2 = (0, _asyncToGenerator.default)(function* (target) {let data;try {const fs = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getFileSystemServiceByNuclideUri)(target.path);data = (yield fs.readFile(target.path)).toString('utf8');} catch (e) {return null;}
  ...
  });return function findTargetLocation(_x4) {return _ref2.apply(this, arguments);};})();let getSuggestion = exports.getSuggestion = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  ...
  position)
  {
    ...
    !VALID_BUILD_FILE_EXTENSIONS.has((_nuclideUri || _load_nuclideUri()).default.extname(baseName)))
    {
      return null;
    }
    ...
    textEditor,
    position,
    (_nuclideUri || _load_nuclideUri()).default.dirname(absolutePath))]);


    const hyperclickMatch = results.find(function (x) {return x != null;});
  ...
  });return function getSuggestion(_x5, _x6) {return _ref3.apply(this, arguments);};})();
...
/**
                                                                                           ...
                                                                                           */let findBuildTarget = (() => {var _ref4 = (0, _asyncToGenerator.default)(
  function* (
  textEditor,
  position,
  absolutePath,
  ...
  });return function findBuildTarget(_x7, _x8, _x9, _x10) {return _ref4.apply(this, arguments);};})();
 ...
 */let findLoadTarget = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  function* (
  textEditor,
  position,
  absolutePath,
  buckRoot)
  {
    ...
    return Object.assign({}, location, { range });
  });return function findLoadTarget(_x11, _x12, _x13, _x14) {return _ref5.apply(this, arguments);};})();
...
/**
                                                                                                          ...
                                                                                                          */let resolveLoadTargetPath = exports.resolveLoadTargetPath = (() => {var _ref6 = (0, _asyncToGenerator.default)(
  function* (
  wordMatch,
  buckRoot)
  {
    ...
    yield (0, (_buildFiles || _load_buildFiles()).getCellLocation)(buckRoot, cellName) :
    ...
    return path;
  });return function resolveLoadTargetPath(_x15, _x16) {return _ref6.apply(this, arguments);};})();
...
/**
                                                                                                     ...
                                                                                                     */let findRelativeFilePath = (() => {var _ref7 = (0, _asyncToGenerator.default)(
  function* (
  textEditor,
  position,
  directory)
  {
    const wordMatchAndRange = (0, (_range || _load_range()).wordAtPosition)(
    textEditor,
    position,
  ...
  });return function findRelativeFilePath(_x17, _x18, _x19) {return _ref7.apply(this, arguments);};})();var _nuclideBuckBase;function _load_nuclideBuckBase() {return _nuclideBuckBase = require('../../nuclide-buck-base');}var _buildFiles;function _load_buildFiles() {return _buildFiles = require('./buildFiles');}var _range;function _load_range() {return _range = require('../../../modules/nuclide-commons-atom/range');}var _nuclideRemoteConnection;function _load_nuclideRemoteConnection() {return _nuclideRemoteConnection = require('../../nuclide-remote-connection');}var _goToLocation;function _load_goToLocation() {return _goToLocation = require('../../../modules/nuclide-commons-atom/go-to-location');}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _escapeStringRegexp;function _load_escapeStringRegexp() {return _escapeStringRegexp = _interopRequireDefault(require('escape-string-regexp'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const VALID_BUILD_FILE_NAMES = new Set(['BUCK', 'BUCK.autodeps', 'TARGETS']);const VALID_BUILD_FILE_EXTENSIONS = new Set(['.bzl']);const TARGET_REGEX = /(\/(?:\/[\w.-]*)*){0,1}:([\w.-]+)/;const LOAD_REGEX = /(@[\w-]+)?\/\/([\w.\-/]*):([\w.-]+\.bzl)/;const RELATIVE_FILE_PATH_REGEX = /(['"])(.*)(['"])/;