...
var debugBuckTarget = _asyncToGenerator(function* (buckProject, buildTarget) {
  ...
  var remoteBuckRoot = (_nuclideRemoteUri2 || _nuclideRemoteUri()).default.getPath(buckRoot);
  var remoteOutputPath = (_nuclideRemoteUri2 || _nuclideRemoteUri()).default.getPath((_nuclideRemoteUri2 || _nuclideRemoteUri()).default.join(buckRoot, relativeOutputPath));

  var info = new (_nuclideDebuggerLldbClientLibLaunchProcessInfo2 || _nuclideDebuggerLldbClientLibLaunchProcessInfo()).LaunchProcessInfo(buckRoot, {
...
var _nuclideDebuggerLldbClientLibLaunchProcessInfo2;

function _nuclideDebuggerLldbClientLibLaunchProcessInfo() {
  return _nuclideDebuggerLldbClientLibLaunchProcessInfo2 = require('../../nuclide-debugger-lldb-client/lib/LaunchProcessInfo');
}
