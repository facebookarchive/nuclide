...
let debugBuckTarget = (() => {
  var _ref2 = (0, _asyncToGenerator.default)(function* (buckService, buckRoot, buildTarget, runArguments, targetType) {
  ...
  return function debugBuckTarget(_x, _x2, _x3, _x4, _x5) {
...
let debugPidWithLLDB = (() => {
  ...
  return function debugPidWithLLDB(_x6, _x7) {
...
let debugJavaTest = (() => {
  ...
  return function debugJavaTest(_x8, _x9) {
...
let debugAndroidActivity = (() => {
  ...
  return function debugAndroidActivity(_x10, _x11, _x12) {
...
let _getAttachProcessInfoFromPid = (() => {
  ...
  return function _getAttachProcessInfoFromPid(_x13, _x14) {
...
buckService, buckRoot, buildTarget, runArguments, targetType) {
  ...
  return processStream.filter(message => message.kind === 'exit' && message.exitCode === 0).switchMap(() => {
    return _rxjsBundlesRxMinJs.Observable.fromPromise(debugBuckTarget(buckService, buckRoot, buildTarget, runArguments, targetType)).map(path => ({
      type: 'log',
