...
function _load_string() {return _string = require('../../../../modules/nuclide-commons/string');}var _AtomInput;
...
function _load_ButtonGroup() {return _ButtonGroup = require('../../../../modules/nuclide-commons-ui/ButtonGroup');}var _LoadingSpinner;
function _load_LoadingSpinner() {return _LoadingSpinner = require('../../../../modules/nuclide-commons-ui/LoadingSpinner');}var _Modal;
function _load_Modal() {return _Modal = require('../../../../modules/nuclide-commons-ui/Modal');}var _Icon;
function _load_Icon() {return _Icon = require('../../../../modules/nuclide-commons-ui/Icon');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}
    ...
    return (
      _react.createElement((_Modal || _load_Modal()).Modal, { onDismiss: this.props.onDismiss },
        _react.createElement('div', { className: 'block' },
          _react.createElement('div', { className: 'block' },
            _react.createElement('label', null, 'Current Buck root:'),
            _react.createElement('p', null,
              _react.createElement('code', null, this.props.buckRoot)),

            _react.createElement('div', null,
              _react.createElement('label', null, 'Buck version:'),
              this._getBuckversionFileComponent()),

            _react.createElement('label', null, 'Build Arguments:'),
            ...
            _react.createElement('label', null, 'Run Arguments:'),
            _react.createElement((_AtomInput || _load_AtomInput()).AtomInput, {
              tabIndex: '0',
          ...
          _react.createElement('div', { style: { display: 'flex', justifyContent: 'flex-end' } },
            _react.createElement((_ButtonGroup || _load_ButtonGroup()).ButtonGroup, null,
              ...
              _react.createElement((_Button || _load_Button()).Button, {
                  ...
                  onClick: this._onSave.bind(this) }, 'Save'))))));
    ...
    if (buckversionFileContents == null) {
      ...
      return (
        _react.createElement('p', null,
          ...
          label, ' ', _react.createElement('code', null, buckversionFileContents)));
