...
var _nuclideUiLibLoadingSpinner = require('../../nuclide-ui/lib/LoadingSpinner');
      ...
      switch (outline.kind) {
        ...
        case 'loading':
          return _reactForAtom.React.createElement(
            ...
            _reactForAtom.React.createElement(_nuclideUiLibLoadingSpinner.LoadingSpinner, {
              className: 'inline-block',
              size: _nuclideUiLibLoadingSpinner.LoadingSpinnerSizes.MEDIUM
            })
          );
        case 'no-provider':
          return _reactForAtom.React.createElement(
