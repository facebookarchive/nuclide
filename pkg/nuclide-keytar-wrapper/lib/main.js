...
function getApmNodePath() {
  var apmDir = (_path2 || _path()).default.dirname(atom.packages.getApmPath());
  return (_path2 || _path()).default.normalize((_path2 || _path()).default.join(apmDir, 'node'));
}

function getApmNodeModulesPath() {
  var apmDir = (_path2 || _path()).default.dirname(atom.packages.getApmPath());
  return (_path2 || _path()).default.normalize((_path2 || _path()).default.join(apmDir, '..', 'node_modules'));
}
