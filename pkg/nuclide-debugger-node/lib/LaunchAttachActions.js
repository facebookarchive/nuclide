...
function _LaunchAttachDispatcher() {
  return _LaunchAttachDispatcher2 = require('./LaunchAttachDispatcher');
}

var _NodeAttachProcessInfo2;

function _NodeAttachProcessInfo() {
  return _NodeAttachProcessInfo2 = require('./NodeAttachProcessInfo');
}
...
var LaunchAttachActions = (function () {
  function LaunchAttachActions(dispatcher, targetUri) {
    ...
    this._subscriptions = new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(atom.commands.add('atom-workspace', {
  ...
  _createClass(LaunchAttachActions, [{
    ...
    value: function attachDebugger(attachTarget) {
      var attachInfo = new (_NodeAttachProcessInfo2 || _NodeAttachProcessInfo()).NodeAttachProcessInfo(this._targetUri, attachTarget);
    ...
    value: _asyncToGenerator(function* () {
      var rpcService = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getNodeDebuggerServiceByNuclideUri)(this._targetUri);
      var attachTargetList = yield rpcService.getAttachTargetInfoList();
      this._dispatcher.dispatch({
        actionType: (_LaunchAttachDispatcher2 || _LaunchAttachDispatcher()).ActionTypes.UPDATE_ATTACH_TARGET_LIST,
