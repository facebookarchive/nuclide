...
var _NodeDebuggerInstance;

function _load_NodeDebuggerInstance() {
  return _NodeDebuggerInstance = require('./NodeDebuggerInstance');
}
...
var NodeAttachProcessInfo = (function (_DebuggerProcessInfo) {
  ...
  _createClass(NodeAttachProcessInfo, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      return new (_NodeDebuggerInstance || _load_NodeDebuggerInstance()).NodeDebuggerInstance(this, rpcService);
    })
  }, {
    key: '_getRpcService',
    value: function _getRpcService() {
      ...
      var service = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getServiceByNuclideUri)('NodeDebuggerService', this.getTargetUri());
