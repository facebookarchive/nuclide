...
var NodeDebuggerInstance = (function (_DebuggerInstance) {
  ...
  _createClass(NodeDebuggerInstance, [{
    ...
    value: function _registerServerHandlers() {
      this._disposables.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(this._rpcService.getServerMessageObservable().refCount().subscribe(this._handleServerMessage.bind(this), this._handleServerError.bind(this), this._handleSessionEnd.bind(this))));
    }
  }, {
