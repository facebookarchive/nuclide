...
module.exports = _client => {
  ...
  remoteModule.ClangdLanguageService = class {
    isFileKnown(arg0) {
      return Promise.all([_client.marshalArguments(Array.from(arguments), [{
        name: "filePath",
        type: {
        ...
        name: "ClangdLanguageService"
      })]).then(([args, id]) => _client.callRemoteMethod(id, "isFileKnown", "promise", args)).then(value => {
        return _client.unmarshal(value, {
          kind: "boolean"
        });
      });
    ...
    addClangRequest(arg0) {
      return Promise.all([_client.marshalArguments(Array.from(arguments), [{
        ...
        name: "ClangdLanguageService"
      })]).then(([args, id]) => _client.callRemoteMethod(id, "addClangRequest", "promise", args)).then(value => {
        return _client.unmarshal(value, {
          kind: "boolean"
        });
      });
  ...
  remoteModule.createClangdService = function (arg0) {
    return _client.marshalArguments(Array.from(arguments), [{
      ...
      return _client.callRemoteFunction("ClangdLSPService/createClangdService", "promise", args);
    }).then(value => {
      return _client.unmarshal(value, {
        kind: "nullable",
        type: {
