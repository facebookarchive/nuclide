...
function getBuiltinProviders() {
  var providers = [];
  if ((_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get('nuclide-distraction-free-mode.hideToolBar')) {
    providers.push(new ToolBarProvider());
  }
  if ((_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get('nuclide-distraction-free-mode.hideStatusBar')) {
    providers.push(new StatusBarProvider());
  }
  if ((_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get('nuclide-distraction-free-mode.hideFindAndReplace')) {
  ...
  _createClass(StatusBarProvider, [{
    ...
    value: function toggle() {
      ...
      if (this.isVisible()) {
        ...
        (0, (_assert || _load_assert()).default)(this._oldDisplay != null);
