...
var ProjectStore = (function () {
  ...
  _createDecoratedClass(ProjectStore, [{
    ...
    value: _asyncToGenerator(function* (fileUri) {
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.isRemote(fileUri) && (yield (0, (_nuclideHackLibHackLanguage || _load_nuclideHackLibHackLanguage()).isFileInHackProject)(fileUri));
    })
  }, {
    ...
    value: function getDebugTarget() {
      ...
      if ((_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.isRemote(filePath)) {
        return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.getHostname(filePath);
      }
      return '';
    }
  }, {
