...
function _load_tasks() {return _tasks = require('../../commons-node/tasks');}var _bindObservableAsProps;
...
function _load_Icon() {return _Icon = require('../../../modules/nuclide-commons-ui/Icon');}var _HhvmDebug;

function _load_HhvmDebug() {return _HhvmDebug = require('./HhvmDebug');}var _HhvmToolbar;
function _load_HhvmToolbar() {return _HhvmToolbar = _interopRequireDefault(require('./HhvmToolbar'));}var _ProjectStore;
function _load_ProjectStore() {return _ProjectStore = _interopRequireDefault(require('./ProjectStore'));}
...
class HhvmBuildSystem {
  ...
  getExtraUi() {
    if (this._extraUi == null) {
      ...
      const subscription = (0, (_event || _load_event()).observableFromSubscribeFunction)(
      ...
      subscription.startWith(null).mapTo({ projectStore }), (_HhvmToolbar || _load_HhvmToolbar()).default);
  ...
  getIcon() {
    return () =>
    _react.createElement((_Icon || _load_Icon()).Icon, { icon: 'nuclicon-hhvm', className: 'nuclide-hhvm-task-runner-icon' });

  }

  runTask(taskName) {
    return (0, (_tasks || _load_tasks()).taskFromObservable)(
    _rxjsBundlesRxMinJs.Observable.fromPromise(
    (0, (_HhvmDebug || _load_HhvmDebug()).debug)(
  ...
  callback)
  {
    const enabledObservable = (0, (_event || _load_event()).observableFromSubscribeFunction)(
