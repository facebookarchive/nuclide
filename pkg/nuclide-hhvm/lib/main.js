  ...
  _debugDeepWithHhvm(params) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      if (startDebugger) {
        ...
        yield debuggerService.startDebugging((yield (0, (_HhvmLaunchAttachProvider || _load_HhvmLaunchAttachProvider()).getAttachProcessInfo)(hackRootUri, null /* attachPort */
        , true /* serverAttach */
        )));
      }
