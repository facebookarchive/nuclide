...
function _load_createPackage() {return _createPackage = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/createPackage'));}var _nuclideUri;
...
function _load_goToLocation() {return _goToLocation = require('../../../modules/nuclide-commons-atom/go-to-location');}var _nuclideAnalytics;
function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _HhvmLaunchAttachProvider;


function _load_HhvmLaunchAttachProvider() {return _HhvmLaunchAttachProvider = require('../../nuclide-debugger-vsp/lib/HhvmLaunchAttachProvider');}var _HhvmBuildSystem;
function _load_HhvmBuildSystem() {return _HhvmBuildSystem = _interopRequireDefault(require('./HhvmBuildSystem'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // eslint-disable-next-line nuclide-internal/no-cross-atom-imports
...
class Activation {
  ...
  _debugDeepWithHhvm(params) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const { nuclidePath, hackRoot, line, addBreakpoint, source } = params;

      if (
      typeof nuclidePath !== 'string' ||
      !(_nuclideUri || _load_nuclideUri()).default.isRemote(nuclidePath) ||
      ...
      if (_this._remoteProjectsService == null) {
        ...
        yield new Promise(function (resolve) {return (
      ...
      _this._remoteProjectsService != null)) {throw new Error('Invariant violation: "this._remoteProjectsService != null"');}
      ...
      (_nuclideUri || _load_nuclideUri()).default.getPath(pathString));
      ...
      if (startDebugger) {
        ...
        yield (0, (_HhvmLaunchAttachProvider || _load_HhvmLaunchAttachProvider()).startAttachProcessInfo)(
        hackRootUri,
        null /* attachPort */,
        true /* serverAttach */);
