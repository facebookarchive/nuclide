...
var Matcher = (function () {
  ...
  _createClass(Matcher, [{
    ...
    value: function match(query) {
      ...
      var topScores = new (_TopScores || _load_TopScores()).default(options.maxResults || 0);
    ...
    value: function addCandidates(candidates) {
      ...
      candidates.forEach(function (candidate) {
        _this._queryItems.set(candidate, new (_QueryItem || _load_QueryItem()).default(candidate));
      });
    }
  }, {
