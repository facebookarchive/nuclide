...
valueComparator = valueComparator;exports.
...
scoreComparator = scoreComparator;exports.
...
inverseScoreComparator = inverseScoreComparator; /**
    ...
    return charA === aUpper ? -1 : 1;}return a.length - b.length;} /**
                                                                    ...
                                                                    */ /**
                                                                        ...
                                                                        * 
                                                                        * @format
                                                                        */function scoreComparator(a, b) {const cmp = a.score - b.score;if (cmp !== 0) {return cmp;} else {return valueComparator(b.value, a.value);}}function inverseScoreComparator(a, b) {return scoreComparator(b, a);}