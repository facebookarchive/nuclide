...
var LldbDebuggerInstance = (function (_DebuggerInstance) {
  ...
  _createClass(LldbDebuggerInstance, [{
    ...
    value: function _registerServerHandlers(rpcService) {
      ...
      this._disposables.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(rpcService.getServerMessageObservable().refCount().subscribe(this._handleServerMessage.bind(this), this._handleServerError.bind(this), this._handleSessionEnd.bind(this))));
    }
  }, {
