...
class Activation {
  ...
  _debugPidWithLLDB(pid, buckRoot) {
    return (0, _asyncToGenerator.default)(function* () {
      const attachInfo = yield (0, (_utils3 || _load_utils3()).getNativeVSPAttachProcessInfo)((_nuclideDebuggerCommon || _load_nuclideDebuggerCommon()).VsAdapterTypes.NATIVE_LLDB, buckRoot, {
        pid,
  ...
  _debugBuckTarget(buckService, buckRoot, buildTarget, runArguments) {
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const info = yield (0, (_utils3 || _load_utils3()).getNativeVSPLaunchProcessInfo)(adapter, (_nuclideUri || _load_nuclideUri()).default.join(buckRoot, relativeOutputPath), {
