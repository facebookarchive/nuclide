...
var PanelLocation = (function (_SimpleModel) {
  ...
  _createClass(PanelLocation, [{
    ...
    value: function _createPanel() {
      ...
      var item = { getReactElement: function getReactElement() {
          return (_reactForAtom2 || _reactForAtom()).React.createElement(Component, null);
        } };
