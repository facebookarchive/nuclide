  ...
  _createClass(PanelLocation, [{
    ...
    value: function initialize() {
      ...
      paneContainer.observePanes(function (pane) {
        ...
        var initializeTabBar = function initializeTabBar() {
          (0, (_assert || _load_assert()).default)(typeof tabBarView.initialize === 'function');
        ...
        if (typeof tabBarView.initialize === 'function') {
          ...
          (function () {
            var disposables = new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(atom.packages.onDidActivatePackage(function (pkg) {
              if (typeof tabBarView.initialize === 'function') {
                initializeTabBar();
                disposables.dispose();
              }
