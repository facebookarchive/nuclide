...
var _nuclideUiLibView2;

function _nuclideUiLibView() {
  return _nuclideUiLibView2 = require('../../../nuclide-ui/lib/View');
}
  ...
  _createClass(Panel, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiLibView2 || _nuclideUiLibView()).View, { item: this.props.item })
      );
    }
  }]);
