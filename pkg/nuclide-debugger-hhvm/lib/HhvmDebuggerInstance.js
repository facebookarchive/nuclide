...
function getConfig() {
  return (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.get('nuclide-debugger-hhvm');
}
...
var HhvmDebuggerInstance = (function (_DebuggerInstance) {
  ...
  _createClass(HhvmDebuggerInstance, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      var service = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getServiceByNuclideUri)('HhvmDebuggerProxyService', this.getTargetUri());
