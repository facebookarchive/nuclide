...
var _ChromeMessageRemoting = require('./ChromeMessageRemoting');
...
function getConfig() {
  return _nuclideFeatureConfig2.default.get('nuclide-debugger-hhvm');
}
  ...
  _createClass(HhvmDebuggerInstance, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      this._observableManager = new _ObservableManager.ObservableManager(proxy.getNotificationObservable(), proxy.getServerMessageObservable(), proxy.getOutputWindowObservable().map(function (message) {
        var serverMessage = (0, _ChromeMessageRemoting.translateMessageFromServer)(_nuclideRemoteUri2.default.getHostname(_this.getTargetUri()), _nuclideRemoteUri2.default.getPort(_this.getTargetUri()), message);
      ...
      var sessionConfig = {
        ...
        targetUri: _nuclideRemoteUri2.default.getPath(this.getTargetUri()),
      ...
      var wsPort = 2000;
      var server = new _ws2.default.Server({ port: wsPort });
      this._server = server;
    ...
    value: function _sendServerMessageToChromeUi(message) {
      ...
      if (webSocket != null) {
        webSocket.send((0, _ChromeMessageRemoting.translateMessageFromServer)(_nuclideRemoteUri2.default.getHostname(this.getTargetUri()), _nuclideRemoteUri2.default.getPort(this.getTargetUri()), message));
      }
    }
  }, {
    key: '_endSession',
    ...
    value: function _onSocketMessage(message) {
      ...
      if (proxy) {
        proxy.sendCommand((0, _ChromeMessageRemoting.translateMessageToServer)(message));
      }
    }
  }, {
    key: '_onSocketError',
