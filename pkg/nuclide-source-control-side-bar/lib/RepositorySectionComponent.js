...
var RepositorySectionComponent = (function (_React$Component) {
  ...
  _createClass(RepositorySectionComponent, [{
    ...
    value: function _handleBookmarkClick(bookmark) {
      (0, (_assert || _load_assert()).default)(this.props.repository != null);
    ...
    value: function render() {
      ...
      if (repository != null) {
        if (repository.getType() === 'hg') {
          ...
          createButton = (_reactForAtom || _load_reactForAtom()).React.createElement('button', {
        ...
        if (repository.getType() === 'hg') {
          ...
          if (repositoryBookmarks == null) {
            bookmarksBranchesListItems = (_reactForAtom || _load_reactForAtom()).React.createElement(
              'li',
            ...
            bookmarksBranchesListItems = repositoryBookmarks.map(function (bookmark) {
              ...
              var isSelected = selectedItem != null && selectedItem.type === 'bookmark' && (0, (_bookmarkIsEqual || _load_bookmarkIsEqual()).default)(bookmark, selectedItem.bookmark);
              var liClassName = (0, (_classnames || _load_classnames()).default)('list-item nuclide-source-control-side-bar--list-item', {
                selected: isSelected
              });
              ...
              var iconClassName = (0, (_classnames || _load_classnames()).default)('icon', {
              ...
              if (isLoading) {
                loadingSpinner = (_reactForAtom || _load_reactForAtom()).React.createElement('span', { className: 'loading loading-spinner-tiny inline-block inline-block-tight' });
              }
          ...
          bookmarksBranchesList = (_reactForAtom || _load_reactForAtom()).React.createElement(
            'ul',
      ...
      if (this.props.hasSeparator) {
        separator = (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiHR || _load_nuclideUiHR()).HR, null);
      }

      var uncommittedChangesClassName = (0, (_classnames || _load_classnames()).default)('list-item nuclide-source-control-side-bar--list-item', {
