  ...
  _createClass(RepositorySectionComponent, [{
    ...
    value: function render() {
        ...
        if (repository.getType() === 'hg') {
          ...
          if (repositoryBookmarks == null) {
            ...
            bookmarksBranchesListItems = repositoryBookmarks.map(function (bookmark) {
              ...
              if (isLoading) {
                loadingSpinner = (_reactForAtom2 || _reactForAtom()).React.createElement('span', { className: 'loading loading-spinner-tiny inline-block inline-block-tight' });
              }
      ...
      if (this.props.hasSeparator) {
        separator = (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiHR2 || _nuclideUiHR()).HR, null);
      }
