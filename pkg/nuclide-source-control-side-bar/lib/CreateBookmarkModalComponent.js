...
var CreateBookmarkModal = (function (_React$Component) {
  ...
  _createClass(CreateBookmarkModal, [{
    ...
    value: function componentDidMount() {
      this.disposables.add(atom.commands.add((_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this), 'core:confirm', this._handleCreateClick));
    ...
    value: function render() {
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement('atom-text-editor', { mini: true, ref: 'atomTextEditor', tabIndex: '0' }),
        (_reactForAtom || _load_reactForAtom()).React.createElement(
          'div',
