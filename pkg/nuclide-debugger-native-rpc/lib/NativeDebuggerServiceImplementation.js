...
class NativeDebuggerService extends (_nuclideDebuggerCommon || _load_nuclideDebuggerCommon()).DebuggerRpcWebSocketService {
  ...
  _startDebugging(inferiorArguments) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const pythonBinaryPath = _this._config.pythonBinaryPath || (yield _getDefaultLLDBConfig()).pythonPath;
      const lldbPythonPath = inferiorArguments.lldb_python_path || (yield _getDefaultLLDBConfig()).lldbModulePath;
