...
var NativeDebuggerService = (function () {
  ...
  _createClass(NativeDebuggerService, [{
    ...
    value: function _registerIpcChannel(lldbProcess) {
      ...
      this._subscriptions.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default((0, (_commonsNodeStream2 || _commonsNodeStream()).splitStream)((0, (_commonsNodeStream2 || _commonsNodeStream()).observeStream)(ipcStream)).subscribe(this._handleIpcMessage.bind(this, ipcStream), function (error) {
