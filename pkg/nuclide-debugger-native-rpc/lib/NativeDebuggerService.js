...
const logTrace = (_utils || _load_utils()).default.logTrace;
...
let NativeDebuggerService = exports.NativeDebuggerService = class NativeDebuggerService {
  ...
  attach(attachInfo) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const inferiorArguments = {
        ...
        basepath: attachInfo.basepath ? attachInfo.basepath : _this._config.buckConfigRootFile
      };
      yield _this._startDebugging(inferiorArguments);
    })();
  }
  ...
  launch(launchInfo) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const inferiorArguments = {
        ...
        basepath: launchInfo.basepath ? launchInfo.basepath : _this2._config.buckConfigRootFile
      };
      yield _this2._startDebugging(inferiorArguments);
    })();
  }
  ...
  _startDebugging(inferiorArguments) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const lldbProcess = _this3._spawnPythonBackend();
      lldbProcess.on('exit', _this3._handleLLDBExit.bind(_this3));
      _this3._registerIpcChannel(lldbProcess);
      _this3._sendArgumentsToPythonBackend(lldbProcess, inferiorArguments);
      const lldbWebSocket = yield _this3._connectWithLLDB(lldbProcess);
      _this3._lldbWebSocket = lldbWebSocket;
      _this3._subscriptions.add(function () {
        return lldbWebSocket.terminate();
      });
      lldbWebSocket.on('message', _this3._handleLLDBMessage.bind(_this3));
    })();
  }
