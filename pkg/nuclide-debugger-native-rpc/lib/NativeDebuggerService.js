...
var NativeDebuggerService = (function () {
  function NativeDebuggerService(config) {
    ...
    this._subscriptions = new (_eventKit || _load_eventKit()).CompositeDisposable(this._clientCallback);
  }
  ...
  _createClass(NativeDebuggerService, [{
    ...
    value: function _registerIpcChannel(lldbProcess) {
      ...
      this._subscriptions.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default((0, (_commonsNodeObservable || _load_commonsNodeObservable()).splitStream)((0, (_commonsNodeStream || _load_commonsNodeStream()).observeStream)(ipcStream)).subscribe(this._handleIpcMessage.bind(this, ipcStream), function (error) {
    ...
    value: function _sendArgumentsToPythonBackend(child, args) {
      ...
      this._subscriptions.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default((0, (_commonsNodeStream || _load_commonsNodeStream()).observeStream)(argumentsStream).first().subscribe(function (text) {
