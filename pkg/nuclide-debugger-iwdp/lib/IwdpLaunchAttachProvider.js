...
var IwdpLaunchAttachProvider = (function (_DebuggerLaunchAttachProvider) {
  _inherits(IwdpLaunchAttachProvider, _DebuggerLaunchAttachProvider);

  function IwdpLaunchAttachProvider(debuggingTypeName, targetUri) {
    _classCallCheck(this, IwdpLaunchAttachProvider);

    _get(Object.getPrototypeOf(IwdpLaunchAttachProvider.prototype), 'constructor', this).call(this, debuggingTypeName, targetUri);
  }

  _createClass(IwdpLaunchAttachProvider, [{
    key: 'getActions',
  ...
  return IwdpLaunchAttachProvider;
