...
/**
...

  {
    ...
    return result;
                                                                                                                   ...
                                                                                                                   * 
                                                                                                                   * @format
                                                                                                                   */var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _which;function _load_which() {return _which = _interopRequireDefault(require('nuclide-commons/which'));}var _LspLanguageService;function _load_LspLanguageService() {return _LspLanguageService = require('./LspLanguageService');}var _main;function _load_main() {return _main = require('../../nuclide-open-files-rpc/lib/main');}var _nuclideLanguageServiceRpc;function _load_nuclideLanguageServiceRpc() {return _nuclideLanguageServiceRpc = require('../../nuclide-language-service-rpc');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}