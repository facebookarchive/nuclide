...
module.exports = _client => {
  ...
  remoteModule.processPlatform = function () {
    return _client.callRemoteFunction("VSCodeLanguageService/processPlatform", "promise", _client.marshalArguments(Array.from(arguments), [])).then(value => {
      return _client.unmarshal(value, {
        kind: "string"
      });
    });
