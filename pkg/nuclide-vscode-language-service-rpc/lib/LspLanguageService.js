...
class LspLanguageService {
  ...
  _executeCommand(command, args) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this10._state !== 'Running') {
        throw new Error(`${_this10._languageId} is not currently in a state to handle the request`);
      } else if (!_this10._serverCapabilities.executeCommandProvider) {
        throw new Error(`${_this10._languageId} cannot handle the request`);
      }
      try {
        yield _this10._lspConnection.executeCommand({
          command,
          arguments: args
        });
      } catch (e) {
  ...
  getCodeActions(fileVersion, range, diagnostics) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this11._state !== 'Running' || !_this11._serverCapabilities.codeActionProvider) {
        return [];
      }
      ...
      let response;
      try {
        response = yield _this11._lspConnection.codeAction(params);
      } catch (e) {
      ...
      return response.map(function (command) {
        ...
        const applyFunc = (() => {
          var _ref2 = (0, _asyncToGenerator.default)(function* () {
            yield _this11._executeCommand(command.command, command.arguments);
          });
  ...
  typeHint(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this12._state !== 'Running' || !_this12._serverCapabilities.hoverProvider || !(yield _this12._lspFileVersionNotifier.waitForBufferAtVersion(fileVersion))) {
        return null;
      }
      const params = (_convert || _load_convert()).atom_lspPositionParams(fileVersion.filePath, position);
      ...
      let response;
      try {
        _this12._hoverCancellation.cancel();
        _this12._hoverCancellation = new (_vscodeJsonrpc || _load_vscodeJsonrpc()).CancellationTokenSource();
        response = yield _this12._lspConnection.hover(params, _this12._hoverCancellation.token);
  ...
  highlight(fileVersion, position) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this13._state !== 'Running' || !_this13._serverCapabilities.documentHighlightProvider || !(yield _this13._lspFileVersionNotifier.waitForBufferAtVersion(fileVersion))) {
        return null;
      }
      const params = (_convert || _load_convert()).atom_lspPositionParams(fileVersion.filePath, position);
      ...
      let response;
      try {
        _this13._highlightCancellation.cancel();
        _this13._highlightCancellation = new (_vscodeJsonrpc || _load_vscodeJsonrpc()).CancellationTokenSource();
        response = yield _this13._lspConnection.documentHighlight(params, _this13._highlightCancellation.token);
  ...
  formatSource(fileVersion, atomRange, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const buffer = yield _this14.tryGetBufferWhenWeAndLspAtSameVersion(fileVersion);
      if (buffer == null) {
        _this14._logger.error('LSP.formatSource - buffer changed before we could format');
        return null;
      }
      const params = {
        textDocument: (_convert || _load_convert()).localPath_lspTextDocumentIdentifier(fileVersion.filePath),
      ...
      const canAll = Boolean(_this14._serverCapabilities.documentFormattingProvider);
      const canRange = Boolean(_this14._serverCapabilities.documentRangeFormattingProvider);
      const wantAll = buffer.getRange().compare(atomRange) === 0;
      if (canAll && (wantAll || !canRange)) {
        try {
          response = yield _this14._lspConnection.documentFormatting(params);
        ...
        try {
          response = yield _this14._lspConnection.documentRangeFormatting(params2);
        ...
        _this14._logger.error('LSP.formatSource - not supported by server');
        return null;
      }
  ...
  formatAtPosition(fileVersion, point, triggerCharacter, options) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const triggerCharacters = _this15._derivedServerCapabilities.onTypeFormattingTriggerCharacters;
      if (_this15._state !== 'Running' || !triggerCharacters.has(triggerCharacter) || !(yield _this15._lspFileVersionNotifier.waitForBufferAtVersion(fileVersion))) {
        return null;
      }
      const params = {
        textDocument: (_convert || _load_convert()).localPath_lspTextDocumentIdentifier(fileVersion.filePath),
      ...
      let response;
      try {
        response = yield _this15._lspConnection.documentOnTypeFormatting(params);
  ...
  symbolSearch(query, directories) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this16._state !== 'Running' || !_this16._serverCapabilities.workspaceSymbolProvider) {
        return null;
      }
      const params = { query };
      ...
      let response;
      try {
        response = yield _this16._lspConnection.workspaceSymbol(params);
