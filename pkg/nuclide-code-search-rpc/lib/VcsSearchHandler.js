...
search = search;var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _process;function _load_process() {return _process = require('../../../modules/nuclide-commons/process');}var _handlerCommon;function _load_handlerCommon() {return _handlerCommon = require('./handlerCommon');}var _parser;function _load_parser() {return _parser = require('./parser');} /**
                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                              * 
                                                                                                                                                                                                                                                                                                                                                                              * @format
                                                                                                                                                                                                                                                                                                                                                                              */function search(directory, regex) {const sharedArgs = (regex.ignoreCase ? ['-i'] : []).concat([// print line number
  ...
  event => (0, (_parser || _load_parser()).parseVcsGrepLine)(event, directory, regex),
  regex,
  0,
  0);
