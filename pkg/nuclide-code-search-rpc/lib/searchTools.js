...
const searchToolHandlers = new Map([['ack', (_AckHandler || _load_AckHandler()).search], ['rg', (_RgHandler || _load_RgHandler()).search], ['grep', (_GrepHandler || _load_GrepHandler()).search]]);
