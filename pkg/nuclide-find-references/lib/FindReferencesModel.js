...
var readFileContents = _asyncToGenerator(function* (uri) {
  var localPath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.getPath(uri);
...
var FindReferencesModel = (function () {
  ...
  _createClass(FindReferencesModel, [{
    ...
    value: _asyncToGenerator(function* (offset, limit) {
      ...
      return (0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayCompact)(fileReferences);
    })
  }, {
    key: 'getBasePath',
    ...
    value: _asyncToGenerator(function* (fileReferences) {
      ...
      refGroups = refGroups.map(function (group) {
        ...
        startLine = Math.max(startLine - _this.getPreviewContext(), 0);
        endLine = Math.min(endLine + _this.getPreviewContext(), fileLines.length - 1);
