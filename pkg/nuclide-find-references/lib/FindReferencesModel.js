...
var readFileContents = _asyncToGenerator(function* (uri) {
  var localPath = (0, _nuclideRemoteUri.getPath)(uri);
  var contents = undefined;
  try {
    contents = (yield (0, _nuclideClient.getFileSystemServiceByNuclideUri)(uri).readFile(localPath)).toString('utf8');
  } catch (e) {
    (0, _nuclideLogging.getLogger)().error('find-references: could not load file ' + uri, e);
    return null;
  }
  return contents;
});
...
var FindReferencesModel = (function () {
  ...
  _createClass(FindReferencesModel, [{
    ...
    value: _asyncToGenerator(function* (offset, limit) {
      ...
      return _nuclideCommons.array.compact(fileReferences);
    })
  }, {
    key: 'getBasePath',
