...
var _viewFindReferencesView;

function _load_viewFindReferencesView() {
  return _viewFindReferencesView = _interopRequireDefault(require('./view/FindReferencesView'));
}
...
var FindReferencesElement = (function (_HTMLElement) {
  ...
  _createClass(FindReferencesElement, [{
    ...
    value: function attachedCallback() {
      (_reactForAtom || _load_reactForAtom()).ReactDOM.render((_reactForAtom || _load_reactForAtom()).React.createElement((_viewFindReferencesView || _load_viewFindReferencesView()).default, { model: this._model }), this);
    }
