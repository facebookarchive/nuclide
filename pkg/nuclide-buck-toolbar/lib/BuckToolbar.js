...
var _SimulatorDropdown = require('./SimulatorDropdown');

var _SimulatorDropdown2 = _interopRequireDefault(_SimulatorDropdown);
...
var BuckToolbar = (function (_React$Component) {
  ...
  _createClass(BuckToolbar, null, [{
    key: 'propTypes',
    value: {
      store: _reactForAtom.React.PropTypes.instanceOf(_BuckToolbarStore2.default).isRequired,
      actions: _reactForAtom.React.PropTypes.instanceOf(_BuckToolbarActions2.default).isRequired
    },
    enumerable: true
  }]);
  ...
  function BuckToolbar(props) {
    ...
    this._handleBuildTargetChange = (0, _nuclideCommons.debounce)(this._handleBuildTargetChange.bind(this), 100, false);
    ...
    this._disposables.add(_nuclideAtomHelpers.atomEventDebounce.onWorkspaceDidStopChangingActivePaneItem(this._onActivePaneItemChanged.bind(this)));
  ...
  _createClass(BuckToolbar, [{
    ...
    value: function render() {
      ...
      if (buckToolbarStore.isReactNativeApp()) {
        serverModeCheckbox = _reactForAtom.React.createElement(
          'div',
      ...
      if (buckToolbarStore.isBuilding()) {
        progressBar = _reactForAtom.React.createElement('progress', {
      ...
      return _reactForAtom.React.createElement(
        ...
        _reactForAtom.React.createElement(_nuclideUiLibCombobox.Combobox, {
          className: 'inline-block',
          ref: 'buildTarget',
        ...
        _reactForAtom.React.createElement(_SimulatorDropdown2.default, {
          className: 'inline-block',
