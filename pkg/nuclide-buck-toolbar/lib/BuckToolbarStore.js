...
var _nuclideBuckCommons = require('../../nuclide-buck-commons');
...
var BuckToolbarStore = (function () {
  ...
  _createClass(BuckToolbarStore, [{
    ...
    value: function _setupActions() {
      ...
      this._dispatcher.register(function (action) {
        switch (action.actionType) {
          case _BuckToolbarActions2.default.ActionType.UPDATE_PROJECT:
            _this._updateProject(action.editor);
            break;
          case _BuckToolbarActions2.default.ActionType.UPDATE_BUILD_TARGET:
            _this._updateBuildTarget(action.buildTarget);
            break;
          case _BuckToolbarActions2.default.ActionType.UPDATE_SIMULATOR:
            _this._simulator = action.simulator;
            break;
          case _BuckToolbarActions2.default.ActionType.UPDATE_REACT_NATIVE_SERVER_MODE:
            _this._isReactNativeServerMode = action.serverMode;
            _this.emitChange();
            break;
          case _BuckToolbarActions2.default.ActionType.BUILD:
            _this._doBuild('build', /* debug */false);
            break;
          case _BuckToolbarActions2.default.ActionType.RUN:
            _this._doBuild('install', /* debug */false);
            break;
          case _BuckToolbarActions2.default.ActionType.TEST:
            _this._doBuild('test', /* debug */false);
            break;
          case _BuckToolbarActions2.default.ActionType.DEBUG:
            _this._doDebug();
            break;
          case _BuckToolbarActions2.default.ActionType.TOGGLE_PANEL_VISIBILITY:
            _this._isPanelVisible = !_this._isPanelVisible;
            _this.emitChange();
            break;
          case _BuckToolbarActions2.default.ActionType.UPDATE_PANEL_VISIBILITY:
    ...
    value: _asyncToGenerator(function* () {
      ...
      return _path2.default.join(repoRoot, serverCommand);
    })
  }, {
    key: '_updateProject',
    value: _asyncToGenerator(function* (editor) {
      ...
      if (!buckProject) {
        buckProject = yield (0, _nuclideBuckCommons.buckProjectRootForPath)(nuclideUri);
        if (!buckProject) {
          return;
        }
    ...
    value: _asyncToGenerator(function* (buckParams) {
      ...
      var runProcessWithHandlers = _asyncToGenerator(function* (dataHandlerOptions) {
        ...
        (0, _assert2.default)(buckProject);
        if (run) {
