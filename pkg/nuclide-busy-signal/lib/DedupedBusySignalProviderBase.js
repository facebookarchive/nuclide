...
var DedupedBusySignalProviderBase = (function (_BusySignalProviderBase2) {
  _inherits(DedupedBusySignalProviderBase, _BusySignalProviderBase2);
  ...
  _createClass(DedupedBusySignalProviderBase, [{
    ...
    value: function _decrementCount(message, options) {
      var key = this._getKey(message, options);
      var record = this._messageRecords.get(key);
      (0, (_assert || _load_assert()).default)(record != null);
      (0, (_assert || _load_assert()).default)(record.count > 0);
      if (record.count === 1) {
...
})((_BusySignalProviderBase || _load_BusySignalProviderBase()).BusySignalProviderBase);
