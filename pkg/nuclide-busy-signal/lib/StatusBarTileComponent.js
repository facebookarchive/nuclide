...
var StatusBarTileComponent = (function (_React$Component) {
  ...
  _createClass(StatusBarTileComponent, [{
    ...
    value: function render() {
      var classes = (0, (_classnames || _load_classnames()).default)('nuclide-busy-signal-status-bar', { 'loading-spinner-tiny': this.props.busy });
      return (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: classes });
    }
  }]);
