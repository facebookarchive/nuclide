...
function printIdentifier(print, node) {
  return (0, (_utilsFlatten2 || _utilsFlatten()).default)([node.name, node.typeAnnotation ? print(node.typeAnnotation) : (_constantsMarkers2 || _constantsMarkers()).default.empty]);
}
