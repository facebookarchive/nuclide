...
function printNewExpression(print, node) {
  ...
  return wrap(['new', (_constantsMarkers2 || _constantsMarkers()).default.noBreak, (_constantsMarkers2 || _constantsMarkers()).default.space, print(node.callee), (_constantsMarkers2 || _constantsMarkers()).default.noBreak, '(', (0, (_commonPrintCommaSeparatedNodes2 || _commonPrintCommaSeparatedNodes()).default)(print, node.arguments), ')']);
}
