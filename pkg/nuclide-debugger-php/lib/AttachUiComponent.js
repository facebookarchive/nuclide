...
var AttachUiComponent = (function (_React$Component) {
  ...
  _createClass(AttachUiComponent, [{
    ...
    value: function _getPathMenuItems() {
      var connections = (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).RemoteConnection.getByHostname((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getHostname(this.props.targetUri));
    ...
    value: function _handleAttachButtonClick() {
      ...
      var _default$parseRemoteUri = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parseRemoteUri(this.props.targetUri);
      ...
      var processInfo = new (_AttachProcessInfo2 || _AttachProcessInfo()).AttachProcessInfo((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.createRemoteUri(hostname, selectedPath));
