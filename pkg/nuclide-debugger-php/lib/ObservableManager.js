...
var ObservableManager = (function () {
  ...
  _createClass(ObservableManager, [{
    ...
    value: function _subscribe() {
      ...
      this._disposables.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(sharedNotifications.subscribe(this._handleNotificationMessage.bind(this), this._handleNotificationError.bind(this), this._handleNotificationEnd.bind(this))));
      var sharedServerMessages = this._serverMessages.share();
      this._disposables.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(sharedServerMessages.subscribe(this._handleServerMessage.bind(this), this._handleServerError.bind(this), this._handleServerEnd.bind(this))));
    ...
    value: function _registerOutputWindowLogging(sharedOutputWindowMessages) {
      ...
      if (api != null) {
        ...
        this._disposables.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(sharedOutputWindowMessages.subscribe({
