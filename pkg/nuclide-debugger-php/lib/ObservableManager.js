...
var ObservableManager = (function () {
  ...
  _createClass(ObservableManager, [{
    ...
    value: function _subscribe() {
      ...
      this._disposables.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(sharedNotifications.subscribe(this._handleNotificationMessage.bind(this), this._handleNotificationError.bind(this), this._handleNotificationEnd.bind(this))));
      var sharedServerMessages = this._serverMessages.share();
      this._disposables.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(sharedServerMessages.subscribe(this._handleServerMessage.bind(this), this._handleServerError.bind(this), this._handleServerEnd.bind(this))));
      var sharedOutputWindow = this._outputWindowMessages.share();
      this._registerOutputWindowLogging(sharedOutputWindow);
      (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.merge(sharedNotifications, sharedServerMessages, sharedOutputWindow).subscribe({
    ...
    value: function _registerOutputWindowLogging(sharedOutputWindowMessages) {
      var api = (0, (_nuclideDebuggerBase2 || _nuclideDebuggerBase()).getOutputService)();
      if (api != null) {
        ...
        this._disposables.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(sharedOutputWindowMessages.subscribe({
