...
class LaunchUiComponent extends _react.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default(), this.state = {
      ...
      const processInfo = new (_LaunchProcessInfo || _load_LaunchProcessInfo()).LaunchProcessInfo(this.props.targetUri, scriptPath, null, this.state.runInTerminal, '', cwdPath);
