...
var LaunchUiComponent = (function (_React$Component) {
  ...
  _createClass(LaunchUiComponent, [{
    ...
    value: function _getPathMenuItems() {
      var hostname = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getHostname(this.props.targetUri);
      var connections = (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).RemoteConnection.getByHostname(hostname);
    ...
    value: function _getActiveFilePath() {
      ...
      if (editor != null) {
        ...
        if (fileUri != null && this._isValidScriptUri(fileUri)) {
          return (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getPath(fileUri);
        }
      }
      return '';
    }
    ...
    value: function _isValidScriptUri(uri) {
      ...
      var scriptPath = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getPath(uri);
