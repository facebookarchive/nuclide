  ...
  _createClass(ArcToolbarSection, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiCombobox2 || _nuclideUiCombobox()).Combobox, {
    ...
    value: function _requestOptions(inputText) {
      return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromPromise(this.props.model.loadBuildTargets());
    }
  }, {
