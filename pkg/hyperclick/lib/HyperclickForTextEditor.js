...
var HyperclickForTextEditor = (function () {
  function HyperclickForTextEditor(textEditor, hyperclick) {
    ...
    this._subscriptions.add(atom.config.observe(process.platform === 'darwin' ? 'nuclide.hyperclick.darwinTriggerKeys' : process.platform === 'win32' ? 'nuclide.hyperclick.win32TriggerKeys' : 'nuclide.hyperclick.linuxTriggerKeys', function (newValue) {
  ...
  _createDecoratedClass(HyperclickForTextEditor, [{
    ...
    value: function _setupMouseDownListener() {
      ...
      var getLinesDomNode = function getLinesDomNode() {
        ...
        (0, (_assert || _load_assert()).default)(component);
      ...
      this._subscriptions.add(new (_atom || _load_atom()).Disposable(removeMouseDownListener));
    ...
    value: function _confirmSuggestion(suggestion) {
      if (Array.isArray(suggestion.callback) && suggestion.callback.length > 0) {
        ...
        (0, (_assert || _load_assert()).default)(typeof suggestion.callback === 'function');
        suggestion.callback();
      }
    }
  }, {
    ...
    value: function _onMouseMove(event) {
      ...
      var _ref = (0, (_hyperclickUtils || _load_hyperclickUtils()).getWordTextAndRange)(this._textEditor, this._getMousePositionAsBufferPosition());
    ...
    value: _asyncToGenerator(function* () {
      ...
      if (this._lastSuggestionAtMouse != null) {
        ...
        (0, (_assert || _load_assert()).default)(range, 'Hyperclick result must have a valid Range');
      ...
      this._loadingTracker = (0, (_nuclideAnalytics || _load_nuclideAnalytics()).startTracking)('hyperclick-loading');
    ...
    value: function _getMousePositionAsBufferPosition() {
      ...
      (0, (_assert || _load_assert()).default)(component);
      (0, (_assert || _load_assert()).default)(this._lastMouseEvent);
      ...
      try {
        ...
        return new (_atom || _load_atom()).Point(0, 0);
      }
    }
  }, {
    ...
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('hyperclick:confirm-cursor')],
    value: _asyncToGenerator(function* () {
