...
var SuggestionListElement = (function (_HTMLElement) {
  ...
  _createClass(SuggestionListElement, [{
    ...
    value: function attachedCallback() {
      (_reactForAtom || _load_reactForAtom()).ReactDOM.render((_reactForAtom || _load_reactForAtom()).React.createElement(SuggestionList, { suggestionList: this._model }), this);
    }
    ...
    value: function detachedCallback() {
      (_reactForAtom || _load_reactForAtom()).ReactDOM.unmountComponentAtNode(this);
    }
  }, {
    key: 'dispose',
...
var SuggestionList = (function (_React$Component) {
  ...
  _createClass(SuggestionList, [{
    ...
    value: function componentWillMount() {
      ...
      (0, (_assert || _load_assert()).default)(suggestion);
    ...
    value: function componentDidMount() {
      ...
      (0, (_assert || _load_assert()).default)(textEditor);
      ...
      (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this.refs.scroller).addEventListener('mousewheel', stopPropagation);
      this._subscriptions.add(new (_atom || _load_atom()).Disposable(function () {
        (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(_this.refs.scroller).removeEventListener('mousewheel', stopPropagation);
      }));
