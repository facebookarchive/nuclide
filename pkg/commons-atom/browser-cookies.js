...
var _electron = _interopRequireDefault(require('electron'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                           ...
                                                                                                                                                           *  strict
                                                                                                                                                           * @format
                                                                                                                                                           */const { remote } = _electron.default;if (!(remote != null)) {throw new Error('Invariant violation: "remote != null"');}exports.default = { getCookies(domain) {return new Promise((resolve, reject) => {// $FlowFixMe: Add types for electron$WebContents
