...
observeBuffers = observeBuffers;exports.
...
observeBufferCloseOrRename = observeBufferCloseOrRename;var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _event;function _load_event() {return _event = require('nuclide-commons/event');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                         * 
                                                                                                                                                                                                                                                                                                                                                                                                                                         * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                         */function observeBuffers(observeBuffer) {return atom.project.observeBuffers(buffer => {if (!(_nuclideUri || _load_nuclideUri()).default.isBrokenDeserializedUri(buffer.getPath())) {observeBuffer(buffer);}});} // Observes all buffer opens.
