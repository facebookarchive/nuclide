...
var LanguageTextEditorsListener = (function () {
  function LanguageTextEditorsListener(grammarScopes) {
    ...
    this._grammarSubscription = (0, (_observeGrammarForTextEditors || _load_observeGrammarForTextEditors()).default)(function (textEditor, grammar) {
  ...
  _createClass(LanguageTextEditorsListener, [{
    ...
    value: function observeLanguageTextEditors(fn, cleanupFn) {
      ...
      return new (_atom || _load_atom()).CompositeDisposable(this._emitter.on(START_OBSERVING_TEXT_EDITOR_EVENT, fn), this._emitter.on(STOP_OBSERVING_TEXT_EDITOR_EVENT, cleanupFn));
    }
  }, {
    key: 'dispose',
