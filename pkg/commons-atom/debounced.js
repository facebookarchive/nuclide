...
function observeTextEditorsPositions() {
  ...
  return observeActiveEditorsDebounced(editorDebounceInterval).switchMap(function (editor) {
    return editor == null ? (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.of(null) : (0, (_textEditor2 || _textEditor()).getCursorPositions)(editor).debounceTime(positionDebounceInterval).map(function (position) {
