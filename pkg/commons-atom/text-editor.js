...
function getCursorPositions(editor) {
  ...
  return (_rxjs2 || _rxjs()).Observable.merge((_rxjs2 || _rxjs()).Observable.of(cursor.getBufferPosition()), (0, (_commonsNodeEvent2 || _commonsNodeEvent()).observableFromSubscribeFunction)(cursor.onDidChangePosition.bind(cursor)).map(function (event) {
