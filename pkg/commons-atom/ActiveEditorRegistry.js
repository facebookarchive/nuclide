  ...
  _createClass(ActiveEditorRegistry, [{
    ...
    value: function _createResultsStream(eventSources) {
      ...
      var results = eventSources.activeEditors.switchMap(function (editorArg) {
        ...
        (_rxjs2 || _rxjs()).Observable.of({
          kind: 'pane-change',
          editor: editor
        }), (_rxjs2 || _rxjs()).Observable.fromPromise(_this2._getResultForEditor(_this2._getProviderForEditor(editor), editor)), _this2._resultsForEditor(editor, eventSources));
      });
    ...
    value: function _resultsForEditor(editor, eventSources) {
      ...
      return (_rxjs2 || _rxjs()).Observable.merge(eventSources.changesForEditor(editor).map(function () {
        ...
        (_rxjs2 || _rxjs()).Observable.of({ kind: event, editor: editor }), (_rxjs2 || _rxjs()).Observable.fromPromise(_this3._getResultForEditor(provider, editor)));
      });
    }
  }, {
