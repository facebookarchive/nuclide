...
app = app;var _Actions;function _load_Actions() {return _Actions = _interopRequireWildcard(require('./Actions'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    *  strict-local
                                                                                                                                                                                                                                                                                                                                                                                    * @format
                                                                                                                                                                                                                                                                                                                                                                                    */function app(state, action) {switch (action.type) {case (_Actions || _load_Actions()).SET_CUSTOM_ADB_PATH:const customAdbPaths = new Map(state.customAdbPaths);customAdbPaths.set(action.payload.host, action.payload.path);return Object.assign({}, state, { customAdbPaths });
