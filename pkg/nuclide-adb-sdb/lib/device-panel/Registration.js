...
var _ATEmulatorComponentProvider;

function _load_ATEmulatorComponentProvider() {
  return _ATEmulatorComponentProvider = require('./ATEmulatorComponentProvider');
}
