...
var _nuclideUiWebview2;

function _nuclideUiWebview() {
  return _nuclideUiWebview2 = require('../../../nuclide-ui/Webview');
}
...
var Inspector = (function (_React$Component) {
  ...
  _createClass(Inspector, [{
    ...
    value: function render() {
      return (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiWebview2 || _nuclideUiWebview()).Webview, {
    ...
    value: function _handleDidFinishLoad(event) {
      ...
      var inspectorDevTools = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(__dirname, '../../VendorLib/dev-tools/standalone.js');
