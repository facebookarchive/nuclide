...
var _nuclideUiWebview;

function _load_nuclideUiWebview() {
  return _nuclideUiWebview = require('../../../nuclide-ui/Webview');
}
...
var Inspector = (function (_React$Component) {
  ...
  _createClass(Inspector, [{
    ...
    value: function render() {
      return (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiWebview || _load_nuclideUiWebview()).Webview, {
    ...
    value: function _handleDidFinishLoad(event) {
      ...
      var inspectorDevTools = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(__dirname, '../../VendorLib/dev-tools/standalone.js');
