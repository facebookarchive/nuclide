...
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _main;

function _load_main() {return _main = require('./main');} /**
                                                           ...
                                                           * 
                                                           * @format
                                                           */const SHOW_CONSOLE_ON_PROCESS_EVENTS = ['stdout', 'stderr', 'error'];class ConsoleClient {
  constructor(
  processName,
  progressUpdates,
  ...
  processMessage /* TODO(T17463635) */)
  {
    (0, (_main || _load_main()).pipeProcessMessagesToConsole)(
    this._processName,
