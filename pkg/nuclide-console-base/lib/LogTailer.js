'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.LogTailer = undefined;var _UniversalDisposable;
...
class LogTailer {
  ...
  constructor(options) {
    ...
    this._messages = _rxjsBundlesRxMinJs.Observable.merge(
    messages,
    this._ready == null ? _rxjsBundlesRxMinJs.Observable.empty() : this._ready.ignoreElements() // For the errors.
    ).
    do({
      complete: () => {
      ...
      (0, (_log4js || _load_log4js()).getLogger)('nuclide-console').error(
