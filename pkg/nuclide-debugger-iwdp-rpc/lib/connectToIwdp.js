...
function connectToIwdp() {
  ...
  'script', (0, (_process || _load_process()).createArgsForScriptCommand)('ios_webkit_debug_proxy', ['--no-frontend']), { /* TODO(T17353599) */isExitError: () => false }).catch(error => _rxjsBundlesRxMinJs.Observable.of({ kind: 'error', error })) // TODO(T17463635)
  .mergeMap(message => {
