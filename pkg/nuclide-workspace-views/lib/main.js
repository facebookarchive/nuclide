...
function createPackageStore(rawState) {
  ...
  var disposables = new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default((0, (_commonsAtomSyncAtomCommands || _load_commonsAtomSyncAtomCommands()).default)(states.map(function (state) {
    return state.viewableFactories;
  }).distinctUntilChanged().map(function (viewableFactories) {
