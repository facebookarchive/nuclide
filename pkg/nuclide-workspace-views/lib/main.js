  ...
  _createClass(Activation, [{
    ...
    value: function provideWorkspaceViewsService() {
      ...
      if (this._service == null) {
        (function () {
          var pkg = _this; // eslint-disable-line consistent-this
          ...
          _this._service = {
            ...
            observeViewableFactories: function observeViewableFactories(location, cb) {
              ...
              (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.from(pkg._getStore()).map(function (state) {
...
function createPackageStore(rawState) {
  ...
  var states = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.from(store);
