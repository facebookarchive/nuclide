...
function serialize(state) {
  return {
    serializedLocationStates: (0, (_commonsNodeCollection || _load_commonsNodeCollection()).objectFromMap)(new Map(Array.from(state.locations.entries()).map(function (_ref) {
...
function deserialize(rawState) {
  return {
    ...
    serializedLocationStates: new Map((0, (_commonsNodeCollection || _load_commonsNodeCollection()).objectEntries)(rawState.serializedLocationStates || {}))
  };
}