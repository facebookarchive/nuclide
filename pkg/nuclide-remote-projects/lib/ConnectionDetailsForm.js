...
var _nuclideUiRadioGroup2;

function _nuclideUiRadioGroup() {
  return _nuclideUiRadioGroup2 = _interopRequireDefault(require('../../nuclide-ui/RadioGroup'));
}
  ...
  _createClass(ConnectionDetailsForm, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement(
          ...
          (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiRadioGroup2 || _nuclideUiRadioGroup()).default, {
    ...
    value: function getFormFields() {
      return {
        ...
        remoteServerCommand: this._getText('remoteServerCommand') || (0, (_connectionProfileUtils2 || _connectionProfileUtils()).getOfficialRemoteServerCommand)(),
