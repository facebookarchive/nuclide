...
function addRemoteFolderToProject(connection) {
  ...
  function checkClosedProject() {
    ...
    var confirmServerActionOnLastProject = (_nuclideFeatureConfig2 || _nuclideFeatureConfig()).default.get('nuclide-remote-projects.confirmServerActionOnLastProject');
    (0, (_assert2 || _assert()).default)(typeof confirmServerActionOnLastProject === 'boolean');

    var shutdownServerAfterDisconnection = (_nuclideFeatureConfig2 || _nuclideFeatureConfig()).default.get('nuclide-remote-projects.shutdownServerAfterDisconnection');
