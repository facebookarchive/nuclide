...
var createEditorForNuclide = _asyncToGenerator(function* (uri) {
  try {
    var buffer = yield (0, (_commonsAtomTextEditor2 || _commonsAtomTextEditor()).loadBufferForUri)(uri);
...
function createRemoteDirectorySearcher() {
  ...
  var _require4 = require('../../nuclide-remote-connection');

  var RemoteDirectory = _require4.RemoteDirectory;
