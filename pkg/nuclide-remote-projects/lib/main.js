...
var createEditorForNuclide = _asyncToGenerator(function* (uri) {
  try {
    ...
    try {
      buffer = yield (0, (_commonsAtomLoadingNotification || _load_commonsAtomLoadingNotification()).default)((0, (_commonsAtomTextEditor || _load_commonsAtomTextEditor()).loadBufferForUri)(uri), 'Opening ' + (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.nuclideUriToDisplayString(uri) + '...', 1000);
    } /* delay */
    catch (err) {
