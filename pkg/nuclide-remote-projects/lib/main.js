...
var createEditorForNuclide = _asyncToGenerator(function* (uri) {
  try {
    ...
    var editor = atom.workspace.buildTextEditor({ buffer: buffer });
    if (atom.workspace.handleGrammarUsed != null) {
      (function () {
        // Atom >=1.9.0
        ...
        var grammarSubscription = editor.observeGrammar(function (grammar) {
          (0, (_assert2 || _assert()).default)(atom.workspace.handleGrammarUsed != null);
