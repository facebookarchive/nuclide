...
class RemoteProjectConnectionModal extends _react.default.Component {
  constructor(...args) {
    var _temp;
  ...
  render() {
    switch (this.props.screen) {
      case 'connect':
        return _react.default.createElement((_ConnectionDialog || _load_ConnectionDialog()).default, {
      ...
      case 'create-connection':
        return _react.default.createElement((_CreateConnectionProfileForm || _load_CreateConnectionProfileForm()).default, {
          onCancel: () => {
