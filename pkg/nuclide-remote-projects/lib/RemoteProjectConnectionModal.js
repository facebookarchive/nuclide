'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _connectionProfileUtils;
...
function _load_connectionProfileUtils() {return _connectionProfileUtils = require('./connection-profile-utils');}var _ConnectionDialog;
function _load_ConnectionDialog() {return _ConnectionDialog = _interopRequireDefault(require('./ConnectionDialog'));}var _CreateConnectionProfileForm;
function _load_CreateConnectionProfileForm() {return _CreateConnectionProfileForm = _interopRequireDefault(require('./CreateConnectionProfileForm'));}
...
{constructor(...args) {var _temp;return _temp = super(...args), this.
    ...
    _updatePanelClass = () => {
      ...
      panelEl.classList.add(`nuclide-remote-projects-panel-${this.props.screen}`);
    }, _temp;}componentDidMount() {this._updatePanelClass();}componentDidUpdate(prevProps) {if (this.props.screen !== prevProps.screen) {this._updatePanelClass();}} /**
                                                                                                                                                                      ...
                                                                                                                                                                      */render() {switch (this.props.screen) {
      case 'connect':
        return (
          _react.createElement((_ConnectionDialog || _load_ConnectionDialog()).default, {
      ...
      case 'create-connection':
        return (
          _react.createElement((_CreateConnectionProfileForm || _load_CreateConnectionProfileForm()).default, {
            onCancel: () => {
              this.props.onScreenChange('connect');
            },
            onSave: this.props.onProfileCreated,
            initialFormFields: this.props.initialFormFields,
            profileHosts: (0, (_connectionProfileUtils || _load_connectionProfileUtils()).getUniqueHostsForProfiles)(
