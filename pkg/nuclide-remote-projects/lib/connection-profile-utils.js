...
function getDefaultConnectionProfile() {
  ...
  var _lastConnectionDetail = lastConnectionDetails;
  const lastOfficialRemoteServerCommand = _lastConnectionDetail.lastOfficialRemoteServerCommand;
  const updatedConfig = _lastConnectionDetail.updatedConfig;
  ...
  const dialogSettings = _extends({}, defaultConnectionSettings, lastConfig, { remoteServerCommand: remoteServerCommand });
...
function saveConnectionConfig(config, lastOfficialRemoteServerCommand) {
  ...
  const updatedConfig = _extends({}, config, { password: '' });
