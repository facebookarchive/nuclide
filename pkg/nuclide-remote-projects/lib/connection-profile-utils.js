...
function getDefaultConnectionProfile() {
  ...
  const lastOfficialRemoteServerCommand = _lastConnectionDetail.lastOfficialRemoteServerCommand,
        updatedConfig = _lastConnectionDetail.updatedConfig;
  ...
  const dialogSettings = Object.assign({}, defaultConnectionSettings, lastConfig, { remoteServerCommand: remoteServerCommand });
