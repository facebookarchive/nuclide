'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.RemoteTextEditorPlaceholder = exports.TextEditor = undefined;var _renderReactRoot;
...
function _load_renderReactRoot() {return _renderReactRoot = require('../../../modules/nuclide-commons-ui/renderReactRoot');}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}
var _react = _interopRequireWildcard(require('react'));var _RemoteTextEditorPlaceholderComponent;
...
class TextEditor {
  ...
  getElement() {
    ...
    _react.createElement((_RemoteTextEditorPlaceholderComponent || _load_RemoteTextEditorPlaceholderComponent()).default, {
      contents: this._contents,
      uri: this._uri }));
