...
var _nuclideUiMutableListSelector;

function _load_nuclideUiMutableListSelector() {
  return _nuclideUiMutableListSelector = require('../../nuclide-ui/MutableListSelector');
}
  ...
  _createClass(ConnectionDetailsPrompt, [{
    ...
    value: function render() {
      ...
      if (connectionProfiles == null || connectionProfiles.length === 0) {
        ...
        var mostRecentClassName = (0, (_classnames || _load_classnames()).default)('list-item', {
          selected: this.props.indexOfSelectedConnectionProfile === 0
        });

        defaultConnectionProfileList = (_reactForAtom || _load_reactForAtom()).React.createElement(
          'div',
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiMutableListSelector || _load_nuclideUiMutableListSelector()).MutableListSelector, {
