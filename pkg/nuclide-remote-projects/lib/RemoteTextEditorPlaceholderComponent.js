...
var _atom = require('atom');var _AtomTextEditor;
function _load_AtomTextEditor() {return _AtomTextEditor = require('../../../modules/nuclide-commons-ui/AtomTextEditor');}var _Message;
function _load_Message() {return _Message = require('../../../modules/nuclide-commons-ui/Message');}var _nuclideUri;
...

{
  render() {
    ...
    return (
      _react.createElement('div', { className: 'nuclide-remote-text-editor-placeholder' },
        _react.createElement((_Message || _load_Message()).Message, {
            className: 'nuclide-remote-text-editor-placeholder-header',
            type: (_Message || _load_Message()).MessageTypes.info },
          _react.createElement('strong', null, 'This is a read-only preview.'),
          _react.createElement('br', null), 'Please reconnect to the remote host ',
          hostname, ' to edit or save this file.'),


        _react.createElement((_AtomTextEditor || _load_AtomTextEditor()).AtomTextEditor, {
          readOnly: true,
          textBuffer:
          new _atom.TextBuffer({
