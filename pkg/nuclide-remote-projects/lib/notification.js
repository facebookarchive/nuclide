...
notifySshHandshakeError = notifySshHandshakeError;var _nuclideRemoteConnection;function _load_nuclideRemoteConnection() {return _nuclideRemoteConnection = require('../../nuclide-remote-connection');} /**
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         * 
                                                                                                                                                                                                         * @format
                                                                                                                                                                                                         */function notifySshHandshakeError(errorType, error, config) {let message = '';let detail = '';const originalErrorDetail = `Original error message:\n ${error.message}`;const createTimeoutDetail = () => 'Troubleshooting:\n' +
