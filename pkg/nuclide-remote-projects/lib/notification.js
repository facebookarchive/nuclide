    ...
    case 'SSH_AUTHENTICATION':
      switch (config.authMethod) {
        ...
        default:
          ...
          detail = `Unknown authentication method '${authMethod}' provided. Make sure your` + ' SSH connection is properly configured.';
          break;
      }
