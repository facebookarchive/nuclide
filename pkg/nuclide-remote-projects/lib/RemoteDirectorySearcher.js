...
var RemoteDirectorySearcher = (function () {
  ...
  _createClass(RemoteDirectorySearcher, [{
    ...
    value: function search(directories, regex, options) {
      ...
      var searchStream = (_Observable = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable).merge.apply(_Observable, _toConsumableArray(searchStreams));

      // Create a subject that we can use to track search completion.
      var searchCompletion = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).ReplaySubject();
