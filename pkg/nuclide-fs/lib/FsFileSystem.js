'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.FsFileSystem = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
var _fs = _interopRequireDefault(require('fs'));var _collection;
function _load_collection() {return _collection = require('nuclide-commons/collection');}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _fsPromise;
function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _process;
function _load_process() {return _process = require('nuclide-commons/process');}var _stream;
function _load_stream() {return _stream = require('nuclide-commons/stream');}
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _admZip;
function _load_admZip() {return _admZip = _interopRequireDefault(require('adm-zip'));}var _FileSystem;
function _load_FileSystem() {return _FileSystem = require('./FileSystem');}var _ZipFileSystem;
function _load_ZipFileSystem() {return _ZipFileSystem = require('./ZipFileSystem');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                   ...
                                                                                                                                                                                   */ /**
                                                                                                                                                                                       ...
                                                                                                                                                                                       */class FsFileSystem {exists(path) {return (_fsPromise || _load_fsPromise()).default.exists(path);}findNearestFile(name, directory) {return (_fsPromise || _load_fsPromise()).default.findNearestFile(name, directory);}findInDirectories(
  name,
  directories)
  {
    ...
    return (0, (_process || _load_process()).runCommand)('find', findArgs).
  ...
  newFile(filePath) {return (0, _asyncToGenerator.default)(function* () {
  ...
  readdir(path) {return (0, _asyncToGenerator.default)(function* () {
  ...
  readFile(path, options) {return (0, _asyncToGenerator.default)(function* () {
  ...
  openArchive(path) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const [buffer, stat, lstat] = yield Promise.all([
      (_fsPromise || _load_fsPromise()).default.readFile(path),
      _this.stat(path),
      _this.lstat(path)]);
