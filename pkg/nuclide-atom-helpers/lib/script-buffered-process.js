...
var createScriptBufferedProcessWithEnv = _asyncToGenerator(function* (options) {
  ...
  localOptions.env = yield (0, _nuclideCommons.createExecEnvironment)(localOptions.env || process.env, _nuclideCommons.COMMON_BINARY_PATHS);
...
var ScriptBufferedProcess = (function (_BufferedProcess) {
  ...
  function ScriptBufferedProcess(options) {
    ...
    var localOptions = _extends({}, options);
    localOptions.args = (0, _nuclideCommons.createArgsForScriptCommand)(localOptions.command, localOptions.args);
