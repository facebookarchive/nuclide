...
function getValidProjectPaths() {
  return atom.project.getDirectories().filter(function (directory) {
    ...
    if ((0, _nuclideRemoteUri.isRemote)(directory.getPath()) && directory instanceof _atom.Directory) {
      return false;
    }
    return true;
...
function getProjectManager() {
  return _nuclideCommons.singleton.get(PROJECT_PATH_WATCHER_INSTANCE_KEY, function () {
