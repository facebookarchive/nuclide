...
exports.formatEnoentNotification = formatEnoentNotification;
...
function formatEnoentNotification(options) {
  ...
  var schema = _nuclideFeatureConfig2['default'].getSchema(pathSetting);
  var settingTitle = schema.title;
  var categoryTitle = capitalize(pathSetting.split('.').shift());
  var command = _nuclideFeatureConfig2['default'].get(pathSetting);
