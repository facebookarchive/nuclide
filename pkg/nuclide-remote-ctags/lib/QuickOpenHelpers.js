...
var getCtagsService = _asyncToGenerator(function* (directory) {
  ...
  var path = (0, (_nuclideRemoteUri2 || _nuclideRemoteUri()).join)(directory.getPath(), 'file');
...
var QuickOpenHelpers = (function () {
  ...
  _createClass(QuickOpenHelpers, null, [{
    ...
    value: function getComponentForItem(uncastedItem) {
      ...
      var path = (0, (_nuclideRemoteUri2 || _nuclideRemoteUri()).relative)(item.dir, item.path);
      var kind = undefined;
      var icon = undefined;
      if (item.kind != null) {
