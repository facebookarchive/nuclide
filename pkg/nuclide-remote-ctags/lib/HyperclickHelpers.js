...
function createCallback(tag) {
  return _asyncToGenerator(function* () {
    ...
    (0, (_nuclideAtomHelpers2 || _nuclideAtomHelpers()).goToLocation)(tag.file, lineNumber, 0);
  });
}
    ...
    value: _asyncToGenerator(function* (textEditor, text, range) {
      ...
      try {
        var _ret = yield* (function* () {
          ...
          var tagsDir = (0, (_nuclideRemoteUri2 || _nuclideRemoteUri()).dirname)((yield ctagsService.getTagsPath()));
          return {
            v: {
              range: range,
              callback: tags.map(function (tag) {
                ...
                var relpath = (0, (_nuclideRemoteUri2 || _nuclideRemoteUri()).relative)(tagsDir, file);
