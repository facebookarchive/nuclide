...
let getUseTextEditAutocomplete = (() => {
  var _ref3 = (0, _asyncToGenerator.default)(function* () {
    return (0, (_passesGK || _load_passesGK()).default)('nuclide_hack_use_textedit_autocomplete');
  });

  return function getUseTextEditAutocomplete() {
    return _ref3.apply(this, arguments);
  };
})();

let connectionToHackService = (() => {
  var _ref4 = (0, _asyncToGenerator.default)(function* (connection) {
...
let getHackLanguageForUri = exports.getHackLanguageForUri = (() => {
  var _ref6 = (0, _asyncToGenerator.default)(function* (uri) {
...
let isFileInHackProject = exports.isFileInHackProject = (() => {
  var _ref7 = (0, _asyncToGenerator.default)(function* (fileUri) {
