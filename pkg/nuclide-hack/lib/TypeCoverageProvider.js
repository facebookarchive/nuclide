...
var TypeCoverageProvider = (function () {
  ...
  _createDecoratedClass(TypeCoverageProvider, [{
    key: 'getCoverage',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('hack:run-type-coverage')],
    value: _asyncToGenerator(function* (path) {
      var hackLanguage = yield (0, (_HackLanguage || _load_HackLanguage()).getHackLanguageForUri)(path);
