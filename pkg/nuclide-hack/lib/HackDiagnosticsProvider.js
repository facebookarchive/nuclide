...
var ObservableDiagnosticProvider = function ObservableDiagnosticProvider() {
  ...
  this.updates = (0, (_HackLanguage2 || _HackLanguage()).observeHackLanguages)().mergeMap(function (language) {
  ...
  this.invalidations = (0, (_commonsNodeEvent2 || _commonsNodeEvent()).observableFromSubscribeFunction)((_nuclideRemoteConnection2 || _nuclideRemoteConnection()).ServerConnection.onDidCloseServerConnection).map(function (connection) {
    return {
      scope: 'file',
