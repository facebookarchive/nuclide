...
var CodeFormatProvider = (function () {
  ...
  _createDecoratedClass(CodeFormatProvider, [{
    key: 'formatCode',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('hack.formatCode')],
    value: _asyncToGenerator(function* (editor, range) {
      ...
      return yield hackLanguage.formatSource(fileVersion, range);
    })
  }]);
...
exports.default = CodeFormatProvider;
