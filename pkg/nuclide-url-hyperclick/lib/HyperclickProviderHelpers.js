...
matchUrl = matchUrl;var _atom = require('atom');var _electron = require('electron');var _string;function _load_string() {return _string = require('../../../modules/nuclide-commons/string');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
...
function matchUrl(text) {const match = (_string || _load_string()).URL_REGEX.exec(text);if (match == null) {return null;}(_string || _load_string()).URL_REGEX.lastIndex = 0;return { index: match.index, url: match[0].replace(TRAILING_JUNK_REGEX, '') };}
...
class HyperclickProviderHelpers {
  ...
  {return (0, _asyncToGenerator.default)(function* () {
      ...
      const urlRange = new _atom.Range(
