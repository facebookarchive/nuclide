...
function _load_HyperclickProviderHelpers() {
  return _HyperclickProviderHelpers = require('../lib/HyperclickProviderHelpers');
}

function expectMatch(urlText, expectedMatch) {
  const match = (0, (_HyperclickProviderHelpers || _load_HyperclickProviderHelpers()).matchUrl)(urlText);
