...
var _reactDom = _interopRequireDefault(require('react-dom'));var _createPackage;
...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _KeyBindingHint;
...
class Activation {constructor(state) {this._statusNode = document.createElement('div');this._statusNode.classList.add('inline-block', 'text');if (!this._statusNode) {throw new Error('Invariant violation: "this._statusNode"');}_reactDom.default.render(_react.createElement((_KeyBindingHint || _load_KeyBindingHint()).default, null), this._statusNode);
