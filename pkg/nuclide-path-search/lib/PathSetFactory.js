...
var getFilesFromWatchman = _asyncToGenerator(function* (localDirectory) {
  ...
  try {
    return yield Promise.race([watchmanClient.listFiles(localDirectory), (0, (_commonsNodePromise2 || _commonsNodePromise()).awaitMilliSeconds)(WATCHMAN_TIMEOUT_MS).then(function () {
