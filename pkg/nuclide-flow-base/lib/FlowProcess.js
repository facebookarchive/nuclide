...
var FlowProcess = (function () {
  ...
  _createClass(FlowProcess, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      pathToFlow, ['server', '--from', 'nuclide', '--max-workers', this._getMaxWorkers().toString(), this._root], (0, (_FlowHelpers2 || _FlowHelpers()).getFlowExecOptions)(this._root));
    ...
    value: _asyncToGenerator(function* (args) {
      ...
      try {
        var result = yield FlowProcess.execFlowClient(args, this._root, options);
    ...
    key: 'execFlowClient',
    value: _asyncToGenerator(function* (args, root) {
      var options = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];

      args = [].concat(_toConsumableArray(args), ['--from', 'nuclide']);
      options = _extends({}, (0, (_FlowHelpers2 || _FlowHelpers()).getFlowExecOptions)(root), options);
      var pathToFlow = (0, (_FlowHelpers2 || _FlowHelpers()).getPathToFlow)();
