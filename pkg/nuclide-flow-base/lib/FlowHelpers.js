...
exports.isFlowInstalled = isFlowInstalled;
...
exports.getPathToFlow = getPathToFlow;
exports.getStopFlowOnExit = getStopFlowOnExit;

var findFlowConfigDir = _asyncToGenerator(function* (localFile) {
  if (!flowConfigDirCache.has(localFile)) {
    var flowConfigDir = yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.findNearestFile('.flowconfig', (_nuclideRemoteUri2 || _nuclideRemoteUri()).default.dirname(localFile));
    flowConfigDirCache.set(localFile, flowConfigDir);
  }
  return flowConfigDirCache.get(localFile);
});

exports.findFlowConfigDir = findFlowConfigDir;
exports.flowCoordsToAtomCoords = flowCoordsToAtomCoords;
exports.getFlowExecOptions = getFlowExecOptions;
