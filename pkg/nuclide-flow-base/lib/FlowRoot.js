...
var FlowRoot = (function () {
  ...
  _createClass(FlowRoot, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      var json = undefined;
      try {
        var result = yield (_FlowProcess2 || _FlowProcess()).FlowProcess.execFlowClient(args, this._root);
        if (result == null) {
          return null;
        }
        json = parseJSON(args, result.stdout);
    ...
    value: _asyncToGenerator(function* (currentContents) {
      ...
      var json = undefined;
      try {
        var result = yield (_FlowProcess2 || _FlowProcess()).FlowProcess.execFlowClient(args, null, options);
        if (result == null) {
          return null;
        }
        json = parseJSON(args, result.stdout);
