'use strict';var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let main = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  function* () {
    ...
    const indexDirStream = (0, (_AutoImportsWorker || _load_AutoImportsWorker()).indexDirectory)(
    index,
    hasteSettings,
    _os.default.cpus().length).
    do({
    ...
    _rxjsBundlesRxMinJs.Observable.merge(indexModulesStream, indexDirStream).
    concat(
    // Don't bother checking non-Flow files.
    (0, (_process || _load_process()).observeProcess)('flow', [
    'ls',
    root,
    '--ignore',
    '.*/\\(node_modules\\|VendorLib\\|3rdParty\\)/.*']).

    filter(function (event) {return event.kind === 'stdout';}).
    mergeMap(function (event) {if (!(
    ...
    subscribe({
      complete: function () {
        ...
        process.exit(numErrors > 0 ? 1 : 0);
  ...
  });return function main() {return _ref.apply(this, arguments);};})();var _os = _interopRequireDefault(require('os'));var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _process;function _load_process() {return _process = require('nuclide-commons/process');}var _Config;function _load_Config() {return _Config = require('../src/Config');}var _AutoImportsManager;function _load_AutoImportsManager() {return _AutoImportsManager = require('../src/lib/AutoImportsManager');}var _AutoImportsWorker;function _load_AutoImportsWorker() {return _AutoImportsWorker = require('../src/lib/AutoImportsWorker');}var _fileIndex;function _load_fileIndex() {return _fileIndex = require('../src/lib/file-index');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const DEFAULT_PROJECT_PATH = (_nuclideUri || _load_nuclideUri()).default.join(__dirname, '..', '..', '..'); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             */ /* eslint-disable no-console */let numErrors = 0;let numFiles = 0;function checkFileForMissingImports(file, autoImportsManager) {numFiles++;return (_fsPromise || _load_fsPromise()).default.readFile(file, 'utf8').then(fileContents => {const missingImports = autoImportsManager.
