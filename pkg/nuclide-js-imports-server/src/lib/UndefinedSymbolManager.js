...
function _load_babelTraverse() {return _babelTraverse = _interopRequireDefault(require('babel-traverse'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
(_babelTraverse || _load_babelTraverse()).default.Scope.prototype.warnOnFlowBinding = x => x; /**
                                                                                               ...
                                                                                               * 
                                                                                               * @format
                                                                                               */const BUILT_INS = ['Iterator', '__DEV__'];const FBT_TAG = 'fbt';const REACT_MODULE_NAME = 'React';const JSX_CSX_PRAGMA_REGEX = /\*?\s*@csx/;class UndefinedSymbolManager {
