...
let getFileIndex = exports.getFileIndex = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (root, hasteSettings) {
    ...
    try {
      const [jsFiles, nodeModulesPackageJsonFiles, mainFiles] = yield Promise.all([watchmanListFiles(client, root, '*.js'), nodeModulesPackageJsonFilesPromise, watchmanListFiles(client, root, 'package.json').then(function (files) {
