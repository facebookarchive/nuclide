'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.WorkspaceSymbols = undefined;var _nuclideUri;
...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _protocol;
...
const WORKSPACE_SYMBOLS_LIMIT = 30; /**
                                     ...
                                     *  strict-local
                                     * @format
                                     */function exportTypeToSymbolKind(type) {switch (type) {case 'FunctionDeclaration':case 'FunctionExpression':return (_protocol || _load_protocol()).SymbolKind.Function;case 'ClassDeclaration':case 'ClassExpression':return (_protocol || _load_protocol()).SymbolKind.Class;
