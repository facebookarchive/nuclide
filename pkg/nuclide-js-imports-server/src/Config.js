...
serializeConfig = serializeConfig;exports.
...
getEslintGlobals = getEslintGlobals;exports.
...
getConfigFromFlow = getConfigFromFlow;var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _fs = _interopRequireDefault(require('fs'));var _globals;function _load_globals() {return _globals = _interopRequireWildcard(require('globals'));}var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _vm = _interopRequireDefault(require('vm'));function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const ALL_ENVS = Object.keys(_globals || _load_globals()); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */ /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    */function serializeConfig(config) {const { moduleDirs, hasteSettings: settings } = config; // RegExps aren't normally stringifyable.
  return JSON.stringify({ moduleDirs, hasteSettings: { isHaste: settings.isHaste, useNameReducers: settings.useNameReducers, nameReducers: settings.nameReducers.map(reducer => ({ regexp: reducer.regexp.toString(), replacement: reducer.replacement })), nameReducerBlacklist: settings.nameReducerBlacklist.map(String), nameReducerWhitelist: settings.nameReducerWhitelist.map(String) } });}function getEslintGlobals(root) {return parseEslintrc((_nuclideUri || _load_nuclideUri()).default.join(root, '.eslintrc')) || parseEslintrcJs((_nuclideUri || _load_nuclideUri()).default.join(root, '.eslintrc.js')) || packageJsonEslintConfig((_nuclideUri || _load_nuclideUri()).default.join(root, 'package.json')) || Array.from(getGlobalsForEnvs(ALL_ENVS));}function getConfigFromFlow(root) {let moduleDirs = [];let hasteSettings = { isHaste: false, useNameReducers: false, nameReducers: [], nameReducerWhitelist: [], nameReducerBlacklist: [] };try {const flowFile = (_nuclideUri || _load_nuclideUri()).default.join(root, '.flowconfig');const flowConfigContents = _fs.default.readFileSync(flowFile, 'utf8');moduleDirs = flowConfigToResolveDirnames(flowFile, flowConfigContents).concat(getYarnWorkspaces(root));hasteSettings = flowConfigToHasteSettings(root, flowConfigContents);
  } catch (error) {}
  return {
    moduleDirs,
    hasteSettings };
...
flowFileContents)
{
  ...
  (_nuclideUri || _load_nuclideUri()).default.join((_nuclideUri || _load_nuclideUri()).default.dirname(flowFile), dirString.split('=')[1])) :

  [(_nuclideUri || _load_nuclideUri()).default.join((_nuclideUri || _load_nuclideUri()).default.dirname(flowFile), 'node_modules')];
}
    ...
    if (Array.isArray(json.workspaces)) {
      ...
      map(workspace => {
        ...
        if (typeof workspace === 'string') {
          try {
            return (_nuclideUri || _load_nuclideUri()).default.resolve(
            root,
            (_nuclideUri || _load_nuclideUri()).default.dirname(workspace));

          } catch (err) {
            (0, (_log4js || _load_log4js()).getLogger)('js-imports-server').error(
