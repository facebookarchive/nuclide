...
var _Task = (function () {
  function _Task() {
    ...
    var child = this._child = (_child_process2 || _child_process()).default.fork((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(__dirname, '/bootstrap.js'), options);
