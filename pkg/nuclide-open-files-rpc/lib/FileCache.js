...
var FileCache = (function () {
  function FileCache() {
    ...
    this._events = new (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Subject();
  }
  ...
  _createClass(FileCache, [{
    ...
    value: function onEvent(event) {
      ...
      switch (event.kind) {
        ...
        case 'edit':
          ...
          (0, (_assert2 || _assert()).default)(buffer.getTextInRange(oldRange) === event.oldText);
    ...
    value: function _syncEdit(filePath, buffer, contents, changeCount) {
      ...
      this._events.next(createEditEvent(this.createFileVersion(filePath, changeCount), (0, (_nuclideOpenFilesCommon2 || _nuclideOpenFilesCommon()).convertRange)(oldRange), oldText, (0, (_nuclideOpenFilesCommon2 || _nuclideOpenFilesCommon()).convertRange)(newRange), buffer.getText()));
    }
  }, {
    key: '_open',
    ...
    value: function observeFileEvents() {
      ...
      return (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.from(Array.from(this._buffers.entries()).map(function (_ref) {
