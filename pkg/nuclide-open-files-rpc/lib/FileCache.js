...
var FileCache = (function () {
  function FileCache() {
    ...
    this._requests = new (_FileVersionNotifier2 || _FileVersionNotifier()).FileVersionNotifier();

    this._resources = new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default();
  ...
  _createClass(FileCache, [{
    ...
    value: function observeFileEvents() {
      ...
      return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.from(Array.from(this._buffers.entries()).map(function (_ref4) {
