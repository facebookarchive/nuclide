...
let FileCache = exports.FileCache = class FileCache {
  ...
  constructor() {
    ...
    this._resources.add(this._events.subscribe(event => {
  ...
  getBufferAtVersion(fileVersion) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (!(yield _this._requests.waitForBufferAtVersion(fileVersion))) {
        return null;
      }
      const buffer = _this.getBuffer(fileVersion.filePath);
