  ...
  _createClass(FileCache, [{
    ...
    value: function _syncEdit(filePath, buffer, contents, changeCount) {
      ...
      this._events.next({
        ...
        oldRange: (0, (_nuclideOpenFilesCommon2 || _nuclideOpenFilesCommon()).convertRange)(oldRange),
        oldText: oldText,
        newRange: (0, (_nuclideOpenFilesCommon2 || _nuclideOpenFilesCommon()).convertRange)(newRange),
