'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ConnectionFactory = exports.Connection = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _UniversalDisposable;
...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('nuclide-commons/UniversalDisposable'));}var _log4js;
function _load_log4js() {return _log4js = require('log4js');}
var _net = _interopRequireDefault(require('net'));var _utils;
function _load_utils() {return _utils = require('../../nuclide-server/lib/utils');}var _nuclideAnalytics;
function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 * 
                                                                                                                                                                                                 * @format
                                                                                                                                                                                                 */const PROTOCOL_LOGGER_COUNT = 20;class Connection {
    ...
    this._socket.on('data', data => {
      if (!this._closed) {
        ...
        (0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)('socket-service:attempting-to-write-data-after-close', {
          ...
          protocolLog: (_utils || _load_utils()).protocolLogger.dump(PROTOCOL_LOGGER_COUNT) });
