...
function open(state, action) {
  (0, (_assert2 || _assert()).default)(state.type === 'closed');
...
function gotRefactorings(state, action) {
  (0, (_assert2 || _assert()).default)(state.type === 'open');
  (0, (_assert2 || _assert()).default)(state.phase.type === 'get-refactorings');
...
function pickedRefactor(state, action) {
  (0, (_assert2 || _assert()).default)(state.type === 'open');
  (0, (_assert2 || _assert()).default)(state.phase.type === 'pick');
