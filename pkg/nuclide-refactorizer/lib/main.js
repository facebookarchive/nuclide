...
let Activation = class Activation {
  ...
  constructor() {
    ...
    let panel = null;
    this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default(this._store.subscribe(() => {
      ...
      this._store.dispatch((_refactorActions || _load_refactorActions()).open());
    }));
  }
