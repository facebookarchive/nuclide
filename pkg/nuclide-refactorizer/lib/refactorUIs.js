...
initRefactorUIs = initRefactorUIs;var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _react = _interopRequireWildcard(require('react'));var _reactDom = _interopRequireDefault(require('react-dom'));var _MainRefactorComponent;function _load_MainRefactorComponent() {return _MainRefactorComponent = require('./components/MainRefactorComponent');}var _refactorActions;function _load_refactorActions() {return _refactorActions = _interopRequireWildcard(require('./refactorActions'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     *  strict-local
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     */const refactorUIFactories = [genericRefactorUI, closeOnEscape, focusEditorOnClose, renameShortcut];function initRefactorUIs(store) {const disposables = refactorUIFactories.map(uiFn => uiFn(store));return new (_UniversalDisposable || _load_UniversalDisposable()).default(...disposables);}function genericRefactorUI(store) {const renderer = new GenericUIRenderer(store);const disposeFn = store.subscribe(() => {const state = store.getState();if (
    state.type === 'closed' ||
...
function closeOnEscape(store) {
  ...
  store.subscribe(() => {
    ...
    } else if (state.type === 'closed') {if (!(
      escapeSubscription != null)) {throw new Error('Invariant violation: "escapeSubscription != null"');}
...
class GenericUIRenderer {
  ...
  renderState(state) {
    if (state.type === 'open') {
      ...
      _react.createElement((_MainRefactorComponent || _load_MainRefactorComponent()).MainRefactorComponent, { appState: state, store: this._store }),
      this._panel.getItem());
