'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.RenameComponent = undefined;
...
function _load_Button() {return _Button = require('../../../../modules/nuclide-commons-ui/Button');}var _refactorActions;
...
class RenameComponent extends _react.Component {
      ...
      _react.createElement('div', null,
        ...
        _react.createElement((_Button || _load_Button()).Button
          ...
          , { className: 'nuclide-refactorizer-execute-button',
            onClick: () => this._runRename() }, 'Execute')));
  ...
  _runRename() {
    ...
    (_refactorActions || _load_refactorActions()).execute(this.props.phase.provider, refactoring));
