'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.PickRefactorComponent = undefined;
...
var _react = _interopRequireWildcard(require('react'));var _refactorActions;
function _load_refactorActions() {return _refactorActions = _interopRequireWildcard(require('../refactorActions'));}var _Button;
function _load_Button() {return _Button = require('../../../../modules/nuclide-commons-ui/Button');}var _classnames;
...
{constructor(...args) {var _temp;return _temp = super(...args), this.
    state = {
      selectedRefactoring: null }, _temp;}


  render() {
    const { availableRefactorings } = this.props.pickPhase;
    if (availableRefactorings.length === 0) {
      return _react.createElement('div', null, 'No refactorings available at this location');
    }
    ...
    return (
      _react.createElement('div', { className: 'select-list nuclide-refactorizer-pick-refactor' },
        _react.createElement('ol', { className: 'list-group' }, elements)));
  ...
  _pickRefactor(refactoring) {
    if (refactoring.kind === 'freeform' && refactoring.arguments.length === 0) {
      ...
      (_refactorActions || _load_refactorActions()).execute(this.props.pickPhase.provider, {
        kind: 'freeform',
