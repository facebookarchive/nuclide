'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.FreeformRefactorComponent = undefined;
...
function _load_Checkbox() {return _Checkbox = require('../../../../modules/nuclide-commons-ui/Checkbox');}var _Dropdown;
function _load_Dropdown() {return _Dropdown = require('../../../../modules/nuclide-commons-ui/Dropdown');}var _refactorActions;
...
class FreeformRefactorComponent extends _react.Component {
  constructor(props) {
    ...
    _execute = () => {
      ...
      (_refactorActions || _load_refactorActions()).execute(this.props.phase.provider, {
        kind: 'freeform',
        editor,
        originalRange,
        id: refactoring.id,
