...
var DiffViewEditorPane = (function (_React$Component) {
  ...
  _createClass(DiffViewEditorPane, [{
    ...
    value: function _updateDiffView(oldProps) {
      ...
      if (diffEditorUpdated || !_nuclideCommons.array.equal(oldProps.highlightedLines.added, newProps.highlightedLines.added) || !_nuclideCommons.array.equal(oldProps.highlightedLines.removed, newProps.highlightedLines.removed)) {
        this._setHighlightedLines(newProps.highlightedLines);
      }
      if (diffEditorUpdated || !_nuclideCommons.map.equal(oldProps.offsets, newProps.offsets)) {
        this._setOffsets(newProps.offsets);
      }
      if (!_nuclideCommons.array.equal(oldProps.inlineElements, newProps.inlineElements)) {
