...
var DiffViewEditorPane = (function (_React$Component) {
  ...
  _createClass(DiffViewEditorPane, [{
    ...
    value: function _setupDiffEditor() {
      ...
      var debouncedOnChange = (0, (_nuclideCommons2 || _nuclideCommons()).debounce)(function () {
    ...
    value: function _updateDiffView(oldProps) {
      ...
      if (diffEditorUpdated || !(_nuclideCommons2 || _nuclideCommons()).map.equal(oldProps.offsets, newProps.offsets)) {
        this._setOffsets(newProps.offsets);
      }
      if (!(_nuclideCommons2 || _nuclideCommons()).array.equal(oldProps.inlineElements, newProps.inlineElements)) {
