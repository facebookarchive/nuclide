...
var DiffViewToolbar = (function (_React$Component) {
  ...
  _createClass(DiffViewToolbar, [{
    ...
    value: function _getPreviousDiffSection() {
      ...
      var selectedDiffSectionIndex = _props.selectedDiffSectionIndex;

      var previousSectionIndex = selectedDiffSectionIndex - 1;
    ...
    value: function _getNextDiffSection() {
      ...
      var selectedDiffSectionIndex = _props2.selectedDiffSectionIndex;

      var nextSectionIndex = selectedDiffSectionIndex + 1;
