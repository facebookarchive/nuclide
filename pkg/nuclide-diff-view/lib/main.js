...
var Activation = (function () {
  function Activation(rawState) {
    ...
    this._store = (0, (_redux2 || _redux()).createStore)((_reduxReducers2 || _reduxReducers()).app, initialState, (0, (_redux2 || _redux()).applyMiddleware)((0, (_commonsNodeReduxObservable2 || _commonsNodeReduxObservable()).createEpicMiddleware)(rootEpic)));
    var states = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.from(this._store);

    var useReduxStore = (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.get('nuclide-diff-view.useReduxStore');
    if (useReduxStore || atom.inSpecMode()) {
      ...
      states.subscribe(function (state) {
        return (0, (_nuclideLogging2 || _nuclideLogging()).getLogger)().info('diff-view-state', state);
      ...
      this._actionCreators = (0, (_redux2 || _redux()).bindActionCreators)(_reduxActions2 || _reduxActions(), function () {});
    }
