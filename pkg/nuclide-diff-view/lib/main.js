...
var Activation = (function () {
  ...
  _createClass(Activation, [{
    ...
    value: function consumeToolBar(getToolBar) {
      ...
      var toolBarSubscriptions = new (_atom || _load_atom()).CompositeDisposable(diffModel.onDidUpdateState(function () {
        updateToolbarCount();
    ...
    value: function addItemsToFileTreeContextMenu(contextMenu) {
      ...
      var menuItemDescriptions = new (_atom || _load_atom()).CompositeDisposable();
