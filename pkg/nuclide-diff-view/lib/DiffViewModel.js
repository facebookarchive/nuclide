...
var DiffViewModel = (function () {
  ...
  _createDecoratedClass(DiffViewModel, [{
    ...
    value: function _updateCommitMergeFileChanges() {
      var commitMergeFileChanges = (0, (_commonsNodeCollection2 || _commonsNodeCollection()).mapUnion).apply(undefined, _toConsumableArray(Array.from(this._repositoryStacks.values()).map(function (repositoryStack) {
        return repositoryStack.getCommitMergeFileChanges();
      })));
      var lastCommitMergeFileChanges = (0, (_commonsNodeCollection2 || _commonsNodeCollection()).mapUnion).apply(undefined, _toConsumableArray(Array.from(this._repositoryStacks.values()).map(function (repositoryStack) {
    ...
    value: function _updateCompareChangedStatus(dirtyFileChanges, commitMergeFileChanges, lastCommitMergeFileChanges) {
      ...
      switch (this._state.viewMode) {
        case (_constants2 || _constants()).DiffMode.COMMIT_MODE:
          ...
          selectedFileChanges = (0, (_commonsNodeCollection2 || _commonsNodeCollection()).mapFilter)(dirtyFileChanges, activeRepositorySelector);
          showNonHgRepos = false;
          break;
        case (_constants2 || _constants()).DiffMode.PUBLISH_MODE:
          // Publish mode only shows the changes of the active repository.
          selectedFileChanges = (0, (_commonsNodeCollection2 || _commonsNodeCollection()).mapFilter)(lastCommitMergeFileChanges, activeRepositorySelector);
          showNonHgRepos = false;
          break;
        case (_constants2 || _constants()).DiffMode.BROWSE_MODE:
