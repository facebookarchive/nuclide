...
var DiffViewModel = (function () {
  ...
  _createDecoratedClass(DiffViewModel, [{
    ...
    value: _asyncToGenerator(function* (publishMessage, amended) {
      ...
      var stream = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getArcanistServiceByNuclideUri)(filePath).createPhabricatorRevision(filePath).share();
    ...
    value: _asyncToGenerator(function* (publishMessage, allowUntracked) {
      ...
      var stream = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getArcanistServiceByNuclideUri)(filePath).updatePhabricatorRevision(filePath, userUpdateMessage, allowUntracked).share();
      yield this._processArcanistOutput(stream);
    ...
    value: _asyncToGenerator(function* () {
      ...
      var phabricatorRevision = (0, (_nuclideArcanistRpcLibUtils2 || _nuclideArcanistRpcLibUtils()).getPhabricatorRevisionFromCommitMessage)(headRevision.description);
      return {
        headRevision: headRevision,
