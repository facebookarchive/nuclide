...
var _nuclideArcanistBaseLibUtils = require('../../nuclide-arcanist-base/lib/utils');
...
var DiffViewModel = (function () {
  function DiffViewModel() {
    ...
    this._serializedUpdateActiveFileDiff = _nuclideCommons.promises.serializeAsyncCall(function () {
  ...
  _createDecoratedClass(DiffViewModel, [{
    ...
    value: _asyncToGenerator(function* (publishMessage, amended) {
      ...
      return (0, _nuclideArcanistBaseLibUtils.getPhabricatorRevisionFromCommitMessage)(commitMessage);
    })
  }, {
    ...
    value: _asyncToGenerator(function* () {
      if (this._state.publishModeState === _constants.PublishModeState.AWAITING_PUBLISH) {
    ...
    value: _asyncToGenerator(function* () {
      ...
      var phabricatorRevision = (0, _nuclideArcanistBaseLibUtils.getPhabricatorRevisionFromCommitMessage)(headRevision.description);
      return {
        headRevision: headRevision,
