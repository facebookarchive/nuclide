...
var DiffViewModel = (function () {
  ...
  _createDecoratedClass(DiffViewModel, [{
    ...
    value: _asyncToGenerator(function* (publishMessage, amended) {
      ...
      var stream = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getArcanistBaseServiceByNuclideUri)(filePath).createPhabricatorRevision(filePath).share();
    ...
    value: _asyncToGenerator(function* (publishMessage, allowUntracked) {
      ...
      var stream = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getArcanistBaseServiceByNuclideUri)(filePath).updatePhabricatorRevision(filePath, userUpdateMessage, allowUntracked).share();
      yield this._processArcanistOutput(stream);
