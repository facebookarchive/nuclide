...
var RepositoryStack = (function () {
  function RepositoryStack(repository) {
    ...
    this._serializedUpdateStatus = (0, (_commonsNodePromise2 || _commonsNodePromise()).serializeAsyncCall)(function () {
      return _this._tryUpdateCommitMergeFileChanges();
    });
    var debouncedSerializedUpdateStatus = (0, (_commonsNodeDebounce2 || _commonsNodeDebounce()).default)(this._serializedUpdateStatus, UPDATE_STATUS_DEBOUNCE_MS, false);
  ...
  _createDecoratedClass(RepositoryStack, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      if (lastRevisionsState == null || !(0, (_commonsNodeCollection2 || _commonsNodeCollection()).arrayEqual)(lastRevisionsState.revisions, revisionsState.revisions, function (revision1, revision2) {
      ...
      if (this._lastRevisionsFileHistory != null) {
        ...
        if ((0, (_commonsNodeCollection2 || _commonsNodeCollection()).arrayEqual)(revisionIds, fileHistoryRevisionIds)) {
