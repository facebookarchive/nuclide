...
function _computeDiffChunks(oldText_, newText_) {
  ...
  var lineDiff = (0, (_diff || _load_diff()).diffLines)(oldText, newText);
  var chunks = [];
...
function computeDiffSections(addedLines, removedLines, oldLineOffsets, newLineOffsets) {
  ...
  var lineSections = Array.from((0, (_commonsNodeCollection || _load_commonsNodeCollection()).concatIterators)(getLineSectionsWithStatus(addedLinesWithOffsets.entries(), (_constants || _load_constants()).DiffSectionStatus.ADDED), getLineSectionsWithStatus(changedLinesWithOffsets.entries(), (_constants || _load_constants()).DiffSectionStatus.CHANGED), getLineSectionsWithStatus(removedLinesWithOffsets.entries(), (_constants || _load_constants()).DiffSectionStatus.REMOVED)));
