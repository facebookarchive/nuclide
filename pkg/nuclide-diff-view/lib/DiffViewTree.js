...
var _nuclideUiTreeRootComponent2;

function _nuclideUiTreeRootComponent() {
  return _nuclideUiTreeRootComponent2 = require('../../nuclide-ui/TreeRootComponent');
}
  ...
  _createClass(DiffViewTree, [{
    ...
    value: function componentDidMount() {
      ...
      this._subscriptions.add(atom.commands.add('.nuclide-diff-view-tree .entry.file-change', 'nuclide-diff-tree:copy-full-path', function (event) {
        var filePath = (0, (_commonsAtomUiTreePath2 || _commonsAtomUiTreePath()).default)(event);
        atom.clipboard.write((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getPath(filePath || ''));
      }));
    ...
    value: function _rootChildrenFetcher(rootNode) {
      var noChildrenFetcher = function noChildrenFetcher() {
        return Promise.resolve((_immutable2 || _immutable()).default.List.of());
      };
      ...
      return Promise.resolve((_immutable2 || _immutable()).default.List(childNodes));
    }
  }, {
    ...
    value: function render() {
      return (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiTreeRootComponent2 || _nuclideUiTreeRootComponent()).TreeRootComponent, {
        initialRoots: [],
