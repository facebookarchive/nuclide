  ...
  render() {
    ...
    if (revisionsState == null) {
      ...
      const compareCommitId = revisionsState.compareCommitId,
            revisionStatuses = revisionsState.revisionStatuses,
            headCommitId = revisionsState.headCommitId,
            headToForkBaseRevisions = revisionsState.headToForkBaseRevisions;
