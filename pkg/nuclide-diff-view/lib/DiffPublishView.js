...
var DiffPublishView = (function (_React$Component2) {
  ...
  _createClass(DiffPublishView, [{
    ...
    value: function componentDidMount() {
      ...
      this._subscriptions = new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(this.props.diffModel.getPublishUpdates().subscribe(this._onPublishUpdate.bind(this)));
