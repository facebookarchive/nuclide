...
var DiffPublishView = (function (_React$Component2) {
  ...
  _createClass(DiffPublishView, [{
    ...
    value: function _getToolbar() {
      ...
      if (publishMode === (_constants2 || _constants()).PublishMode.CREATE) {
        prepareOptionElement = (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiCheckbox2 || _nuclideUiCheckbox()).Checkbox, {
    ...
    value: function _onClickBack() {
      ...
      var diffMode = publishModeState === (_constants2 || _constants()).PublishModeState.PUBLISH_ERROR ? (_constants2 || _constants()).DiffMode.PUBLISH_MODE : (_constants2 || _constants()).DiffMode.BROWSE_MODE;
