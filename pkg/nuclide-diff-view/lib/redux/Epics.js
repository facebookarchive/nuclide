      ...
      return observeRepositoryHeadRevision(repository).filter(function (headRevision) {
        ...
        switch (mode) {
          case (_constants2 || _constants()).PublishMode.CREATE:
            ...
            return trackComplete('diff-view.publish-diff', (0, (_utils2 || _utils()).createPhabricatorRevision)(repository, publishUpdates, headRevision.description, message, amended, isPrepareMode, lintExcuse));
