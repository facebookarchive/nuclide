...
function renderPublishView(diffModel) {
  ...
  const message = _diffModel$getState$p.message,
        ...
        suggestedReviewers = _diffModel$getState.suggestedReviewers;
...
function renderCommitView(diffModel) {
  ...
  const message = _diffModel$getState2$.message,
        ...
        suggestedReviewers = _diffModel$getState2.suggestedReviewers;
...
function renderFileChanges(diffModel) {
  ...
  const getCompareRevision = () => {
    const compareRevisionId = diffModel.getState().activeRepositoryState.compareRevisionId;
