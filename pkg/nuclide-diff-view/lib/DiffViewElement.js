...
var DiffViewElement = (function (_HTMLElement) {
  ...
  _createClass(DiffViewElement, [{
    ...
    value: function initialize(diffModel, uri) {
      ...
      this._subscriptions.add(this._diffModel.onDidUpdateState(function () {
    ...
    value: function _getActiveFileName() {
      var _diffModel$getState = this._diffModel.getState();

      var filePath = _diffModel$getState.filePath;

      if (filePath == null || filePath.length === 0) {
        return null;
      }
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.basename(filePath);
    }
  }, {
    key: 'getIconName',
