...
var _nuclideUiLazyTreeNode2;

function _nuclideUiLazyTreeNode() {
  return _nuclideUiLazyTreeNode2 = require('../../nuclide-ui/LazyTreeNode');
}
...
var DiffViewTreeNode = (function (_LazyTreeNode) {
  ...
  _createClass(DiffViewTreeNode, [{
    ...
    value: function getLabel() {
      ...
      var fileName = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.basename(item.filePath);
...
})((_nuclideUiLazyTreeNode2 || _nuclideUiLazyTreeNode()).LazyTreeNode);
