...
var datatip = _asyncToGenerator(function* (editor, position) {
  if (!(yield (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).default)(GK_DIAGNOSTICS_DATATIPS, 0))) {
    return null;
  }
  (0, (_assert || _load_assert()).default)(fileDiagnostics);
  ...
  (0, (_assert || _load_assert()).default)(range);
  return {
