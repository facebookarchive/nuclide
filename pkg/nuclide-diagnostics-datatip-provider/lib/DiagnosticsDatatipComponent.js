...
var _nuclideUiDiagnosticsMessage2;

function _nuclideUiDiagnosticsMessage() {
  return _nuclideUiDiagnosticsMessage2 = require('../../nuclide-ui/DiagnosticsMessage');
}
  ...
  _createClass(DiagnosticsDatatipComponent, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiDiagnosticsMessage2 || _nuclideUiDiagnosticsMessage()).DiagnosticsMessage, {
          message: message,
