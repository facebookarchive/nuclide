...
function _load_parseLogcatMetadata() {
  return _parseLogcatMetadata = _interopRequireDefault(require('../lib/parseLogcatMetadata'));
}
...
describe('parseLogcatMetadata', () => {
  const formats = ['[ 01-14 17:15:01.003   640:  654 I/ProcessStatsService ]',
  // Older versions use hex for the tid.
  '[ 01-14 17:15:01.003   640:0x28e I/ProcessStatsService ]'];

  formats.forEach(raw => {
    describe(raw, () => {
      const parsed = (0, (_parseLogcatMetadata || _load_parseLogcatMetadata()).default)(raw);
  ...
  it('parses weird tags', () => {
    const parsed = (0, (_parseLogcatMetadata || _load_parseLogcatMetadata()).default)('[ 05-10 17:49:43.925  5846: 5993 D/fb4a(:<default>):PeriodicForegroundScheduler ]');
  ...
  it('parses the 5-digit tid', () => {
    const parsed = (0, (_parseLogcatMetadata || _load_parseLogcatMetadata()).default)('[ 01-28 14:59:27.633  3211:15223 I/ReactNativeJS ]');
