'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _formatEnoentNotification;
...
function _load_formatEnoentNotification() {return _formatEnoentNotification = _interopRequireDefault(require('../../commons-atom/format-enoent-notification'));}var _createProcessStream;
function _load_createProcessStream() {return _createProcessStream = require('./createProcessStream');}var _createMessageStream;
function _load_createMessageStream() {return _createMessageStream = _interopRequireDefault(require('./createMessageStream'));}var _LogTailer;
...
class Activation {
  ...
  constructor(state) {
    const message$ = _rxjsBundlesRxMinJs.Observable.defer(() =>
    (0, (_createMessageStream || _load_createMessageStream()).default)(
    (0, (_createProcessStream || _load_createProcessStream()).createProcessStream)()
