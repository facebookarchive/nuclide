...
var _HomeFeatureComponent = require('./HomeFeatureComponent');

var _HomeFeatureComponent2 = _interopRequireDefault(_HomeFeatureComponent);

var _NuclideLogo = require('./NuclideLogo');

var _NuclideLogo2 = _interopRequireDefault(_NuclideLogo);

var _nuclideFeatureConfig = require('../../nuclide-feature-config');

var _nuclideFeatureConfig2 = _interopRequireDefault(_nuclideFeatureConfig);

var DEFAULT_WELCOME = _reactForAtom.React.createElement(
  'div',
  null,
...
function createHomePaneItem(allHomeFragmentsStream) {
  var HomePaneItem = (function (_React$Component) {
    ...
    function HomePaneItem() {
      ...
      this.state = {
        allHomeFragments: _immutable2.default.Set()
      };
    }
    ...
    _createClass(HomePaneItem, [{
      ...
      value: function componentDidMount() {
        ...
        _nuclideFeatureConfig2.default.set('nuclide-home.showHome', true);
      }
    }, {
      key: 'render',
      value: function render() {
        ...
        sortedHomeFragments.forEach(function (fragment) {
          ...
          if (feature) {
            features.push(_reactForAtom.React.createElement(_HomeFeatureComponent2.default, _extends({ key: features.length }, feature)));
          }
        });

        var containers = [_reactForAtom.React.createElement(
          'div',
          { key: 'welcome', className: 'nuclide-home-container' },
          _reactForAtom.React.createElement(
            'section',
            { className: 'text-center' },
            _reactForAtom.React.createElement(_NuclideLogo2.default, { className: 'nuclide-home-logo' }),
            _reactForAtom.React.createElement(
              'h1',
      ...
      value: function componentWillUnmount() {
        _nuclideFeatureConfig2.default.set('nuclide-home.showHome', false);
