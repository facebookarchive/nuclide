...
let HomePaneItem = class HomePaneItem extends _reactForAtom.React.Component {
  ...
  render() {
    ...
    sortedHomeFragments.forEach(fragment => {
      ...
      const feature = fragment.feature;
      ...
      if (feature) {
        features.push(_reactForAtom.React.createElement((_HomeFeatureComponent || _load_HomeFeatureComponent()).default, _extends({ key: features.length }, feature)));
      }
    });
