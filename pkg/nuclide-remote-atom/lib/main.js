...
var Activation = (function () {
  function Activation() {
    ...
    this._commands = {
      ...
      openRemoteFile: function openRemoteFile(uri, line, column) {
        if ((_nuclideRemoteConnection4 || _nuclideRemoteConnection3()).ServerConnection.getForUri(uri) == null) {
          return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.throw(new Error('Atom is not connected to host for ' + uri)).publish();
        }
        return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromPromise((0, (_commonsAtomGoToLocation2 || _commonsAtomGoToLocation()).goToLocation)(uri, line, column).then(function (editor) {
          atom.applicationDelegate.focusWindow();
          return editor;
        })).switchMap(function (editor) {
          return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.merge((_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.of('open'), (0, (_commonsAtomTextEditor2 || _commonsAtomTextEditor()).observeEditorDestroy)(editor).map(function (value) {
