...
var _querystring = _interopRequireDefault(require('querystring'));var _nuclideRemoteConnection;
...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _goToLocation;
function _load_goToLocation() {return _goToLocation = require('../../../modules/nuclide-commons-atom/go-to-location');}var _createPackage;
function _load_createPackage() {return _createPackage = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/createPackage'));}var _featureConfig;
function _load_featureConfig() {return _featureConfig = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/feature-config'));}var _log4js;
function _load_log4js() {return _log4js = require('log4js');}var _textEditor;
function _load_textEditor() {return _textEditor = require('../../../modules/nuclide-commons-atom/text-editor');}
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _nuclideUri;

function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _nuclideOpenFiles;
...
const REMOTE_COMMAND_SERVICE = 'RemoteCommandService'; /**
                                                        ...
                                                        *  strict-local
                                                        * @format
                                                        */const ATOM_URI_ADD_PATH = 'add-path';class Activation {constructor() {var _this = this;this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default();
    this._commands = {
      openFile(
      uri,
      line,
      ...
      {return (0, _asyncToGenerator.default)(function* () {
          if ((_nuclideUri || _load_nuclideUri()).default.isLocal(projectPath)) {
            ...
            _querystring.default.stringify(queryParams);
            _electron.shell.openExternal(url);
          }})();
      },

      getProjectState() {return (0, _asyncToGenerator.default)(function* () {
          return {
    ...
    new (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).ConnectionCache((() => {var _ref = (0, _asyncToGenerator.default)(function* (connection) {
        ...
        if (
        connection == null &&
        !(_featureConfig || _load_featureConfig()).default.get('nuclide-remote-atom.enableLocalCommandService'))
        {
          return { dispose: function () {} };
        }

        const service = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getServiceByConnection)(
        ...
        return service.registerAtomCommands(fileNotifier, _this._commands);
  ...
  consumeDeepLinkService(service) {var _this2 = this;
    const disposable = service.subscribeToPath(
    ATOM_URI_ADD_PATH, (() => {var _ref2 = (0, _asyncToGenerator.default)(
      function* (params) {
        const { path: projectPath } = params;if (!(
        typeof projectPath === 'string')) {throw new Error('Invariant violation: "typeof projectPath === \'string\'"');}
...
isWaiting)
{
  ...
  (0, (_goToLocation || _load_goToLocation()).goToLocation)(uri, { line, column }).then(editor => {
...

    {
      ...
      `The command line has opened \`${(_nuclideUri || _load_nuclideUri()).default.getPath(uri)}\`` +
      ' and is waiting for it to be closed.',
      {
        ...
        {
          onDidClick: () => {
            (_featureConfig || _load_featureConfig()).default.set(
            'nuclide-remote-atom.shouldNotifyWhenCommandLineIsWaitingOnFile',
            false);
  ...
  _rxjsBundlesRxMinJs.Observable.of('open'),
  (0, (_textEditor || _load_textEditor()).observeEditorDestroy)(editor).map(value => 'close'))).
