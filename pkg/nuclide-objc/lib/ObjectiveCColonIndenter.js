...
var ObjectiveCColonIndenter = (function () {
  ...
  _createClass(ObjectiveCColonIndenter, [{
    ...
    value: function getIndentedColonColumn(buffer, startPosition) {
      var startPositionText = buffer.getTextInRange(_atom.Range.fromObject([startPosition, startPosition.translate([0, 1])]));
      ...
      /:|\[|\]|\+|-/g, _atom.Range.fromObject([startPosition.translate([-NUMBER_OF_PREVIOUS_LINES_TO_SEARCH_FOR_COLONS, 0]), startPosition.translate([0, -1])]), function (_ref) {
