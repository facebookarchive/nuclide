...
var ObjectiveCColonIndenter = (function () {
  ...
  _createClass(ObjectiveCColonIndenter, [{
    ...
    value: function enable() {
      ...
      var subscriptions = this._subscriptions = new (_atom || _load_atom()).CompositeDisposable();
      ...
      subscriptions.add((0, (_commonsAtomObserveLanguageTextEditors || _load_commonsAtomObserveLanguageTextEditors()).default)(GRAMMARS, function (textEditor) {
    ...
    value: function _enableInTextEditor(textEditor) {
      this._insertTextSubscriptionsMap.set(textEditor, textEditor.onDidInsertText(function (event) {
        (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackOperationTiming)('objc:indent-colon', function () {
    ...
    value: function getIndentedColonColumn(buffer, startPosition) {
      ...
      /:|\[|\]|\+|-/g, (_atom || _load_atom()).Range.fromObject([startPosition.translate([-NUMBER_OF_PREVIOUS_LINES_TO_SEARCH_FOR_COLONS, 0]), startPosition.translate([0, -1])]), function (_ref) {
