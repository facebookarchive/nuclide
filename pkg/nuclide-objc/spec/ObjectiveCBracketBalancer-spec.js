...
describe('ObjectiveCBracketBalancer', () => {
  describe('getOpenBracketInsertPosition', () => {
    ...
    it('returns the correct point on a line that contains only whitespace before the close'
      + ' bracket', () => {
    ...
    it('inserts an open bracket before the nearest expression when within an existing balanced'
      + ' bracket pair', () => {
    ...
    it('does not insert an open bracket after an equals sign when initalizing or messaging a class'
