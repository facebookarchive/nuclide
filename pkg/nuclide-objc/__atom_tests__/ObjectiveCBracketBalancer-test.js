...
function _load_ObjectiveCBracketBalancer() {
  return _ObjectiveCBracketBalancer = _interopRequireDefault(require('../lib/ObjectiveCBracketBalancer'));
}
...
const { getOpenBracketInsertPosition } = (_ObjectiveCBracketBalancer || _load_ObjectiveCBracketBalancer()).default;
