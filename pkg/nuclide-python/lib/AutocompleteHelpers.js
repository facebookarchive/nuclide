...
var AutocompleteHelpers = (function () {
  ...
  _createDecoratedClass(AutocompleteHelpers, null, [{
    ...
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-python:getAutocompleteSuggestions')],
    value: _asyncToGenerator(function* (request) {
      ...
      return results.map(function (completion) {
        ...
        var snippet = (0, (_config || _load_config()).getAutocompleteArguments)() ? getText(completion, (0, (_config || _load_config()).getIncludeOptionalArguments)(), true /* createPlaceholders */) : completion.text;
        return {
