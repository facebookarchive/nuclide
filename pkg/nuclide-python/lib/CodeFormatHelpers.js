...
var CodeFormatHelpers = (function () {
  ...
  _createDecoratedClass(CodeFormatHelpers, null, [{
    ...
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('python.formatCode')],
    value: _asyncToGenerator(function* (editor, range) {
      ...
      (0, (_assert || _load_assert()).default)(service, 'Failed to get service for python.');
