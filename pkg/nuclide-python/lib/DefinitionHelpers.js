...
var DefinitionHelpers = (function () {
  ...
  _createDecoratedClass(DefinitionHelpers, null, [{
    ...
    value: _asyncToGenerator(function* (editor, position) {
      ...
      var service = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getServiceByNuclideUri)('JediService', src);
      if (service == null) {
        return null;
      }
      ...
      var definitions = result.definitions.map(function (definition) {
        return {
