...
class DefinitionHelpers {
  static getDefinition(editor, position) {
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('python.get-definition', () => DefinitionHelpers._getDefinition(editor, position));
  }
  ...
  static getDefinitionById(filePath, id) {
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('python.get-definition-by-id', (0, _asyncToGenerator.default)(function* () {
      // TODO:
      return null;
    }));
  }
