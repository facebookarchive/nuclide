...
function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _diagnosticRange;
function _load_diagnosticRange() {return _diagnosticRange = require('./diagnostic-range');}var _config;
function _load_config() {return _config = require('./config');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                              ...
                                                                                                                                                              *  strict-local
                                                                                                                                                              * @format
                                                                                                                                                              */class LintHelpers {static lint(editor) {const src = editor.getPath();if (src == null || !(0, (_config || _load_config()).getEnableLinting)() || (0, (_config || _load_config()).getLintExtensionBlacklist)().includes((_nuclideUri || _load_nuclideUri()).default.extname(src))) {
    ...
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-python.lint', (0, _asyncToGenerator.default)(function* () {
      ...
      const diagnostics = yield service.getDiagnostics(src);
