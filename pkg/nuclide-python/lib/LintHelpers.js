...
var LintHelpers = (function () {
  ...
  _createDecoratedClass(LintHelpers, null, [{
    ...
    value: _asyncToGenerator(function* (editor) {
      ...
      var extname = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.extname(src);
      ...
      var ext = extname.length > 0 ? extname.slice(1) : (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.basename(src);

      if ((_constants || _load_constants()).NO_LINT_EXTENSIONS.has(ext)) {
        return [];
      }
