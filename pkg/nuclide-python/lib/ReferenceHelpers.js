...
var ReferenceHelpers = (function () {
  ...
  _createDecoratedClass(ReferenceHelpers, null, [{
    ...
    value: _asyncToGenerator(function* (editor, position) {
      ...
      var baseUri = (0, (_commonsAtomProjects2 || _commonsAtomProjects()).getAtomProjectRootPath)(src) || (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(src);
      ...
      var references = result.map(function (ref) {
        return {
          uri: ref.file,
          name: ref.parentName,
          range: new (_simpleTextBuffer2 || _simpleTextBuffer()).Range(new (_simpleTextBuffer2 || _simpleTextBuffer()).Point(ref.line, ref.column), new (_simpleTextBuffer2 || _simpleTextBuffer()).Point(ref.line, ref.column + ref.text.length))
        };
      });
