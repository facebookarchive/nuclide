...
class AtomLanguageService {
  ...
  activate() {
    ...
    this._subscriptions.add((_AdditionalLogFileProvider || _load_AdditionalLogFileProvider()).AdditionalLogFileProvider.register(this._connectionToLanguageService));
  }
