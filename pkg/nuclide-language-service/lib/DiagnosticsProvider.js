'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ObservableDiagnosticProvider = exports.FileDiagnosticsProvider = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));exports.
...
registerDiagnostics = registerDiagnostics;var _cache;function _load_cache() {return _cache = require('nuclide-commons/cache');}var _nuclideRemoteConnection;function _load_nuclideRemoteConnection() {return _nuclideRemoteConnection = require('../../nuclide-remote-connection');}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _nuclideAnalytics;function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _promise;function _load_promise() {return _promise = require('nuclide-commons/promise');}var _DiagnosticsProviderBase;function _load_DiagnosticsProviderBase() {return _DiagnosticsProviderBase = require('./DiagnosticsProviderBase');}var _projects;function _load_projects() {return _projects = require('nuclide-commons-atom/projects');}var _nuclideOpenFiles;function _load_nuclideOpenFiles() {return _nuclideOpenFiles = require('../../nuclide-open-files');}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _event;function _load_event() {return _event = require('nuclide-commons/event');}var _textEditor;function _load_textEditor() {return _textEditor = require('nuclide-commons-atom/text-editor');}var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('nuclide-commons/UniversalDisposable'));}var _nuclideLanguageServiceRpc;function _load_nuclideLanguageServiceRpc() {return _nuclideLanguageServiceRpc = require('../../nuclide-language-service-rpc');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          */function registerDiagnostics(name, grammars, config, logger, connectionToLanguageService, busySignalProvider) {const result = new (_UniversalDisposable || _load_UniversalDisposable()).default();let provider;
...
class FileDiagnosticsProvider {
  ...
  connectionToLanguageService,
  busySignalProvider,
  ProviderBase = (_DiagnosticsProviderBase || _load_DiagnosticsProviderBase()).DiagnosticsProviderBase)
  {
    this.name = name;
     ...
     */_runDiagnostics(textEditor) {this._busySignalProvider.reportBusyWhile(
    `${this.name}: Waiting for diagnostics`,
    () => this._runDiagnosticsImpl(textEditor));

  }

  _runDiagnosticsImpl(textEditor) {var _this = this;
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(this._analyticsEventName, (0, _asyncToGenerator.default)(function* () {
      ...
      const diagnosisResult = yield _this._requestSerializer.run(
      _this.findDiagnostics(textEditor));
      ...
      const projectRoot = yield (yield languageService).getProjectRoot(
      filePath);
  ...
  _receivedNewUpdateSubscriber(callback) {
    ...
    if (
    activeTextEditor &&
    !(_nuclideUri || _load_nuclideUri()).default.isBrokenDeserializedUri(activeTextEditor.getPath()))
    {
      if (
      this._providerBase.
      getGrammarScopes().
  ...
  invalidateProjectPath(projectPath) {
    ...
    .filter(
    rootPath =>
    (_nuclideUri || _load_nuclideUri()).default.contains(projectPath, rootPath) ||
    (_nuclideUri || _load_nuclideUri()).default.contains(rootPath, projectPath)).
  ...
  findDiagnostics(editor) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  connectionToLanguageService)
  {
    ...
    mergeMap(([connection, languageService]) => {
      ...
      mergeMap(language => {
        ...
        return (0, (_nuclideLanguageServiceRpc || _load_nuclideLanguageServiceRpc()).ensureInvalidations)(
        this._logger,
        language.
        observeDiagnostics().
        refCount().
    ...
    this.invalidations = (0, (_event || _load_event()).observableFromSubscribeFunction)(
    (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).ServerConnection.onDidCloseServerConnection).
