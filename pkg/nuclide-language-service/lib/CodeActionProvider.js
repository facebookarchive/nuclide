'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.CodeActionProvider = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _nuclideRemoteConnection;
...
class CodeActionProvider {
  ...
  {var _this = this;
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(this._analyticsEventName, (0, _asyncToGenerator.default)(function* () {
      ...
      const codeActions = yield (yield languageService).getCodeActions(
      fileVersion,
      range,
      // $FlowIssue: Flow doesn't understand this.
      diagnostics.map(function (d) {return Object.assign({}, d, { actions: undefined });}));


      return codeActions.map(function (action) {return {
          apply: function () {
            return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(
            _this._applyAnalyticsEventName,
