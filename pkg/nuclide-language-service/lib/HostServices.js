'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.getHostServices = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _memoize2;function _load_memoize() {return _memoize2 = _interopRequireDefault(require('lodash/memoize'));}let getHostServices = exports.getHostServices = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  });return function getHostServices() {return _ref.apply(this, arguments);};})();

// Following type implements the HostServicesForLanguage interface
var _consumeFirstProvider;function _load_consumeFirstProvider() {return _consumeFirstProvider = _interopRequireDefault(require('nuclide-commons-atom/consumeFirstProvider'));}var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('nuclide-commons/UniversalDisposable'));}var _HostServicesAggregator;function _load_HostServicesAggregator() {return _HostServicesAggregator = require('../../nuclide-language-service-rpc/lib/HostServicesAggregator');}var _textEdit;function _load_textEdit() {return _textEdit = require('nuclide-commons-atom/text-edit');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */let rootAggregatorPromise;const logger = (0, (_log4js || _load_log4js()).getLogger)('HostServices');null;class RootHostServices {constructor() {this._nullProgressMessage = { setTitle: s => {}, dispose: () => {} };this._getConsoleService = (0, (_memoize2 || _load_memoize()).default)(() =>
    (0, (_consumeFirstProvider || _load_consumeFirstProvider()).default)('console', '0.1.0'));this.





    _getConsoleApi = (0, (_memoize2 || _load_memoize()).default)(source =>
    this._getConsoleService().then(createApi =>
    createApi({ id: source, name: source })));} // This method creates registers sources with the atom-ide-console service, but never disposes
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      const busyMessage =
      service == null ?
      _this._nullProgressMessage :
      service.reportBusy(title, Object.assign({}, options));
  ...
  options)
  {
    return _rxjsBundlesRxMinJs.Observable.defer(() => this._getBusySignalService()).
    switchMap(service => {
      return _rxjsBundlesRxMinJs.Observable.create(observer => {
        let onDidClick;
  ...
  dispose() {
    ...
    if (!false) {throw new Error('RootHostServices and RootAggregator cannot be disposed.');}
  }

  childRegister(child) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      return _this2;
  ...
  options)
  {
    switch (level) {
      ...
      default:if (!
        false) {throw new Error('Unrecognized ShowMessageLevel');}}
