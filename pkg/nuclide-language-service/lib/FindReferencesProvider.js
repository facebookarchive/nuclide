'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.FindReferencesProvider = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _nuclideRemoteConnection;
...
function _load_nuclideOpenFiles() {return _nuclideOpenFiles = require('../../nuclide-open-files');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class FindReferencesProvider {
  ...
  isEditorSupported(textEditor) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      return (
        textEditor.getPath() != null &&
        _this.grammarScopes.includes(textEditor.getGrammar().scopeName));})();
