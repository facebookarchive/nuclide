'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.SyntacticSelectionProvider = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _nuclideRemoteConnection;
...
class SyntacticSelectionProvider {
  ...
  getExpandedSelectionRange(editor) {var _this = this;
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(this._expandAnalyticsEventName, (0, _asyncToGenerator.default)(function* () {
      ...
      return (yield languageService).getExpandedSelectionRange(
      fileVersion,
  ...
  {var _this2 = this;
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(this._collapseAnalyticsEventName, (0, _asyncToGenerator.default)(function* () {
      ...
      return (yield languageService).getCollapsedSelectionRange(
      fileVersion,
      editor.getSelectedBufferRange(),
      originalCursorPosition);
