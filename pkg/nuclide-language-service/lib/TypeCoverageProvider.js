...
class TypeCoverageProvider {
  ...
  constructor(name, selector, priority, analyticsEventName, icon, connectionToLanguageService) {
    ...
    this._connectionToLanguageService.observeValues().subscribe((() => {
      var _ref = (0, _asyncToGenerator.default)(function* (languageService) {
  ...
  onToggle(on) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      yield Promise.all(Array.from(_this3._connectionToLanguageService.values()).map((() => {
        var _ref3 = (0, _asyncToGenerator.default)(function* (languageService) {
          const ls = yield languageService;
