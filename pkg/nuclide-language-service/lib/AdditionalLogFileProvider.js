'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.LanguageAdditionalLogFilesProvider = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _collection;
...
class LanguageAdditionalLogFilesProvider {
  ...
  constructor(name, connectionToLanguageService) {this.id = 'als';
    this._name = name;
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const resultsForConnection = (() => {var _ref = (0, _asyncToGenerator.default)(function* (prefix, connection) {
          ...
          return subResults.map(function (log) {return Object.assign({}, log, { title: prefix + log.title });});
        });return function resultsForConnection(_x, _x2) {return _ref.apply(this, arguments);};})();
