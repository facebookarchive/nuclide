...
var _commonsNodeBatchProcessedQueue;

function _load_commonsNodeBatchProcessedQueue() {
  return _commonsNodeBatchProcessedQueue = _interopRequireDefault(require('../../commons-node/BatchProcessedQueue'));
}
...
var AnalyticsBatcher = (function () {
  function AnalyticsBatcher(track) {
    ...
    this._track = track;
    this._queue = new (_commonsNodeBatchProcessedQueue || _load_commonsNodeBatchProcessedQueue()).default(REPORTING_PERIOD, function (events) {
