'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _Ansi;
...
function _load_Ansi() {return _Ansi = _interopRequireDefault(require('./Ansi'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
const Status = Object.freeze({
  ...
  TIMEOUT: 5 }); /**
                  ...
                  *  strict-local
                  * @format
                  */const StatusSymbol = {};StatusSymbol[Status.PASSED] = `${(_Ansi || _load_Ansi()).default.GREEN}✓${(_Ansi || _load_Ansi()).default.RESET}`;StatusSymbol[Status.FAILED] = `${(_Ansi || _load_Ansi()).default.RED}✗${(_Ansi || _load_Ansi()).default.RESET}`;StatusSymbol[Status.SKIPPED] = `${(_Ansi || _load_Ansi()).default.YELLOW}?${(_Ansi || _load_Ansi()).default.RESET}`;StatusSymbol[Status.FATAL] = `${(_Ansi || _load_Ansi()).default.RED}✘${(_Ansi || _load_Ansi()).default.RESET}`;StatusSymbol[Status.TIMEOUT] = `${(_Ansi || _load_Ansi()).default.BLUE}✉${(_Ansi || _load_Ansi()).default.RESET}`;
const StatusMessage = {};
...
class TestRunModel {
  ...
  }}exports.default = TestRunModel;TestRunModel.Status = Status;