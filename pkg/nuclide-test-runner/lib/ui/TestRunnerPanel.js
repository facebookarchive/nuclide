    ...
    value: function render() {
      ...
      if (this.props.path) {
        pathMsg = (_reactForAtom2 || _reactForAtom()).React.createElement(
          ...
          (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.basename(this.props.path)
        );
      }
      ...
      if (this.isDisabled()) {
        ...
        dropdown = (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiDropdown2 || _nuclideUiDropdown()).Dropdown, {
      ...
      if (this.props.attachDebuggerBeforeRunning != null) {
        attachDebuggerCheckbox = (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiCheckbox2 || _nuclideUiCheckbox()).Checkbox, {
