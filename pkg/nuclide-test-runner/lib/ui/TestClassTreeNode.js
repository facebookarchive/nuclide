...
var _nuclideUiLazyTreeNode;

function _load_nuclideUiLazyTreeNode() {
  return _nuclideUiLazyTreeNode = require('../../../nuclide-ui/LazyTreeNode');
}
...
})((_nuclideUiLazyTreeNode || _load_nuclideUiLazyTreeNode()).LazyTreeNode);
