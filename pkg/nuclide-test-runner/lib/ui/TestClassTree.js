...
var _TestClassTreeNode = require('./TestClassTreeNode');

var _TestClassTreeNode2 = _interopRequireDefault(_TestClassTreeNode);
...
var TestClassTree = (function (_React$Component) {
  ...
  _createClass(TestClassTree, [{
      ...
      if (this.props.testSuiteModel !== prevProps.testSuiteModel) {
        ...
        if (this.props.testSuiteModel) {
          for (var testClass of this.props.testSuiteModel.testClasses.values()) {
            roots.push(new _TestClassTreeNode2.default(testClass));
          }
        }
    ...
    value: function render() {
      var emptyRenderMessage = _reactForAtom.React.createElement(
        'div',
        null,
      ...
      return _reactForAtom.React.createElement(
        ...
        _reactForAtom.React.createElement(
          'div',
          { className: 'padded' },
          _reactForAtom.React.createElement(_nuclideUiLibTreeRootComponent.TreeRootComponent, {
