...
var _TestRunModel = require('./TestRunModel');

var _TestRunModel2 = _interopRequireDefault(_TestRunModel);

var _uiTestRunnerPanel = require('./ui/TestRunnerPanel');

var _uiTestRunnerPanel2 = _interopRequireDefault(_uiTestRunnerPanel);

var _TestSuiteModel = require('./TestSuiteModel');

var _TestSuiteModel2 = _interopRequireDefault(_TestSuiteModel);
...
var TestRunnerController = (function () {
  function TestRunnerController(state, testRunners) {
    ...
    this._executionState = _uiTestRunnerPanel2.default.ExecutionState.STOPPED;
  ...
  _createClass(TestRunnerController, [{
    ...
    value: _asyncToGenerator(function* (path) {
      ...
      this._setExecutionState(_uiTestRunnerPanel2.default.ExecutionState.RUNNING);
      this._path = testPath;
      this._renderPanel();
    })
  }, {
    ...
    value: function stopTests() {
      ...
      this._setExecutionState(_uiTestRunnerPanel2.default.ExecutionState.STOPPED);
    }
  }, {
    key: 'serialize',
    ...
    value: function showPanel(didRender) {
      (0, _nuclideAnalytics.track)('testrunner-show-panel');
    ...
    value: function togglePanel() {
      (0, _nuclideAnalytics.track)('testrunner-hide-panel');
    ...
    value: function _appendToBuffer(text) {
      ...
      this._buffer.append('' + text + _os2.default.EOL, { undo: 'skip' });
    }
  }, {
    ...
    value: function _runTestRunnerServiceForPath(testRun, path, label) {
      ...
      var subscription = testRun.do(function (message) {
        switch (message.kind) {
          case 'summary':
            _this2._testSuiteModel = new _TestSuiteModel2.default(message.summaryInfo);
            _this2._renderPanel();
            break;
          case 'run-test':
            ...
            _this2._appendToBuffer(_TestRunModel2.default.formatStatusMessage(testInfo.name, testInfo.durationSecs, testInfo.status));
            _this2._renderPanel();
            break;
          case 'start':
            if (_this2._run) {
          ...
          case 'error':
            ...
            if (error.code === 'ENOENT') {
              _this2._appendToBuffer(_Ansi2.default.YELLOW + 'Command \'' + error.path + '\' does not exist' + _Ansi2.default.RESET);
              _this2._appendToBuffer(_Ansi2.default.YELLOW + 'Are you trying to run remotely?' + _Ansi2.default.RESET);
              _this2._appendToBuffer(_Ansi2.default.YELLOW + 'Path: ' + path + _Ansi2.default.RESET);
            }
            _this2._appendToBuffer(_Ansi2.default.RED + 'Original Error: ' + error.message + _Ansi2.default.RESET);
            _this2._setExecutionState(_uiTestRunnerPanel2.default.ExecutionState.STOPPED);
            logger.error('Error running tests: "' + error.message + '"');
            break;
          case 'stderr':
            // Color stderr output red in the console to distinguish it as error.
            _this2._appendToBuffer('' + _Ansi2.default.RED + message.data + _Ansi2.default.RESET);
            break;
        }
      }).finally(function () {
      ...
      this._run = new _TestRunModel2.default(label, subscription.unsubscribe.bind(subscription));
    }
  }, {
    ...
    value: function _renderPanel(didRender) {
      ...
      if (this._testSuiteModel && this._executionState === _uiTestRunnerPanel2.default.ExecutionState.RUNNING) {
      ...
      var component = _reactForAtom.ReactDOM.render(_reactForAtom.React.createElement(_uiTestRunnerPanel2.default, {
      ...
      (0, _assert2.default)(component instanceof _uiTestRunnerPanel2.default);
