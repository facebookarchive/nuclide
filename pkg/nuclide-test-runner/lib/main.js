...
var Activation = (function () {
  function Activation(state) {
    ...
    this._disposables.add(atom.commands.add('atom-workspace', 'nuclide-test-runner:run-tests', function () {
      _this._getController().runTests();
    }));
  ...
  _createClass(Activation, [{
    ...
    value: function addItemsToFileTreeContextMenu(contextMenu) {
      ...
      (0, (_assert || _load_assert()).default)(fileItem.shouldDisplay);
      var fileItemShouldDisplay = fileItem.shouldDisplay.bind(fileItem);
      (0, (_assert || _load_assert()).default)(directoryItem.shouldDisplay);
      ...
      var menuItemSubscriptions = new (_atom || _load_atom()).CompositeDisposable();
