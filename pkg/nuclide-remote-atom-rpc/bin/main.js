...
/**
                                                                                             ...
                                                                                             */let getRealPath = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (filePath) {
    ...
    while (true) {
      try {
        ...
        const realpath = yield (_fsPromise || _load_fsPromise()).default.realpath(prefix);
    ...
    return resolved;
  });return function getRealPath(_x) {return _ref.apply(this, arguments);};})();let getIsDirectory = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  });return function getIsDirectory(_x2) {return _ref2.apply(this, arguments);};})();let main = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  ...
  function* (argv) {
    ...
    if (argv._ != null && argv._.length > 0) {
      let commands;
      try {
        commands = yield (0, (_CommandClient || _load_CommandClient()).getCommands)(argv, /* rejectIfZeroConnections */true);
      } catch (error) {
  ...
  });return function main(_x3) {return _ref3.apply(this, arguments);};})();let run = (() => {var _ref4 = (0, _asyncToGenerator.default)(
...
function parseLocationParameter(value) {let filePath = value.replace(/[:\s]+$/, '');const match = filePath.match(LocationSuffixRegExp);let line = 0;let column = 0;if (match) {filePath = filePath.slice(0, -match[0].length);if (match[1]) {line = Math.max(0, parseInt(match[1].slice(1), 10) - 1);}if (match[2]) {column = Math.max(0, parseInt(match[2].slice(1), 10) - 1);}}return { filePath, line, column };}run();