...
/**
                                                                                             ...
                                                                                             */let main = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  function* (argv) {
    ...
    yield commands.addNotification(notification);

    return (_errors || _load_errors()).EXIT_CODE_SUCCESS;
  });return function main(_x) {return _ref.apply(this, arguments);};})(); /**
                                                                           ...
                                                                           * 
                                                                           * @format
                                                                           */let run = (() => {var _ref2 = (0, _asyncToGenerator.default)(function* () {const { argv } = (_yargs || _load_yargs()).default.usage('Usage: atom-notify').help('h').alias('h', 'help').option('p', { alias: 'port', describe: 'Port for connecting to nuclide',
      type: 'number' }).
