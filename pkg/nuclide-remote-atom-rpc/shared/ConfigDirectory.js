'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.getServer = exports.createNewEntry = exports.RPC_PROTOCOL = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
/**
                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                         */let createConfigDirectory = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (
  clearDirectory)
  {
    ...
    // a local directory.
    return (0, (_promise || _load_promise()).asyncFind)(getCandidateDirectories(), (() => {var _ref2 = (0, _asyncToGenerator.default)(function* (directory) {
  ...
  });return function createConfigDirectory(_x) {return _ref.apply(this, arguments);};})();let createNewEntry = exports.createNewEntry = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  ...
  family)
  {
    ...
    (_nuclideUri || _load_nuclideUri()).default.join(subdir, SERVER_INFO_FILE),
    JSON.stringify(info));
  ...
  });return function createNewEntry(_x3, _x4) {return _ref3.apply(this, arguments);};})();let getServer = exports.getServer = (() => {var _ref4 = (0, _asyncToGenerator.default)(
  ...
  });return function getServer() {return _ref4.apply(this, arguments);};})();let getServerInfos = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  ...
  configDirectory)
  {
    ...
    // $FlowFixMe
    yield Promise.all(
    entries.map((() => {var _ref6 = (0, _asyncToGenerator.default)(function* (entry) {
        const subdir = (_nuclideUri || _load_nuclideUri()).default.join(configDirectory, entry);
        const info = JSON.parse((
        yield (_fsPromise || _load_fsPromise()).default.readFile((_nuclideUri || _load_nuclideUri()).default.join(subdir, SERVER_INFO_FILE), 'utf8')));
        ...
        if (info.commandPort != null && info.family != null) {
          ...
          return null;
      ...
      });return function (_x6) {return _ref6.apply(this, arguments);};})()))));


  });return function getServerInfos(_x5) {return _ref5.apply(this, arguments);};})();var _collection;function _load_collection() {return _collection = require('nuclide-commons/collection');}var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _promise;function _load_promise() {return _promise = require('nuclide-commons/promise');}var _os = _interopRequireDefault(require('os'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const logger = (0, (_log4js || _load_log4js()).getLogger)('nuclide-remote-atom-rpc'); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */const RPC_PROTOCOL = exports.RPC_PROTOCOL = 'atom_rpc_protocol';const NUCLIDE_DIR = '.nuclide';const NUCLIDE_SERVER_INFO_DIR = 'command-server';const SERVER_INFO_FILE = 'serverInfo.json';function getConfigDirectory(directory) {return (_nuclideUri || _load_nuclideUri()).default.join(directory, NUCLIDE_DIR, NUCLIDE_SERVER_INFO_DIR);}function findPathToConfigDirectory() {return (0, (_promise || _load_promise()).asyncFind)(getCandidateDirectories(), (() => {var _ref7 = (0, _asyncToGenerator.default)(function* (directory) {const configDir = getConfigDirectory(directory);return (yield (_fsPromise || _load_fsPromise()).default.exists(configDir)) ? configDir : null;});return function (_x7) {return _ref7.apply(this, arguments);};})());}function getCandidateDirectories() {
