'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.PathSet = undefined;
...
var _os = _interopRequireDefault(require('os'));var _minimatch;
function _load_minimatch() {return _minimatch = require('minimatch');}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../../modules/nuclide-commons/nuclideUri'));}var _nuclideFuzzyNative;
function _load_nuclideFuzzyNative() {return _nuclideFuzzyNative = require('../../../nuclide-fuzzy-native');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
  ...
  rootPath)
  {
    ...
    map(name => (0, (_minimatch || _load_minimatch()).makeRe)(name, { matchBase: true, dot: true }))
     ...
     */addPaths(paths) {this._matcher.addCandidates(this._transformPaths(paths));}
  ...
  options = Object.freeze({}))
  {
    ...
    const basePath = (_nuclideUri || _load_nuclideUri()).default.ensureTrailingSeparator(
    (_nuclideUri || _load_nuclideUri()).default.dirname(rootPath));
    ...
    if (queryRoot != null && (_nuclideUri || _load_nuclideUri()).default.contains(basePath, queryRoot)) {
  ...
  _transformPaths(paths) {
    ...
    map(path => (_nuclideUri || _load_nuclideUri()).default.join(this._basename, path));
