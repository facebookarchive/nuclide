...
const CodeSearchProvider = exports.CodeSearchProvider = {
  ...
  getComponentForItem(_item) {
    const item = _item;
    const context = replaceAndWrap(item.context || '', item.query, (rest, i) => _react.default.createElement(
      'span',
      {
        key: `rest-${i}`,
        className: 'code-search-provider-result-context-rest' },
      rest
    ), (match, i) => _react.default.createElement(
      'span',
      {
        key: `match-${i}`,
    ...
    return _react.default.createElement(
      ...
      item.isFirstResultForPath && _react.default.createElement((_PathWithFileIcon || _load_PathWithFileIcon()).default, {
