...
let generateHgRepo1Fixture = exports.generateHgRepo1Fixture = (() => {
  var _ref2 = (0, _asyncToGenerator.default)(function* () {
    ...
    yield (0, (_process || _load_process()).runCommand)('hg', ['commit', '-A', '-m', 'first commit'], { cwd: repoPath }).toPromise();
    ...
    yield (0, (_process || _load_process()).runCommand)('hg', ['commit', '-A', '-m', 'second commit'], { cwd: repoPath }).toPromise();
    return repoPath;
  });
...
let generateHgRepo2Fixture = exports.generateHgRepo2Fixture = (() => {
  var _ref3 = (0, _asyncToGenerator.default)(function* () {
    ...
    yield (0, (_process || _load_process()).runCommand)('hg', ['commit', '-A', '-m', 'add .arcconfig to set base'], { cwd: repoPath }).toPromise();
