'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.copyBuildFixture = exports.generateHgRepo4Fixture = exports.overwriteFileWithTestContent = exports.generateHgRepo3Fixture = exports.generateHgRepo2Fixture = exports.generateHgRepo1Fixture = exports.copyFixture = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                 */let copyFixture = exports.copyFixture = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (
  fixtureName,
  startDir)
  {
    const fixturePath = (_nuclideUri || _load_nuclideUri()).default.join('fixtures', fixtureName);
    const fixtureRoot = yield (_fsPromise || _load_fsPromise()).default.findNearestFile(fixturePath, startDir);if (!(
    fixtureRoot != null)) {throw new Error('Could not find source fixture.');}
    ...
    return realTempDir;
  });return function copyFixture(_x, _x2) {return _ref.apply(this, arguments);};})();
...
/**
                                                                                       ...
                                                                                       */let generateHgRepo1Fixture = exports.generateHgRepo1Fixture = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  function* () {
    const testTxt = 'this is a test file\nline 2\n\n  indented line\n';
    const tempDir = yield (0, (_testHelpers || _load_testHelpers()).generateFixture)(
    'hg_repo_1',
    ...
    yield (_fsPromise || _load_fsPromise()).default.writeFile(
    (_nuclideUri || _load_nuclideUri()).default.join(repoPath, '.hg', 'hgrc'),
    ...
    toPromise();
    yield (_fsPromise || _load_fsPromise()).default.writeFile(
    (_nuclideUri || _load_nuclideUri()).default.join(repoPath, 'test.txt'),
    ...
    toPromise();
    return repoPath;
  });return function generateHgRepo1Fixture() {return _ref2.apply(this, arguments);};})();
...
/**
                                                                                            ...
                                                                                            *
                                                                                            * @returns the path to the temporary directory that this function creates.
                                                                                            */let generateHgRepo2Fixture = exports.generateHgRepo2Fixture = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  function* () {
    const testTxt = 'this is a test file\nline 2\n\n  indented line\n';
    const tempDir = yield (0, (_testHelpers || _load_testHelpers()).generateFixture)(
    'hg_repo_2',
    ...
    toPromise();
    return repoPath;
  });return function generateHgRepo2Fixture() {return _ref3.apply(this, arguments);};})();
...
/**
                                                                                            ...
                                                                                            *
                                                                                            * @returns the path to the temporary directory that this function creates.
                                                                                            */let generateHgRepo3Fixture = exports.generateHgRepo3Fixture = (() => {var _ref4 = (0, _asyncToGenerator.default)(
  function* (
  fileName = 'temp.txt')
  {
    ...
    toPromise();
    yield (_fsPromise || _load_fsPromise()).default.writeFile(
    (_nuclideUri || _load_nuclideUri()).default.join(repoPath, fileName),
    ...
    toPromise();
    return repoPath;
  });return function generateHgRepo3Fixture() {return _ref4.apply(this, arguments);};})();let overwriteFileWithTestContent = exports.overwriteFileWithTestContent = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  ...
  });return function overwriteFileWithTestContent(_x3, _x4) {return _ref5.apply(this, arguments);};})();
...
/**
                                                                                                          ...
                                                                                                          *
                                                                                                          * @returns the path to the temporary directory that this function creates.
                                                                                                          */let generateHgRepo4Fixture = exports.generateHgRepo4Fixture = (() => {var _ref6 = (0, _asyncToGenerator.default)(
  function* () {
    const testTxt = 'this is a test file\n';
    ...
    for (let i = 1; i < 5; i++) {
      ...
      yield (_fsPromise || _load_fsPromise()).default.writeFile(
      (_nuclideUri || _load_nuclideUri()).default.join(repoPath, `test_${i}.txt`),
      `this is test file ${i}`);
    ...
    return repoPath;
  });return function generateHgRepo4Fixture() {return _ref6.apply(this, arguments);};})();
...
/**
                                                                                            ...
                                                                                            * @param fixtureName The name of the subdirectory of the `fixtures/` directory.
                                                                                            * @returns the path to the temporary directory that this function creates.
                                                                                            */let copyBuildFixture = exports.copyBuildFixture = (() => {var _ref7 = (0, _asyncToGenerator.default)(
  function* (
  fixtureName,
  source)
  {
    ...
    return projectDir;
  });return function copyBuildFixture(_x5, _x6) {return _ref7.apply(this, arguments);};})();let copyBuckVersion = (() => {var _ref8 = (0, _asyncToGenerator.default)(

  function* (projectDir) {
    const versionFile = '.buckversion';
    const buckVersionDir = yield (_fsPromise || _load_fsPromise()).default.findNearestFile(
    versionFile,
    __dirname);

    if (buckVersionDir != null) {
      yield (_fsPromise || _load_fsPromise()).default.copy(
      (_nuclideUri || _load_nuclideUri()).default.join(buckVersionDir, versionFile),
      (_nuclideUri || _load_nuclideUri()).default.join(projectDir, versionFile));

    }
  });return function copyBuckVersion(_x7) {return _ref8.apply(this, arguments);};})();let renameBuckFiles = (() => {var _ref9 = (0, _asyncToGenerator.default)(
  ...
  });return function renameBuckFiles(_x8) {return _ref9.apply(this, arguments);};})();var _fsExtra;function _load_fsExtra() {return _fsExtra = _interopRequireDefault(require('fs-extra'));}var _temp;function _load_temp() {return _temp = _interopRequireDefault(require('temp'));}var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _process;function _load_process() {return _process = require('nuclide-commons/process');}var _testHelpers;function _load_testHelpers() {return _testHelpers = require('nuclide-commons/test-helpers');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
