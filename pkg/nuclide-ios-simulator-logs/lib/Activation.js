...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _formatEnoentNotification;
function _load_formatEnoentNotification() {return _formatEnoentNotification = _interopRequireDefault(require('../../commons-atom/format-enoent-notification'));}var _LogTailer;
function _load_LogTailer() {return _LogTailer = require('../../nuclide-console-base/lib/LogTailer');}var _createMessageStream;
function _load_createMessageStream() {return _createMessageStream = require('./createMessageStream');}var _createProcessStream;
function _load_createProcessStream() {return _createProcessStream = require('./createProcessStream');}
...
class Activation {
  ...
  constructor(state) {
    this._iosLogTailer = new (_LogTailer || _load_LogTailer()).LogTailer({
      ...
      messages: _rxjsBundlesRxMinJs.Observable.defer(() =>
      (0, (_createMessageStream || _load_createMessageStream()).createMessageStream)((0, (_createProcessStream || _load_createProcessStream()).createProcessStream)())),
