...
createMessageStream = createMessageStream;var _observable;function _load_observable() {return _observable = require('nuclide-commons/observable');}var _featureConfig;function _load_featureConfig() {return _featureConfig = _interopRequireDefault(require('nuclide-commons-atom/feature-config'));}var _createMessage;function _load_createMessage() {return _createMessage = require('./createMessage');}var _plist;function _load_plist() {return _plist = _interopRequireDefault(require('plist'));}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     */function createMessageStream(line$) {// Group the lines into valid plist strings.
  const messages = line$.let((0, (_observable || _load_observable()).bufferUntil)(line => line.trim() === '</plist>')) // Don't include empty buffers. This happens if the stream completes since we opened a new
  ...
  .flatMap(xml => (_plist || _load_plist()).default.parse(xml)) // Exclude dicts that don't have any message property.
  ...
  .filter(record => {
    const blacklist = (_featureConfig || _load_featureConfig()).default.get(
...
messages)
{
  const patterns = (_featureConfig || _load_featureConfig()).default.
