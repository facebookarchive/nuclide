var findVcsHelper = _asyncToGenerator(function* (src) {
  var options = {
    'cwd': _path2.default.dirname(src)
  };
  var hgResult = undefined;
  try {
    hgResult = yield (0, _process.asyncExecute)('hg', ['root'], options);
  } catch (e) {
    hgResult = e;
  }
  ...
  try {
    gitResult = yield (0, _process.asyncExecute)('git', ['rev-parse', '--show-toplevel'], options);
  } catch (e) {
    gitResult = e;
  }
