...
var JumpToRelatedFile = (function () {
  ...
  _createClass(JumpToRelatedFile, [{
    ...
    value: _asyncToGenerator(function* (path) {
      var _ref = yield (_RelatedFileFinder || _load_RelatedFileFinder()).default.find(path);
    ...
    value: _asyncToGenerator(function* (path) {
      var _ref2 = yield (_RelatedFileFinder || _load_RelatedFileFinder()).default.find(path);
