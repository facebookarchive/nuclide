'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _nuclideRemoteConnection;
...
function _load_promise() {return _promise = require('../../../modules/nuclide-commons/promise');}var _UniversalDisposable;
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            */const relatedFilesProviders = new Set(); /**
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        */class RelatedFileFinder {static registerRelatedFilesProvider(provider) {relatedFilesProviders.add(provider);
  ...
  static _findRelatedFilesFromProviders(
  path)
  {return (0, _asyncToGenerator.default)(function* () {
      const relatedLists = yield Promise.all(
      Array.from(relatedFilesProviders.values()).map(function (provider) {return (
          (0, (_promise || _load_promise()).timeoutPromise)(provider.getRelatedFiles(path), 1000).catch(function (error) {
  ...
  {return (0, _asyncToGenerator.default)(function* () {
      ...
      map(function (entry) {return (_nuclideUri || _load_nuclideUri()).default.join(dirName, entry[0]);}).
      concat((yield RelatedFileFinder._findRelatedFilesFromProviders(filePath)));

      let wlFilelist =
      fileTypeWhitelist.size <= 0 ?
      filelist :
      filelist.filter(function (otherFilePath) {
