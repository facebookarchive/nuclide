...
function runTask(buildSystem, task) {
  return (0, (_rxjsObservableUsing2 || _rxjsObservableUsing()).using)(function () {
    ...
    var progressStream = taskInfo.observeProgress == null ? (_rxjs2 || _rxjs()).Observable.empty() : (0, (_commonsNodeEvent2 || _commonsNodeEvent()).observableFromSubscribeFunction)(taskInfo.observeProgress.bind(taskInfo));
    ...
    return (_rxjs2 || _rxjs()).Observable.of({
      ...
      throw err;
    })).takeUntil((0, (_commonsNodeEvent2 || _commonsNodeEvent()).observableFromSubscribeFunction)(taskInfo.onDidComplete.bind(taskInfo))).concat((_rxjs2 || _rxjs()).Observable.of({
