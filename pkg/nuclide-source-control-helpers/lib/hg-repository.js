...
findHgRepository;var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _ini;function _load_ini() {return _ini = _interopRequireDefault(require('ini'));}var _fs = _interopRequireDefault(require('fs'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                       */function findHgRepository(startDirectoryPath) {if (!(_nuclideUri || _load_nuclideUri()).default.isLocal(startDirectoryPath)) {
    return null;
  }
   ...
   * 
   * @format
   */function tryIsDirectorySync(dirname) {try {const stat = _fs.default.statSync(dirname);return stat.isDirectory();} catch (err) {return false;}}
