...
var ProgressBar = (function (_React$Component) {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function render() {
      var className = (0, (_classnames || _load_classnames()).default)('nuclide-task-runner-progress-bar', {
    ...
    value: function _renderBar() {
      ...
      (0, (_assert || _load_assert()).default)(this.props.progress != null);
      return (_reactForAtom || _load_reactForAtom()).React.createElement(Bar, { progress: this.props.progress });
    }
  }]);
