'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _Button;
...
function _load_ButtonGroup() {return _ButtonGroup = require('../../../../modules/nuclide-commons-ui/ButtonGroup');}var _TaskRunnerButton;
function _load_TaskRunnerButton() {return _TaskRunnerButton = require('./TaskRunnerButton');}var _Dropdown;
function _load_Dropdown() {return _Dropdown = require('../../../../modules/nuclide-commons-ui/Dropdown');}var _FullWidthProgressBar;
function _load_FullWidthProgressBar() {return _FullWidthProgressBar = _interopRequireDefault(require('../../../nuclide-ui/FullWidthProgressBar'));}var _classnames;
...
class Toolbar extends _react.Component {
  render() {
    ...
    _react.createElement((_TaskRunnerButton || _load_TaskRunnerButton()).TaskRunnerButton, Object.assign({},
    buttonProps, {
    ...
    return (
      _react.createElement('div', { className: `${className} padded` },
        _react.createElement('div', { className: 'nuclide-task-runner-toolbar-contents' },
          _react.createElement('span', { className: 'inline-block', style: dropdownVisibility },
  ...
  _renderTaskButtons() {
    ...
    return (
      _react.createElement('span', { className: 'inline-block', key: 'taskButtons' },
  ...
  _getButtonsForTasks() {
    const { activeTaskRunner } = this.props;if (!
    activeTaskRunner) {throw new Error('Invariant violation: "activeTaskRunner"');}
    const state = this.props.statesForTaskRunners.get(activeTaskRunner);
    if (!state) {
      return [];
    }if (!
    state) {throw new Error('Invariant violation: "state"');}
      ...
      return (
        _react.createElement((_Button || _load_Button()).Button, {
          ...
          onClick: event => {
            ...
            this.props.runTask(Object.assign({},
            effectiveTask, {
...
function NoTaskRunnersMessage() {
  ...
  return (
    _react.createElement('span', { style: { 'white-space': 'nowrap' } }, 'Install and enable a ',
      _react.createElement('a', { href: featureLink }, 'task runner'), ' to use this toolbar'));
