  ...
  _createClass(Toolbar, [{
    ...
    value: function _renderExtraUi() {
      if (this.props.activeTaskId) {
        ...
        return ExtraUi ? (_reactForAtom || _load_reactForAtom()).React.createElement(ExtraUi, { activeTaskType: this.props.activeTaskId.type }) : null;
      }
    ...
    value: function render() {
      ...
      var activeTask = activeTaskId == null ? null : (0, (_getTaskMetadata || _load_getTaskMetadata()).getTaskMetadata)(activeTaskId, this.props.taskLists);
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement(
            ...
            (_reactForAtom || _load_reactForAtom()).React.createElement((_TaskButton || _load_TaskButton()).TaskButton, {
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement(
            'div',
            { className: 'inline-block' },
            (_reactForAtom || _load_reactForAtom()).React.createElement('button', {
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement((_ProgressBar || _load_ProgressBar()).ProgressBar, {
