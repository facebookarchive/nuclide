...
var _nuclideUiSplitButtonDropdown;

function _load_nuclideUiSplitButtonDropdown() {
  return _nuclideUiSplitButtonDropdown = require('../../../nuclide-ui/SplitButtonDropdown');
}
...
function TaskButton(props) {
  ...
  ? function (buttonProps) {
    ...
    return (_reactForAtom || _load_reactForAtom()).React.createElement((_TaskRunnerButton || _load_TaskRunnerButton()).TaskRunnerButton, _extends({}, buttonProps, { iconComponent: TaskRunnerIcon }));
  };
  ...
  return (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiSplitButtonDropdown || _load_nuclideUiSplitButtonDropdown()).SplitButtonDropdown, {
