...
function CommonControls(props) {
  ...
  // shows its icon.
  const ButtonComponent = activeTask == null ? (_Button || _load_Button()).Button : buttonProps => _reactForAtom.React.createElement((_TaskRunnerButton || _load_TaskRunnerButton()).TaskRunnerButton, Object.assign({}, buttonProps, { iconComponent: TaskRunnerIcon }));
...
function getTaskRunnerOptions(taskRunners) {
