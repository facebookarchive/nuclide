...
getToolbarProps;var _observable;function _load_observable() {return _observable = require('../../../../modules/nuclide-commons/observable');}var _Actions;function _load_Actions() {return _Actions = _interopRequireWildcard(require('../redux/Actions'));}var _react = _interopRequireWildcard(require('react'));var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _shallowequal;function _load_shallowequal() {return _shallowequal = _interopRequireDefault(require('shallowequal'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function getToolbarProps(store) {
  const staticProps = {
    runTask: taskMeta => {
  ...
  const alwaysUpToDateProps = states.map(state => Object.assign({},
  staticProps, {
    toolbarDisabled:
    !state.initialPackagesActivated ||
    state.readyTaskRunners.count() !== state.taskRunners.count(),
  ...
  let((0, (_observable || _load_observable()).throttle)(() => (_observable || _load_observable()).nextAnimationFrame));
 ...
 * 
 * @format
 */const extraUiComponentCache = new WeakMap();function getExtraUiComponent(taskRunner) {if (!taskRunner) {return null;}let extraUi = extraUiComponentCache.get(taskRunner);if (extraUi != null) {return extraUi;
  }
