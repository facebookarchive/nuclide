    ...
    case (_Actions || _load_Actions()).TASK_LIST_UPDATED:
      {
        var _ret = (function () {
          ...
          if ((0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayEqual)(annotatedTaskList, state.taskLists.get(taskRunnerId) || [], (_shallowequal || _load_shallowequal()).default)) {
            return {
              v: state
            };
          }
