 ...
 * 
 * @format
 */const COMMON_TASK_TYPES = ['build', 'run', 'test', 'debug'];function getVisible(event) {if (event.detail != null && typeof event.detail === 'object') {const { visible } = event.detail;return visible != null ? Boolean(visible) : null;}return null;}
class Activation {
