...
function _load_bindObservableAsProps() {return _bindObservableAsProps = require('nuclide-commons-ui/bindObservableAsProps');}var _renderReactRoot;
function _load_renderReactRoot() {return _renderReactRoot = require('nuclide-commons-ui/renderReactRoot');}var _syncAtomCommands;
...
function _load_createPackage() {return _createPackage = _interopRequireDefault(require('nuclide-commons-atom/createPackage'));}var _LocalStorageJsonTable;
function _load_LocalStorageJsonTable() {return _LocalStorageJsonTable = require('../../commons-atom/LocalStorageJsonTable');}var _event;
function _load_event() {return _event = require('nuclide-commons/event');}var _collection;

function _load_collection() {return _collection = require('nuclide-commons/collection');}var _reduxObservable;
function _load_reduxObservable() {return _reduxObservable = require('nuclide-commons/redux-observable');}var _UniversalDisposable;
...
function _load_Toolbar() {return _Toolbar = _interopRequireDefault(require('./ui/Toolbar'));}var _redux;

function _load_redux() {return _redux = require('redux');}
...
function _load_ToolbarUtils() {return _ToolbarUtils = require('nuclide-commons-ui/ToolbarUtils');}
...
class Activation {
  ...
  constructor(rawState) {
    ...
    (0, (_redux || _load_redux()).combineReducers)(_Reducers || _load_Reducers()),
    { visible: initialVisibility },
