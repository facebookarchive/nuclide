...
var Activation = (function () {
  function Activation(rawState) {
    ...
    (0, (_commonsAtomSyncAtomCommands2 || _commonsAtomSyncAtomCommands()).default)(states.debounceTime(500).map(function (state) {
      ...
      var taskMetaByType = new Map();
      allTasks.forEach(function (taskMeta) {
      ...
      return {
        'atom-workspace': _defineProperty({}, 'nuclide-task-runner:' + taskMeta.type, function () {
          _this._actionCreators.runTask(taskMeta);
        })
      };
    }, function (taskMeta) {
      return taskMeta.taskRunnerId + ':' + taskMeta.type;
    }),
