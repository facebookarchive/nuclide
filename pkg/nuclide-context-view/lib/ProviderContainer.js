...
var ProviderContainer = (function (_React$Component) {
  ...
  function ProviderContainer(props) {
    ...
    _get(Object.getPrototypeOf(ProviderContainer.prototype), 'constructor', this).call(this, props);
    this.state = {
      collapsed: false
    };
  ...
  _createClass(ProviderContainer, [{
    ...
    value: function _setCollapsed(collapsed) {
      ...
      (_nuclideAnalytics2 || _nuclideAnalytics()).default.track('nuclide-context-view-toggle-provider', {
