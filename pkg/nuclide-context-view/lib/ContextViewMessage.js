...
var ContextViewMessage = (function (_React$Component) {
  ...
  _createClass(ContextViewMessage, [{
    ...
    key: 'NOT_LOGGED_IN',
    value: (_reactForAtom2 || _reactForAtom()).React.createElement(
      'div',
      null,
      ...
      (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        { className: 'pull-right', onClick: showLoginModal },
        'Log in'
      )
    ),
    enumerable: true
...
function showLoginModal() {
  atom.commands.dispatch(atom.views.getView(atom.workspace), 'fb-login:login-logout');
}
