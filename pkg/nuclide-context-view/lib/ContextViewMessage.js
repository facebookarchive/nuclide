...

{
  ...
  render() {
    return _react.createElement('div', null, this.props.message);
                                           ...
                                           */ /**
                                               ...
                                               */ContextViewMessage.NO_DEFINITION = 'No definition selected.';ContextViewMessage.LOADING = 'Loading...';ContextViewMessage.NOT_LOGGED_IN = _react.createElement('div', null, _react.createElement('div', null, 'You need to log in to see this data!'));