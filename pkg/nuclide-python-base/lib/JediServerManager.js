  ...
  _createClass(JediServerManager, [{
    ...
    value: _asyncToGenerator(function* (src) {
      ...
      if (topLevelModulePathPromise == null) {
        ...
        topLevelModulePathPromise = (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.findFurthestFile('__init__.py', (_nuclideRemoteUri2 || _nuclideRemoteUri()).default.dirname(src), true /* stopOnMissing */
        );
