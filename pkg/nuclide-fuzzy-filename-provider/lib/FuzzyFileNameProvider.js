'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _featureConfig;
...
function _load_featureConfig() {return _featureConfig = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/feature-config'));}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _passesGK;
function _load_passesGK() {return _passesGK = require('../../commons-node/passesGK');}var _nuclideRemoteConnection;
function _load_nuclideRemoteConnection() {return _nuclideRemoteConnection = require('../../nuclide-remote-connection');}var _utils;
...
function _load_utils() {return _utils = require('./utils');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                           ...
                                                                                                                                                           * 
                                                                                                                                                           * @format
                                                                                                                                                           */exports.default = { providerType: 'DIRECTORY', name: 'FuzzyFileNameProvider', debounceDelay: 0, display: { title: 'Filenames', prompt: 'Fuzzy filename search...', action: 'nuclide-fuzzy-filename-provider:toggle-provider' },
  ...
  {return (0, _asyncToGenerator.default)(function* () {
      ...
      const results = yield service.queryFuzzyFile({
        rootDirectory: directoryPath,
        queryRoot: getQueryRoot(directoryPath),
        queryString: fileName,
        ignoredNames: (0, (_utils || _load_utils()).getIgnoredNames)(),
        smartCase: Boolean(
        (_featureConfig || _load_featureConfig()).default.get('nuclide-fuzzy-filename-provider.smartCase')),
...
function getQueryRoot(directoryPath) {
  ...
  return uri != null && (_nuclideUri || _load_nuclideUri()).default.contains(directoryPath, uri) ?
