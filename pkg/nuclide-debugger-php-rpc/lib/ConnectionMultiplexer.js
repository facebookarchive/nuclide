...
let ConnectionMultiplexer = exports.ConnectionMultiplexer = class ConnectionMultiplexer {
  ...
  _attachModeListen() {
    var _getConfig2 = (0, (_config || _load_config()).getConfig)();

    const xdebugAttachPort = _getConfig2.xdebugAttachPort,
          xdebugLaunchingPort = _getConfig2.xdebugLaunchingPort;
  ...
  _launchModeListen() {
    var _getConfig3 = (0, (_config || _load_config()).getConfig)();

    const xdebugLaunchingPort = _getConfig3.xdebugLaunchingPort;
  ...
  _shouldEnableConnection(connection) {
    ...
    return this._isFirstStartingConnection(connection) || connection.getStatus() === (_DbgpSocket || _load_DbgpSocket()).CONNECTION_STATUS.BREAK && (
  ...
  _isFirstStartingConnection(connection) {
    return this._status === MULTIPLEXER_STATUS.USER_ASYNC_BREAK_SENT && connection.getStatus() === (_DbgpSocket || _load_DbgpSocket()).CONNECTION_STATUS.STARTING && this._connections.size === 2 // Dummy connection + first connection.
  ...
  _checkForEnd() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this6._onlyDummyRemains() && (_this6._attachConnector == null || _this6._launchConnector == null || (0, (_config || _load_config()).getConfig)().endDebugWhenNoRequests)) {
        ...
        _this6._setStatus(MULTIPLEXER_STATUS.END);
      }
    })();
  }
