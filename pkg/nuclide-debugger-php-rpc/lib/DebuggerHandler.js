...
class DebuggerHandler {
  ...
  getProperties(variablesReference) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const id = _this11._variableHandles.get(variablesReference);
      if (id == null) {
        return [];
      }
      const properties = yield _this11._connectionMultiplexer.getProperties(id);
      return properties.map(function (prop) {
        return {
          ...
          variablesReference:
          // flowlint-next-line sketchy-null-string:off
          prop.value && prop.value.objectId ? _this11._variableHandles.create(prop.value.objectId) : 0
        };
      });
    })();
  }
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      if (hhResult.wasThrown) {
        ...
        response.body = {
          ...
          variablesReference: hhResult.result.objectId ? _this12._variableHandles.create(hhResult.result.objectId) : 0
        };
      }
    })();
  }
