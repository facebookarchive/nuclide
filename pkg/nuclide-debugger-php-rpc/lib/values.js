...
function convertBoolValue(dbgpProperty) {
  (0, (_assert || _load_assert()).default)(dbgpProperty._ != null);
...
function convertArrayValue(contextId, dbgpProperty) {
  ...
  var numchildren = String(dbgpProperty.$.numchildren != null ? dbgpProperty.$.numchildren : 0);
  var description = 'Array[' + numchildren + ']';
...
function getAggregateRemoteObjectId(contextId, dbgpProperty) {
  ...
  if (pageCount > 1) {
    ...
    (0, (_assert || _load_assert()).default)(dbgpProperty.$.fullname != null);
