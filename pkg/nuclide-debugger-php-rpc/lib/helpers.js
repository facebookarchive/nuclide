...
var hphpdMightBeAttached = _asyncToGenerator(function* () {
  var processes = yield (0, (_commonsNodeProcess || _load_commonsNodeProcess()).checkOutput)('ps', ['aux'], {});
...
function launchPhpScriptWithXDebugEnabled(scriptPath, sendToOutputWindowAndResolve) {
  ...
  var runtimeArgs = (0, (_commonsNodeString || _load_commonsNodeString()).shellParse)(phpRuntimeArgs);
  var scriptArgs = (0, (_commonsNodeString || _load_commonsNodeString()).shellParse)(scriptPath);
  var proc = (_child_process || _load_child_process()).default.spawn(phpRuntimePath, [].concat(_toConsumableArray(runtimeArgs), _toConsumableArray(scriptArgs)));
