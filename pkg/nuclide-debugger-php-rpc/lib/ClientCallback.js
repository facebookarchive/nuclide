...
var ClientCallback = (function () {
  ...
  function ClientCallback() {
    ...
    this._serverMessageObservable = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    this._notificationObservable = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    this._outputWindowObservable = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
  }
