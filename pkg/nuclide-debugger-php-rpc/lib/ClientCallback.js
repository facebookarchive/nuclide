...
var ClientCallback = (function () {
  ...
  function ClientCallback() {
    ...
    this._serverMessageObservable = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
    this._notificationObservable = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
    this._outputWindowObservable = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
  }
