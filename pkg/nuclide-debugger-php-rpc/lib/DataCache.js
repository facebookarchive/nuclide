...
var DataCache = (function () {
  ...
  _createClass(DataCache, [{
    ...
    value: _asyncToGenerator(function* (frameIndex, expression) {
      ...
      var id = (0, (_ObjectId || _load_ObjectId()).getWatchContextObjectId)(this._enableCount, frameIndex);
      (0, (_assert || _load_assert()).default)(evaluatedResult.result != null);
      ...
      var result = (0, (_values || _load_values()).convertValue)(id, evaluatedResult.result);
      return {
        result: result,
        wasThrown: false
      };
    ...
    value: _asyncToGenerator(function* (frameIndex, expression) {
      ...
      var id = (0, (_ObjectId || _load_ObjectId()).getWatchContextObjectId)(this._enableCount, frameIndex);
      (0, (_assert || _load_assert()).default)(evaluatedResult.result);
      var result = (0, (_values || _load_values()).convertValue)(id, evaluatedResult.result);
      return {
        result: result,
        wasThrown: false
    ...
    value: _asyncToGenerator(function* (id) {
      ...
      (0, (_assert || _load_assert()).default)(fullname != null);
      (0, (_assert || _load_assert()).default)(page != null);
    ...
    value: _asyncToGenerator(function* (id) {
      ...
      var filteredProperties = properties.filter(function (property) {
        (0, (_assert || _load_assert()).default)(property.$.fullname != null);
