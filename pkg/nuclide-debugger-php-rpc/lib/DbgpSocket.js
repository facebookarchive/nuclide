...
let DbgpSocket = exports.DbgpSocket = class DbgpSocket {
  ...
  _handleResponse(response, message) {
    ...
    const transaction_id = responseAttributes.transaction_id;
    const status = responseAttributes.status;
  ...
  setFileLineBreakpoint(breakpointInfo) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const lineNumber = breakpointInfo.lineNumber;
      const conditionExpression = breakpointInfo.conditionExpression;
