...
var DbgpSocket = (function () {
  ...
  _createClass(DbgpSocket, [{
    ...
    value: function onStatus(callback) {
      return (0, (_commonsNodeEvent || _load_commonsNodeEvent()).attachEvent)(this._emitter, DBGP_SOCKET_STATUS_EVENT, callback);
    }
  }, {
    key: 'onNotification',
    value: function onNotification(callback) {
      return (0, (_commonsNodeEvent || _load_commonsNodeEvent()).attachEvent)(this._emitter, DBGP_SOCKET_NOTIFICATION_EVENT, callback);
    }
  }, {
    key: '_onError',
    ...
    value: function _handleEvaluationCommand(transactionId, message) {
      (0, (_assert || _load_assert()).default)(this._pendingEvalTransactionIdStack.length > 0, 'No pending Eval Ids');
      ...
      (0, (_assert || _load_assert()).default)(lastEvalId === transactionId, 'Evaluation requests are being processed out of order.');
      ...
      (0, (_assert || _load_assert()).default)(continuationCommandCall != null, 'no pending continuation command request');
    ...
    value: function _handleStream(stream) {
      ...
      var outputText = stream._ != null ? (0, (_helpers || _load_helpers()).base64Decode)(stream._) : '';
    ...
    value: _asyncToGenerator(function* (expr) {
      var response = yield this._callDebugger('eval', '-- ' + (0, (_helpers || _load_helpers()).base64Encode)(expr));
    ...
    value: function _callDebugger(command, params) {
      ...
      var isContinuation = (0, (_helpers || _load_helpers()).isContinuationCommand)(command);
      if (isContinuation) {
