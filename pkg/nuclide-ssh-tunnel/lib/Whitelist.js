...
exports.validateTunnel = undefined;
...
let validateTunnel = exports.validateTunnel = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (tunnel) {
  ...
  return function validateTunnel(_x) {
