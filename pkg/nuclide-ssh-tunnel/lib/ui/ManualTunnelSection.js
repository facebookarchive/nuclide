...
function _load_ButtonGroup() {return _ButtonGroup = require('../../../../modules/nuclide-commons-ui/ButtonGroup');}var _Section;
function _load_Section() {return _Section = require('../../../../modules/nuclide-commons-ui/Section');}var _Tunnel;
function _load_Tunnel() {return _Tunnel = require('../../../nuclide-socket-rpc/lib/Tunnel');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}
...
class ManualTunnelSection extends _react.Component {
  ...
  render() {
    ...
    return (
      _react.createElement((_Section || _load_Section()).Section, { headline: 'Manual tunnel', collapsable: false },
        _react.createElement('div', { className: 'nuclide-ssh-tunnels-manual-tunnel-section' },
          boxContents)));
  ...
  _getManualEntryForm(hostname) {
    ...
    _react.createElement('code', { className: 'nuclide-ssh-tunnels-manual-tunnel-section-host-field' },
      (0, (_Tunnel || _load_Tunnel()).shortenHostname)(hostname), ':');


    const localhostLabel =
    _react.createElement('code', { className: 'nuclide-ssh-tunnels-manual-tunnel-section-host-field' }, 'localhost:');



    const fromAndToRow =
    _react.createElement('div', { className: 'nuclide-ssh-tunnels-manual-tunnel-section-row' },
      ...
      _react.createElement((_Button || _load_Button()).Button, { onClick: () => this._switchToAndFrom() }, '\u21C4'),
      _react.createElement('div', null,
        this.state.fromCurrentWorkingRoot ?
        localhostLabel :
        workingRootLabel,
    ...
    _react.createElement('div', { className: 'nuclide-ssh-tunnels-manual-tunnel-section-row' },
      ...
      _react.createElement((_ButtonGroup || _load_ButtonGroup()).ButtonGroup, null,
        _react.createElement((_Button || _load_Button()).Button, {
            ...
            onClick: () => this.setState({ family: 4 }) }, 'IPv4'),


        _react.createElement((_Button || _load_Button()).Button, {
            key: '6',
            selected: this.state.family === 6,
            onClick: () => this.setState({ family: 6 }) }, 'IPv6')),



      _react.createElement((_Button || _load_Button()).Button, {
          disabled: !this._openButtonEnabled(),
          onClick: () => this._openTunnel() }, 'Open'));
  ...
  _openTunnel() {if (!(
    ...
    this.state.toPort != null)) {throw new Error('Invariant violation: "this.props.workingDirectoryHost != null &&\\n        this.props.workingDirectoryHost !== \'localhost\' &&\\n        this.state.fromPort != null &&\\n        this.state.toPort != null"');}
