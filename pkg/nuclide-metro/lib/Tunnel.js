...
let openTunnel = exports.openTunnel = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (serviceUri, behavior) {
    ...
    const tunnelService = yield _getTunnelService();
...
let _getTunnelService = (() => {
  ...
  return function _getTunnelService() {
...
function _desiredTunnelTo(uri) {
  return {
    ...
    to: { host: (_nuclideUri || _load_nuclideUri()).default.getHostname(uri), port: 8081 }
  };
}