...
class DefaultMetroAtomService {
  ...
  constructor(projectRootPath) {
    ...
    this.start = (() => {
      var _ref = (0, _asyncToGenerator.default)(function* (tunnelBehavior) {
        ...
        _this._currentTunnelDisposable = yield (0, (_Tunnel || _load_Tunnel()).openTunnel)(projectRoot, tunnelBehavior);
      });
