...
function _load_types() {return _types = _interopRequireWildcard(require('@babel/types'));}var _generator;

function _load_generator() {return _generator = _interopRequireDefault(require('@babel/generator'));}var _yargs;
...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _main;
