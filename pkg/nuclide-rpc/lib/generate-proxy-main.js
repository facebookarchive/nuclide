...
function _load_babelTypes() {return _babelTypes = _interopRequireWildcard(require('babel-types'));}var _babelGenerator;

function _load_babelGenerator() {return _babelGenerator = _interopRequireDefault(require('babel-generator'));}var _yargs;
function _load_yargs() {return _yargs = _interopRequireDefault(require('yargs'));}
var _fs = _interopRequireDefault(require('fs'));var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _main;
function _load_main() {return _main = require('./main');}var _location;
function _load_location() {return _location = require('./location');}var _proxyGenerator;
function _load_proxyGenerator() {return _proxyGenerator = _interopRequireDefault(require('./proxy-generator'));}var _serviceParser;
...
const { generateProxy } = (0, (_proxyGenerator || _load_proxyGenerator()).default)(_babelTypes || _load_babelTypes(), (_babelGenerator || _load_babelGenerator()).default); /**
                                                                                                                                                                             ...
                                                                                                                                                                             * 
                                                                                                                                                                             * @format
                                                                                                                                                                             */ /* eslint-disable no-console */const argv = (_yargs || _load_yargs()).default.usage('Usage: $0 -d path/to/definition -n serviceName').options({ definitionPath: { demand: true, describe: 'Path to definition', type: 'string' },
  serviceName: {
    demand: true,
...
(_nuclideUri || _load_nuclideUri()).default.NUCLIDE_URI_TYPE_NAME,
'atom$Point',
'atom$Range'];
...
if (argv.validate) {
  try {
    const fakeClient = {};
    const factory = (0, (_main || _load_main()).createProxyFactory)(
    serviceName,
    preserveFunctionNames,
    definitionPath,
    predefinedTypeNames);
