'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.RpcProcess = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _StreamTransport;
...
function _load_StreamTransport() {return _StreamTransport = require('./StreamTransport');}var _RpcConnection;
function _load_RpcConnection() {return _RpcConnection = require('./RpcConnection');}var _process;
function _load_process() {return _process = require('../../../modules/nuclide-commons/process');}var _log4js;
...
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
  ...
  getService(serviceName) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _ensureConnection() {
    ...
    if (this._rpcConnection == null) {
      ...
      processStream.
      switchMap(proc =>
      (0, (_process || _load_process()).getOutputStream)(proc, {
      ...
      then(proc => {
        ...
        return new (_RpcConnection || _load_RpcConnection()).RpcConnection(
        'client',
        this._serviceRegistry,
        new (_StreamTransport || _load_StreamTransport()).StreamTransport(proc.stdin, proc.stdout, this._messageLogger));
  ...
  _onProcessMessage(message) {
    switch (message.kind) {
      ...
      case 'exit':
        logger.error(
        `${this._name} - exited with ${(0, (_process || _load_process()).exitEventToMessage)(message)}`);
