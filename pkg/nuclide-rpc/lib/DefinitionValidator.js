...
function validateDefinitions(definitions) {
    ...
    switch (type.kind) {
      ...
      case 'named':
        ...
        if (containingDefinitions.indexOf(definition) !== -1) {
          ...
          (0, (_assert || _load_assert()).default)(definition.definition);
  ...
  function validateIntersectionType(intersectionType) {
    ...
    for (var field of fields) {
      if (fieldNameToLocation.has(field.name)) {
        ...
        (0, (_assert || _load_assert()).default)(otherLocation != null);
  ...
  function validateLiteralUnionType(type, alternates) {
    alternates.reduce(function (previousAlternates, alternate) {
      ...
      previousAlternates.forEach(function (previous) {
        (0, (_assert || _load_assert()).default)(previous.kind === 'string-literal' || previous.kind === 'number-literal' || previous.kind === 'boolean-literal');
        (0, (_assert || _load_assert()).default)(alternate.kind === 'string-literal' || alternate.kind === 'number-literal' || alternate.kind === 'boolean-literal');
  ...
  function findObjectUnionDiscriminant(type, alternates) {
    ...
    (0, (_assert || _load_assert()).default)(alternates.length > 0);
    // $FlowFixMe
    var possibleFields = alternates.reduce(function (possibilities, alternate) {
      ...
      if (possibilities == null) {
        ...
        return (0, (_commonsNodeCollection || _load_commonsNodeCollection()).setIntersect)(alternatePossibilities, possibilities);
      }
    }, null);
  ...
  function resolveNamedType(_x) {
    ...
    _function: while (_again) {
      ...
      (0, (_assert || _load_assert()).default)(def != null);
      switch (def.kind) {
        case 'alias':
  ...
  function errorDefinitions(defs, message) {
    ...
    var fullMessage = (0, (_location || _load_location()).locationToString)(defs[0].location) + ':' + message;
