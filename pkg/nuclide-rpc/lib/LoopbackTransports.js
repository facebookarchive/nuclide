...
var LoopbackTransports = function LoopbackTransports() {
  ...
  var serverMessages = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
  var clientMessages = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
