...
var ObjectRegistry = (function () {
  ...
  _createClass(ObjectRegistry, [{
    ...
    key: 'unmarshal',
    value: function unmarshal(id, interfaceName, proxyClass) {
      if (this._isLocalId(id)) {
        return this._unmarshalLocalObject(id);
      } else {
        (0, (_assert || _load_assert()).default)(proxyClass != null);
        (0, (_assert || _load_assert()).default)(interfaceName != null);
    ...
    value: function _unmarshalRemoteObject(remoteId, interfaceName, proxyClass) {
    ...
    value: function _getRegistration(id) {
      var result = this._isLocalId(id) ? this._registrationsById.get(id) : this._proxiesById.get(id);
      (0, (_assert || _load_assert()).default)(result != null);
      return result;
    }
  }, {
    key: 'getInterface',
    value: function getInterface(id) {
    ...
    value: function _marshalLocalObject(interfaceName, object) {
      ...
      if (existingRegistration != null) {
        (0, (_assert || _load_assert()).default)(existingRegistration.interface === interfaceName);
    ...
    value: _asyncToGenerator(function* (proxy) {
      (0, (_assert || _load_assert()).default)(this._idsByProxy.has(proxy));
    ...
    key: 'addProxy',
    value: _asyncToGenerator(function* (proxy, interfaceName, idPromise) {
      (0, (_assert || _load_assert()).default)(!this._idsByProxy.has(proxy));
      this._idsByProxy.set(proxy, idPromise);

      var id = yield idPromise;
      (0, (_assert || _load_assert()).default)(!this._proxiesById.has(id));
