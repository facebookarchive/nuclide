  ...
  _createClass(RpcConnection, [{
        ...
        case 'observable':
          {
            var _ret = (function () {
              ...
              var observable = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.create(function (observer) {
    ...
    value: function _returnObservable(id, returnVal, elementType) {
      ...
      if (!isConnectableObservable(returnVal)) {
        result = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.throw(new Error('Expected an Observable, but the function returned something else.')).publish();
      } else {
        result = returnVal;
      }
    ...
    value: function createRemote(transport, predefinedTypes, services) {
      return new RpcConnection('client', new (_ServiceRegistry2 || _ServiceRegistry()).ServiceRegistry(predefinedTypes, services), transport);
    }
