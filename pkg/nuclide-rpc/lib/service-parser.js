...
parseServiceDefinition = parseServiceDefinition;exports.
...
_clearFileParsers = _clearFileParsers;var _memoizeWithDisk;function _load_memoizeWithDisk() {return _memoizeWithDisk = _interopRequireDefault(require('../../commons-node/memoizeWithDisk'));}var _builtinTypes;function _load_builtinTypes() {return _builtinTypes = require('./builtin-types');}var _location;function _load_location() {return _location = require('./location');}var _DefinitionValidator;function _load_DefinitionValidator() {return _DefinitionValidator = require('./DefinitionValidator');}var _resolveFrom;function _load_resolveFrom() {return _resolveFrom = _interopRequireDefault(require('resolve-from'));}var _collection;function _load_collection() {return _collection = require('nuclide-commons/collection');}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _fs = _interopRequireDefault(require('fs'));var _os = _interopRequireDefault(require('os'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   */function isPrivateMemberName(name) {return name.startsWith('_');} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */function parseServiceDefinition(fileName, source, predefinedTypes) {return new ServiceParser(predefinedTypes).parseService(fileName, source);}class ServiceParser {constructor(predefinedTypes) {this._defs = new Map();this._visitedExports = new WeakSet(); // Add all builtin types
    const defineBuiltinType = name => {if (!!this._defs.has(name)) {throw new Error('Duplicate builtin type');}this._defs.set(name, { kind: 'alias', name, location: { type: 'builtin' } });};(_builtinTypes || _load_builtinTypes()).namedBuiltinTypes.forEach(defineBuiltinType);predefinedTypes.forEach(defineBuiltinType);} // Set of exported AST nodes. Ensures we don't process the same export twice.
  parseService(fileName, source) {const fileParser = getFileParser(fileName, source, true);fileParser.getExports().forEach(node => fileParser.parseExport(this, node));const objDefs = (0, (_collection || _load_collection()).objectFromMap)(this._defs);(0, (_DefinitionValidator || _load_DefinitionValidator()).validateDefinitions)(objDefs);return objDefs;}hasDefinition(id) {return this._defs.has(id);}addDefinition(definition) {const existingDef = this._defs.get(definition.name);if (existingDef != null) {throw errorLocations([definition.location, existingDef.location], `Duplicate definition for ${definition.name}`);} else {this._defs.set(definition.name, definition);}return definition;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    * Returns false if the export node has already been visited.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    * This prevents duplicate exports from being added.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    */visitExport(node) {if (this._visitedExports.has(node)) {return false;}this._visitedExports.add(node);return true;}}const fileParsers = new Map();function getFileParser(fileName, source, isDefinition) {let parser = fileParsers.get(fileName);if (parser != null) {return parser;}parser = new FileParser(fileName, Boolean(isDefinition)); // flowlint-next-line sketchy-null-string:off
  parser.parse(source || _fs.default.readFileSync(fileName, 'utf8'));fileParsers.set(fileName, parser);return parser;} // Exported for testing.
function _clearFileParsers() {fileParsers.clear();}const memoizedBabylonParse = (0, (_memoizeWithDisk || _load_memoizeWithDisk()).default)(function babylonParse(src, options) {// External dependency: ensure that it's included in the key below.
  const babylon = require('babylon');return babylon.parse(src, options).program;}, (src, options) => [src, options, require('babylon/package.json').version], (_nuclideUri || _load_nuclideUri()).default.join(_os.default.tmpdir(), 'nuclide-rpc-cache'));class FileParser {// Map of exported identifiers to their nodes.
  ...
  parse(source) {
    ...
    const program = memoizedBabylonParse(source, babylonOptions);if (!(

    program && program.type === 'Program')) {throw new Error(
  ...
  parseExport(serviceParser, node) {
    ...
    if (node.type === 'ExportSpecifier') {
      ...
      if (!(imp != null)) {throw new Error('export type {...} only supports imported types.');}
    ...
    node.type === 'ExportNamedDeclaration')) {throw new Error('Invariant violation: "node.type === \'ExportNamedDeclaration\'"');}
  ...
  _visitImport(serviceParser, imp) {
    ...
    const exportNode = importedFile.getExports().get(imp.imported);if (!(

    exportNode != null)) {throw new Error(
  ...
  _parseImport(node) {
    const from = node.source.value;if (!(

    typeof from === 'string')) {throw new Error('Invariant violation: "typeof from === \'string\'"');}
  ...
  declaration)
  {
    ...
    declaration.body.type === 'ObjectTypeAnnotation')) {throw new Error('Invariant violation: "declaration.body.type === \'ObjectTypeAnnotation\'"');}
    const properties = declaration.body.properties;
    for (const property of properties) {if (!(
      property.type === 'ObjectTypeProperty')) {throw new Error('Invariant violation: "property.type === \'ObjectTypeProperty\'"');}
      ...
      if (!isPrivateMemberName(property.key.name)) {
        ...
        !property.static) {throw new Error(
  ...
  definition)
  {
    ...
    const returnType = this._parseTypeAnnotation(
    serviceParser,
    definition.value.returnType);if (!(

    typeof definition.key.name === 'string')) {throw new Error('Invariant violation: "typeof definition.key.name === \'string\'"');}if (!(
    typeof definition.optional === 'boolean')) {throw new Error('Invariant violation: "typeof definition.optional === \'boolean\'"');}
  ...
  param)
  {
    if (!param.typeAnnotation) {
      ...
      const name = param.name.name;if (!(
      typeof name === 'string')) {throw new Error('Invariant violation: "typeof name === \'string\'"');}
  ...
  _parseParameter(serviceParser, param) {
    ...
    if (param.type === 'AssignmentPattern') {
      return this._parseParameter(serviceParser, Object.assign({},
      param.left, {
  ...
  typeAnnotation)
  {
    switch (typeAnnotation.type) {
      ...
      case 'ObjectTypeAnnotation':
        return {
          kind: 'object',
          fields: typeAnnotation.properties.map(prop => {if (!(
            prop.type === 'ObjectTypeProperty')) {throw new Error('Invariant violation: "prop.type === \'ObjectTypeProperty\'"');}
            return {
              name: prop.key.name,
  ...
  typeAnnotation)
  {if (!(
    typeAnnotation.type === 'GenericTypeAnnotation')) {throw new Error('Invariant violation: "typeAnnotation.type === \'GenericTypeAnnotation\'"');}
  ...
  _parseTypeName(serviceParser, type) {
    switch (type.type) {
      case 'Identifier':
        return type.name;
      case 'QualifiedTypeIdentifier':if (!(
        type.id.type === 'Identifier')) {throw new Error('Invariant violation: "type.id.type === \'Identifier\'"');}
