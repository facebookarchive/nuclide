'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.TypeRegistry = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
var _fs = _interopRequireDefault(require('fs'));var _builtinTypes;
...
function _load_builtinTypes() {return _builtinTypes = require('./builtin-types');}var _location;
...
function _load_location() {return _location = require('./location');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
 ...
 */ /**
     ...
     * 
     * @format
     */function smartPromiseAll(arr) {if (arr.length === 0 || !(arr[0] instanceof Promise)) {return arr;}return Promise.all(arr);} // Same as the above, but works for non-homogenous input.
function checkedSmartPromiseAll(arr) {for (const elem of arr) {if (elem instanceof Promise) {return Promise.all(arr);}}return arr;}function canBeUndefined(type) {
  return (
    type.kind === 'nullable' ||
    type.kind === 'mixed' ||
    type.kind === 'any' ||
...
class TypeRegistry {
  ...
  constructor(predefinedTypes) {
    ...
    this._registerKind(
    'nullable',
    (value, type, context) => {if (!(
      type.kind === 'nullable')) {throw new Error('Invariant violation: "type.kind === \'nullable\'"');}
      if (value == null) {
        return value;
      }
    ...
    'named',
    (value, type, context) => {if (!(
      type.kind === 'named')) {throw new Error('Invariant violation: "type.kind === \'named\'"');}
  ...
  unmarshaller)
  {if (!
    !this._kindMarshallers.has(kind)) {throw new Error('Invariant violation: "!this._kindMarshallers.has(kind)"');}
  ...
  unmarshaller)
  {
    ...
    if (existingMarshaller != null) {
      ...
      if (!(0, (_location || _load_location()).locationsEqual)(existingMarshaller.location, location)) {
        ...
        ` been registered at ${(0, (_location || _load_location()).locationToString)(
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const marshalledargs = yield Promise.all(
      argTypes.map(function (param, i) {return _this.marshal(context, args[i], param.type);}));
      ...
      marshalledargs.forEach(function (arg, i) {
        if (typeof argTypes[i].name !== 'string') {
          ...
          throw new Error(
          `Unnamed function parameter for ${nameOrKind}. (Are you destructuring in a function argument list?)`);
  ...
  {
    return Promise.all(
    argTypes.map((arg, i) => {if (!(

      Object.hasOwnProperty.call(args, arg.name) ||
      canBeUndefined(arg.type))) {throw new Error(
  ...
  _registerLiterals() {
    const literalTransformer = (arg, type) => {if (!(

      type.kind === 'string-literal' ||
      type.kind === 'number-literal' ||
      type.kind === 'boolean-literal')) {throw new Error('Invariant violation: "type.kind === \'string-literal\' ||\\n          type.kind === \'number-literal\' ||\\n          type.kind === \'boolean-literal\'"');}if (!(

      arg === type.value)) {throw new Error('Invariant violation: "arg === type.value"');}
      return arg;
    };
    this._registerKind(
    'string-literal',
  ...
  _registerUnions() {
    const unionLiteralTransformer = (arg, type) => {if (!(
      type.kind === 'union')) {throw new Error('Invariant violation: "type.kind === \'union\'"');}
      const alternate = type.types.find(element => {if (!(

        element.kind === 'string-literal' ||
        element.kind === 'number-literal' ||
        element.kind === 'boolean-literal')) {throw new Error('Invariant violation: "element.kind === \'string-literal\' ||\\n            element.kind === \'number-literal\' ||\\n            element.kind === \'boolean-literal\'"');}

        return arg === element.value;
      });if (!
      alternate) {throw new Error('Invariant violation: "alternate"');}
      // This is just the literal transformer inlined ...
      return arg;
    };
    const unionObjectMarshaller = (arg, type, context) => {if (!(
      type.kind === 'union')) {throw new Error('Invariant violation: "type.kind === \'union\'"');}
      return this._marshal(context, arg, findAlternate(arg, type));
    };
    const unionObjectUnmarshaller = (arg, type, context) => {if (!(
      type.kind === 'union')) {throw new Error('Invariant violation: "type.kind === \'union\'"');}
      return this._unmarshal(context, arg, findAlternate(arg, type));
    };
    const unionMarshaller = (arg, type, context) => {if (!(
      type.kind === 'union')) {throw new Error('Invariant violation: "type.kind === \'union\'"');}
    ...
    const unionUnmarshaller = (arg, type, context) => {if (!(
      type.kind === 'union')) {throw new Error('Invariant violation: "type.kind === \'union\'"');}
      if (type.discriminantField != null) {
  ...
  _registerIntersections() {
    const intersectionMarshaller = (arg, type, context) => {if (!(
      type.kind === 'intersection')) {throw new Error('Invariant violation: "type.kind === \'intersection\'"');}if (!(
      type.flattened != null)) {throw new Error('Invariant violation: "type.flattened != null"');}
      return this._marshal(context, arg, type.flattened);
    };
    const intersectionUnmarshaller = (arg, type, context) => {if (!(
      type.kind === 'intersection')) {throw new Error('Invariant violation: "type.kind === \'intersection\'"');}if (!(
      type.flattened != null)) {throw new Error('Invariant violation: "type.flattened != null"');}
  ...
  _registerSpecialTypes() {
    ...
    this.registerType(
    (_builtinTypes || _load_builtinTypes()).objectType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation,
    ...
    this.registerType(
    (_builtinTypes || _load_builtinTypes()).dateType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation,
    ...
    this.registerType(
    (_builtinTypes || _load_builtinTypes()).regExpType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation,
    ...
    this.registerType(
    (_builtinTypes || _load_builtinTypes()).bufferType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation,
    ...
    // fs.Stats
    this.registerType(
    (_builtinTypes || _load_builtinTypes()).fsStatsType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation,
  ...
  _registerContainers() {
    ...
    'array',
    (value, type, context) => {
      (0, _assert.default)(value instanceof Array, 'Expected an object of type Array.');if (!(
      type.kind === 'array')) {throw new Error('Invariant violation: "type.kind === \'array\'"');}
    ...
    'object',
    (obj, type, context) => {
      (0, _assert.default)(typeof obj === 'object', 'Expected an argument of type object.');if (!(
      type.kind === 'object')) {throw new Error('Invariant violation: "type.kind === \'object\'"');}
    ...
    'set',
    (value, type, context) => {if (!(
      type.kind === 'set')) {throw new Error('Invariant violation: "type.kind === \'set\'"');}
    ...
    'map',
    (map, type, context) => {
      (0, _assert.default)(map instanceof Map, 'Expected an object of type Set.');if (!(
      type.kind === 'map')) {throw new Error('Invariant violation: "type.kind === \'map\'"');}
      const serializePromises = [];
    ...
    (serialized, type, context) => {
      ...
      'Expected an object of type Array.');if (!(
    ...
    (value, type, context) => {
      ...
      (0, _assert.default)(Array.isArray(value), 'Expected an object of type Array.');if (!(
      type.kind === 'tuple')) {throw new Error('Invariant violation: "type.kind === \'tuple\'"');}
...
fieldName)
{
  const result = type.fields.find(field => field.name === fieldName);if (!(
  result != null)) {throw new Error('Invariant violation: "result != null"');}
  return result;
}

function findAlternate(arg, type) {
  const discriminantField = type.discriminantField;if (!(
  discriminantField != null)) {throw new Error('Invariant violation: "discriminantField != null"');}
  const discriminant = arg[discriminantField];if (!(
  discriminant != null)) {throw new Error('Invariant violation: "discriminant != null"');}
  const alternates = type.types;
  const result = alternates.find(alternate => {if (!(
    alternate.kind === 'object')) {throw new Error('Invariant violation: "alternate.kind === \'object\'"');}
    ...
    alternateType.kind === 'boolean-literal')) {throw new Error('Invariant violation: "alternateType.kind === \'string-literal\' ||\\n        alternateType.kind === \'number-literal\' ||\\n        alternateType.kind === \'boolean-literal\'"');}
