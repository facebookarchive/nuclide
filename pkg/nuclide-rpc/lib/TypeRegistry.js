...
function objectToStats(jsonStats) {
  var stats = new (_fs || _load_fs()).default.Stats();
...
var TypeRegistry = (function () {
  function TypeRegistry(predefinedTypes) {
    var _this = this;
    ...
    this._registerKind('nullable', function (value, type, context) {
      (0, (_assert2 || _load_assert2()).default)(type.kind === 'nullable');
    ...
    this._registerKind('named', function (value, type, context) {
      (0, (_assert2 || _load_assert2()).default)(type.kind === 'named');
    ...
    predefinedTypes.forEach(function (type) {
      _this.registerPredefinedType(type.typeName, type.marshaller, type.unmarshaller);
    });
  }
  ...
  _createClass(TypeRegistry, [{
    ...
    value: function _registerKind(kind, marshaller, unmarshaller) {
      (0, (_assert2 || _load_assert2()).default)(!this._kindMarshallers.has(kind));
    ...
    key: 'registerPredefinedType',
    value: function registerPredefinedType(typeName, marshaller, unmarshaller) {
    ...
    value: _asyncToGenerator(function* (context, args, argTypes) {
      ...
      marshalledargs.forEach(function (arg, i) {
        (0, (_assert2 || _load_assert2()).default)(typeof argTypes[i].name === 'string');
    ...
    value: function unmarshalArguments(context, args, argTypes) {
      ...
      return Promise.all(argTypes.map(function (arg, i) {
        (0, (_assert2 || _load_assert2()).default)(Object.hasOwnProperty.call(args, arg.name) || canBeUndefined(arg.type), 'unmarshalArguments: Missing argument: ' + arg.name);
    ...
    value: function _registerPrimitives() {
      ...
      var stringTransformer = function stringTransformer(arg_) {
        var arg = arg_;
        // Unbox argument.
        arg = arg instanceof String ? arg.valueOf() : arg;
        (0, (_assert || _load_assert()).default)(typeof arg === 'string', 'Expected a string argument');
        return arg;
      };
      var numberMarshaller = function numberMarshaller(arg_) {
        var arg = arg_;
        // Unbox argument.
        if (arg instanceof Number) {
          arg = arg.valueOf();
        }
        (0, (_assert || _load_assert()).default)(typeof arg === 'number', 'Expected a number argument');
      ...
      var numberUnmarshaller = function numberUnmarshaller(arg_) {
        var arg = arg_;
      ...
      var booleanTransformer = function booleanTransformer(arg_) {
        var arg = arg_;
        // Unbox argument
        if (arg instanceof Boolean) {
          arg = arg.valueOf();
        }
        (0, (_assert || _load_assert()).default)(typeof arg === 'boolean', 'Expected a boolean argument');
        return arg;
      };
    ...
    value: function _registerLiterals() {
      var literalTransformer = function literalTransformer(arg, type) {
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'string-literal' || type.kind === 'number-literal' || type.kind === 'boolean-literal');
        (0, (_assert2 || _load_assert2()).default)(arg === type.value);
        return arg;
      };
    ...
    value: function _registerUnions() {
      ...
      var unionLiteralTransformer = function unionLiteralTransformer(arg, type) {
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'union');
        var alternate = type.types.find(function (element) {
          (0, (_assert2 || _load_assert2()).default)(element.kind === 'string-literal' || element.kind === 'number-literal' || element.kind === 'boolean-literal');
          return arg === element.value;
        });
        (0, (_assert2 || _load_assert2()).default)(alternate);
    ...
    value: function _registerIntersections() {
      ...
      var intersectionMarshaller = function intersectionMarshaller(arg, type, context) {
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'intersection');
        (0, (_assert2 || _load_assert2()).default)(type.flattened != null);
    ...
    value: function _registerSpecialTypes() {
      ...
      this.registerType((_builtinTypes || _load_builtinTypes()).objectType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation, function (object) {
        (0, (_assert || _load_assert()).default)(object != null && typeof object === 'object', 'Expected Object argument.');
        return object;
      }, function (object) {
        (0, (_assert || _load_assert()).default)(object != null && typeof object === 'object', 'Expected Object argument.');
        return object;
      ...
      this.registerType((_builtinTypes || _load_builtinTypes()).dateType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation, function (date) {
        (0, (_assert || _load_assert()).default)(date instanceof Date, 'Expected date argument.');
        return date.toJSON();
      }, function (dateStr_) {
        ...
        (0, (_assert || _load_assert()).default)(typeof dateStr === 'string', 'Expeceted a string argument.');
        return new Date(dateStr);
      });

      // Serialize / Deserialize RegExp objects
      this.registerType((_builtinTypes || _load_builtinTypes()).regExpType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation, function (regexp) {
        (0, (_assert || _load_assert()).default)(regexp instanceof RegExp, 'Expected a RegExp object as an argument');
        ...
        (0, (_assert || _load_assert()).default)(typeof regStr === 'string', 'Expected a string argument.');
        return (_vm || _load_vm()).default.runInThisContext(regStr);
      });

      // Serialize / Deserialize Buffer objects through Base64 strings
      this.registerType((_builtinTypes || _load_builtinTypes()).bufferType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation, function (buffer) {
        (0, (_assert || _load_assert()).default)(buffer instanceof Buffer, 'Expected a buffer argument.');
        return buffer.toString('base64');
      }, function (base64string_) {
        var base64string = base64string_;
        // Unbox argument.
        base64string = base64string instanceof String ? base64string.valueOf() : base64string;

        (0, (_assert || _load_assert()).default)(typeof base64string === 'string', 'Expected a base64 string. Not ' + typeof base64string);
        return new Buffer(base64string, 'base64');
      });

      // fs.Stats
      this.registerType((_builtinTypes || _load_builtinTypes()).fsStatsType.name, (_builtinTypes || _load_builtinTypes()).builtinLocation, function (stats) {
        (0, (_assert || _load_assert()).default)(stats instanceof (_fs || _load_fs()).default.Stats);
        return JSON.stringify(statsToObject(stats));
      }, function (json) {
        (0, (_assert || _load_assert()).default)(typeof json === 'string');
    ...
    value: function _registerContainers() {
      ...
      this._registerKind('array', function (value, type, context) {
        (0, (_assert || _load_assert()).default)(value instanceof Array, 'Expected an object of type Array.');
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'array');
      ...
      this._registerKind('object', function (obj, type, context) {
        (0, (_assert || _load_assert()).default)(typeof obj === 'object', 'Expected an argument of type object.');
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'object');
        ...
        var promise = checkedSmartPromiseAll(type.fields.map(function (prop) {
          ...
          var annotateErrorAndThrow = function annotateErrorAndThrow(e) {
          ...
          if (obj != null && obj.hasOwnProperty(name)) {
            try {
              var _value = _this7._marshal(context, originalValue, prop.type);
              if (_value instanceof Promise) {
                return _value.then(function (result) {
                  return newObj[name] = result;
        ...
        var promise = checkedSmartPromiseAll(type.fields.map(function (prop) {
          ...
          if (obj != null && obj.hasOwnProperty(prop.name)) {
            var _ret = (function () {
              ...
              try {
                var _value2 = _this7._unmarshal(context, originalValue, prop.type);
                if (_value2 instanceof Promise) {
                  return {
                    v: _value2.then(function (result) {
                      return newObj[name] = result;
                    }, annotateErrorAndThrow)
                  };
                } else {
      ...
      this._registerKind('set', function (value, type, context) {
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'set');
        (0, (_assert || _load_assert()).default)(value instanceof Set, 'Expected an object of type Set.');
      ...
      this._registerKind('map', function (map, type, context) {
        (0, (_assert || _load_assert()).default)(map instanceof Map, 'Expected an object of type Set.');
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'map');
        var serializePromises = [];
        ...
        (0, (_assert || _load_assert()).default)(serialized instanceof Array, 'Expected an object of type Array.');
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'map');
      ...
      this._registerKind('tuple', function (value, type, context) {
        ...
        (0, (_assert || _load_assert()).default)(Array.isArray(value), 'Expected an object of type Array.');
        (0, (_assert2 || _load_assert2()).default)(type.kind === 'tuple');
        var types = type.types;
        (0, (_assert || _load_assert()).default)(value.length === types.length, 'Expected tuple of length ' + types.length + '.');
...
function getObjectFieldByName(type, fieldName) {
  ...
  (0, (_assert2 || _load_assert2()).default)(result != null);
  return result;
}

function findAlternate(arg, type) {
  var discriminantField = type.discriminantField;
  (0, (_assert2 || _load_assert2()).default)(discriminantField != null);
  var discriminant = arg[discriminantField];
  (0, (_assert2 || _load_assert2()).default)(discriminant != null);
  var alternates = type.types;
  var result = alternates.find(function (alternate) {
    (0, (_assert2 || _load_assert2()).default)(alternate.kind === 'object');
    var alternateType = getObjectFieldByName(alternate, discriminantField).type;
    (0, (_assert2 || _load_assert2()).default)(alternateType.kind === 'string-literal' || alternateType.kind === 'number-literal' || alternateType.kind === 'boolean-literal');
...
function makeKindMarshaller(kind, transformer) {
  return function (value, type, context) {
    try {
