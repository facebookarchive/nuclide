...
const STATUS_BAR_PRIORITY = -100; /**
                                   ...
                                   * 
                                   * @format
                                   */function consumeStatusBar(statusBar, navigationStackServices) {const props = navigationStackServices.switchMap(navigationStack => {if (navigationStack == null) {return _rxjsBundlesRxMinJs.Observable.of({ available: false });}const onBack = () => {
    ...
    return (0, (_event || _load_event()).observableFromSubscribeFunction)(navigationStack.subscribe).map(
    stack => ({
      available: true,
