...
let main = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* () {
    ...
    dispatcher.registerCommand(new (_HelpCommand || _load_HelpCommand()).default(cli, function () {
    ...
    try {
      ...
      if (adapter != null) {
        yield debuggerInstance.openSession(adapter.adapterInfo, adapter.launchArgs);
      }
