...
class VsDebugSessionTranslator {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const responseGroups = yield Promise.all(Array.from(breakpointCommandsByUrl).map((() => {
        var _ref16 = (0, _asyncToGenerator.default)(function* ([url, breakpointCommands]) {
          ...
          }).concat(_this4._getBreakpointsForFilePath(path).map(function (bp) {
            return Object.assign({}, bp);
          }));

          const translatorBreakpoins = yield _this4._setBreakpointsForFilePath(path, breakpointDescriptors);
  ...
  _setBreakpointsForFilePath(path, breakpoints) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      return vsBreakpoints.map(function (vsBreakpoint, i) {
        ...
        const breakpointId = bpDescriptior.breakpointId || String(vsBreakpoint.id) || _this6._nextBreakpointId();
        ...
        _this6._breakpointsById.set(breakpointId, translatorBreakpoint);
  ...
  _removeBreakpoint(breakpointId) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      yield _this7._setBreakpointsForFilePath(foundBreakpoint.path, remainingBreakpoints.map(function (bp) {
        return Object.assign({}, bp);
      }));
    })();
  }
