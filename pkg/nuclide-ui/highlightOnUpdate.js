...
function highlightOnUpdate(ComposedComponent) {
   ...
   */
  arePropsEqual = arguments.length <= 1 || arguments[1] === undefined ? (_shallowequal || _load_shallowequal()).default : arguments[1];
  var
  /**
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        return (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement(ComposedComponent, this.props)
        );
      }
    }]);
