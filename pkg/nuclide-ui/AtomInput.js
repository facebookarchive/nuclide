...
var AtomInput = (function (_React$Component) {
  ...
  function AtomInput(props) {
    ...
    var value = props.value == null ? props.initialValue : props.value;
    this.state = {
      value: value
    };
  }
  ...
  _createClass(AtomInput, [{
    ...
    value: function componentDidMount() {
      ...
      var disposables = this._disposables = new (_atom || _load_atom()).CompositeDisposable();
    ...
    value: function render() {
      var className = (0, (_classnames || _load_classnames()).default)(this.props.className, _defineProperty({
        'atom-text-editor-unstyled': this.props.unstyled
      }, 'atom-text-editor-' + (0, (_commonsNodeString || _load_commonsNodeString()).maybeToString)(this.props.size), this.props.size != null));
      ...
      return(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement('atom-text-editor', {
          'class': className,
          mini: true,
    ...
    value: function getTextEditorElement() {
      return (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this);
    }
  }, {
    key: '_updateWidth',
    value: function _updateWidth(prevWidth) {
      if (this.props.width !== prevWidth) {
        ...
        this.getTextEditorElement().setWidth(_width);
      }
    }
  }, {
    key: 'focus',
