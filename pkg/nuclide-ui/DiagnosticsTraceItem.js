...
var DiagnosticsTraceItem = function DiagnosticsTraceItem(props) {
  ...
  if (path) {
    ...
    locSpan = (_reactForAtom || _load_reactForAtom()).React.createElement(
      'span',
      null,
      ': ',
  ...
  return (_reactForAtom || _load_reactForAtom()).React.createElement(
    'div',
    null,
    (_reactForAtom || _load_reactForAtom()).React.createElement((_DiagnosticsMessageText || _load_DiagnosticsMessageText()).DiagnosticsMessageText, { message: trace }),
    locSpan
  );
};
