'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.PathWithFileIconExamples = undefined;
...
function _load_Block() {return _Block = require('../../modules/nuclide-commons-ui/Block');}var _PathWithFileIcon;
function _load_PathWithFileIcon() {return _PathWithFileIcon = _interopRequireDefault(require('./PathWithFileIcon'));}var _PathWithFileIcon2;function _load_PathWithFileIcon2() {return _PathWithFileIcon2 = require('./PathWithFileIcon');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}

function ListItem(props) {
  return (
    // $FlowFixMe(>=0.53.0) Flow suppress
    _react.createElement('div', { className: 'list-item' }, props.children));
   ...
   * 
   * @format
   */function BasicExample() {return _react.createElement('div', null, _react.createElement((_Block || _load_Block()).Block, null, _react.createElement('p', null, 'Simply wrap paths in <PathWithFileIcon /> to get the appropriate icons:'),
      _react.createElement('div', null,
        _react.createElement(ListItem, null,
  ...
  return (
    _react.createElement('div', null,
      _react.createElement((_Block || _load_Block()).Block, null,
        _react.createElement('p', null, 'PathWithFileIcon export a DecorationIcons object containing custom decorations. You can optionally pass one of those decorations to decorate the file icon with e.g. a small AtomIcon:'),
