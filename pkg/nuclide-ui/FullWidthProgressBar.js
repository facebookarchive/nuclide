...
class FullWidthProgressBar extends _react.Component {
  render() {
    ...
    return (
      _react.createElement('div', { className: className, hidden: !this.props.visible },
        this._renderBar()));
  ...
  _renderBar() {
    ...
    this.props.progress != null)) {throw new Error('Invariant violation: "this.props.progress != null"');}
    return _react.createElement(Bar, { progress: this.props.progress });
                                             ...
                                             * 
                                             * @format
                                             */class Bar extends _react.Component {render() {const pct = Math.max(0, Math.min(100, this.props.progress * 100));
    return (
