...
var Checkbox = (function (_React$PureComponent) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function _setIndeterminate() {
      (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this.refs.input).indeterminate = this.props.indeterminate;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var // exclude `indeterminate` from `remainingProps`
      label = _props.label;
