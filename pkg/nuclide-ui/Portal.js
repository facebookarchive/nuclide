  ...
  _createClass(Portal, [{
    ...
    value: function _render(element, container) {
      if (this._container != null && (container !== this._container || element == null)) {
        (_reactForAtom || _load_reactForAtom()).ReactDOM.unmountComponentAtNode(this._container);
      }

      if (element != null) {
        (_reactForAtom || _load_reactForAtom()).ReactDOM.render((_reactForAtom || _load_reactForAtom()).React.Children.only(element), container);
      }
