...
class ChangedFilesList extends _react.Component {
  ...
  render() {
    ...
    (_nuclideUri || _load_nuclideUri()).default.
    basename(change1.filePath).
    localeCompare((_nuclideUri || _load_nuclideUri()).default.basename(change2.filePath)));
