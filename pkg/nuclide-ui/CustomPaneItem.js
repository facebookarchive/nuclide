'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.CustomPaneItem = undefined;
...
class CustomPaneItem extends HTMLElement {
  ...
  getTitle() {
    ...
    if (!this._title) {throw new Error('Invariant violation: "this._title"');}
    return this._title;
  }
