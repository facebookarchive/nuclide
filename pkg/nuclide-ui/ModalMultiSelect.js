 ...
 */
let ModalMultiSelect = exports.ModalMultiSelect = (_temp = _class = class ModalMultiSelect extends _reactForAtom.React.Component {
  ...
  _renderModal() {
    ...
    return _reactForAtom.React.createElement(
      ...
      _reactForAtom.React.createElement((_MultiSelectList || _load_MultiSelectList()).MultiSelectList, {
        ...
        onChange: activeValues => this.setState({ activeValues: activeValues })
      }),
