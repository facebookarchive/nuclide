...
var ModalMultiSelect = (function (_React$Component) {
  ...
  _createClass(ModalMultiSelect, [{
    ...
    value: function render() {
      ...
      var className = (0, (_classnames || _load_classnames()).default)(this.props.className, {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement(LabelComponent, { selectedOptions: selectedOptions }),
        this._renderModal()
      );
    }
  }, {
    ...
    value: function _renderModal() {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement((_MultiSelectList || _load_MultiSelectList()).MultiSelectList, {
