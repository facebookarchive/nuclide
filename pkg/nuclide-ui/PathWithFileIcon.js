'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.DecorationIcons = undefined;
...
function _load_classnames() {return _classnames = _interopRequireDefault(require('classnames'));}var _log4js;
function _load_log4js() {return _log4js = require('log4js');}var _UniversalDisposable;
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../modules/nuclide-commons/UniversalDisposable'));}var _Icon;
function _load_Icon() {return _Icon = require('../../modules/nuclide-commons-ui/Icon');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           */function WarningIconWithShadow() {return _react.createElement('div', null, _react.createElement('svg', { className: 'nuclide-ui-path-with-file-icon-warning-icon-background', width: '20', height: '18', viewBox: '0 0 20 20',
...
_addItemToElement => {
  addItemToElement = (element, path) => {
    try {
      ...
      (0, (_log4js || _load_log4js()).getLogger)('nuclide-ui-path-with-file-icon').error(
...
class PathWithFileIcon extends _react.Component {
  ...
  constructor(props) {
    ...
    };this._mounted = false;this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default(() => {if (this._fileIconsDisposable != null) {this._fileIconsDisposable.dispose();}});}componentDidMount() {this._mounted = true;}componentDidUpdate(prevProps) {if (prevProps.path !== this.props.path) {this._forceIconUpdate();}}

  _getDefaultClassName() {
    const { className, isFolder } = this.props;
    return (0, (_classnames || _load_classnames()).default)(
    'icon',
    'name',
  ...
  render() {
    ...
    this.props,{ className, children, decorationIcon: DecorationIcon, isFolder, path } = _props,rest = _objectWithoutProperties(_props, ['className', 'children', 'decorationIcon', 'isFolder', 'path']);
    const displayPath = children == null ? path : children;
    const decoration =
    DecorationIcon == null ? null :
    _react.createElement('div', { className: 'nuclide-ui-path-with-file-icon-decoration-icon' },
