...
var PanelComponent = (function (_React$Component) {
  ...
  _createClass(PanelComponent, [{
    ...
    value: function _repaint() {
      var element = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this);
    ...
    value: function render() {
      ...
      if (this.state.isResizing) {
        resizeCursorOverlay = (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: 'nuclide-ui-panel-component-resize-cursor-overlay ' + this.props.dock });
      }
      ...
      var content = (_reactForAtom || _load_reactForAtom()).React.cloneElement((_reactForAtom || _load_reactForAtom()).React.Children.only(this.props.children), { ref: 'child' });

      var wrappedContent = undefined;
      if (this.props.noScroll) {
        wrappedContent = content;
      } else {
        wrappedContent = (_reactForAtom || _load_reactForAtom()).React.createElement(
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: 'nuclide-ui-panel-component-resize-handle ' + this.props.dock,
          ref: 'handle',
    ...
    value: function _handleMouseDown(event) {
      ...
      this._resizeSubscriptions = new (_atom || _load_atom()).CompositeDisposable({ dispose: function dispose() {
    ...
    value: function _handleMouseMove(event) {
      var containerEl = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this);
      var length = 0;
    ...
    value: function _handleDoubleClick() {
      ...
      this.forceUpdate(function () {
        var length = 0;
        var childNode = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(_this2.refs.child);
        var handle = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(_this2.refs.handle);
