...
var ShowMoreComponent = (function (_React$Component) {
  ...
  _createClass(ShowMoreComponent, [{
    ...
    value: function render() {
      ...
      var showMoreButton = (_reactForAtom || _load_reactForAtom()).React.createElement(
        'div',
        {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: 'nuclide-ui-show-more-gradient', style: displayNoneIfBelowMaxHeight }),
          (_reactForAtom || _load_reactForAtom()).React.createElement(
