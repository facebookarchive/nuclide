  ...
  _createClass(Combobox, [{
    ...
    value: function _getFilteredOptions(options, filterValue) {
      ...
      return options.map(function (option) {
        ...
        var indexDiff = a.matchIndex - b.matchIndex;
        if (indexDiff !== 0) {
          return indexDiff;
        }
    ...
    value: function _handleInputFocus() {
      this.requestUpdate(this.state.textInput);
      var boundingRect = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this).getBoundingClientRect();
      this.setState({
        optionsVisible: true,
        optionsRect: {
    ...
    value: function _handleItemClick(selectedValue, event) {
      ...
      this.selectValue(selectedValue, function () {
        ...
        var input = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(_this3.refs.freeformInput);
        if (input) {
          input.focus();
        }
      });
    ...
    value: function _scrollSelectedOptionIntoViewIfNeeded() {
      var selectedOption = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this.refs.selectedOption);
      if (selectedOption) {
    ...
    value: function render() {
      ...
      if (this.props.loadingMessage && this.state.loadingOptions) {
        options.push((_reactForAtom || _load_reactForAtom()).React.createElement(
          'li',
      ...
      if (this.state.optionsVisible) {
        ...
        optionsContainer = (_reactForAtom || _load_reactForAtom()).React.createElement(
