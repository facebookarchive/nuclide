  ...
  _createClass(Tabs, [{
    ...
    value: function _handleTabChange(selectedTabName) {
      if (typeof this.props.onActiveTabChange === 'function') {
        this.props.onActiveTabChange((0, (_nullthrows || _load_nullthrows()).default)(this.props.tabs.find(function (tab) {
    ...
    value: function _renderTabMenu() {
      ...
      var closeButton = this.props.closeable ? (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: 'close-icon', onClick: this.props.onClose }) : null;
      var tabs = this.props.tabs.map(function (tab) {
        var icon = tab.icon == null ? null : (_reactForAtom || _load_reactForAtom()).React.createElement((_Icon || _load_Icon()).Icon, { icon: tab.icon });
        var handler = {};
