...
var Dropdown = (function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var className = (0, (_classnames || _load_classnames()).default)('nuclide-ui-dropdown', this.props.className, {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement((_Icon || _load_Icon()).Icon, {
          icon: 'triangle-down',
