...
var ListView = (function (_React$Component2) {
  ...
  _createClass(ListView, [{
    ...
    value: function render() {
      ...
      var renderedItems = (_reactForAtom || _load_reactForAtom()).React.Children.map(children, function (child, index) {
        return (_reactForAtom || _load_reactForAtom()).React.cloneElement(child, {
          index: index,
