...
var LoadingSpinner = (function (_React$Component) {
  ...
  _createClass(LoadingSpinner, [{
    ...
    value: function render() {
      ...
      var newClassName = (0, (_classnames || _load_classnames()).default)(className, 'loading', sizeClassname);
      return (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: newClassName });
    }
  }]);
