...
var Dropdown = (function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var selectClassName = (0, _classnames3.default)('nuclide-dropdown', (_classnames = {
        'btn': !this.props.isFlat
      }, _defineProperty(_classnames, 'btn-' + this.props.size, !this.props.isFlat && this.props.size != null), _defineProperty(_classnames, 'nuclide-dropdown-flat', this.props.isFlat), _classnames));
      ...
      return _reactForAtom.React.createElement(
        ...
        _reactForAtom.React.createElement('i', { className: 'icon icon-triangle-down text-center' })
      );
    }
  }, {
    key: '_onChange',
