...
var Combobox = (function (_React$Component) {
  ...
  _createClass(Combobox, [{
    ...
    value: function requestUpdate(textInput) {
      ...
      this._updateSubscription = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise(this.props.requestOptions(textInput)).subscribe(function (options) {
