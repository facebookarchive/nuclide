...
var _PanelComponentScroller = require('./PanelComponentScroller');
...
var PanelComponent = (function (_React$Component) {
  ...
  _createClass(PanelComponent, null, [{
    key: 'propTypes',
    value: {
      children: _reactForAtom.React.PropTypes.element.isRequired,
      dock: _reactForAtom.React.PropTypes.oneOf(['left', 'bottom', 'right']).isRequired,
      hidden: _reactForAtom.React.PropTypes.bool.isRequired,
      initialLength: _reactForAtom.React.PropTypes.number.isRequired,
      /*
       ...
       */
      noScroll: _reactForAtom.React.PropTypes.bool.isRequired,
      onResize: _reactForAtom.React.PropTypes.func.isRequired,
      overflowX: _reactForAtom.React.PropTypes.string
    },
    enumerable: true
  }, {
    key: 'defaultProps',
  ...
  _createClass(PanelComponent, [{
    ...
    value: function render() {
      ...
      var content = _reactForAtom.React.cloneElement(_reactForAtom.React.Children.only(this.props.children), { ref: 'child' });
      ...
      if (this.props.noScroll) {
        ...
        wrappedContent = _reactForAtom.React.createElement(
          _PanelComponentScroller.PanelComponentScroller,
    ...
    value: function _handleMouseDown(event) {
      ...
      this._resizeSubscriptions = new _atom.CompositeDisposable();
    ...
    value: function _handleMouseMove(event) {
      var containerEl = _reactForAtom.ReactDOM.findDOMNode(this.refs['container']);
      var length = 0;
    ...
    value: function _handleDoubleClick() {
      ...
      this.forceUpdate(function () {
        var length = 0;
        var childNode = _reactForAtom.ReactDOM.findDOMNode(_this2.refs['child']);
        var handle = _reactForAtom.ReactDOM.findDOMNode(_this2.refs['handle']);
