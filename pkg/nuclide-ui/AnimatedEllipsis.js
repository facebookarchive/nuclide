...
const DOT_ANIMATION_INTERVAL = 500; /* ms */ /**
                                              ...
                                              * 
                                              * @format
                                              */class AnimatedEllipsis extends _react.Component {constructor(props) {super(props);this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default();this.state = { n: 0 };
  }

  componentDidMount() {
    this._disposables.add(
    _rxjsBundlesRxMinJs.Observable.interval(DOT_ANIMATION_INTERVAL).subscribe(_ =>
  ...
  render() {
    ...
    return _react.createElement('span', { className: 'nuclide-ui-animated-ellipsis' }, ellipsis);
