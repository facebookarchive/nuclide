...
var TreeRootComponent = (function (_React$Component) {
  ...
  _createClass(TreeRootComponent, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!prevState || this.state.selectedKeys !== prevState.selectedKeys) {
        ...
        if (firstSelectedDescendant !== undefined) {
          (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(firstSelectedDescendant).scrollIntoViewIfNeeded(false);
        }
      }

      (0, (_assert || _load_assert()).default)(this._emitter);
    ...
    value: function _deselectDescendants(root) {
      ...
      (0, (_treeNodeTraversals || _load_treeNodeTraversals()).forEachCachedNode)(root, function (node) {
    ...
    value: function render() {
      ...
      this.state.roots.forEach(function (root) {
        ...
        while (stack.length !== 0) {
          ...
          var child = (_reactForAtom || _load_reactForAtom()).React.createElement((_TreeNodeComponent || _load_TreeNodeComponent()).TreeNodeComponent, _extends({}, item, {
    ...
    value: function _createDidUpdateListener(shouldResolve) {
      ...
      return new Promise(function (resolve, reject) {
        (0, (_assert || _load_assert()).default)(_this5._emitter);
