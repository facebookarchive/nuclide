...
exports.queryWithArgs = exports.query = exports.getHTTPServerPort = exports.buildRuleTypeFor = exports.showOutput = exports.resolveAlias = exports.listAliases = exports.getBuckConfig = exports.getOwners = exports.getBuildFile = exports.MULTIPLE_TARGET_RULE_TYPE = undefined;
...
let _runBuckCommandFromProjectRoot = (() => {
  ...
  return function _runBuckCommandFromProjectRoot(_x3, _x4, _x5, _x6, _x7) {
...
let _getBuckCommandAndOptions = (() => {
  ...
  return function _getBuckCommandAndOptions(_x8, _x9) {
...
let getOwners = exports.getOwners = (() => {
  ...
  return function getOwners(_x10, _x11, _x12) {
...
let getBuckConfig = exports.getBuckConfig = (() => {
  ...
  return function getBuckConfig(_x13, _x14, _x15) {
...
let _loadBuckConfig = (() => {
  ...
  return function _loadBuckConfig(_x16) {
...
let _build = (() => {
  ...
  return function _build(_x17, _x18, _x19) {
...
let listAliases = exports.listAliases = (() => {
  ...
  return function listAliases(_x20) {
...
let resolveAlias = exports.resolveAlias = (() => {
  ...
  return function resolveAlias(_x21, _x22) {
...
let showOutput = exports.showOutput = (() => {
  ...
  return function showOutput(_x23, _x24) {
...
let buildRuleTypeFor = exports.buildRuleTypeFor = (() => {
  ...
  return function buildRuleTypeFor(_x25, _x26) {
    return _ref11.apply(this, arguments);
  };
})();

let getHTTPServerPort = exports.getHTTPServerPort = (() => {
  var _ref12 = (0, _asyncToGenerator.default)(function* (rootPath) {
  ...
  return function getHTTPServerPort(_x27) {
...
let query = exports.query = (() => {
  var _ref13 = (0, _asyncToGenerator.default)(function* (rootPath, queryString) {
...
let queryWithArgs = exports.queryWithArgs = (() => {
  var _ref14 = (0, _asyncToGenerator.default)(function* (rootPath, queryString, args) {
  ...
  return function queryWithArgs(_x30, _x31, _x32) {
