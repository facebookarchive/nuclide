...
let getOwners = exports.getOwners = (() => {
  var _ref2 = (0, _asyncToGenerator.default)(function* (rootPath, filePath) {
    return query(rootPath, `owner(${ (0, (_shellQuote || _load_shellQuote()).quote)([filePath]) })`);
  });

  return function getOwners(_x6, _x7) {
...
let getBuckConfig = exports.getBuckConfig = (() => {
  ...
  return function getBuckConfig(_x8, _x9, _x10) {
...
let _loadBuckConfig = (() => {
  ...
  return function _loadBuckConfig(_x11) {
...
let _build = (() => {
  ...
  return function _build(_x12, _x13, _x14) {
...
let listAliases = exports.listAliases = (() => {
  ...
  return function listAliases(_x15) {
...
let resolveAlias = exports.resolveAlias = (() => {
  ...
  return function resolveAlias(_x16, _x17) {
...
let showOutput = exports.showOutput = (() => {
  ...
  return function showOutput(_x18, _x19) {
...
let buildRuleTypeFor = exports.buildRuleTypeFor = (() => {
  ...
  return function buildRuleTypeFor(_x20, _x21) {
...
let getHTTPServerPort = exports.getHTTPServerPort = (() => {
  ...
  return function getHTTPServerPort(_x22) {
...
let query = exports.query = (() => {
  ...
  return function query(_x23, _x24) {
...
let queryWithArgs = exports.queryWithArgs = (() => {
  ...
  return function queryWithArgs(_x25, _x26, _x27) {
...
function getRootForPath(file) {
  ...
  const options = _getBuckCommandAndOpt.buckCommandOptions;
...
function _getBuckCommandAndOptions(rootPath) {
  ...
  const buckCommandOptions = _extends({
    cwd: rootPath,
...
function _buildWithOutput(rootPath, buildTargets, options) {
  ...
  const buckCommandOptions = _getBuckCommandAndOpt2.buckCommandOptions;
...
function _translateOptionsToBuckBuildArgs(options) {
  ...
  const pathToBuildReport = options.pathToBuildReport;
  const buildTargets = options.buildTargets;
  const doInstall = baseOptions.install;
  const simulator = baseOptions.simulator;
  const test = baseOptions.test;
  const extraArguments = baseOptions.extraArguments;
