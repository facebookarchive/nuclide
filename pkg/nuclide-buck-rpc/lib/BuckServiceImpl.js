...
exports.getBuildFile = exports._getFbRepoSpecificArgs = exports.query = exports.runBuckCommandFromProjectRoot = exports.getOwners = exports._build = exports._getBuckCommandAndOptions = undefined;
...
let _getFbRepoSpecificArgs = exports._getFbRepoSpecificArgs = (() => {
  var _ref6 = (0, _asyncToGenerator.default)(function* (buckRoot) {
    try {
      // $FlowFB
  ...
  return function _getFbRepoSpecificArgs(_x15) {
    return _ref6.apply(this, arguments);
  };
})();

let getBuildFile = exports.getBuildFile = (() => {
  var _ref7 = (0, _asyncToGenerator.default)(function* (rootPath, targetName) {
    try {
  ...
  return function getBuildFile(_x16, _x17) {
