  ...
  _createClass(BuckProject, [{
    ...
    value: _asyncToGenerator(function* (targetName) {
      try {
        ...
        return (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(this._rootPath, result[0]);
      } catch (e) {
    ...
    value: _asyncToGenerator(function* () {
      ...
      var buckConfigContent = yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.readFile((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(this._rootPath, '.buckconfig'));
    ...
    value: function buildWithOutput(buildTargets, extraArguments) {
      return this._buildWithOutput(buildTargets, { extraArguments: extraArguments }).publish();
    }
    ...
    value: function testWithOutput(buildTargets, extraArguments) {
      return this._buildWithOutput(buildTargets, { test: true, extraArguments: extraArguments }).publish();
    }
    ...
    value: function getWebSocketStream(httpPort) {
      return (0, (_createBuckWebSocket2 || _createBuckWebSocket()).default)(this, httpPort).publish();
    }
  }], [{
    key: 'getRootForPath',
