...
let loadCompilationDatabaseFromBuck = (() => {
  var _ref2 = (0, _asyncToGenerator.default)(function* (src) {
    ...
    const target = (yield (_BuckServiceImpl || _load_BuckServiceImpl()).getOwners(buckRoot, src, TARGET_KIND_REGEX)).find(function (x) {
    ...
    return targetCache.getOrCreate(buckRoot + ':' + target, function () {
