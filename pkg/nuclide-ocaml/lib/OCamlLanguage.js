'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let createOCamlLanguageService = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  connection)
  {
    ...
    const logLevel = (0, (_rpcTypes || _load_rpcTypes()).parseLogLevel)(
    (_featureConfig || _load_featureConfig()).default.get('nuclide-ocaml.logLevel'),
    'DEBUG');
    ...
    return lspService || new (_nuclideLanguageServiceRpc || _load_nuclideLanguageServiceRpc()).NullLanguageService();
  });return function createOCamlLanguageService(_x) {return _ref.apply(this, arguments);};})(); /**
                                                                                                 ...
                                                                                                 * 
                                                                                                 * @format
                                                                                                 */exports.createLanguageService = createLanguageService;var _featureConfig;function _load_featureConfig() {return _featureConfig = _interopRequireDefault(require('nuclide-commons-atom/feature-config'));}var _nuclideLanguageService;function _load_nuclideLanguageService() {return _nuclideLanguageService = require('../../nuclide-language-service');}var _nuclideLanguageServiceRpc;function _load_nuclideLanguageServiceRpc() {return _nuclideLanguageServiceRpc = require('../../nuclide-language-service-rpc');}var _rpcTypes;function _load_rpcTypes() {return _rpcTypes = require('../../nuclide-logging/lib/rpc-types');}var _nuclideOpenFiles;function _load_nuclideOpenFiles() {return _nuclideOpenFiles = require('../../nuclide-open-files');}var _nuclideRemoteConnection;function _load_nuclideRemoteConnection() {return _nuclideRemoteConnection = require('../../nuclide-remote-connection');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function createLanguageService() {const atomConfig = { name: 'OCaml', grammars: ['source.ocaml', 'source.reason'], outline: { version: '0.1.0', priority: 1, analyticsEventName: 'ocaml.outline' },
