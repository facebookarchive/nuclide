...
var Activation = (function () {
  ...
  _createClass(Activation, [{
    ...
    value: function _createToolbar() {
      ...
      (_reactForAtom2 || _reactForAtom()).ReactDOM.render((_reactForAtom2 || _reactForAtom()).React.createElement((_NuclideToolbar2 || _NuclideToolbar()).default, { projectStore: this._projectStore }), item);
