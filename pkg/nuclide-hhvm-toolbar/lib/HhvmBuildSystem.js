...
var HhvmBuildSystem = (function () {
  function HhvmBuildSystem() {
    ...
    this._disposables = new (_atom2 || _atom()).CompositeDisposable(new (_commonsNodeStream2 || _commonsNodeStream()).DisposableSubscription(this._outputMessages));
  }
  ...
  _createClass(HhvmBuildSystem, [{
    ...
    value: function runTask(taskType) {
      ...
      return (0, (_commonsNodeObservableToTaskInfo2 || _commonsNodeObservableToTaskInfo()).observableToTaskInfo)(taskFunction());
    }
  }, {
    key: 'dispose',
