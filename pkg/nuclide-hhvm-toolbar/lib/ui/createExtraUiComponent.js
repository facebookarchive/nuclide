...
var _ArcToolbarSection2;

function _ArcToolbarSection() {
  return _ArcToolbarSection2 = _interopRequireDefault(require('../ArcToolbarSection'));
}
  ...
  return (function (_React$Component) {
    ...
    _createClass(ExtraUi, [{
      ...
      value: function render() {
        return (_reactForAtom2 || _reactForAtom()).React.createElement((_ArcToolbarSection2 || _ArcToolbarSection()).default, { model: model });
      }
    }]);
