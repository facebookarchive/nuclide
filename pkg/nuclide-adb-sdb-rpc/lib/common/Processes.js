'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.Processes = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _Adb;
...
function _load_Adb() {return _Adb = require('../bridges/Adb');}var _Sdb;
function _load_Sdb() {return _Sdb = require('../bridges/Sdb');}var _collection;
...
var _os = _interopRequireDefault(require('os'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                               ...
                                                                                                                                               * 
                                                                                                                                               * @format
                                                                                                                                               */const VALID_PROCESS_REGEX = new RegExp(/\d+\s()/);class Processes {
  constructor(db) {
    this._db = db;
  }
  ...
  fetch(timeout) {
    ...
    timeout(internalTimeout).
    catch(() => _rxjsBundlesRxMinJs.Observable.of(new Map()))).
  ...
  _getProcessAndMemoryUsage() {
    return _rxjsBundlesRxMinJs.Observable.interval(2000).
    startWith(0).
    switchMap(() => {
      return _rxjsBundlesRxMinJs.Observable.forkJoin(
  ...
  getPidFromPackageName(packageName) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const pidLine = (yield _this._db.
      runShortCommand('shell', 'ps', '|', 'grep', '-i', packageName).
      toPromise()).split(_os.default.EOL)[0];
      if (pidLine == null) {
        throw new Error(
