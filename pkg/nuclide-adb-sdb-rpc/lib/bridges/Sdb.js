'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.Sdb = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _nuclideUri;
...
function _load_Store() {return _Store = require('../common/Store');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                   ...
                                                                                                                                                                   * 
                                                                                                                                                                   * @format
                                                                                                                                                                   */class Sdb extends (_DebugBridge || _load_DebugBridge()).DebugBridge {getFileContentsAtPath(path) {var _this = this;return (0, _asyncToGenerator.default)(function* () {return _this.runShortCommand('shell', 'cat', path).toPromise();})();}getDeviceInfo() {
  ...
  stopProcess(packageName, pid) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  }}exports.Sdb = Sdb;Sdb.configObs = (0, (_Store || _load_Store()).createConfigObs)('sdb');