...
exports.dumpsysPackage = exports.getJavaProcesses = exports.activityExists = exports.launchActivity = exports.forwardJdwpPortToPid = exports.getPidFromPackageName = exports.startServer = exports.getDeviceList = exports.forceStopPackage = exports.getProcesses = exports.getDeviceInfo = exports.registerAdbPath = undefined;
...
let forceStopPackage = exports.forceStopPackage = (() => {
  var _ref5 = (0, _asyncToGenerator.default)(function* (device, packageName) {
    return (yield getAdb()).forceStopPackage(device, packageName);
  });

  return function forceStopPackage(_x5, _x6) {
