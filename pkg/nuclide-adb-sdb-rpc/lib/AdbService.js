...
exports.getInstalledPackages = exports.removeFile = exports.touchFile = exports.dumpsysPackage = exports.activityExists = exports.launchActivity = exports.forwardJdwpPortToPid = exports.getPidFromPackageName = exports.stopPackage = exports.registerCustomPath = exports.getFullConfig = exports.registerAdbPath = undefined;
...
let dumpsysPackage = exports.dumpsysPackage = (() => {
  ...
  return function dumpsysPackage(_x20, _x21) {
...
let touchFile = exports.touchFile = (() => {
  ...
  return function touchFile(_x22, _x23) {
...
let removeFile = exports.removeFile = (() => {
  ...
  return function removeFile(_x24, _x25) {
...
let getInstalledPackages = exports.getInstalledPackages = (() => {
  ...
  return function getInstalledPackages(_x26) {
