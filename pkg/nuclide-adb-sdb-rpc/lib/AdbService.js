...
let launchMainActivity = exports.launchMainActivity = (() => {
  var _ref9 = (0, _asyncToGenerator.default)(function* (device, packageName, debug, parameters) {
    return new (_Adb || _load_Adb()).Adb(device).launchMainActivity(packageName, debug, parameters);
  });

  return function launchMainActivity(_x19, _x20, _x21, _x22) {
...
let activityExists = exports.activityExists = (() => {
  ...
  return function activityExists(_x23, _x24, _x25) {
...
let dumpsysPackage = exports.dumpsysPackage = (() => {
  ...
  return function dumpsysPackage(_x26, _x27) {
...
let touchFile = exports.touchFile = (() => {
  ...
  return function touchFile(_x28, _x29) {
...
let removeFile = exports.removeFile = (() => {
  ...
  return function removeFile(_x30, _x31) {
...
let getInstalledPackages = exports.getInstalledPackages = (() => {
  ...
  return function getInstalledPackages(_x32) {
