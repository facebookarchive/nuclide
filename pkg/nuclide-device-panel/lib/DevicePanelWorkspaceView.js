'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.DevicePanelWorkspaceView = exports.WORKSPACE_VIEW_URI = undefined;
...
function _load_renderReactRoot() {return _renderReactRoot = require('../../../modules/nuclide-commons-ui/renderReactRoot');}var _RootPanel;
function _load_RootPanel() {return _RootPanel = require('./ui/RootPanel');}
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _bindObservableAsProps;
function _load_bindObservableAsProps() {return _bindObservableAsProps = require('../../../modules/nuclide-commons-ui/bindObservableAsProps');}var _Actions;
function _load_Actions() {return _Actions = _interopRequireWildcard(require('./redux/Actions'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                   *  strict-local
                                                                                                                                                                                                                                                                                                                                                                   * @format
                                                                                                                                                                                                                                                                                                                                                                   */const WORKSPACE_VIEW_URI = exports.WORKSPACE_VIEW_URI = 'atom://nuclide/devices';class DevicePanelWorkspaceView {constructor(store) {this._store = store;}
  ...
  getElement() {
    ...
    map(state => this._appStateToProps(state)), (_RootPanel || _load_RootPanel()).RootPanel);
