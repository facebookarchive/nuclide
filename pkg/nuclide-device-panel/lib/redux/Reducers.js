...
app = app;var _Actions;function _load_Actions() {return _Actions = _interopRequireWildcard(require('./Actions'));}var _immutable;function _load_immutable() {return _immutable = _interopRequireWildcard(require('immutable'));}var _expected;function _load_expected() {return _expected = require('nuclide-commons/expected');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function app(state, action) {
   ...
   * 
   * @format
   */function isDeviceConnected(device, deviceList) {if (device == null || deviceList.isError) {return false;}for (const _device of deviceList.value) {
