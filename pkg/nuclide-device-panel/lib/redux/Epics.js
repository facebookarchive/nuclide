...
pollDevicesEpic = pollDevicesEpic;exports.
...
pollProcessesEpic = pollProcessesEpic;exports.
...
setDeviceEpic = setDeviceEpic;exports.
...
setDeviceTypesEpic = setDeviceTypesEpic;exports.
...
setDeviceTypeEpic = setDeviceTypeEpic;exports.
...
setProcessesEpic = setProcessesEpic;exports.
...
setAppInfoEpic = setAppInfoEpic;exports.
...
setDeviceTypeComponentsEpic = setDeviceTypeComponentsEpic;var _log4js;function _load_log4js() {return _log4js = _interopRequireDefault(require('log4js'));}var _collection;function _load_collection() {return _collection = require('nuclide-commons/collection');}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _nuclideAnalytics;function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../../nuclide-analytics');}var _constants;function _load_constants() {return _constants = require('../constants');}var _Actions;function _load_Actions() {return _Actions = _interopRequireWildcard(require('./Actions'));}var _providers;function _load_providers() {return _providers = require('../providers');}var _DeviceTask;function _load_DeviceTask() {return _DeviceTask = require('../DeviceTask');}var _cache;function _load_cache() {return _cache = require('../../../commons-node/cache');}var _shallowequal;function _load_shallowequal() {return _shallowequal = _interopRequireDefault(require('shallowequal'));}var _immutable;function _load_immutable() {return _immutable = _interopRequireWildcard(require('immutable'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */function pollDevicesEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).TOGGLE_DEVICE_POLLING).map(action => {if (!(action.type === (_Actions || _load_Actions()).TOGGLE_DEVICE_POLLING)) {throw new Error('Invariant violation: "action.type === Actions.TOGGLE_DEVICE_POLLING"');}return [store.getState(), action.payload.isActive];}).distinctUntilChanged(([stateA, isActiveA], [stateB, isActiveB]) => stateA.deviceType === stateB.deviceType && stateA.host === stateB.host && isActiveA === isActiveB).switchMap(([state, isActive]) => {if (state.deviceType == null || !isActive) {return _rxjsBundlesRxMinJs.Observable.empty();}for (const fetcher of (0, (_providers || _load_providers()).getProviders)().deviceList) {if (fetcher.getType() === state.deviceType) {return fetcher.observe(state.host).map(devices => (_Actions || _load_Actions()).setDevices(devices));}}return _rxjsBundlesRxMinJs.Observable.empty();});}function pollProcessesEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).TOGGLE_PROCESS_POLLING).switchMap(action => {if (!(action.type === (_Actions || _load_Actions()).TOGGLE_PROCESS_POLLING)) {throw new Error('Invariant violation: "action.type === Actions.TOGGLE_PROCESS_POLLING"');}return _rxjsBundlesRxMinJs.Observable.of([store.getState(), action.payload.isActive]);}).distinctUntilChanged(([stateA, isActiveA], [stateB, isActiveB]) => stateA.deviceType === stateB.deviceType && stateA.host === stateB.host && (0, (_shallowequal || _load_shallowequal()).default)(stateA.device, stateB.device) && isActiveA === isActiveB).switchMap(([state, isActive]) => {const device = state.device;if (device == null || !isActive) {return _rxjsBundlesRxMinJs.Observable.empty();}const providers = Array.from((0, (_providers || _load_providers()).getProviders)().deviceProcesses).filter(provider => provider.getType() === state.deviceType);if (providers[0] != null) {return providers[0].observe(state.host, device).map(processes => (_Actions || _load_Actions()).setProcesses(processes));}return _rxjsBundlesRxMinJs.Observable.empty();});}function setDeviceEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).SET_DEVICE).switchMap(action => {if (!(action.type === (_Actions || _load_Actions()).SET_DEVICE)) {throw new Error('Invariant violation: "action.type === Actions.SET_DEVICE"');}const state = store.getState();return _rxjsBundlesRxMinJs.Observable.merge(getInfoTables(state).switchMap(infoTables => _rxjsBundlesRxMinJs.Observable.of((_Actions || _load_Actions()).setInfoTables(infoTables))), getProcessTasks(state).switchMap(processTasks => _rxjsBundlesRxMinJs.Observable.of((_Actions || _load_Actions()).setProcessTasks(processTasks))), getDeviceTasks(state).switchMap(deviceTasks => _rxjsBundlesRxMinJs.Observable.of((_Actions || _load_Actions()).setDeviceTasks(deviceTasks))));});}function setDeviceTypesEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).SET_DEVICE_TYPES).switchMap(action => {if (!(action.type === (_Actions || _load_Actions()).SET_DEVICE_TYPES)) {throw new Error('Invariant violation: "action.type === Actions.SET_DEVICE_TYPES"');}const state = store.getState();const deviceType = state.deviceType != null ? state.deviceType : state.deviceTypes[0];return _rxjsBundlesRxMinJs.Observable.merge(_rxjsBundlesRxMinJs.Observable.of((_Actions || _load_Actions()).setDeviceType(deviceType)), _rxjsBundlesRxMinJs.Observable.of((_Actions || _load_Actions()).toggleDevicePolling(state.isPollingDevices)));});}const deviceTypeTaskCache = new (_cache || _load_cache()).Cache({ keyFactory: ([state, providerName]) => JSON.stringify([state.host, state.deviceType, providerName]) });function setDeviceTypeEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).SET_DEVICE_TYPE).switchMap(action => {const state = store.getState();return _rxjsBundlesRxMinJs.Observable.of(Array.from((0, (_providers || _load_providers()).getProviders)().deviceTypeTask).filter(provider => provider.getType() === state.deviceType).map(provider => deviceTypeTaskCache.getOrCreate([state, provider.getName()], () => new (_DeviceTask || _load_DeviceTask()).DeviceTask(() => provider.getTask(state.host), provider.getName())))).map(tasks => (_Actions || _load_Actions()).setDeviceTypeTasks(tasks.sort((a, b) => a.getName().localeCompare(b.getName()))));});}function setProcessesEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).SET_PROCESSES).switchMap(action => {const state = store.getState();return getProcessTasks(state).switchMap(processTasks => _rxjsBundlesRxMinJs.Observable.of((_Actions || _load_Actions()).setProcessTasks(processTasks)));});}function setAppInfoEpic(actions, store) {return observeProcessNamesOfInterest(actions, store).switchMap(processNames => {const { device, host } = store.getState();if (device == null || processNames.length === 0) {return _rxjsBundlesRxMinJs.Observable.of(new Map());}const providers = Array.from((0, (_providers || _load_providers()).getProviders)().appInfo);return observeAppInfoTables(processNames, providers, host, device);}).map(appInfoTables => (_Actions || _load_Actions()).setAppInfoTables(appInfoTables));}function setDeviceTypeComponentsEpic(actions, store) {return actions.ofType((_Actions || _load_Actions()).SET_DEVICE_TYPE).switchMap(action => {if (!(action.type === (_Actions || _load_Actions()).SET_DEVICE_TYPE)) {throw new Error('Invariant violation: "action.type === Actions.SET_DEVICE_TYPE"');}const { deviceType } = action.payload;const { host } = store.getState();if (deviceType == null) {return _rxjsBundlesRxMinJs.Observable.empty();
    }

    const providers = Array.from((0, (_providers || _load_providers()).getProviders)().deviceTypeComponent).filter(
    ...
    _rxjsBundlesRxMinJs.Observable.from(
    ...
    (_immutable || _load_immutable()).List(components).
    filter(c => c != null).
    map(c => {if (!(
      c != null)) {throw new Error('Invariant violation: "c != null"');}
      return c;
    }).
    ...
    (_Actions || _load_Actions()).setDeviceTypeComponents((_immutable || _load_immutable()).Map(value)));
...
{
  return actions.
  ofType((_Actions || _load_Actions()).SET_PROCESSES).
  map(action => {
...
device)
{
  ...
  (0, (_collection || _load_collection()).collect)(
  (0, (_collection || _load_collection()).arrayFlatten)(multipleAppInfoRows).map(appInfoRow => [
  appInfoRow.appName,
  appInfoRow]));
...
device)
{
  ...
  _rxjsBundlesRxMinJs.Observable.timer(0, APP_INFO_UPDATE_INTERVAL).
  switchMap(() => {
    return provider.
    observe(host, device).
    map(value => ({ value })).
    catch(error => _rxjsBundlesRxMinJs.Observable.of({ value: error.message, isError: true }));
  }).
...
state)
{
  ...
  ...Array.from((0, (_providers || _load_providers()).getProviders)().deviceInfo).
...
function getProcessTasks(state) {
  ...
  return _rxjsBundlesRxMinJs.Observable.merge(
  ...Array.from((0, (_providers || _load_providers()).getProviders)().processTask).
  filter(provider => provider.getType() === state.deviceType).
  map(provider => {
...
function getDeviceTasks(state) {
  ...
  return _rxjsBundlesRxMinJs.Observable.merge(
  ...Array.from((0, (_providers || _load_providers()).getProviders)().deviceTask).
  filter(provider => provider.getType() === state.deviceType).
  map(provider => {
    return provider.
    isSupported(state.host).
    switchMap(isSupported => {
      ...
      () =>
      new (_DeviceTask || _load_DeviceTask()).DeviceTask(
