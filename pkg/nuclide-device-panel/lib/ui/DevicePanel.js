...
class DevicePanel extends _react.default.Component {
  ...
  _createInfoTables() {
    if (this.props.infoTables.isError) {
      ...
      return [_react.default.createElement((_LoadingSpinner || _load_LoadingSpinner()).LoadingSpinner, { size: 'EXTRA_SMALL', key: 'infoTableLoading' })];
    } else {
      return Array.from(this.props.infoTables.value.entries()).map(([title, infoTable]) => _react.default.createElement(
        'div',
