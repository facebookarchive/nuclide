...
class LspLanguageService {
  ...
  _handleLogMessageNotification(params) {
    // CARE! This method may be called before initialization has finished.
    this._host.consoleNotification(this._consoleSource, (_convert || _load_convert()).lspMessageType_atomShowNotificationLevel(params.type), params.message);
  }
  ...
  _handleShowMessageRequest(params, cancellationToken) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const response = yield _this3._host.dialogRequest((_convert || _load_convert()).lspMessageType_atomShowNotificationLevel(params.type), params.message, titles, closeTitle).refCount().toPromise();
