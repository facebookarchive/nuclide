...
function copyAbsolutePath() {
  trackOperation('copyAbsolutePath', function () {
    ...
    copyToClipboard('Copied absolute path', (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getPath(uri));
  });
}
...
function copyProjectRelativePath() {
  trackOperation('copyProjectRelativePath', function () {
    ...
    if (projectRelativePath) {
      ...
      copyToClipboard('Path not contained in any open project.\nCopied absolute path', (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getPath(uri));
    }
  });
}
...
function getArcanistRelativePath(path) {
  var arcService = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getArcanistBaseServiceByNuclideUri)(path);
