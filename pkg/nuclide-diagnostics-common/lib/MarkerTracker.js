...
var MarkerTracker = (function () {
  function MarkerTracker() {
    ...
    this._fileToMessages = new (_commonsNodeCollection || _load_commonsNodeCollection()).MultiMap();
  ...
  _createClass(MarkerTracker, [{
    ...
    value: function _assertNotDisposed() {
      (0, (_assert || _load_assert()).default)(!this._disposed, 'MarkerTracker has been disposed');
    }
  }]);
