...
var _applyTextEdits2;

function _applyTextEdits() {
  return _applyTextEdits2 = _interopRequireDefault(require('./applyTextEdits'));
}
...
var DiagnosticStore = (function () {
  ...
  _createClass(DiagnosticStore, [{
    ...
    value: function _applyFixes(filePath) {
      ...
      var succeeded = (0, (_applyTextEdits2 || _applyTextEdits()).default).apply(undefined, [filePath].concat(fixes));
      if (succeeded) {
        for (var message of messagesWithFixes) {
