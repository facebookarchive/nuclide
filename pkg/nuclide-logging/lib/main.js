...
exports.getDefaultConfig = (_config2 || _config()).getDefaultConfig;
exports.getPathToLogFileForToday = (_config2 || _config()).getPathToLogFileForToday;
exports.CurrentDateFileAppender = (_config2 || _config()).CurrentDateFileAppender;
exports.getServerLogAppenderConfig = (_config2 || _config()).getServerLogAppenderConfig;
...
function flushLogsAndExit(exitCode) {
  (_log4js2 || _log4js()).default.shutdown(function () {
...
function initialUpdateConfig() {
  return (_commonsNodeSingleton2 || _commonsNodeSingleton()).default.get(INITIAL_UPDATE_CONFIG_KEY, _asyncToGenerator(function* () {
    var defaultConfig = yield (0, (_config2 || _config()).getDefaultConfig)();
