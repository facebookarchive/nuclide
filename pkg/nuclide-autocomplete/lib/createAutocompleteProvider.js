'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));exports.default =
...
createAutocompleteProvider;var _performanceNow;function _load_performanceNow() {return _performanceNow = _interopRequireDefault(require('../../../modules/nuclide-commons/performanceNow'));}var _promise;function _load_promise() {return _promise = require('../../../modules/nuclide-commons/promise');}var _nuclideAnalytics;function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */ /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */const AUTOCOMPLETE_TIMEOUT = atom.inSpecMode() ? 3000 : 500;const durationBySuggestion = new WeakMap(); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 */function createAutocompleteProvider(provider) {// The `eventNames` could be computed in deep functions, but we don't want
  // to change the logger if a provider decides to changes its name.
  const eventNames = getAnalytics(provider);const proxy = new Proxy(provider, { get: (target, prop, receiver) => {switch (prop) {case 'getSuggestions':return getSuggestions.bind(null, target, eventNames);case 'onDidInsertSuggestion':return onDidInsertSuggestion.bind(null, target, eventNames);case 'getSuggestionDetailsOnSelect':if (target.getSuggestionDetailsOnSelect != null) {return getSuggestionDetailsOnSelect.bind(null, target, eventNames);} else {return () => Promise.resolve(null);}default:return Reflect.get(target, prop, receiver);}} });
...
request)
{
  ...
  eventNames.onGetSuggestions, (0, _asyncToGenerator.default)(
  function* () {
    let result = null;
    ...
    if (request.activatedManually) {
      ...
      try {
        result = yield (0, (_promise || _load_promise()).timeoutPromise)(
    ...
    if (result) {
      result.forEach(function (suggestion) {return (
...
function getSuggestionDetailsOnSelect(
provider,
eventNames,
suggestion)
{
  ...
  return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(
  eventNames.onGetSuggestionDetailsOnSelect, (0, _asyncToGenerator.default)(
  function* () {
    let result = null;
    if (provider.getSuggestionDetailsOnSelect != null) {
      try {
        result = yield provider.getSuggestionDetailsOnSelect(suggestion);
      } catch (e) {
...
function trackOnDidInsertSuggestion(
eventName,
