  ...
  return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(eventNames.onGetSuggestions, (0, _asyncToGenerator.default)(function* () {
    ...
    if (result) {
      result.forEach(function (suggestion) {
        return durationBySuggestion.set(suggestion, endTime - startTime);
      });
    }
    return result;
  }), logObject);
...
function getSuggestionDetailsOnSelect(provider, eventNames, suggestion) {
  ...
  return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)(eventNames.onGetSuggestionDetailsOnSelect, (0, _asyncToGenerator.default)(function* () {
    let result = null;
