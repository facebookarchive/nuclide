...
public abstract class AbstractEclipsePreferencesShim
    extends AbstractEclipseShim<IEclipsePreferences> implements IEclipsePreferences {

  @Override
  public void addNodeChangeListener(INodeChangeListener il) {
    getProxy().addNodeChangeListener(il);
  }

  @Override
  public void removeNodeChangeListener(INodeChangeListener il) {
    getProxy().removeNodeChangeListener(il);
  }

  @Override
  public void addPreferenceChangeListener(IPreferenceChangeListener il) {
    getProxy().addPreferenceChangeListener(il);
  }

  @Override
  public void removePreferenceChangeListener(IPreferenceChangeListener il) {
    getProxy().removePreferenceChangeListener(il);
  }
  ...
  @Override
  public void accept(IPreferenceNodeVisitor ipnv) throws BackingStoreException {
    getProxy().accept(ipnv);
  }
