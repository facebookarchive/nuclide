...
var AttachProcessInfo = (function (_DebuggerProcessInfo) {
  ...
  _createClass(AttachProcessInfo, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      var outputDisposable = (0, (_nuclideDebuggerBase2 || _nuclideDebuggerBase()).registerOutputWindowLogging)(rpcService.getOutputWindowObservable());
      try {
    ...
    value: function _getRpcService() {
      ...
      var service = (0, (_nuclideRemoteConnection2 || _nuclideRemoteConnection()).getServiceByNuclideUri)('LLDBDebuggerRpcService', this.getTargetUri());
