'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.getInteractiveCommitEditorConfig = exports.hgAsyncExecute = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
/**
                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                         */let hgAsyncExecute = exports.hgAsyncExecute = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (
  args_,
  options_)
  {
  ...
  });return function hgAsyncExecute(_x, _x2) {return _ref.apply(this, arguments);};})();

/**
                                                                                          * Calls hg commands, returning an Observable to allow aborting and streaming progress output.
                                                                                          */let getHgExecParams = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  options_)
  {
    ...
    options_, {
      env: Object.assign({}, (
      yield (0, (_process || _load_process()).getOriginalEnvironment)()), {
  ...
  });return function getHgExecParams(_x3, _x4) {return _ref2.apply(this, arguments);};})();let getInteractiveCommitEditorConfig = exports.getInteractiveCommitEditorConfig = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  ...
  });return function getInteractiveCommitEditorConfig() {return _ref3.apply(this, arguments);};})();exports.hgObserveExecution = hgObserveExecution;exports.hgRunCommand = hgRunCommand;exports.formatCommitMessage = formatCommitMessage;var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _process;function _load_process() {return _process = require('nuclide-commons/process');}var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nuclideRemoteAtomRpc;function _load_nuclideRemoteAtomRpc() {return _nuclideRemoteAtomRpc = require('../../nuclide-remote-atom-rpc');}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // Mercurial (as of v3.7.2) [strips lines][1] matching the following prefix when a commit message is
...
'diff', 'log', 'show', 'status']);function hgObserveExecution(args_, options_) {// TODO(T17463635)
  return _rxjsBundlesRxMinJs.Observable.fromPromise(getHgExecParams(args_, Object.assign({}, options_, { TTY_OUTPUT: process.platform !== 'win32' }))).switchMap(({ command, args, options }) => {return (0, (_process || _load_process()).observeProcess)(command, args, Object.assign({}, options, { killTreeWhenDone: true, /* TODO(T17353599) */isExitError: () => false })).catch(error => _rxjsBundlesRxMinJs.Observable.of({ kind: 'error', error })); // TODO(T17463635)
  });} /**
        * Calls hg commands, returning an Observable to allow aborting.
        * Resolves to stdout.
        */function hgRunCommand(args_, options_) {return _rxjsBundlesRxMinJs.Observable.fromPromise(getHgExecParams(args_, options_)).switchMap(({ command, args, options }) => (0, (_process || _load_process()).runCommand)(command, args, Object.assign({}, options, { killTreeWhenDone: true })));}function logAndThrowHgError(args, options, err) {if (err instanceof (_process || _load_process()).ProcessExitError) {(0, (_log4js || _load_log4js()).getLogger)('nuclide-hg-rpc').error(`Error executing hg command: ${JSON.stringify(args)}\n` + `stderr: ${err.stderr}\nstdout: ${String(err.stdout)}\n` + `options: ${JSON.stringify(options)}`);const { stdout, stderr, exitCode } = err;let message = 'hg error';if (exitCode != null) {message += ` (exit code ${exitCode})`;}if (stderr.length > 0) {message += `\nstderr: ${stderr}`;}if (stdout != null && stdout.length > 0) {message += `\nstdout: ${stdout}`;}throw new Error(message);} else {(0, (_log4js || _load_log4js()).getLogger)('nuclide-hg-rpc').error(`Error executing hg command: ${JSON.stringify(args)}\n` + `options: ${JSON.stringify(options)}`);throw err;}}function formatCommitMessage(commitMessage) {return commitMessage.replace(COMMIT_MESSAGE_STRIP_LINE, '');}let atomRpcEditorPath;function getAtomRpcScriptPath() {if (atomRpcEditorPath == null) {try {atomRpcEditorPath = require.resolve('../../nuclide-remote-atom-rpc/bin/fb-atom');} catch (error) {atomRpcEditorPath = require.resolve('../../nuclide-remote-atom-rpc/bin/atom');}}return atomRpcEditorPath;}