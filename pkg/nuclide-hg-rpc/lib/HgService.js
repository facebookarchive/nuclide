...
class HgService {
  ...
  batchFetchFileContentsAtRevision(filePaths, revision) {
    return (0, (_hgRevisionStateHelpers || _load_hgRevisionStateHelpers()).batchFetchFileContentsAtRevision)(filePaths, revision, this._workingDirectory);
  }
