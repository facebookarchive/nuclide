'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.HgService = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let logWhenSubscriptionEstablished = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  });return function logWhenSubscriptionEstablished(_x, _x2) {return _ref.apply(this, arguments);};})();let getForkBaseName = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  });return function getForkBaseName(_x3) {return _ref2.apply(this, arguments);};})();
...
/** @return .hg/store directory for the specified Hg working directory root. */let findStoreDirectory = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  function* (workingDirectory) {
    ...
    try {
      hgFolderWithStore = yield (_fsPromise || _load_fsPromise()).default.readFile(sharedpath, 'utf8');
    } catch (error) {
    ...
    return (_nuclideUri || _load_nuclideUri()).default.join(hgFolderWithStore, 'store');
  });return function findStoreDirectory(_x4) {return _ref3.apply(this, arguments);};})();var _collection;function _load_collection() {return _collection = require('nuclide-commons/collection');}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _observable;function _load_observable() {return _observable = require('nuclide-commons/observable');}var _promise;function _load_promise() {return _promise = require('nuclide-commons/promise');}var _string;function _load_string() {return _string = require('nuclide-commons/string');}var _nuclideWatchmanHelpers;function _load_nuclideWatchmanHelpers() {return _nuclideWatchmanHelpers = require('nuclide-watchman-helpers');}var _fs = _interopRequireDefault(require('fs'));var _hgConstants;function _load_hgConstants() {return _hgConstants = require('./hg-constants');}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _hgDiffOutputParser;function _load_hgDiffOutputParser() {return _hgDiffOutputParser = require('./hg-diff-output-parser');}var _hgRevisionExpressionHelpers;function _load_hgRevisionExpressionHelpers() {return _hgRevisionExpressionHelpers = require('./hg-revision-expression-helpers');}var _hgRevisionStateHelpers;function _load_hgRevisionStateHelpers() {return _hgRevisionStateHelpers = require('./hg-revision-state-helpers');}var _hgUtils;function _load_hgUtils() {return _hgUtils = require('./hg-utils');}var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _debounce;function _load_debounce() {return _debounce = _interopRequireDefault(require('nuclide-commons/debounce'));}var _hgBookmarkHelpers;function _load_hgBookmarkHelpers() {return _hgBookmarkHelpers = require('./hg-bookmark-helpers');}var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _watchFileCreationAndDeletion;function _load_watchFileCreationAndDeletion() {return _watchFileCreationAndDeletion = require('./watchFileCreationAndDeletion');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const logger = (0, (_log4js || _load_log4js()).getLogger)('nuclide-hg-rpc'); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             */const DEFAULT_ARC_PROJECT_FORK_BASE = 'remote/master';const DEFAULT_FORK_BASE_NAME = 'default';const WATCHMAN_SUBSCRIPTION_NAME_PRIMARY = 'hg-repository-watchman-subscription-primary';const WATCHMAN_SUBSCRIPTION_NAME_HGBOOKMARK = 'hg-repository-watchman-subscription-hgbookmark';const WATCHMAN_SUBSCRIPTION_NAME_HGBOOKMARKS = 'hg-repository-watchman-subscription-hgbookmarks';const WATCHMAN_HG_DIR_STATE = 'hg-repository-watchman-subscription-dirstate';const WATCHMAN_SUBSCRIPTION_NAME_CONFLICTS = 'hg-repository-watchman-subscription-conflicts';const WATCHMAN_SUBSCRIPTION_NAME_PROGRESS = 'hg-repository-watchman-subscription-progress';const WATCHMAN_SUBSCRIPTION_NAME_LOCK_FILES = 'hg-repository-watchman-subscription-lock-files';const CHECK_CONFLICT_DELAY_MS = 2000;const COMMIT_CHANGE_DEBOUNCE_MS = 1000; // If Watchman reports that many files have changed, it's not really useful to report this.
...
const FILES_CHANGED_LIMIT = 1000;const NUM_FETCH_STATUSES_LIMIT = 200; // Suffixes of hg error messages that indicate that an error is safe to ignore,
...
function getPrimaryWatchmanSubscriptionRefinements() {let refinements = [];try {// $FlowFB
    refinements = require('./fb/config').primaryWatchSubscriptionRefinements;} catch (e) {// purposely blank
  }return refinements;}function resolvePathForPlatform(path) {// hg resolve on win has a bug where it returns path with both unix
  // and win separators (T22157755). We normalize the path here.
  if (process.platform === 'win32') {return path.replace(/\//g, '\\');}return path;}class HgService {// used to limit lifespan of other observables
  constructor(workingDirectory) {this._workingDirectory = workingDirectory;this._filesDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._hgActiveBookmarkDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._lockFilesDidChange = _rxjsBundlesRxMinJs.Observable.empty();this._hgBookmarksDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._hgRepoStateDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._hgConflictStateDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._hgRepoCommitsDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._hgOperationProgressDidChangeObserver = new _rxjsBundlesRxMinJs.Subject();this._isInConflict = false;this._debouncedCheckConflictChange = (0, (_debounce || _load_debounce()).default)(() => {
  ...
  dispose() {var _this = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  toRevision)
  {
    ...
    return (0, (_hgUtils || _load_hgUtils()).hgRunCommand)(args, execOptions).
    map(stdout => {
      ...
      for (const status of (0, (_collection || _load_collection()).takeIterable)(statuses, NUM_FETCH_STATUSES_LIMIT)) {
        statusMap.set(
        (_nuclideUri || _load_nuclideUri()).default.join(this._workingDirectory, status.path),
        status.status);
  ...
  {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      const base = yield (0, (_promise || _load_promise()).timeoutAfterDeadline)(
      deadline,
      getForkBaseName(_this2._workingDirectory));
      // e.g. master
      ...
      // The ID of the root
      const getId = (() => {var _ref4 = (0, _asyncToGenerator.default)(function* () {
          try {
        ...
        });return function getId() {return _ref4.apply(this, arguments);};})();

      // Diff from base to current working directory
      const getDiff = (() => {var _ref5 = (0, _asyncToGenerator.default)(function* () {
          try {
        ...
        });return function getDiff() {return _ref5.apply(this, arguments);};})();

      // Summary of changes from base to current working directory
      const getStatus = (() => {var _ref6 = (0, _asyncToGenerator.default)(function* () {
          const statuses = yield _this2.fetchStatuses(root).
          refCount().
          toPromise();
          let result = '';
          ...
          return result;
        });return function getStatus() {return _ref6.apply(this, arguments);};})();

      const [id, diff, status] = yield Promise.all([
      (0, (_promise || _load_promise()).timeoutAfterDeadline)(deadline, getId()).catch(
      function (e) {return `id ${e.message}\n${e.stack}`;}),

      (0, (_promise || _load_promise()).timeoutAfterDeadline)(deadline, getDiff()).catch(
      function (e) {return 'diff ' + (0, (_string || _load_string()).stringifyError)(e);}),

      (0, (_promise || _load_promise()).timeoutAfterDeadline)(deadline, getStatus()).catch(
      function (e) {return 'status ' + (0, (_string || _load_string()).stringifyError)(e);})]);
  ...
  _subscribeToWatchman() {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      let primarySubscriptionExpression = [
      'allof',
      ['not', ['dirname', '.hg']],
      ...
      _this3._lockFilesDidChange = (0, (_watchFileCreationAndDeletion || _load_watchFileCreationAndDeletion()).subscribeToFilesCreateAndDelete)(
      watchmanClient,
      workingDirectory, (_hgConstants || _load_hgConstants()).LockFilesList,
      ...
      const hgStoreDirectory = yield findStoreDirectory(workingDirectory);
      const commitChangeIndicators = ['00changelog.i', 'obsstore', 'inhibit'];
      try {
        _this3._hgStoreDirWatcher = _fs.default.watch(
        hgStoreDirectory,
        ...
        (0, (_log4js || _load_log4js()).getLogger)('nuclide-hg-rpc').error(
      ...
      'change',
      _this3._hgActiveBookmarkDidChange.bind(_this3));
      ...
      'change',
      _this3._hgOperationProgressDidChange.bind(_this3));})();

  }

  _cleanUpWatchman() {var _this4 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _filesDidChange(fileChanges) {
    ...
    (_nuclideUri || _load_nuclideUri()).default.join(workingDirectory, change.name));
  ...
  _checkMergeDirectoryExists() {
    return (_fsPromise || _load_fsPromise()).default.exists(
    (_nuclideUri || _load_nuclideUri()).default.join(this._workingDirectory, '.hg', 'merge'));

  }

  _checkConflictChange() {var _this5 = this;return (0, _asyncToGenerator.default)(function* () {
      const mergeDirectoryExists = yield _this5._checkMergeDirectoryExists();
      _this5._isInConflict = mergeDirectoryExists;
      _this5._hgConflictStateDidChangeObserver.next(mergeDirectoryExists);})();
  }

  _fetchMergeConflicts() {var _this6 = this;return (0, _asyncToGenerator.default)(function* () {
      return _this6.fetchMergeConflicts().
      refCount().
      toPromise();})();
  }
  ...
  observeHgCommitsDidChange() {
    return (
      ...
      .let((0, (_observable || _load_observable()).fastDebounce)(COMMIT_CHANGE_DEBOUNCE_MS)).
      publish());
  ...
  observeHgOperationProgressDidChange() {
    ...
    let((0, (_observable || _load_observable()).fastDebounce)(50)).
    switchMap(() =>
    _rxjsBundlesRxMinJs.Observable.fromPromise(
    (_fsPromise || _load_fsPromise()).default.readFile(
    (_nuclideUri || _load_nuclideUri()).default.join(this._workingDirectory, '.hg', 'progress'),
    'utf8')).
  ...
  {var _this7 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      for (const [filePath, diffInfo] of pathToDiffInfo) {
        ...
        (_nuclideUri || _load_nuclideUri()).default.join(_this7._workingDirectory, filePath),
        diffInfo);
  ...
  revision)
  {
    return (0, (_hgRevisionStateHelpers || _load_hgRevisionStateHelpers()).fetchFileContentAtRevision)(
    filePath,
    revision,
  ...
  revision)
  {
    return (0, (_hgRevisionStateHelpers || _load_hgRevisionStateHelpers()).batchFetchFileContentsAtRevision)(
    filePaths,
    revision,
    this._workingDirectory);
  ...
  /**
     ...
     */
  fetchRevisionInfoBetweenHeadAndBase() {var _this8 = this;return (0, _asyncToGenerator.default)(function* () {
      const forkBaseName = yield getForkBaseName(_this8._workingDirectory);
      const revisionsInfo = yield (0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).fetchRevisionInfoBetweenRevisions)(
      (0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).expressionForCommonAncestor)(forkBaseName),
      (0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).expressionForRevisionsBeforeHead)(0),
      _this8._workingDirectory);
  ...
  /**
     ...
     */
  getBaseRevision() {var _this9 = this;return (0, _asyncToGenerator.default)(function* () {
      const forkBaseName = yield getForkBaseName(_this9._workingDirectory);
      return (0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).fetchRevisionInfo)(
      (0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).expressionForCommonAncestor)(forkBaseName),
      _this9._workingDirectory);})();
  ...
  /**
     ...
     */
  getBlameAtHead(filePath) {var _this10 = this;return (0, _asyncToGenerator.default)(function* () {
      let revisionsByLine;
      try {
        revisionsByLine = (yield _this10._hgAsyncExecute(
        [
        'blame',
        '-c', // Query the hash
        '-T',
      ...
      const uniqueRevisions = [...new Set(revisionsByLine.filter(function (e) {return e;}))];

      let revisionsArray;
      try {
        revisionsArray = yield (0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).fetchRevisionsInfo)(
        uniqueRevisions.join('+'),
        _this10._workingDirectory,
      ...
      return revisionsByLine.map(function (hash) {return revisionsByHash[hash];});})();
  }
  ...
  /**
     ...
     */
  getConfigValueAsync(key) {var _this11 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _runSimpleInWorkingDirectory(
  action,
  args)
  {var _this14 = this;return (0, _asyncToGenerator.default)(function* () {
      const options = {
  ...
  /**
     ...
     * @param create Currently, this parameter is ignored.
     */
  checkoutForkBase() {var _this15 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  {var _this16 = this;return (0, _asyncToGenerator.default)(function* () {
      const args = [
      ...filePaths.map(function (p) {return (_nuclideUri || _load_nuclideUri()).default.getPath(p);}), // Sources
  ...
  /**
     ...
     */
  remove(filePaths, after) {var _this17 = this;return (0, _asyncToGenerator.default)(function* () {
      const args = ['-f', ...filePaths.map(function (p) {return (_nuclideUri || _load_nuclideUri()).default.getPath(p);})];
      if (after) {
        args.unshift('--after');
      }
  ...
  /**
     ...
     */
  forget(filePaths) {var _this18 = this;return (0, _asyncToGenerator.default)(function* () {
      const args = [...filePaths.map(function (p) {return (_nuclideUri || _load_nuclideUri()).default.getPath(p);})];
      try {
  ...
  getTemplateCommitMessage() {var _this19 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  getHeadCommitMessage() {var _this20 = this;return (0, _asyncToGenerator.default)(function* () {
      const args = [
      'log',
      '-T',
      '{desc}\n',
  ...
  fetchMergeConflicts() {
    ...
    return (
      ...
      .catch(() => _rxjsBundlesRxMinJs.Observable.of(null)).
      publish());
  ...
  /**
     ...
     */
  getFullHashForRevision(rev) {var _this23 = this;return (0, _asyncToGenerator.default)(function* () {
      const args = ['log', '--template', '{node}', '--limit', '1', '-r', rev];
      const options = {
        cwd: _this23._workingDirectory };

      const output = yield _this23._hgAsyncExecute(args, options);
