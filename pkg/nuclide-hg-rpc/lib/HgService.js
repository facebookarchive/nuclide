...
class HgService {
  ...
  getAdditionalLogFiles() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const base = yield getForkBaseName(_this2._workingDirectory); // e.g. master
      ...
      const getSummary = (() => {
        var _ref5 = (0, _asyncToGenerator.default)(function* () {
          const statuses = yield _this2.fetchStatuses((0, (_hgRevisionExpressionHelpers || _load_hgRevisionExpressionHelpers()).expressionForCommonAncestor)(base)).refCount().toPromise();
          let result = '';
      ...
      const [id, diff, summary] = yield Promise.all([getId(), Promise.race([getDiff(), (0, (_promise || _load_promise()).sleep)(40000).then(function () {
        return 'diff timed out';
      })]), Promise.race([getSummary(), (0, (_promise || _load_promise()).sleep)(40000).then(function () {
