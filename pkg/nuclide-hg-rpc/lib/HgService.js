...
class HgService {
  ...
  fetchMergeConflicts(fetchResolved) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const { stdout } = yield _this21._hgAsyncExecute(['resolve', '--list', '-Tjson'], {
      ...
      const origBackupPath = yield _this21._getOrigBackupPath();
      const conflicts = yield Promise.all(conflictedFiles.map((() => {
        var _ref4 = (0, _asyncToGenerator.default)(function* (conflictedFile) {
          ...
          if (yield _this21._checkOrigFile(origBackupPath, conflictedFile.path)) {
  ...
  _getOrigBackupPath() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this22._origBackupPath == null) {
        const relativeBackupPath = yield _this22.getConfigValueAsync('ui.origbackuppath');
        if (relativeBackupPath == null) {
          _this22._origBackupPath = _this22._workingDirectory;
        } else {
          _this22._origBackupPath = (_nuclideUri || _load_nuclideUri()).default.join(_this22._workingDirectory, relativeBackupPath);
        }
      }
      return _this22._origBackupPath;
    })();
  }
  ...
  copy(filePaths, destPath, after) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      try {
        yield _this23._runSimpleInWorkingDirectory('copy', args);
      } catch (e) {
        if (after) {
          _this23._rethrowErrorIfHelpful(e);
        } else {
          throw e;
        }
      }
