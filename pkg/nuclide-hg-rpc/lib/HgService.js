...
var _rxjsBundlesRxMinJs4;

function _rxjsBundlesRxMinJs3() {
  return _rxjsBundlesRxMinJs4 = require('rxjs/bundles/Rx.min.js');
}
...
var HgService = (function () {
  function HgService(workingDirectory) {
    ...
    this._filesDidChangeObserver = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    this._hgActiveBookmarkDidChangeObserver = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    this._hgBookmarksDidChangeObserver = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    this._hgRepoStateDidChangeObserver = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    this._hgConflictStateDidChangeObserver = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
  ...
  _createClass(HgService, [{
    ...
    value: function fetchSmartlogRevisions() {
      return (0, (_hgRevisionExpressionHelpers2 || _hgRevisionExpressionHelpers()).fetchSmartlogRevisions)(this._workingDirectory);
    }
    ...
    value: function _commitCode(message, args) {
      ...
      return (_rxjsBundlesRxMinJs4 || _rxjsBundlesRxMinJs3()).Observable.fromPromise(_asyncToGenerator(function* () {
        if (message == null) {
          return args;
        } else {
