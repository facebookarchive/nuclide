...
let HgService = exports.HgService = class HgService {
  ...
  fetchDiffInfo(filePaths) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      for (const _ref2 of pathToDiffInfo) {
        var _ref3 = _slicedToArray(_ref2, 2);

        const filePath = _ref3[0];
        const diffInfo = _ref3[1];
  ...
  getTemplateCommitMessage() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const execOptions = {
        cwd: _this16._workingDirectory,
        HGEDITOR: ''
      };
      try {
        var _ref5 = yield _this16._hgAsyncExecute(args, execOptions);
  ...
  getHeadCommitMessage() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      try {
        const output = yield _this17._hgAsyncExecute(args, execOptions);
        const stdout = output.stdout.trim();
        return stdout || null;
      } catch (e) {
        // This should not happen: `hg log` does not error even if it does not recognize the template.
  ...
  log(filePaths, limit) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const result = yield _this18._hgAsyncExecute(args, execOptions);
  ...
  fetchMergeConflicts() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      var _ref6 = yield _this19._hgAsyncExecute(['resolve', '--list', '-Tjson'], {
      ...
      const origBackupPath = yield _this19._getOrigBackupPath();
      const conflicts = yield Promise.all(conflictedFiles.map((() => {
        var _ref7 = (0, _asyncToGenerator.default)(function* (conflictedFile) {
          let message;
          // Heuristic: If the `.orig` file doesn't exist, then it's deleted by the rebasing commit.
          if (yield _this19._checkOrigFile(origBackupPath, conflictedFile.path)) {
  ...
  _getOrigBackupPath() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this20._origBackupPath == null) {
        const relativeBackupPath = yield _this20.getConfigValueAsync('ui.origbackuppath');
        if (relativeBackupPath == null) {
          _this20._origBackupPath = _this20._workingDirectory;
        } else {
          _this20._origBackupPath = (_nuclideUri || _load_nuclideUri()).default.join(_this20._workingDirectory, relativeBackupPath);
        }
      }
      return _this20._origBackupPath;
    })();
  }
