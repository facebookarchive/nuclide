'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.fetchBookmarks = exports.fetchActiveBookmark = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));
...
/**
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            */let fetchActiveBookmark = exports.fetchActiveBookmark = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (repoPath) {
    ...
    return result;
  });return function fetchActiveBookmark(_x) {return _ref.apply(this, arguments);};})();let fetchBookmarks = exports.fetchBookmarks = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  repoPath)
  {
    ...
    try {
      ...
      result = bookmarks.
      split('\n').
      filter(function (bookmark) {return bookmark.length > 0;}).
