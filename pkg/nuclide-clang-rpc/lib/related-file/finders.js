...
function _load_cache() {return _cache = require('../../../commons-node/cache');}var _utils;
...
const SOURCE_FOR_HEADER_RECHECK_INTERVAL = 10 * 60 * 1000; /**
                                                            ...
                                                            * 
                                                            * @format
                                                            */class RelatedFileFinder {constructor() {this._sourceForHeaderCache = new (_cache || _load_cache()).Cache({ keyFactory: key => JSON.stringify(key) });} // Finding the source file that relates to header may be very expensive
