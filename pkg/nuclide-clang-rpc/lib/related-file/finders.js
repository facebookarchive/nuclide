...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _SimpleCache;
function _load_SimpleCache() {return _SimpleCache = require('nuclide-commons/SimpleCache');}var _utils;
function _load_utils() {return _utils = require('../utils');}var _buckFinder;
function _load_buckFinder() {return _buckFinder = require('./buck-finder');}var _common;
...
const SOURCE_FOR_HEADER_RECHECK_INTERVAL = 10 * 60 * 1000; /**
                                                            ...
                                                            * 
                                                            * @format
                                                            */class RelatedFileFinder {constructor() {this._sourceForHeaderCache = new (_SimpleCache || _load_SimpleCache()).SimpleCache({ keyFactory: key => JSON.stringify(key) });} // Finding the source file that relates to header may be very expensive
  ...
  {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      return (0, (_buckFinder || _load_buckFinder()).findSourceFileInSameFolderIfBelongsToBuck)(header);})();
  }
