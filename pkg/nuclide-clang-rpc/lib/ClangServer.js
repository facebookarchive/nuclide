...
function getServiceRegistry() {
  if (serviceRegistry == null) {
    serviceRegistry = new (_nuclideRpc2 || _nuclideRpc()).ServiceRegistry([(_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.localMarshallers], (0, (_nuclideRpc2 || _nuclideRpc()).loadServicesConfig)((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(__dirname, '..')));
  }
