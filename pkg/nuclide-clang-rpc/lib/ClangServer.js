...
/**
                                                                                                                                                           ...
                                                                                                                                                           */let getLibClangFromFlags = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  function* (
  flagsData)
  {
    if (
    ...
    return null;
  });return function getLibClangFromFlags(_x) {return _ref2.apply(this, arguments);};})();var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _nuclideMarshalersCommon;function _load_nuclideMarshalersCommon() {return _nuclideMarshalersCommon = require('../../nuclide-marshalers-common');}var _idx;function _load_idx() {return _idx = _interopRequireDefault(require('idx'));}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _process2;function _load_process() {return _process2 = require('nuclide-commons/process');}var _nuclideRpc;function _load_nuclideRpc() {return _nuclideRpc = require('../../nuclide-rpc');}var _nuclideFilewatcherRpc;function _load_nuclideFilewatcherRpc() {return _nuclideFilewatcherRpc = require('../../nuclide-filewatcher-rpc');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}let serviceRegistry = null; /**
  ...
  switchMap(([serverArgs, flagsData, libClangFromFlags]) => {var _ref;
