...
function getServiceRegistry() {
  if (serviceRegistry == null) {
    serviceRegistry = new (_nuclideRpc2 || _nuclideRpc()).ServiceRegistry((_nuclideMarshalersCommon2 || _nuclideMarshalersCommon()).getServerSideMarshalers, (0, (_nuclideRpc2 || _nuclideRpc()).loadServicesConfig)((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(__dirname, '..')));
  }
...
var ClangServer = (function (_default) {
  ...
  function ClangServer(src, serverArgs, flags) {
    var usesDefaultFlags = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];
    ...
    _get(Object.getPrototypeOf(ClangServer.prototype), 'constructor', this).call(this, 'ClangServer-' + src, getServiceRegistry(), function () {
      return spawnClangProcess(src, serverArgs, flags);
    });
