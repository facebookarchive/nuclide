...
function _load_process() {return _process = require('../../../modules/nuclide-commons/process');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                ...
                                                                                                                                                                                                * 
                                                                                                                                                                                                * @format
                                                                                                                                                                                                */let fbFindClangServerArgs;exports.default = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  configLibclangPath)
  {
    ...
    if (process.platform === 'darwin') {
      try {
        const stdout = yield (0, (_process || _load_process()).runCommand)('xcode-select', [
        '--print-path']).
        toPromise();
  ...
  });function findClangServerArgs(_x) {return _ref.apply(this, arguments);}return findClangServerArgs;})();