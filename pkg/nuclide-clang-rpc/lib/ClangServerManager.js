'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let augmentDefaultFlags = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  flags)
  {
    ...
    return flags;
  });return function augmentDefaultFlags(_x, _x2) {return _ref.apply(this, arguments);};})();var _lruCache;function _load_lruCache() {return _lruCache = _interopRequireDefault(require('lru-cache'));}var _os = _interopRequireDefault(require('os'));var _promise;function _load_promise() {return _promise = require('../../../modules/nuclide-commons/promise');}var _process;function _load_process() {return _process = require('../../../modules/nuclide-commons/process');}var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _ClangFlagsManager;function _load_ClangFlagsManager() {return _ClangFlagsManager = _interopRequireDefault(require('./ClangFlagsManager'));}var _ClangServer;function _load_ClangServer() {return _ClangServer = _interopRequireDefault(require('./ClangServer'));}var _findClangServerArgs;function _load_findClangServerArgs() {return _findClangServerArgs = _interopRequireDefault(require('./find-clang-server-args'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // Limit the number of active Clang servers.
/**
...
const DEFAULT_MEMORY_LIMIT = Math.round(_os.default.totalmem() * 15 / 100);let _getDefaultFlags;class ClangServerManager {constructor() {this._memoryLimit = DEFAULT_MEMORY_LIMIT;this._flagsManager = new (_ClangFlagsManager || _load_ClangFlagsManager()).default();this._servers = new (_lruCache || _load_lruCache()).default({ max: SERVER_LIMIT,
      dispose(_, val) {
        val.dispose();
      } });
  ...
  restartIfChanged)
  {
    ...
    server = new (_ClangServer || _load_ClangServer()).default(
    src,
    contents,
    (0, (_findClangServerArgs || _load_findClangServerArgs()).default)(
    src,
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const flagsData = yield _this._flagsManager.
      getFlagsForSrc(src, requestSettings).
      catch(function (e) {
        (0, (_log4js || _load_log4js()).getLogger)('nuclide-clang-rpc').error(
      ...
      if (flagsData != null && flagsData.flags.length > 0) {
        ...
        return {
          flags: yield augmentDefaultFlags(src, defaultSettings.defaultFlags),
  ...
  _checkMemoryUsageImpl() {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      const serverPids = _this2._servers.
      values().
      map(function (server) {return server.getPID();}).
      filter(Boolean);
      if (serverPids.length === 0) {
        return 0;
      }

      const usage = yield (0, (_process || _load_process()).memoryUsagePerPid)(serverPids);
      let total = Array.from(usage.values()).reduce(function (a, b) {return a + b;}, 0);
      ...
      if (count > 1 && total > _this2._memoryLimit) {
        ...
        toDispose.forEach(function (key) {return _this2._servers.del(key);});
      }
