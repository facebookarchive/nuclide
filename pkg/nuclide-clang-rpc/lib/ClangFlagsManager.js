...
class ClangFlagsManager {
  ...
  _getRelatedSrcFileForHeader(header, dbFlags, projectRoot) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const source = yield _this5._relatedFileFinder.getRelatedSourceForHeader(header);
      if (source != null) {
        return source;
      }
      if (dbFlags != null) {
      ...
      return projectRoot != null ? _this5._relatedFileFinder.getRelatedSourceForHeader(header, projectRoot) : null;
    })();
  }
