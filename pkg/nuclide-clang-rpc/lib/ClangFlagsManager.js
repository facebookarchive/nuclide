'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _SimpleCache;
...
function _load_SimpleCache() {return _SimpleCache = require('../../../modules/nuclide-commons/SimpleCache');}var _nullthrows;
function _load_nullthrows() {return _nullthrows = _interopRequireDefault(require('nullthrows'));}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _string;
function _load_string() {return _string = require('../../../modules/nuclide-commons/string');}var _nuclideAnalytics;
function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _fsPromise;
function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('../../../modules/nuclide-commons/fsPromise'));}var _log4js;
function _load_log4js() {return _log4js = require('log4js');}var _clangFlagsReader;
function _load_clangFlagsReader() {return _clangFlagsReader = require('./clang-flags-reader');}var _clangFlagsParser;



function _load_clangFlagsParser() {return _clangFlagsParser = require('./clang-flags-parser');}var _ClangFlagsPool;
function _load_ClangFlagsPool() {return _ClangFlagsPool = _interopRequireDefault(require('./ClangFlagsPool'));}var _finders;
function _load_finders() {return _finders = require('./related-file/finders');}var _utils;
...
class ClangFlagsManager {
  ...
  constructor() {this._compilationDatabases = new (_SimpleCache || _load_SimpleCache()).SimpleCache();this._uriResolveCache = new (_SimpleCache || _load_SimpleCache()).SimpleCache({ keyFactory: ([parent, relative]) => relative + parent });this._relatedFileFinder = new (_finders || _load_finders()).RelatedFileFinder();
    this._realpathCache = {};
  ...
  {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-clang.get-flags', function () {return (
          _this2._getFlagsForSrcImpl(src, requestSettings));});})();
  ...
  {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      const projectFlagsDir = yield (_fsPromise || _load_fsPromise()).default.findNearestFile(
      ...
      const projectFlagsFile = (_nuclideUri || _load_nuclideUri()).default.join(
      projectFlagsDir,
      PROJECT_CLANG_FLAGS_FILE);
      ...
      return originalFlags.
      filter(function (flag) {return projectFlags.ignoredCompilerFlags.indexOf(flag) === -1;}).
      concat(projectFlags.extraCompilerFlags);})();
  }

  _getDBFlagsAndDirForSrc(
  src,
  requestSettings)
  ...
  {var _this4 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (compilationDB != null && compilationDB.file != null) {
        ...
        dbDir = yield (_fsPromise || _load_fsPromise()).default.findNearestFile(
  ...
  _getRelatedSrcFileForHeader(
  header,
  dbFlags,
  projectRoot)
  {var _this5 = this;return (0, _asyncToGenerator.default)(function* () {
      const source = yield _this5._relatedFileFinder.getRelatedSourceForHeader(
      header);
      ...
      if (dbFlags != null) {
        const sourceFile = _this5._findSourceFileForHeaderFromCompilationDatabase(
        header,
        dbFlags);
      ...
      _this5._relatedFileFinder.getRelatedSourceForHeader(header, projectRoot) :
      null;})();
  }
  ...
  {var _this6 = this;return (0, _asyncToGenerator.default)(function* () {
      const { dbFlags, dbDir } = yield _this6._getDBFlagsAndDirForSrc(
      src,
      requestSettings);
      ...
      if ((0, (_utils || _load_utils()).isHeaderFile)(src)) {
        return _this6._getRelatedSrcFileForHeader(
        src,
        dbFlags,
      ...
      return _this6._relatedFileFinder.getRelatedHeaderForSource(src);})();
  }
  ...
  {var _this7 = this;return (0, _asyncToGenerator.default)(function* () {
      const { dbFlags, dbDir } = yield _this7._getDBFlagsAndDirForSrc(
      src,
      requestSettings);
      ...
      if ((0, (_utils || _load_utils()).isHeaderFile)(src)) {
        const sourceFile = yield _this7._getRelatedSrcFileForHeader(
        src,
        dbFlags,
        // flowlint-next-line sketchy-null-string:off
      ...
      yield (0, (_utils || _load_utils()).guessBuildFile)(src);
      if (buildFile != null) {
        return {
          flags: [],
          flagsFile: buildFile,
  ...
  _loadProjectCompilerFlagsImpl(
  flagsFile)
  {return (0, _asyncToGenerator.default)(function* () {
      let result = null;
      try {
        const contents = yield (_fsPromise || _load_fsPromise()).default.readFile(flagsFile, 'utf8');
        const data = JSON.parse(contents);if (!(
        data instanceof Object)) {throw new Error('Invariant violation: "data instanceof Object"');}
        ...
        if (extra_compiler_flags != null) {
          extra_compiler_flags.forEach(function (flag) {return extraCompilerFlags.push(flag);});
        }
        if (ignored_compiler_flags != null) {
          ignored_compiler_flags.forEach(function (flag) {return ignoredCompilerFlags.push(flag);});
        }
  ...
  _assertCompilationDatabaseEntry(entry) {if (!(

    typeof entry.file === 'string' &&
    typeof entry.directory === 'string' && (
    typeof entry.command === 'string' || Array.isArray(entry.arguments)))) {throw new Error(
      'The compilation database entry is invalid and does not comply with the spec.');}

  }

  _processCompilationDatabaseEntry(
  entry,
  dbDir,
  flagsFile,
  dbFile)
  {var _this9 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      _this9._uriResolveCached(dbDir, entry.directory),
      _this9._realpathCache);
      ...
      const clangFlags = _this9.sanitizeEntry(
      entry,
  ...
  _loadFlagsFromCompilationDatabase(
  dbFile,
  flagsFile)
  {var _this10 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      entry) {return (
          ...
          _this10._processCompilationDatabaseEntry(entry, dbDir, flagsFile, dbFile));};

      const processedEntries = yield (0, (_clangFlagsReader || _load_clangFlagsReader()).readCompilationFlags)(dbFile).
      ...
      toPromise().
        ...
        return (0, (_clangFlagsReader || _load_clangFlagsReader()).fallbackReadCompilationFlags)(dbFile).then(function (entries) {return (
  ...
  _uriResolveCached(parent, relative) {
    ...
    (_nuclideUri || _load_nuclideUri()).default.resolve(parent, relative));
  ...
  flagsFile)
  {
    ...
    entry.arguments :
    (0, (_string || _load_string()).shellParse)((0, (_nullthrows || _load_nullthrows()).default)(entry.command));
