...
class ClangFlagsManager {
  ...
  _getRelatedSrcFileForHeader(header, dbFlags, projectRoot) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      const source = yield new (_RelatedFileFinder || _load_RelatedFileFinder()).RelatedFileFinder().getRelatedSourceForHeader(header);
      if (source != null) {
        return source;
      }
      if (dbFlags != null) {
      ...
      return projectRoot != null ? new (_RelatedFileFinder || _load_RelatedFileFinder()).RelatedFileFinder().getRelatedSourceForHeader(header, projectRoot) : null;
    })();
  }
  ...
  getRelatedSourceOrHeader(src, requestSettings) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      return new (_RelatedFileFinder || _load_RelatedFileFinder()).RelatedFileFinder().getRelatedHeaderForSource(src);
    })();
  }
