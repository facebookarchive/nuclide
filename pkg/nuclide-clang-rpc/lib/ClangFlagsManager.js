...
var ClangFlagsManager = (function () {
  ...
  _createDecoratedClass(ClangFlagsManager, [{
    ...
    value: _asyncToGenerator(function* (buckProjectRoot, target) {
      ...
      var buildReport = yield (_nuclideBuckRpc2 || _nuclideBuckRpc()).build(buckProjectRoot, [buildTarget, '-j', String(maxCpus)], { commandOptions: { timeout: BUCK_TIMEOUT } });
      ...
      var changes = buildFile == null ? (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.empty() : this._watchFlagFile(buildFile);
    ...
    value: function _watchFlagFile(flagFile) {
      ...
      var flagFileDir = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(flagFile);
      var flagFileBase = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.basename(flagFile);
      var observable = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.create(function (obs) {
