...
var ClangFlagsManager = (function () {
  ...
  _createDecoratedClass(ClangFlagsManager, [{
    ...
    value: _asyncToGenerator(function* (dbFile) {
      ...
      try {
        var contents = yield (_commonsNodeFsPromise || _load_commonsNodeFsPromise()).default.readFile(dbFile);
    ...
    value: _asyncToGenerator(function* (src) {
      ...
      var target = (yield (_nuclideBuckRpc || _load_nuclideBuckRpc()).getOwner(buckRoot, src)).find(function (x) {
