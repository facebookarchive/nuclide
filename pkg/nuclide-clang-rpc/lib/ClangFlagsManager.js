'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _nullthrows;
...
function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _cache;
function _load_cache() {return _cache = require('../../commons-node/cache');}var _fsPromise;
...
class ClangFlagsManager {
  ...
  constructor() {this._compilationDatabases = new (_cache || _load_cache()).Cache();this._uriResolveCache = new (_cache || _load_cache()).Cache({ keyFactory: ([parent, relative]) => relative + parent });this._relatedFileFinder = new (_finders || _load_finders()).RelatedFileFinder();
    this._realpathCache = {};
