...
var getCtagsService = _asyncToGenerator(function* (uri) {
  var dir = yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.findNearestFile(TAGS_FILENAME, (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(uri));
  if (dir == null) {
    return null;
  }
  return new CtagsService((_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(dir, TAGS_FILENAME));
});
...
var CtagsService = (function () {
  ...
  _createClass(CtagsService, [{
    ...
    value: function findTags(query, options) {
      ...
      var dir = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(this._tagsPath);
        ...
        ctags.findTags(_this._tagsPath, query, options, _asyncToGenerator(function* (error, tags) {
          if (error != null) {
            ...
            var processed = yield Promise.all(tags.map(_asyncToGenerator(function* (tag) {
              ...
              tag.file = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(dir, tag.file);
