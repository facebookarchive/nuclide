'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.SourceFilePathsModal = undefined;
...
function _load_AtomInput() {return _AtomInput = require('../../../modules/nuclide-commons-ui/AtomInput');}var _ListView;
function _load_ListView() {return _ListView = require('../../../modules/nuclide-commons-ui/ListView');}var _ButtonGroup;
function _load_ButtonGroup() {return _ButtonGroup = require('../../../modules/nuclide-commons-ui/ButtonGroup');}var _Button;
function _load_Button() {return _Button = require('../../../modules/nuclide-commons-ui/Button');}var _nullthrows;
function _load_nullthrows() {return _nullthrows = _interopRequireDefault(require('nullthrows'));}var _nuclideAnalytics;
...
{constructor(...args) {var _temp;return _temp = super(...args), this.
    ...
    _savedSourcePaths = [], this.
    state = {
      currentPaths: this.props.initialSourcePaths.slice(0) }, this.
    ...
    _addItem = () => {
      const text = (0, (_nullthrows || _load_nullthrows()).default)(this._newSourcePath).
      getText().
      trim().
    ...
    _cancelClick = () => {
      ...
      this.props.onClosed();
      (0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)('fb-java-debugger-source-dialog-cancel', {});
    }, this.
