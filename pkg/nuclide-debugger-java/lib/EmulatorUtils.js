  ...
  function* () {
    try {
      ...
      return 'adb';
                                                                               ...
                                                                               * 
                                                                               * @format
                                                                               */let getAdbPorts = exports.getAdbPorts = (() => {var _ref2 = (0, _asyncToGenerator.default)(function* (targetUri) {const adbService = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getAdbServiceByNuclideUri)(targetUri);const ports = yield adbService.getAdbPorts(); // Don't show the user the default adb port. This should always be included.
