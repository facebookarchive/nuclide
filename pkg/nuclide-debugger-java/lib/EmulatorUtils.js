...
exports.addAdbPorts = exports.getAdbPorts = exports.getAdbPath = undefined;

var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));

let getAdbPath = exports.getAdbPath = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* () {
    try {
      // $FlowFB
      return require('../../commons-node/fb-sitevar').fetchSitevarOnce(' NUCLIDE_ONE_WORLD_ADB_PATH');
    } catch (e) {
      return 'adb';
    }
  });

  return function getAdbPath() {
...
let getAdbPorts = exports.getAdbPorts = (() => {
  var _ref2 = (0, _asyncToGenerator.default)(function* (targetUri) {
    const adbService = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getAdbServiceByNuclideUri)(targetUri);
    const ports = yield adbService.getAdbPorts();

    // Don't show the user the default adb port. This should always be included.
    return ports.filter(function (port) {
      return port !== (_AdbDeviceSelector || _load_AdbDeviceSelector()).DEFAULT_ADB_PORT;
    });
  });

  return function getAdbPorts(_x) {
    return _ref2.apply(this, arguments);
  };
})();

let addAdbPorts = exports.addAdbPorts = (() => {
  var _ref3 = (0, _asyncToGenerator.default)(function* (targetUri, ports) {
    const adbService = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getAdbServiceByNuclideUri)(targetUri);
  ...
  return function addAdbPorts(_x2, _x3) {
