...
exports.AndroidAttachComponent = undefined;
...
class AndroidAttachComponent extends _react.Component {
  ...
  constructor(props) {
    ...
    this._handleAttachClick = (0, _asyncToGenerator.default)(function* () {
      ...
      yield (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).debugAndroidDebuggerService)(parseInt(selectedProcess.pid, 10), adbService, null /* service */
      , activity, action, device, packageName, _this.props.targetUri /* adbServiceUri */
      ...
      (0, (_nuclideDebuggerCommon || _load_nuclideDebuggerCommon()).serializeDebuggerConfig)(..._this._getSerializationArgs(), {
        selectedDeviceName: _this.state.selectedDevice == null ? '' : _this.state.selectedDevice.name,
  ...
  _getAdbParameters() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      _this2.setState({
        ...
        adbPath: (_nuclideUri || _load_nuclideUri()).default.isRemote(_this2.props.targetUri) ? yield (0, (_EmulatorUtils || _load_EmulatorUtils()).getAdbPath)() : 'adb'
      });
    })();
  }
      ...
      'core:confirm': (() => {
        var _ref2 = (0, _asyncToGenerator.default)(function* () {
          if (_this3._debugButtonShouldEnable()) {
            yield _this3._handleAttachClick();
          }
        });
  ...
  _debugButtonShouldEnable() {
    return this.state.selectedProcess != null && this.state.selectedDevice != null;
  }
  ...
  _handleDeviceChange(device) {
    ...
    if (device != null) {
      ...
      const adbService = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getAdbServiceByNuclideUri)(this.props.targetUri);

      if (!(adbService != null)) {
        throw new Error('Invariant violation: "adbService != null"');
      }
  ...
  _getSerializationArgs() {
    return [(_nuclideUri || _load_nuclideUri()).default.isRemote(this.props.targetUri) ? (_nuclideUri || _load_nuclideUri()).default.getHostname(this.props.targetUri) : 'local', 'attach', 'Java - Android'];
  }
...
exports.AndroidAttachComponent = AndroidAttachComponent; /**
