'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let getAdditionalLogFilesOnLocalServer = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  ...
  deadline)
  {
    ...
    try {
      ...
      yield Promise.all(
      files.map((() => {var _ref6 = (0, _asyncToGenerator.default)(function* (file) {
        ...
        });return function (_x11) {return _ref6.apply(this, arguments);};})()));

      return results;
    } catch (e) {
      return [];
    }
  });return function getAdditionalLogFilesOnLocalServer(_x10) {return _ref5.apply(this, arguments);};})();exports.createDebuggerProvider = createDebuggerProvider;exports.createJavaDebuggerProvider = createJavaDebuggerProvider;exports.
