...
let getAdditionalLogFilesOnLocalServer = (() => {
  var _ref5 = (0, _asyncToGenerator.default)(function* (deadline) {
  ...
  return function getAdditionalLogFilesOnLocalServer(_x10) {
...
var _JavaLaunchAttachProvider;

function _load_JavaLaunchAttachProvider() {
  return _JavaLaunchAttachProvider = require('./JavaLaunchAttachProvider');
}
...
function createDebuggerProvider() {
  return {
    ...
    getLaunchAttachProvider(connection) {
      return new (_JavaLaunchAttachProvider || _load_JavaLaunchAttachProvider()).JavaLaunchAttachProvider('Java', connection);
    }
  };
} /**
...
function createJavaDebuggerProvider() {
  return {
    createAndroidDebugInfo: (() => {
      var _ref = (0, _asyncToGenerator.default)(function* (parameters) {
        ...
        const adbService = (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).getAdbService)(targetUri);
        const { pid } = yield (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).launchAndroidServiceOrActivityAndGetPid)(parameters.pid, adbService, service, activity, action, device, packageName);

        const subscriptions = new (_UniversalDisposable || _load_UniversalDisposable()).default();
        const attachPortTargetInfo = yield (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).getAdbAttachPortTargetInfo)(device, adbService, adbServiceUri, targetUri, pid, subscriptions);

        const clickEvents = new _rxjsBundlesRxMinJs.Subject();
        const processInfo = yield (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).createJavaVspProcessInfo)(targetUri, attachPortTargetInfo, clickEvents);
      ...
      return function createAndroidDebugInfo(_x) {
        return _ref.apply(this, arguments);
      };
    })(),
    createJavaAttachInfo: (() => {
      var _ref2 = (0, _asyncToGenerator.default)(function* (targetUri, attachPort) {
        const subscriptions = new (_UniversalDisposable || _load_UniversalDisposable()).default();
        const clickEvents = new _rxjsBundlesRxMinJs.Subject();
        const processInfo = yield (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).createJavaVspProcessInfo)(targetUri, {
          debugMode: 'attach',
      ...
      return function createJavaAttachInfo(_x2, _x3) {
    ...
    createJavaTestAttachInfo: (() => {
      ...
      return function createJavaTestAttachInfo(_x4, _x5) {
        return _ref3.apply(this, arguments);
      };
    })(),
    createJavaLaunchInfo: (() => {
      var _ref4 = (0, _asyncToGenerator.default)(function* (targetUri, mainClass, classPath, runArgs) {
        const subscriptions = new (_UniversalDisposable || _load_UniversalDisposable()).default();
        const clickEvents = new _rxjsBundlesRxMinJs.Subject();
        const processInfo = yield (0, (_JavaDebuggerServiceHelpers || _load_JavaDebuggerServiceHelpers()).createJavaVspProcessInfo)(targetUri, {
          debugMode: 'launch',
      ...
      return function createJavaLaunchInfo(_x6, _x7, _x8, _x9) {
