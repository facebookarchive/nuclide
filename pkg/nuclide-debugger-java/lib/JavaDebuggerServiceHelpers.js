'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.javaDebugAddBuckTargetSourcePaths = exports.javaDebugSetSourcePaths = exports.debugJavaDebuggerService = exports.debugAndroidDebuggerService = exports.createJavaVspProcessInfo = exports.getAdbAttachPortTargetInfo = exports.launchAndroidServiceOrActivityAndGetPid = exports.getJavaVSAdapterExecutableInfo = exports.NUCLIDE_DEBUGGER_DEV_GK = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let getJavaVSAdapterExecutableInfo = exports.getJavaVSAdapterExecutableInfo = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  targetUri)
  {
    return (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getJavaDebuggerHelpersServiceByNuclideUri)(
    targetUri).
    getJavaVSAdapterExecutableInfo((yield (0, (_passesGK || _load_passesGK()).default)(NUCLIDE_DEBUGGER_DEV_GK)));
  });return function getJavaVSAdapterExecutableInfo(_x) {return _ref.apply(this, arguments);};})();let launchAndroidServiceOrActivityAndGetPid = exports.launchAndroidServiceOrActivityAndGetPid = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  });return function launchAndroidServiceOrActivityAndGetPid(_x2, _x3, _x4, _x5, _x6, _x7, _x8) {return _ref2.apply(this, arguments);};})();let getAdbAttachPortTargetInfo = exports.getAdbAttachPortTargetInfo = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  ...
  subscriptions)
  {
    ...
    const attachPort = yield new Promise((() => {var _ref5 = (0, _asyncToGenerator.default)(function* (resolve, reject) {
        if (!tunnelRequired) {
          resolve(adbPort);
          return;
        }if (!
      ...
      });return function (_x15, _x16) {return _ref5.apply(this, arguments);};})());
    return {
      debugMode: 'attach',
      machineName: 'localhost',
      port: attachPort };

  });return function getAdbAttachPortTargetInfo(_x9, _x10, _x11, _x12, _x13, _x14) {return _ref3.apply(this, arguments);};})();let createJavaVspProcessInfo = exports.createJavaVspProcessInfo = (() => {var _ref6 = (0, _asyncToGenerator.default)(
  ...
  clickEvents)
  {
    ...
    targetUri,
    info.debugMode,
    (_nuclideDebuggerCommon || _load_nuclideDebuggerCommon()).VsAdapterTypes.JAVA,
    adapterExecutable,
    infoToArgs(info),
    { threads: true },
    { customControlButtons: [getCustomSetSourcePathButton(clickEvents)] });

  });return function createJavaVspProcessInfo(_x17, _x18, _x19) {return _ref6.apply(this, arguments);};})();let debugAndroidDebuggerService = exports.debugAndroidDebuggerService = (() => {var _ref7 = (0, _asyncToGenerator.default)(
  ...
  targetUri)
  {
    ...
    const attachPortTargetInfo = yield getAdbAttachPortTargetInfo(
    device,
    adbService,
    adbServiceUri,
    targetUri,
  ...
  });return function debugAndroidDebuggerService(_x20, _x21, _x22, _x23, _x24, _x25, _x26, _x27, _x28) {return _ref7.apply(this, arguments);};})();let debugJavaDebuggerService = exports.debugJavaDebuggerService = (() => {var _ref8 = (0, _asyncToGenerator.default)(
  ...
  trackDebug = true)
  {
    ...
    const processInfo = yield createJavaVspProcessInfo(
    targetUri,
    info,
    clickEvents);
  ...
  });return function debugJavaDebuggerService(_x29, _x30) {return _ref8.apply(this, arguments);};})();let javaDebugSetSourcePaths = exports.javaDebugSetSourcePaths = (() => {var _ref9 = (0, _asyncToGenerator.default)(
  ...
  });return function javaDebugSetSourcePaths(_x31, _x32) {return _ref9.apply(this, arguments);};})();

// Employs a heuristic to try and find the Java source path roots for a buck target.
let javaDebugAddBuckTargetSourcePaths = exports.javaDebugAddBuckTargetSourcePaths = (() => {var _ref10 = (0, _asyncToGenerator.default)(function* (
  processInfo,
  buckRoot,
  targetName)
  {
 ...
 */let cleanupSubject = null;const NUCLIDE_DEBUGGER_DEV_GK = exports.NUCLIDE_DEBUGGER_DEV_GK = 'nuclide_debugger_dev';function getAdbService(adbServiceUri) {const service = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getAdbServiceByNuclideUri)(adbServiceUri);if (!(service != null)) {throw new Error('Invariant violation: "service != null"');}return service;}function getCustomSetSourcePathButton(clickEvents) {return { icon: 'file-code', title: 'Set Source Path', onClick: () => clickEvents.next() };}function getDialogValues(clickEvents) {let userSourcePaths = getSavedPathsFromConfig();return clickEvents.switchMap(() => {return _rxjsBundlesRxMinJs.Observable.create(observer => {const modalDisposable = (0, (_showModal || _load_showModal()).default)(({ dismiss }) => _react.createElement((_SourceFilePathsModal || _load_SourceFilePathsModal()).SourceFilePathsModal, { initialSourcePaths: userSourcePaths, sourcePathsChanged: newPaths => {userSourcePaths = newPaths;persistSourcePathsToConfig(newPaths);observer.next(newPaths);}, onClosed: dismiss }), { className: 'sourcepath-modal-container' });(0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)('fb-java-debugger-source-dialog-shown');return () => {modalDisposable.dispose();};});});}function persistSourcePathsToConfig(newSourcePaths) {(_featureConfig || _load_featureConfig()).default.set('nuclide-debugger-java.sourceFilePaths', newSourcePaths.join(';'));}function getSavedPathsFromConfig() {const paths = (_featureConfig || _load_featureConfig()).default.get('nuclide-debugger-java.sourceFilePaths'); // flowlint-next-line sketchy-null-mixed:off
  ...
  atom.project.getPaths().forEach(path => {if (remote && (_nuclideUri || _load_nuclideUri()).default.isRemote(path) || !remote && (_nuclideUri || _load_nuclideUri()).default.isLocal(path)) {const translatedPath = remote ? (_nuclideUri || _load_nuclideUri()).default.getPath(path) : path;searchPaths.push(translatedPath);try {// $FlowFB
        require('./fb-AndroidSourcePathUtils').addKnownSubdirectoryPaths(remote, translatedPath, searchPaths);} catch (e) {}}});return searchPaths;}function infoToArgs(info) {return { config: { info }, trace: false };}function getSourcePathString(searchPaths) {return searchPaths.join(';');}