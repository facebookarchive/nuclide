'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.javaDebugAddBuckTargetSourcePaths = exports.debugJavaDebuggerService = exports.debugAndroidDebuggerService = exports.createJavaVspProcessInfo = exports.getAdbAttachPortTargetInfo = exports.launchAndroidServiceOrActivityAndGetPid = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let launchAndroidServiceOrActivityAndGetPid = exports.launchAndroidServiceOrActivityAndGetPid = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  packageName)
  {
    ...
    if (service != null) {
      ...
      if (!activityExists) {
        const packages = yield adbService.getAllAvailablePackages(device);
        const availableActivities = new Set(
        packages.filter(function (line) {return line.includes(packageName + '/');}));
        ...
        map(function (activityLine) {return activityLine.split('/')[1];}).
        join('\n'));
  ...
  subscriptions)
  {
    ...
    const attachPort = yield new Promise((() => {var _ref4 = (0, _asyncToGenerator.default)(function* (resolve, reject) {
        try {
          ...
          const debuggerPort = yield tunnelService.getAvailableServerPort(
          targetUri);
  ...
  clickEvents)
  {
    const processConfig = yield _createJavaVspIProcessConfig(
    targetUri,
    config,
    clickEvents);

    const info = new (_nuclideDebuggerCommon || _load_nuclideDebuggerCommon()).VspProcessInfo(
  ...
  });return function getJavaVSAdapterExecutableInfo(_x19) {return _ref6.apply(this, arguments);};})();let _createJavaVspIProcessConfig = (() => {var _ref7 = (0, _asyncToGenerator.default)(
  ...
  });return function _createJavaVspIProcessConfig(_x20, _x21, _x22) {return _ref7.apply(this, arguments);};})();let debugAndroidDebuggerService = exports.debugAndroidDebuggerService = (() => {var _ref8 = (0, _asyncToGenerator.default)(
  ...
  targetUri)
  {
    ...
    let subscriptions = new (_UniversalDisposable || _load_UniversalDisposable()).default();
    try {
...
getSourcePathString = getSourcePathString;var _nuclideDebuggerCommon;function _load_nuclideDebuggerCommon() {return _nuclideDebuggerCommon = require('../../../modules/nuclide-debugger-common');}var _passesGK;function _load_passesGK() {return _passesGK = _interopRequireDefault(require('../../commons-node/passesGK'));}var _utils;function _load_utils() {return _utils = require('../../../modules/atom-ide-debugger-java/utils');}var _featureConfig;function _load_featureConfig() {return _featureConfig = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/feature-config'));}var _showModal;function _load_showModal() {return _showModal = _interopRequireDefault(require('../../../modules/nuclide-commons-ui/showModal'));}var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _consumeFirstProvider;function _load_consumeFirstProvider() {return _consumeFirstProvider = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/consumeFirstProvider'));}var _debugger;function _load_debugger() {return _debugger = require('../../../modules/nuclide-commons-atom/debugger');}var _nuclideAnalytics;function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _nuclideBuckRpc;function _load_nuclideBuckRpc() {return _nuclideBuckRpc = _interopRequireWildcard(require('../../nuclide-buck-rpc'));}var _react = _interopRequireWildcard(require('react'));var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _utils2;function _load_utils2() {return _utils2 = require('../../../modules/nuclide-adb/lib/utils');}var _SourceFilePathsModal;function _load_SourceFilePathsModal() {return _SourceFilePathsModal = require('./SourceFilePathsModal');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // Only one AdbProcessInfo can be active at a time. Since it ties up a forwarded
