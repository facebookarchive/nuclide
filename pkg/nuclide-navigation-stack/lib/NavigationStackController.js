...
function _load_string() {return _string = require('nuclide-commons/string');}var _NavigationStack;
function _load_NavigationStack() {return _NavigationStack = require('./NavigationStack');}var _nuclideUri;

function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _Location;
