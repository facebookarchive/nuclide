...
function _load_projects() {return _projects = require('../../../modules/nuclide-commons-atom/projects');}var _textEditor;
function _load_textEditor() {return _textEditor = require('../../../modules/nuclide-commons-atom/text-editor');}var _NavigationStackController;
function _load_NavigationStackController() {return _NavigationStackController = require('./NavigationStackController');}var _nuclideAnalytics;
...
function _load_createPackage() {return _createPackage = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/createPackage'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
const controller = new (_NavigationStackController || _load_NavigationStackController()).NavigationStackController(); /**
                                                                                                                       ...
                                                                                                                       * 
                                                                                                                       * @format
                                                                                                                       */class Activation {constructor(state) {this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default();const subscribeEditor = editor => {const subscription = new (_UniversalDisposable || _load_UniversalDisposable()).default(
      editor.onDidDestroy(() => {
    ...
    () => {
      (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-navigation-stack:forwards', () =>
    ...
    () => {
      (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-navigation-stack:backwards', () =>
  ...
  getNavigationStackProvider() {
    ...
    return {
      subscribe: callback =>
      new (_UniversalDisposable || _load_UniversalDisposable()).default(stackChanges.subscribe(callback)),
