...
var Activation = (function () {
  ...
  _createClass(Activation, [{
    ...
    value: function activate() {
      ...
      this._disposables.add(new (_nuclideCommons2 || _nuclideCommons()).DisposableSubscription((0, (_commonsAtomGoToLocation2 || _commonsAtomGoToLocation()).observeNavigatingEditors)().subscribe(function (editor) {
