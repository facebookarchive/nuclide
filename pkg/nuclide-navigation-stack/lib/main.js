...
var Activation = (function () {
  function Activation(state) {
    ...
    this._disposables.add(atom.workspace.onDidAddTextEditor(addEditor), atom.workspace.onDidOpen(function (event) {
    ...
    }), (0, (_commonsAtomProjects || _load_commonsAtomProjects()).onDidRemoveProjectPath)(function (path) {
      controller.removePath(path, atom.project.getDirectories().map(function (directory) {
        return directory.getPath();
      }));
    }), (0, (_commonsAtomGoToLocation || _load_commonsAtomGoToLocation()).observeNavigatingEditors)().subscribe(function (editor) {
      controller.onOptInNavigation(editor);
    }), atom.commands.add('atom-workspace', 'nuclide-navigation-stack:navigate-forwards', function () {
    ...
    }), atom.commands.add('atom-workspace', 'nuclide-navigation-stack:navigate-backwards', function () {
