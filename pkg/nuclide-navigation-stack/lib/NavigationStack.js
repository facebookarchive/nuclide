...
var NavigationStack = (function () {
  function NavigationStack() {
    ...
    this._elements = [];
    this._index = -1;
    this._changes = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
  }
  ...
  _createClass(NavigationStack, [{
    ...
    value: function getCurrent() {
      (0, (_assert || _load_assert()).default)(this._index >= 0 && this._index < this._elements.length);
    ...
    value: function push(newTop) {
      ...
      (0, (_assert || _load_assert()).default)(this._elements.length <= MAX_STACK_DEPTH);
    ...
    value: function filter(predicate) {
      ...
      var originalSize = this._elements.length;
