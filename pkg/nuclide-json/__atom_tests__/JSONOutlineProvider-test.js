...
function _load_JSONOutlineProvider() {
  return _JSONOutlineProvider = require('../lib/JSONOutlineProvider');
}
...
describe('getOutline', () => {
  it('should outline the top-level properties of an object', () => {
    ...
    const outline = (0, (_JSONOutlineProvider || _load_JSONOutlineProvider()).getOutline)(json);
  ...
  it('should return null on a syntax error', () => {
    ...
    expect((0, (_JSONOutlineProvider || _load_JSONOutlineProvider()).getOutline)('{')).toBeNull();
  });
