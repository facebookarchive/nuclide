...
module.exports = _client => {
  ...
  remoteModule.getUseLspConnection = function () {
    return _client.marshalArguments(Array.from(arguments), []).then(args => {
      return _client.callRemoteFunction("OCamlService/getUseLspConnection", "promise", args);
    }).then(value => {
  ...
  remoteModule.LanguageService = class {
    ...
    formatAtPosition(arg0, arg1, arg2) {
      return _client.marshalArguments(Array.from(arguments), [{
        name: "fileVersion",
        type: {
          kind: "named",
  ...
  remoteModule.initializeLsp = function (arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    return _client.marshalArguments(Array.from(arguments), [{
      ...
      return _client.callRemoteFunction("OCamlService/initializeLsp", "promise", args);
    }).then(value => {
      return _client.unmarshal(value, {
        kind: "named",
        name: "LanguageService"
...
Object.defineProperty(module.exports, "defs", {
  value: {
    ...
    getUseLspConnection: {
      kind: "function",
      name: "getUseLspConnection",
      location: {
        type: "source",
        fileName: "OCamlService.js",
        line: 26
      },
      type: {
        location: {
