...
exports.runSingleCommand = exports.outline = exports.errors = exports.complete = exports.enclosingType = exports.locate = exports.pushNewBuffer = exports.pushDotMerlinPath = undefined;
...
let runSingleCommand = exports.runSingleCommand = (() => {
  var _ref8 = (0, _asyncToGenerator.default)(function* (path, command) {
    const instance = yield (0, (_MerlinProcess || _load_MerlinProcess()).getInstance)(path);
    return instance ? instance.runSingleCommand(command) : null;
  });

  return function runSingleCommand(_x17, _x18) {
