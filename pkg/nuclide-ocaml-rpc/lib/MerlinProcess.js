  ...
  locate(file, line, col, kind) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return yield _this12._promiseQueue.submit((0, _asyncToGenerator.default)(function* () {
        const location = yield _this12.runSingleCommand(['locate', /* identifier name */'', kind, 'at', { line: line + 1, col: col }], file);
  ...
  enclosingType(file, line, col) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      return yield _this13._promiseQueue.submit(function () {
        return _this13.runSingleCommand(['type', 'enclosing', 'at', { line: line + 1, col: col }], file);
      });
    })();
  }
