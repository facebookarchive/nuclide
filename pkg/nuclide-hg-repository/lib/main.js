...
var _HgRepositoryProvider2;

function _HgRepositoryProvider() {
  return _HgRepositoryProvider2 = _interopRequireDefault(require('./HgRepositoryProvider'));
}
...
function activate(state) {
  ...
  (0, (_commonsAtomRegisterGrammar2 || _commonsAtomRegisterGrammar()).default)('source.ini', '.hgrc');
}
...
function createHgRepositoryProvider() {
  return new (_HgRepositoryProvider2 || _HgRepositoryProvider()).default();
}