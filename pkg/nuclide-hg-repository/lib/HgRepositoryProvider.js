...
function _load_nuclideRemoteConnection() {return _nuclideRemoteConnection = require('../../nuclide-remote-connection');}var _nuclideHgRepositoryClient;



function _load_nuclideHgRepositoryClient() {return _nuclideHgRepositoryClient = require('../../nuclide-hg-repository-client');}var _log4js;
function _load_log4js() {return _log4js = require('log4js');}var _nuclideSourceControlHelpers;
function _load_nuclideSourceControlHelpers() {return _nuclideSourceControlHelpers = require('../../nuclide-source-control-helpers');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class HgRepositoryProvider {constructor() {this.


    _activeRepositoryClients = new Map();} // Allow having multiple project roots under the same repo while sharing
      ...
      try {
        ...
        function ProjectHgRepositoryClient() {
          ...
          this.destroy = function () {if (!(
            activeRepoClientInfo != null)) {throw new Error('Invariant violation: "activeRepoClientInfo != null"');}
