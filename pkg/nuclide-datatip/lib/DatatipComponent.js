  ...
  _createClass(DatatipComponent, [{
    ...
    value: function render() {
      ...
      if (action != null && IconsForAction[action] != null) {
        ...
        actionButton = (_reactForAtom || _load_reactForAtom()).React.createElement('div', {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        'div',
        _extends({
          className: (0, (_commonsNodeString || _load_commonsNodeString()).maybeToString)(className) + ' nuclide-datatip-container'
        }, props),
