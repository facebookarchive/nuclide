...
let PinnedDatatip = exports.PinnedDatatip = class PinnedDatatip {
  ...
  _updateHostElementPosition() {
    ...
    const _range = this._range;
    const _hostElement = this._hostElement;
    const _offset = this._offset;
  ...
  render() {
    const _editor = this._editor;
    const _range = this._range;
    const ProvidedComponent = this._component;
    const _hostElement = this._hostElement;
    const _isDragging = this._isDragging;
    const _isHovering = this._isHovering;
