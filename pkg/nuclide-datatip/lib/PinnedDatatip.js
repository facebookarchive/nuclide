...
function documentMouseMove$() {
  if (_mouseMove$ == null) {
    _mouseMove$ = (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.fromEvent(document, 'mousemove');
  }
  return _mouseMove$;
}
...
function documentMouseUp$() {
  if (_mouseUp$ == null) {
    _mouseUp$ = (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.fromEvent(document, 'mouseup');
  }
  return _mouseUp$;
}
...
var PinnedDatatip = (function () {
  ...
  _createClass(PinnedDatatip, [{
    ...
    value: function handleGlobalMouseMove(event) {
      ...
      (0, (_assert || _load_assert()).default)(_dragOrigin);
    ...
    value: function render() {
      ...
      if (this._marker == null) {
        ...
        (0, (_assert || _load_assert()).default)(this._rangeDecoration);
    ...
    value: function dispose() {
      ...
      (_reactForAtom || _load_reactForAtom()).ReactDOM.unmountComponentAtNode(this._hostElement);
