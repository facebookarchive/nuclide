...
function documentMouseMove$() {
  if (_mouseMove$ == null) {
    _mouseMove$ = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromEvent(document, 'mousemove');
  }
  return _mouseMove$;
}
...
function documentMouseUp$() {
  if (_mouseUp$ == null) {
    _mouseUp$ = (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromEvent(document, 'mouseup');
  }
  return _mouseUp$;
}
