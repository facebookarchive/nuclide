...
function documentMouseMove$() {
  if (_mouseMove$ == null) {
    _mouseMove$ = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromEvent(document, 'mousemove');
  }
  return _mouseMove$;
}
...
function documentMouseUp$() {
  if (_mouseUp$ == null) {
    _mouseUp$ = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromEvent(document, 'mouseup');
  }
  return _mouseUp$;
}
