...
var DatatipManager = (function () {
  ...
  _createClass(DatatipManager, [{
    ...
    key: 'createSimpleDatatip',
    value: function createSimpleDatatip(message, range, pinnable) {
    ...
    key: 'createSimplePinnedDataTip',
    value: function createSimplePinnedDataTip(message, range, pinnable, editor, onDispose) {
      var datatip = new (_PinnedDatatip2 || _PinnedDatatip()).PinnedDatatip(this.createSimpleDatatip(message, range, pinnable), editor, onDispose);
      this._pinnedDatatips.add(datatip);
      return datatip;
    }
  }, {
