...
var DatatipManager = (function () {
  function DatatipManager() {
    ...
    this._subscriptions.add((_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.observe('nuclide-datatip.datatipDebounceDelay', function (debounceDelay) {
    ...
    this._subscriptions.add(atom.workspace.observeTextEditors(function (editor) {
      ...
      var mouseListenerSubscription = new (_atom || _load_atom()).Disposable(function () {
    ...
    var datatipMouseLeave = (0, (_commonsNodeDebounce || _load_commonsNodeDebounce()).default)(function (event) {
  ...
  _createClass(DatatipManager, [{
    ...
    value: function updateDebounceDelay(debounceDelay) {
      ...
      this._debouncedMouseMove = (0, (_commonsNodeDebounce || _load_commonsNodeDebounce()).default)(function (event, editor, editorView) {
    ...
    value: _asyncToGenerator(function* (editor, position) {
      ...
      var datatips = (0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayCompact)((yield Promise.all(providers.map(_asyncToGenerator(function* (provider) {
        var name = undefined;
        ...
        var datatip = yield (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackOperationTiming)(name + '.datatip', function () {
      ...
      var renderedProviders = datatips.map(function (datatip) {
        ...
        return (_reactForAtom || _load_reactForAtom()).React.createElement(
          (_DatatipComponent || _load_DatatipComponent()).DatatipComponent,
          {
            ...
            key: name },
          (_reactForAtom || _load_reactForAtom()).React.createElement(ProvidedComponent, null)
        );
      });
    ...
    value: function _subscribeToGlobalKeydown() {
      ...
      this._globalKeydownSubscription = new (_atom || _load_atom()).Disposable(function () {
    ...
    value: function _handlePinClicked(editor, datatip) {
      ...
      this.hideDatatip();
      this._pinnedDatatips.add(new (_PinnedDatatip || _load_PinnedDatatip()).PinnedDatatip(datatip, editor, function (pinnedDatatip) {
    ...
    value: function removeProvider(provider) {
      (0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayRemove)(this._datatipProviders, provider);
    }
  }, {
    key: 'createDatatip',
    ...
    value: function createPinnedDataTip(component, range, pinnable, editor, onDispose) {
      var datatip = new (_PinnedDatatip || _load_PinnedDatatip()).PinnedDatatip(this.createDatatip(component, range, pinnable), editor, onDispose);
    ...
    value: function dispose() {
      this.hideDatatip();
      (_reactForAtom || _load_reactForAtom()).ReactDOM.unmountComponentAtNode(this._ephemeralDatatipElement);
