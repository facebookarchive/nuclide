'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.getAttachTargetList = exports.createLogFilePaste = exports.getHhvmStackTraces = exports.getLaunchArgs = exports.getDebuggerArgs = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let getDebuggerArgs = exports.getDebuggerArgs = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  });return function getDebuggerArgs(_x) {return _ref.apply(this, arguments);};})();let getLaunchArgs = exports.getLaunchArgs = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  function* (config) {
    ...
    (_nuclideUri || _load_nuclideUri()).default.dirname(config.targetUri)) :
    ...
    (_nuclideUri || _load_nuclideUri()).default.dirname(launchWrapperCommand) :
  ...
  });return function getLaunchArgs(_x2) {return _ref2.apply(this, arguments);};})();let _getHHVMLogFilePath = (() => {var _ref3 = (0, _asyncToGenerator.default)(

  function* () {
    const path = (_nuclideUri || _load_nuclideUri()).default.join(
    _os.default.tmpdir(),
    ...
    return path;
  });return function _getHHVMLogFilePath() {return _ref3.apply(this, arguments);};})();let _createLogFile = (() => {var _ref4 = (0, _asyncToGenerator.default)(
  ...
  });return function _createLogFile(_x3) {return _ref4.apply(this, arguments);};})();let _rotateHHVMLogs = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  ...
  });return function _rotateHHVMLogs(_x4) {return _ref5.apply(this, arguments);};})();let getHhvmStackTraces = exports.getHhvmStackTraces = (() => {var _ref6 = (0, _asyncToGenerator.default)(
  ...
  function* () {
    ...
    return [];
  });return function getHhvmStackTraces() {return _ref6.apply(this, arguments);};})();let createLogFilePaste = exports.createLogFilePaste = (() => {var _ref7 = (0, _asyncToGenerator.default)(

  function* () {
    try {
      // $FlowFB
      const fbPaste = require('../../fb-pastebin');
      return (_fsPromise || _load_fsPromise()).default.
      readFile((yield _getHHVMLogFilePath()), 'utf8').
  ...
  });return function createLogFilePaste() {return _ref7.apply(this, arguments);};})();let _getAttachArgs = (() => {var _ref8 = (0, _asyncToGenerator.default)(
  ...
  });return function _getAttachArgs(_x5) {return _ref8.apply(this, arguments);};})();let _getStartupDocumentPath = (() => {var _ref9 = (0, _asyncToGenerator.default)(
  ...
  config)
  {
    ...
    const startupDocPath = (_nuclideUri || _load_nuclideUri()).default.join(
    ...
    return null;
  });return function _getStartupDocumentPath(_x6) {return _ref9.apply(this, arguments);};})();let _getHhvmPath = (() => {var _ref10 = (0, _asyncToGenerator.default)(
  ...
  });return function _getHhvmPath(_x7) {return _ref10.apply(this, arguments);};})();let getAttachTargetList = exports.getAttachTargetList = (() => {var _ref11 = (0, _asyncToGenerator.default)(
...

  {
    ...
    toString().
    split('\n').
    filter(function (line) {return line.indexOf('vsDebugPort') > 0;}).
    map(function (line) {
  ...
  });return function getAttachTargetList() {return _ref11.apply(this, arguments);};})();var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _serverPort;function _load_serverPort() {return _serverPort = require('nuclide-commons/serverPort');}var _fsPromise;function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _os = _interopRequireDefault(require('os'));var _process;function _load_process() {return _process = require('nuclide-commons/process');}var _fs = _interopRequireDefault(require('fs'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const DEFAULT_HHVM_PATH = '/usr/local/bin/hhvm'; // The default path (relative to Hack Root) to use for the startup document,
 ...
 * 
 * @format
 */const DEFAULT_STARTUP_DOC_PATH = 'scripts/vsdebug_includes.php';function _expandPath(path, cwd) {// Expand a path to interpret ~/ as home and ./ as relative
