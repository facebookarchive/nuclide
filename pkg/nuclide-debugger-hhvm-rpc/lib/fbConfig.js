...
exports.getHhvmStackTraces = exports.DEVSERVER_HHVM_PATH = undefined;
...
let getHhvmStackTraces = exports.getHhvmStackTraces = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* () {
    ...
    return fileNames.filter(function (fileName) {
      return STACK_TRACE_PATTERN.exec(fileName) != null;
    }).map(function (fileName) {
      return (_nuclideUri || _load_nuclideUri()).default.join(STACK_TRACE_LOCATION, fileName);
    });
  });
