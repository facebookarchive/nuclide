'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ParameterInput = undefined;
...
function _load_Button() {return _Button = require('nuclide-commons-ui/Button');}var _AtomInput;
function _load_AtomInput() {return _AtomInput = require('nuclide-commons-ui/AtomInput');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
  ...
  render() {
    ...
    return (
      _react.createElement('div', null,
        _react.createElement('div', { className: 'nuclide-parameter-container' },
          ...
          _react.createElement((_Button || _load_Button()).Button, {
              ...
              onClick: this._handleRemoveParameter }, 'X'))));
