...
var _uiHealthPaneItemComponent;

function _load_uiHealthPaneItemComponent() {
  return _uiHealthPaneItemComponent = _interopRequireDefault(require('./ui/HealthPaneItemComponent'));
}
  ...
  _createClass(HealthPaneItem, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement((_uiHealthPaneItemComponent || _load_uiHealthPaneItemComponent()).default, {
