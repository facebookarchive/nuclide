      ...
      _react.createElement('table', { className: 'table' },
        _react.createElement('thead', null,
          _react.createElement('tr', null,
            _react.createElement('th', { width: '30%' }, 'Metric'),
            _react.createElement('th', { width: '50%' }, 'Value'),
            _react.createElement('th', { width: '20%', className: 'text-right' }, 'Toolbar'))),
        ...
        _react.createElement('tbody', null,
          stats.map((stat, s) => {
            const props = {};
            return (
              _react.createElement('tr', Object.assign({}, props, { key: s }),
                _react.createElement('th', null, stat.name),
                _react.createElement('td', null, stat.value)));
