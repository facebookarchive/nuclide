...
var _sectionsChildProcessTreeComponent2;

function _sectionsChildProcessTreeComponent() {
  return _sectionsChildProcessTreeComponent2 = _interopRequireDefault(require('./sections/ChildProcessTreeComponent'));
}
  ...
  _createClass(HealthPaneItemComponent, [{
    ...
    value: function render() {
      ...
      var sections = {
        ...
        Subprocesses: (_reactForAtom2 || _reactForAtom()).React.createElement((_sectionsChildProcessTreeComponent2 || _sectionsChildProcessTreeComponent()).default, { childProcessesTree: this.props.childProcessesTree }),
