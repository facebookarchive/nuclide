...
var Activation = (function () {
  function Activation(state) {
    ...
    var statsStream = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.of(null).concat(viewTimeouts.switchMap((_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.interval)).map((_getStats2 || _getStats()).default).share();

    var childProcessesTreeStream = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.of(null).concat(viewTimeouts.switchMap((_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.interval)).switchMap((_getChildProcessesTree2 || _getChildProcessesTree()).default).share();
    ...
    this._paneItemStates = (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.combineLatest(packageStates, (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.of(null).concat(childProcessesTreeStream), function (packageState, childProcessesTree) {
    ...
    new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(statsStream.buffer(analyticsTimeouts.switchMap((_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.interval)).subscribe(this._updateAnalytics)));
  }
