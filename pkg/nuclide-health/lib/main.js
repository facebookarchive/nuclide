...
class Activation {
  ...
  constructor(state) {
    ...
    this._paneItemStates = _rxjsBundlesRxMinJs.Observable.combineLatest(packageStates, domCounterStream, _rxjsBundlesRxMinJs.Observable.of(null).concat(childProcessesTreeStream), (packageState, domCounters, childProcessesTree) => Object.assign({}, packageState, {
      domCounters,
      childProcessesTree,
      updateToolbarJewel
    }));
