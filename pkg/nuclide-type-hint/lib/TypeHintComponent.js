...
function makeTypeHintComponent(content, grammar) {
  return function () {
    return (_reactForAtom || _load_reactForAtom()).React.createElement(TypeHintComponent, { content: content, grammar: grammar });
  };
}
...
var TypeHintComponent = (function (_React$Component) {
  ...
  _createClass(TypeHintComponent, [{
    ...
    value: function renderPrimitive(value) {
      var buffer = new (_atom || _load_atom()).TextBuffer(value);
    ...
    value: function renderHierarchical(tree) {
      ...
      var childrenList = isExpanded ? (_reactForAtom || _load_reactForAtom()).React.createElement(
        'ul',
        { className: 'list-tree' },
        children
      ) : null;
