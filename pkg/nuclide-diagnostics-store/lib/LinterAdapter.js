...
function linterMessageToDiagnosticMessage(msg, providerName) {
  ...
  if (msg.filePath) {
    return {
      ...
      text: msg.text,
      html: msg.html,
      range: msg.range && (_atom || _load_atom()).Range.fromObject(msg.range),
      trace: trace,
...
var LinterAdapter = (function () {
  function LinterAdapter(provider) {
    ...
    var ProviderBase = arguments.length <= 1 || arguments[1] === undefined ? (_nuclideDiagnosticsProviderBase || _load_nuclideDiagnosticsProviderBase()).DiagnosticsProviderBase : arguments[1];
