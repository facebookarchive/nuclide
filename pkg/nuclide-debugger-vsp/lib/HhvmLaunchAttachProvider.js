...
let _getHHVMAttachConfig = (() => {
  var _ref4 = (0, _asyncToGenerator.default)(function* (targetUri, attachPort) {
...
let getAttachProcessInfo = exports.getAttachProcessInfo = (() => {
  var _ref5 = (0, _asyncToGenerator.default)(function* (targetUri, attachPort, serverAttach) {
    const useNewDebugger = yield _useNewDebugger();
    let adapterExecutable;
    let config;
    let processInfo;
    if (!useNewDebugger) {
      ...
      adapterExecutable = yield (0, (_utils || _load_utils()).getHhvmAdapterInfo)(targetUri);
      config = yield _getHHVMAttachConfig(targetUri, attachPort);
