...
class NativeAttachUiComponent extends _react.Component {
  ...
  constructor(props) {
    ...
    this._handleAttachButtonClick = (0, _asyncToGenerator.default)(function* () {
      ...
      const attachInfo = yield (0, (_utils || _load_utils()).getNativeVSPAttachProcessInfo)(_this.state.debuggerBackend, _this.props.targetUri, pid, _this.state.sourcePath);
