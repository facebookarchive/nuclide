...
function _load_AutoGenLaunchAttachProvider() {
  return _AutoGenLaunchAttachProvider = _interopRequireDefault(require('./AutoGenLaunchAttachProvider'));
}
...
class Activation {
  ...
  _registerPythonDebugProvider() {
    this._registerDebugProvider({
      ...
      getLaunchAttachProvider: connection => {
        return new (_AutoGenLaunchAttachProvider || _load_AutoGenLaunchAttachProvider()).default('Python', connection, (0, (_utils || _load_utils()).getPythonAutoGenConfig)(), (_utils || _load_utils()).pythonHandleLaunchButtonClick, null /* Nuclide with vs-py-debugger does not support attach */
        );
      }
    });
  }
  ...
  _registerNodeDebugProvider() {
    this._registerDebugProvider({
      name: 'Node',
      getLaunchAttachProvider: connection => {
        return new (_AutoGenLaunchAttachProvider || _load_AutoGenLaunchAttachProvider()).default('Node', connection, (0, (_utils || _load_utils()).getNodeAutoGenConfig)(), (_utils || _load_utils()).nodeHandleLaunchButtonClick, (_utils || _load_utils()).nodeHandleAttachButtonClick);
      }
    });
  }
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (yield (0, (_passesGK || _load_passesGK()).default)('nuclide_debugger_ocaml')) {
        _this3._registerDebugProvider({
          name: 'OCaml',
          getLaunchAttachProvider: function (connection) {
            return new (_AutoGenLaunchAttachProvider || _load_AutoGenLaunchAttachProvider()).default('OCaml', connection, (0, (_utils || _load_utils()).getOCamlAutoGenConfig)(), (_utils || _load_utils()).ocamlHandleLaunchButtonClick, null /* Nuclide with vs-py-debugger does not support attach */
            );
          }
        });
      }
