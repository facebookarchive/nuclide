...
class AttachUiComponent extends _react.Component {
  ...
  _refreshTargetList() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      if (service != null) {
        const attachTargets = yield service.getAttachTargetList();
  ...
  _handleAttachButtonClick() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const selectedPath = _this3.state.attachType === 'webserver' ? _this3.state.pathMenuItems[_this3.state.selectedPathIndex].label : '/';

      const processInfo = yield _this3.props.getAttachProcessInfo((_nuclideUri || _load_nuclideUri()).default.createRemoteUri(hostname, selectedPath), _this3.state.attachPort, _this3.state.attachType === 'webserver');
