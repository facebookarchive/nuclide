...
class AttachUiComponent extends _react.Component {
  ...
  _handleAttachButtonClick() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const processInfo = yield _this3.props.getAttachProcessInfo((_nuclideUri || _load_nuclideUri()).default.createRemoteUri(hostname, selectedPath), _this3.state.attachPort);
