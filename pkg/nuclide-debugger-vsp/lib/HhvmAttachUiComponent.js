...
class AttachUiComponent extends _react.Component {
  ...
  _handleAttachButtonClick() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      yield _this3.props.startAttachProcessInfo((_nuclideUri || _load_nuclideUri()).default.createRemoteUri(hostname, selectedPath), _this3.state.attachPort, _this3.state.attachType === 'webserver');
