...
class LaunchUiComponent extends _react.Component {
  ...
  _handleLaunchButtonClick() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const cwdPath = (0, (_nullthrows || _load_nullthrows()).default)(_this._cwdPath).getText().trim();
      const scriptArgs = (0, (_nullthrows || _load_nullthrows()).default)(_this._scriptArgs).getText().trim();

      _this._setRecentlyLaunchedScript(scriptPath, _this.state.recentlyLaunchedScripts, cwdPath);

      const processInfo = yield _this.props.getLaunchProcessInfo(_this.props.targetUri, scriptPath, scriptArgs, null, _this.state.runInTerminal, cwdPath);
