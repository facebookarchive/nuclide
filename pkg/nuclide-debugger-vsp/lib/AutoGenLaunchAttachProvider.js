...
const ActionNotSupportedButtonClick = (targetUri, stringValues, booleanValues, enumValues, numberValues) => {
  throw new Error('This method should never be called');
};

class AutoGenLaunchAttachProvider extends (_nuclideDebuggerCommon || _load_nuclideDebuggerCommon()).DebuggerLaunchAttachProvider {

  constructor(debuggingTypeName, targetUri, config, handleLaunchButtonClick, handleAttachButtonClick, isEnabled = LaunchAttachProviderDefaultIsEnabled) {
    super(debuggingTypeName, targetUri);
    this._config = config;
    this._handleLaunchButtonClick = handleLaunchButtonClick || ActionNotSupportedButtonClick;
    this._handleAttachButtonClick = handleAttachButtonClick || ActionNotSupportedButtonClick;
    ...
    return {
      ...
      getComponent: (debuggerTypeName, configIsValidChanged) => {
        ...
        return _react.createElement((_AutoGenLaunchAttachUiComponent || _load_AutoGenLaunchAttachUiComponent()).default, {
          ...
          handleDebugButtonClick: action === 'launch' ? this._handleLaunchButtonClick : this._handleAttachButtonClick,
