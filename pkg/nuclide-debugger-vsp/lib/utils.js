...
let getNodeLaunchProcessInfo = exports.getNodeLaunchProcessInfo = (() => {
  var _ref7 = (0, _asyncToGenerator.default)(function* (scriptPath, nodePath, args, cwd, env, outFiles) {
  ...
  return function getNodeLaunchProcessInfo(_x14, _x15, _x16, _x17, _x18, _x19) {
    return _ref7.apply(this, arguments);
  };
})();

let getNodeAttachProcessInfo = exports.getNodeAttachProcessInfo = (() => {
  var _ref8 = (0, _asyncToGenerator.default)(function* (targetUri, port) {
  ...
  return function getNodeAttachProcessInfo(_x20, _x21) {
...
let getNodeAdapterInfo = (() => {
  ...
  return function getNodeAdapterInfo(_x22) {
    return _ref9.apply(this, arguments);
  };
})();

let getReactNativeAttachProcessInfo = exports.getReactNativeAttachProcessInfo = (() => {
  var _ref10 = (0, _asyncToGenerator.default)(function* (workspacePath, port) {
  ...
  return function getReactNativeAttachProcessInfo(_x23, _x24) {
    return _ref10.apply(this, arguments);
  };
})();

let getReactNativeLaunchProcessInfo = exports.getReactNativeLaunchProcessInfo = (() => {
  var _ref11 = (0, _asyncToGenerator.default)(function* (workspacePath, port, platform) {
    const scriptPath = (_nuclideUri || _load_nuclideUri()).default.getPath((_nuclideUri || _load_nuclideUri()).default.join(workspacePath, '.vscode/launchReactNative.js'));
    const adapterInfo = yield getReactNativeAdapterInfo(scriptPath);
  ...
  return function getReactNativeLaunchProcessInfo(_x25, _x26, _x27) {
...
let getReactNativeAdapterInfo = (() => {
  ...
  return function getReactNativeAdapterInfo(_x28) {
