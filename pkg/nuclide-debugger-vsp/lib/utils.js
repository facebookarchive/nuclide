'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.getNativeVSPAttachProcessInfo = exports.getNativeVSPLaunchProcessInfo = exports.resolveConfiguration = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let lldbVspAdapterWrapperPath = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  configuration)
  {
    ...
    adapterExecutable.command = yield lldbVspAdapterWrapperPath(targetUri);
  ...
  });return function getNativeVSPAttachProcessInfo(_x6, _x7, _x8) {return _ref4.apply(this, arguments);};})();exports.getPrepackAutoGenConfig = getPrepackAutoGenConfig;exports.getNativeAutoGenConfig = getNativeAutoGenConfig;var _nuclideUri;function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _nuclideDebuggerCommon;function _load_nuclideDebuggerCommon() {return _nuclideDebuggerCommon = require('../../../modules/nuclide-debugger-common');}var _react = _interopRequireWildcard(require('react'));function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
