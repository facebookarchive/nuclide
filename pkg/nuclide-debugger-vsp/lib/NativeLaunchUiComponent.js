...
class NativeLaunchUiComponent extends _react.Component {
  ...
  constructor(props) {
    ...
    this._handleLaunchButtonClick = (0, _asyncToGenerator.default)(function* () {
      ...
      const launchInfo = yield (0, (_utils || _load_utils()).getNativeVSPLaunchProcessInfo)(_this.state.debuggerBackend, programUri, args, workingDirectory, environmentVariables, _this.state.sourcePath);
