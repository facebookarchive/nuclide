...
var MercurialConflictContext = (function () {
  ...
  _createClass(MercurialConflictContext, [{
    ...
    value: function clearConflictState() {
      ...
      this.priority = -1;
      this.workingDirectory = new (_atom || _load_atom()).Directory('');
    }
  }, {
    key: 'readConflicts',
    ...
    value: function joinPath(relativePath) {
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(this.workingDirectory.getPath(), relativePath);
    }
  }, {
    key: 'complete',
    value: function complete(wasRebasing) {
      ...
      (0, (_assert || _load_assert()).default)(wasRebasing, 'Mercurial conflict resolver only handles rebasing');
      (0, (_assert || _load_assert()).default)(this._conflictingRepository != null, 'merge conflicts complete with no active repository!');
    ...
    value: function quit(wasRebasing) {
      ...
      (0, (_assert || _load_assert()).default)(wasRebasing, 'Mercurial conflict resolver only handles rebasing');
      (0, (_assert || _load_assert()).default)(this._conflictingRepository != null, 'merge conflicts quit with no active repository!');
      var repository = this._conflictingRepository;
