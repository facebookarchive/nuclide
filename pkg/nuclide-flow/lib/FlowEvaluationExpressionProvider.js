...
var FlowEvaluationExpressionProvider = (function () {
  ...
  _createClass(FlowEvaluationExpressionProvider, [{
    ...
    value: function getEvaluationExpression(editor, position) {
      ...
      var extractedIdentifier = (0, (_commonsAtomRange || _load_commonsAtomRange()).wordAtPosition)(editor, position, (_constants || _load_constants()).JAVASCRIPT_IDENTIFIER_REGEX);
