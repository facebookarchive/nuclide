...
var FlowTypeHintProvider = (function () {
  ...
  _createClass(FlowTypeHintProvider, [{
    ...
    value: _asyncToGenerator(function* (editor, position) {
      var enabled = _nuclideFeatureConfig2.default.get('nuclide-flow.enableTypeHints');
      if (!enabled) {
        return null;
      }
      ...
      var enableStructuredTypeHints = _nuclideFeatureConfig2.default.get('nuclide-flow.enableStructuredTypeHints');
      ...
      var word = (0, _nuclideAtomHelpers.extractWordAtPosition)(editor, position, _constants.JAVASCRIPT_WORD_REGEX);
      var range = undefined;
      if (word) {
        range = word.range;
      } else {
