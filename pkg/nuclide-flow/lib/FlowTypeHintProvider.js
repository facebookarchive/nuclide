...
var FlowTypeHintProvider = (function () {
  ...
  _createClass(FlowTypeHintProvider, [{
    ...
    value: _asyncToGenerator(function* (editor, position) {
      var enabled = (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.get('nuclide-flow.enableTypeHints');
      if (!enabled) {
        return null;
      }
      ...
      var enableStructuredTypeHints = (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.get('nuclide-flow.enableStructuredTypeHints');
