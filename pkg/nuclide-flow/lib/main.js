...
async function getLanguageServiceConfig() {
  ...
  const enableFindRefs = Boolean((_featureConfig || _load_featureConfig()).default.get('nuclide-flow.enableFindReferences')) || (await (0, (_passesGK || _load_passesGK()).default)('nuclide_flow_find_refs',
