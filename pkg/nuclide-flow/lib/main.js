'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.activate = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let activate = exports.activate = (() => {var _ref = (0, _asyncToGenerator.default)(
  ...
  });return function activate() {return _ref.apply(this, arguments);};})();let connectionToFlowService = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  ...
  });return function connectionToFlowService(_x) {return _ref2.apply(this, arguments);};})();

// Exported only for testing
let allowFlowServerRestart = (() => {var _ref3 = (0, _asyncToGenerator.default)(
  ...
  });return function allowFlowServerRestart() {return _ref3.apply(this, arguments);};})();let getLanguageServiceConfig = (() => {var _ref4 = (0, _asyncToGenerator.default)(
  ...
  });return function getLanguageServiceConfig() {return _ref4.apply(this, arguments);};})();let shouldUsePushDiagnostics = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  ...
  .mergeMap(x => x).mergeMap(ls => {return ls.getServerStatusUpdates().refCount();});const subscription = serverStatusUpdatesToBusyMessages(serverStatusUpdates, service);return new (_UniversalDisposable || _load_UniversalDisposable()).default(() => {subscription.unsubscribe();});}function deactivate() {if (disposables != null) {disposables.dispose();disposables = null;}}