...
var _flowMessageToFix2;

function _flowMessageToFix() {
  return _flowMessageToFix2 = _interopRequireDefault(require('./flowMessageToFix'));
}
...
function flowMessageToTrace(message) {
  return {
    ...
    range: (0, (_flowDiagnosticsCommon2 || _flowDiagnosticsCommon()).extractRange)(message)
  };
}
...
function flowMessageToDiagnosticMessage(diagnostic) {
  ...
  var diagnosticMessage = {
    ...
    filePath: path,
    range: (0, (_flowDiagnosticsCommon2 || _flowDiagnosticsCommon()).extractRange)(flowMessage)
  };

  var fix = (0, (_flowMessageToFix2 || _flowMessageToFix()).default)(diagnostic);
  if (fix != null) {
