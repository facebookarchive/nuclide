...
var Activation = (function () {
  function Activation() {
    ...
    this._packageDisposables = new (_atom || _load_atom()).CompositeDisposable();
  ...
  _createDecoratedClass(Activation, [{
    ...
    key: '_showBlame',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('blame.showBlame')],
    ...
    key: '_hideBlame',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('blame.hideBlame')],
      ...
      var contextDisposable = contextMenu.addItemToSourceControlMenu({
        ...
        callback: function callback() {
          findBlameableNodes(contextMenu).forEach(_asyncToGenerator(function* (node) {
            var editor = yield (0, (_commonsAtomGoToLocation || _load_commonsAtomGoToLocation()).goToLocation)(node.uri);
...
function findBlameableNodes(contextMenu) {
  ...
  for (var node of contextMenu.getSelectedNodes()) {
    ...
    var repo = (0, (_nuclideHgGitBridge || _load_nuclideHgGitBridge()).repositoryForPath)(node.uri);
