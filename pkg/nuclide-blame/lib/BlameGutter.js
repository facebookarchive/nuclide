...
var BlameGutter = (function () {
  ...
  _createDecoratedClass(BlameGutter, [{
    ...
    value: _asyncToGenerator(function* (e) {
      ...
      (0, (_assert || _load_assert()).default)(typeof blameProvider.getUrlForRevision === 'function');
    ...
    key: '_updateBlame',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('blame-ui.blame-gutter.updateBlame')],
