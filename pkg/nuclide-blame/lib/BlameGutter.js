...
function _load_fbAvatar() {
  return _fbAvatar = _interopRequireDefault(require('../../nuclide-ui/fb-Avatar'));
}
  ...
  render() {
    ...
    if (isFirstLine) {
      ...
      return _reactForAtom.React.createElement(
        ...
        _reactForAtom.React.createElement((_fbAvatar || _load_fbAvatar()).default, {
          size: 16,
          unixname: unixname
        }),
