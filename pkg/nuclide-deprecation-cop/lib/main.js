...
const DEPRECATED_COMMANDS = {
  ...
  'nuclide-terminal:clear': 'atom-ide-terminal:clear' }; /**
                                                          ...
                                                          * 
                                                          * @format
                                                          */class Activation {constructor() {this._warnedCommands = new Set();this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default(this._deprecateCommands());
