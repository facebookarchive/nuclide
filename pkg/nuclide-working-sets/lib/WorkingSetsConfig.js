...
var WorkingSetsConfig = (function () {
  ...
  _createClass(WorkingSetsConfig, [{
    ...
    value: function observeDefinitions(callback) {
      ...
      return (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.observe(CONFIG_KEY, wrapped);
    }
  }, {
    key: 'getDefinitions',
    value: function getDefinitions() {
      return (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.get(CONFIG_KEY);
    }
  }, {
    key: 'setDefinitions',
    value: function setDefinitions(definitions) {
      (_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.set(CONFIG_KEY, definitions);
    }
  }]);
