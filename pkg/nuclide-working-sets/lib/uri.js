...
function dedupeNormalizedUris(uris) {
  ...
  return dedepped.filter(function (u, i) {
    var sep = (0, _nuclideRemoteUri.pathModuleFor)(u).sep;
...
function splitUri(uri) {
  var sep = (0, _nuclideRemoteUri.pathModuleFor)(uri).sep;
...
function isUriBelow(ancestorUri, descendantUri) {
  var sep = (0, _nuclideRemoteUri.pathModuleFor)(ancestorUri).sep;
...
function normalizePath(path) {
  ...
  var sep = (0, _nuclideRemoteUri.pathModuleFor)(path).sep;
