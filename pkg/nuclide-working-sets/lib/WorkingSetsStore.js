...
var WorkingSetsStore = (function () {
  ...
  _createClass(WorkingSetsStore, [{
    ...
    value: function _setDefinitions(applicable, notApplicable, definitions) {
      var somethingHasChanged = !(0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayEqual)(this._applicableDefinitions, applicable) || !(0, (_commonsNodeCollection || _load_commonsNodeCollection()).arrayEqual)(this._notApplicableDefinitions, notApplicable);
    ...
    value: function _updateCurrentWorkingSet(activeApplicable) {
      ...
      var newWorkingSet = new (_nuclideWorkingSetsCommon || _load_nuclideWorkingSetsCommon()).WorkingSet(combinedUris);
    ...
    value: function _isApplicable(definition) {
      var workingSet = new (_nuclideWorkingSetsCommon || _load_nuclideWorkingSetsCommon()).WorkingSet(definition.uris);
      var dirs = atom.project.getDirectories().filter(function (dir) {
        ...
        try {
          (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parse(dir.getPath());
          return true;
        } catch (e) {
          var logger = (0, (_nuclideLogging || _load_nuclideLogging()).getLogger)();
