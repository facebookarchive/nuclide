...
exports.DebuggerPaneContainerViewModel = undefined;
...
class DebuggerPaneContainerViewModel {
  ...
  constructor(debuggerModel, paneContainer, preferredWidth) {
    ...
    this._disposables.add(() => {
      this._forEachChildPaneItem(item => {
        if (!(item instanceof (_DebuggerPaneViewModel || _load_DebuggerPaneViewModel()).DebuggerPaneViewModel || item instanceof DebuggerPaneContainerViewModel)) {
...
exports.DebuggerPaneContainerViewModel = DebuggerPaneContainerViewModel;