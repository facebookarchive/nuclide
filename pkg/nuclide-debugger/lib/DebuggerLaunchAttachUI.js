  ...
  _createClass(DebuggerLaunchAttachUI, [{
    ...
    value: function render() {
      var connectionItems = this.state.connections.map(function (connection, index) {
        return {
          label: (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.isRemote(connection) ? (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getHostname(connection) : connection,
          value: index
        };
      });
