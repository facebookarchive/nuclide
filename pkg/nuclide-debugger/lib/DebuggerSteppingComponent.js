...
class DebuggerSteppingComponent extends _react.default.Component {
  ...
  constructor(props) {
    super(props);
    this._setWaitingForPause = this._setWaitingForPause.bind(this);
    this._togglePauseState = this._togglePauseState.bind(this);
  ...
  _togglePauseState() {
    ...
    this.props.actions.triggerDebuggerAction((_ChromeActionRegistryActions || _load_ChromeActionRegistryActions()).default.PAUSE);
  }
  ...
  render() {
    ...
    return _react.default.createElement(
      ...
      _react.default.createElement(
        ...
        _react.default.createElement(SVGButton, {
          icon: STEP_OVER_ICON,
          disabled: !isPaused,
          tooltip: Object.assign({}, defaultTooltipOptions, {
            title: 'Step over',
