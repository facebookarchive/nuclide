...
var BreakpointDisplayController = (function () {
  function BreakpointDisplayController(delegate, breakpointStore, editor, debuggerActions) {
    ...
    this._disposables.add(this._breakpointStore.onNeedUIUpdate(this._handleBreakpointsChanged.bind(this)));
    ...
    this._disposables.add(new (_commonsNodeStream2 || _commonsNodeStream()).DisposableSubscription((0, (_commonsAtomDebounced2 || _commonsAtomDebounced()).editorScrollTopDebounced)(this._editor, 300).subscribe(this._update.bind(this, false))), new (_commonsNodeStream2 || _commonsNodeStream()).DisposableSubscription((0, (_commonsAtomDebounced2 || _commonsAtomDebounced()).editorChangesDebounced)(this._editor, 300).subscribe(this._update.bind(this, false))));
  ...
  _createClass(BreakpointDisplayController, [{
    ...
    value: function _update() {
      ...
      shadowMarkerRowsToFill.forEach(function (line) {
        ...
        var elem = document.createElement('a');
        elem.classList.add('nuclide-debugger-shadow-breakpoint', 'nuclide-debugger-shadow-' + line);
    ...
    value: function _handleLineNumberGutterMouseOverOrOut(event) {
      ...
      var shadowMarkerElement = gutterView.getElementsByClassName('nuclide-debugger-shadow-' + row)[0];
