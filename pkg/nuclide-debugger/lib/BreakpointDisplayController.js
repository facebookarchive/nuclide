...
let BreakpointDisplayController = class BreakpointDisplayController {
  ...
  _registerGutterMouseHandlers(gutter) {
    ...
    const boundMouseOutHandler = this._handleGutterMouseOut.bind(this);
  ...
  _handleGutterClick(event) {
    ...
    const target = event.target; // classList isn't in the defs of HTMLElement...
