...
var DebuggerInspector = (function (_React$Component) {
  ...
  _createClass(DebuggerInspector, [{
    ...
    value: function componentDidMount() {
      ...
      var controlBarNode = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(this.refs.controlBar);
    ...
    value: function _getUrl() {
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(__dirname, '../scripts/inspector.html') + '?' + this.props.socket;
    }
  }, {
