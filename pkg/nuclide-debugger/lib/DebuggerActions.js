  ...
  _createClass(DebuggerActions, [{
    ...
    value: function setDebuggerMode(debuggerMode) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.DEBUGGER_MODE_CHANGE,
        data: debuggerMode
      });
    }
  }, {
    ...
    value: _asyncToGenerator(function* (debuggerInstance) {
      ...
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_PROCESS_SOCKET,
        data: socketAddr
      });
    ...
    value: function _setDebuggerInstance(debuggerInstance) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_DEBUGGER_INSTANCE,
    ...
    value: function _registerConsole() {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REGISTER_CONSOLE,
        data: {}
      });
    }
  }, {
    ...
    value: function _unregisterConsole() {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UNREGISTER_CONSOLE,
        data: {}
      });
    }
  }, {
    ...
    value: function addConsoleRegisterFunction(registerExecutor) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_REGISTER_EXECUTOR,
    ...
    value: function removeConsoleRegisterFunction(registerExecutor) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REMOVE_REGISTER_EXECUTOR,
        data: registerExecutor
      });
    }
  }, {
    ...
    value: function addControlButtons(buttons) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_CUSTOM_CONTROL_BUTTONS,
        data: buttons
      });
    }
  }, {
    ...
    value: function addDebuggerProvider(provider) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_DEBUGGER_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function removeDebuggerProvider(provider) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REMOVE_DEBUGGER_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function addEvaluationExpressionProvider(provider) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_EVALUATION_EXPRESSION_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function removeEvaluationExpressionProvider(provider) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REMOVE_EVALUATION_EXPRESSION_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function setError(error) {
      ...
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_ERROR,
        data: error
      });
    }
    ...
    value: function updateConnections() {
      ...
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_CONNECTIONS,
        data: connections
      });
    }
    ...
    value: function addWatchExpression(expression) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_WATCH_EXPRESSION,
        data: {
    ...
    value: function removeWatchExpression(index) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REMOVE_WATCH_EXPRESSION,
        data: {
          index: index
        }
      });
    ...
    value: function updateWatchExpression(index, newExpression) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_WATCH_EXPRESSION,
        data: {
    ...
    value: function openSourceLocation(sourceURL, lineNumber) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.OPEN_SOURCE_LOCATION,
        data: {
          sourceURL: sourceURL,
    ...
    value: function triggerDebuggerAction(actionId) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TRIGGER_DEBUGGER_ACTION,
        data: {
          actionId: actionId
        }
      });
    ...
    value: function updateCallstack(callstack) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_CALLSTACK,
        data: {
          callstack: callstack
        }
      });
    ...
    value: function setSelectedCallFrameLine(options) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_SELECTED_CALLFRAME_LINE,
        data: {
          options: options
        }
      });
    ...
    value: function clearInterface() {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.CLEAR_INTERFACE,
        data: {}
      });
    }
  }, {
    ...
    value: function addBreakpoint(path, line) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_BREAKPOINT,
        data: {
          path: path,
          line: line
        }
    ...
    value: function updateBreakpointEnabled(breakpointId, enabled) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_BREAKPOINT_ENABLED,
        data: {
    ...
    value: function updateBreakpointCondition(breakpointId, condition) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_BREAKPOINT_CONDITION,
        data: {
          breakpointId: breakpointId,
          condition: condition
        }
    ...
    value: function deleteBreakpoint(path, line) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.DELETE_BREAKPOINT,
        data: {
          path: path,
          line: line
        }
    ...
    value: function deleteAllBreakpoints() {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.DELETE_ALL_BREAKPOINTS,
        data: {}
      });
    }
  }, {
    ...
    value: function toggleBreakpoint(path, line) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_BREAKPOINT,
        data: {
          path: path,
          line: line
        }
    ...
    value: function deleteBreakpointIPC(path, line) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.DELETE_BREAKPOINT_IPC,
        data: {
          path: path,
          line: line
        }
    ...
    value: function bindBreakpointIPC(path, line, condition, enabled) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.BIND_BREAKPOINT_IPC,
        data: {
          path: path,
          line: line,
          condition: condition,
    ...
    value: function togglePauseOnException(pauseOnException) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_PAUSE_ON_EXCEPTION,
    ...
    value: function togglePauseOnCaughtException(pauseOnCaughtException) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_PAUSE_ON_CAUGHT_EXCEPTION,
    ...
    value: function toggleSingleThreadStepping(singleThreadStepping) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_SINGLE_THREAD_STEPPING,
    ...
    value: function updateLocals(locals) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_LOCALS,
        data: {
          locals: locals
        }
      });
    ...
    value: function updateThreads(threadData) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_THREADS,
        data: {
    ...
    value: function updateThread(thread) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_THREAD,
        data: {
          thread: thread
        }
      });
    ...
    value: function updateStopThread(id) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_STOP_THREAD,
        data: {
          id: id
        }
      });
    ...
    value: function notifyThreadSwitch(sourceURL, lineNumber, message) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.NOTIFY_THREAD_SWITCH,
        data: {
          sourceURL: sourceURL,
          lineNumber: lineNumber,
          message: message
    ...
    value: function receiveExpressionEvaluationResponse(id, response) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.RECEIVED_EXPRESSION_EVALUATION_RESPONSE,
        data: {
          id: id,
          response: response
        }
    ...
    value: function receiveGetPropertiesResponse(id, response) {
      this._dispatcher.dispatch({
        actionType: (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.RECEIVED_GET_PROPERTIES_RESPONSE,
        data: {
          id: id,
          response: response
        }
