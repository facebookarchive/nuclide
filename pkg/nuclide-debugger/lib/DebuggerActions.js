...
var DebuggerActions = (function () {
  ...
  _createClass(DebuggerActions, [{
    ...
    value: function updateBreakpoint(breakpointId, condition) {
      this._dispatcher.dispatch({
        actionType: (_Constants2 || _Constants()).default.Actions.UPDATE_BREAKPOINT,
        data: {
    ...
    value: function bindBreakpointIPC(path, line, condition) {
      this._dispatcher.dispatch({
