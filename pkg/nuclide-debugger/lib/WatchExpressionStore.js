...
var WatchExpressionStore = (function () {
  ...
  _createClass(WatchExpressionStore, [{
    ...
    value: function getProperties(objectId) {
      ...
      return (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise(getPropertiesPromise);
    }
  }, {
    ...
    value: function _evaluateExpression(expression, supportRepl) {
      ...
      var subject = new (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).BehaviorSubject();
    ...
    value: function _requestExpressionEvaluation(expression, subject, supportRepl) {
      ...
      var evaluationDisposable = new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default((_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.fromPromise(evaluationPromise).merge((_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.never()) // So that we do not unsubscribe `subject` when disposed.
      .subscribe(subject));
