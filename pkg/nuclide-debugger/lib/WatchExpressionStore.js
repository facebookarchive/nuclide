  ...
  _createClass(WatchExpressionStore, [{
    ...
    value: function _handlePayload(payload) {
      switch (payload.actionType) {
        ...
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.RECEIVED_GET_PROPERTIES_RESPONSE:
          {
        ...
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.RECEIVED_EXPRESSION_EVALUATION_RESPONSE:
          {
