...
var Bridge = (function () {
  function Bridge(debuggerModel) {
    ...
    this._cleanupDisposables = new (_atom || _load_atom()).CompositeDisposable();
    this._webview = null;
    this._suppressBreakpointSync = false;
    this._disposables = new (_atom || _load_atom()).CompositeDisposable(debuggerModel.getBreakpointStore().onUserChange(this._handleUserBreakpointChange.bind(this)));
  }
  ...
  _createClass(Bridge, [{
    ...
    value: function setWebviewElement(webview) {
      ...
      this._cleanupDisposables.add(new (_atom || _load_atom()).Disposable(function () {
    ...
    value: function _bindBreakpoint(breakpoint) {
      ...
      var path = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.uriToNuclideUri(sourceURL);
    ...
    value: function _handleUserBreakpointChange(params) {
      ...
      if (webview != null) {
        ...
        webview.send('command', action, {
          sourceURL: (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.nuclideUriToUri(breakpoint.path),
