...
class BreakpointManager {
  ...
  _sendBreakpointResolved(breakpointId, location) {
    ...
    if (breakpoint != null) {
      ...
      this._breakpointEvent$.next(['BreakpointAdded', this._createResolvedBreakpointFromLocation(location, breakpoint.request.condition)]);
      ...
      // is resolved.
      this._breakpointEvent$.next(['BreakpointAdded', this._createResolvedBreakpointFromLocation(location, '')]);
    }
  }
