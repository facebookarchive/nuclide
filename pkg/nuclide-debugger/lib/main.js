...
var Activation = (function () {
  function Activation(state) {
    ...
    this._disposables = new (_atom || _load_atom()).CompositeDisposable(this._model,
...
function registerConsoleExecutor(watchExpressionStore, registerExecutor) {
  ...
  var send = function send(expression) {
    disposables.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(
