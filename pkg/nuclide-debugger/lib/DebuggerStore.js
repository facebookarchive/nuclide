  ...
  _createClass(DebuggerStore, [{
    ...
    value: function _handlePayload(payload) {
      ...
      switch (payload.actionType) {
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_PROCESS_SOCKET:
          this._processSocket = payload.data;
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_ERROR:
          this._error = payload.data;
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.SET_DEBUGGER_INSTANCE:
          this._debuggerInstance = payload.data;
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_PAUSE_ON_EXCEPTION:
          ...
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_PAUSE_ON_CAUGHT_EXCEPTION:
          ...
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.TOGGLE_SINGLE_THREAD_STEPPING:
        ...
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.DEBUGGER_MODE_CHANGE:
          ...
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_EVALUATION_EXPRESSION_PROVIDER:
          if (this._evaluationExpressionProviders.has(payload.data)) {
            return;
          }
          this._evaluationExpressionProviders.add(payload.data);
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REMOVE_EVALUATION_EXPRESSION_PROVIDER:
          if (!this._evaluationExpressionProviders.has(payload.data)) {
            return;
          }
          this._evaluationExpressionProviders.delete(payload.data);
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_REGISTER_EXECUTOR:
          (0, (_assert2 || _assert()).default)(this._registerExecutor == null);
          this._registerExecutor = payload.data;
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REMOVE_REGISTER_EXECUTOR:
          (0, (_assert2 || _assert()).default)(this._registerExecutor === payload.data);
          this._registerExecutor = null;
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.REGISTER_CONSOLE:
          if (this._registerExecutor != null) {
            this._consoleDisposable = this._registerExecutor();
          }
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UNREGISTER_CONSOLE:
          if (this._consoleDisposable != null) {
            this._consoleDisposable.dispose();
            this._consoleDisposable = null;
          }
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.ADD_CUSTOM_CONTROL_BUTTONS:
