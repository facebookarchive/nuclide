...
var debuggerDatatip = _asyncToGenerator(function* (model, editor, position) {
  if (!(yield (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).default)(GK_DEBUGGER_DATATIPS, 0))) {
    return null;
  }
  ...
  return {
    component: (0, (_nuclideUiBindObservableAsProps || _load_nuclideUiBindObservableAsProps()).bindObservableAsProps)(propStream, (_DebuggerDatatipComponent || _load_DebuggerDatatipComponent()).DebuggerDatatipComponent),
    pinnable: true,
    range: range
  };
});
...
function defaultGetEvaluationExpression(editor, position) {
  var extractedIdentifier = (0, (_commonsAtomRange || _load_commonsAtomRange()).wordAtPosition)(editor, position, DEFAULT_WORD_REGEX);
