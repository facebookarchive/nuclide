...
var debuggerDatatip = _asyncToGenerator(function* (model, editor, position) {
  ...
  return {
    component: (0, (_nuclideUiBindObservableAsProps2 || _nuclideUiBindObservableAsProps()).bindObservableAsProps)(propStream, (_DebuggerDatatipComponent2 || _DebuggerDatatipComponent()).DebuggerDatatipComponent),
    pinnable: true,
    range: range
  };
});
