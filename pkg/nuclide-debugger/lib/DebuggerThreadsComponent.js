    ...
    value: function render() {
      ...
      var renderedThreadList = threadList == null || threadList.length === 0 ? '(threads unavailable)' : threadList.map(function (threadItem, i) {
        ...
        return (_reactForAtom2 || _reactForAtom()).React.createElement(
          'tr',
          {
            className: (0, (_classnames2 || _classnames()).default)('nuclide-debugger-thread-list-item', {
          ...
          (_reactForAtom2 || _reactForAtom()).React.createElement(
            'td',
            { className: 'nuclide-debugger-thread-list-item-id', title: id },
            id
          ),
          (_reactForAtom2 || _reactForAtom()).React.createElement(
            'td',
            { className: 'nuclide-debugger-thread-list-item-address', title: address },
            address
          ),
          (_reactForAtom2 || _reactForAtom()).React.createElement(
            'td',
            { className: 'nuclide-debugger-thread-list-item-stop-reason', title: stopReason },
            stopReason
          )
        );
      });
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement(
          'table',
          { className: 'nuclide-debugger-thread-list-table' },
          (_reactForAtom2 || _reactForAtom()).React.createElement(
            'thead',
            null,
            (_reactForAtom2 || _reactForAtom()).React.createElement(
              'tr',
              { className: 'nuclide-debugger-thread-list-item' },
              (_reactForAtom2 || _reactForAtom()).React.createElement('td', { className: 'nuclide-debugger-thread-list-item-current-indicator' }),
              (_reactForAtom2 || _reactForAtom()).React.createElement(
                'td',
                { className: 'nuclide-debugger-thread-list-item-id' },
                'ID'
              ),
              (_reactForAtom2 || _reactForAtom()).React.createElement(
                'td',
                { className: 'nuclide-debugger-thread-list-item-address' },
                'Address'
              ),
              (_reactForAtom2 || _reactForAtom()).React.createElement(
                'td',
                { className: 'nuclide-debugger-thread-list-item-stop-reason' },
                'Stop Reason'
              )
            )
          ),
