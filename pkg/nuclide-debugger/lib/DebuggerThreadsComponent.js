...
var _nuclideUiLibTable2;

function _nuclideUiLibTable() {
  return _nuclideUiLibTable2 = require('../../nuclide-ui/lib/Table');
}
...
var activeThreadIndicatorComponent = function activeThreadIndicatorComponent(props) {
  return (_reactForAtom2 || _reactForAtom()).React.createElement(
    ...
    props.cellData ? (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiLibIcon2 || _nuclideUiLibIcon()).Icon, { icon: 'arrow-right', title: 'Selected Thread' }) : null
  );
};
...
var DebuggerThreadsComponent = (function (_React$Component) {
  ...
  _createClass(DebuggerThreadsComponent, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiLibTable2 || _nuclideUiLibTable()).Table, {
        columns: columns,
