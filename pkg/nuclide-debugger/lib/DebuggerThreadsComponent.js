...
var activeThreadIndicatorComponent = function activeThreadIndicatorComponent(props) {
  return (_reactForAtom || _load_reactForAtom()).React.createElement(
    ...
    props.cellData ? (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiIcon || _load_nuclideUiIcon()).Icon, { icon: 'arrow-right', title: 'Selected Thread' }) : null
  );
};
...
var DebuggerThreadsComponent = (function (_React$Component) {
  ...
  _createClass(DebuggerThreadsComponent, [{
    ...
    value: function render() {
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiTable || _load_nuclideUiTable()).Table, {
        columns: columns,
