...
class NewDebuggerView extends _reactForAtom.React.Component {
  ...
  constructor(props) {
    ...
    this._localsComponentWrapped = (0, (_bindObservableAsProps || _load_bindObservableAsProps()).bindObservableAsProps)(props.model.getLocalsStore().getLocals().map(locals => ({ locals })), (_LocalsComponent || _load_LocalsComponent()).LocalsComponent);
