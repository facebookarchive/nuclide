    ...
    value: function _handlePayload(payload) {
      switch (payload.actionType) {
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.CLEAR_INTERFACE:
          ...
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_THREADS:
          this._updateThreads(payload.data.threadData);
          this._emitter.emit('change');
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_THREAD:
          this._updateThread(payload.data.thread);
          this._emitter.emit('change');
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.UPDATE_STOP_THREAD:
          this._updateStopThread(payload.data.id);
          this._emitter.emit('change');
          break;
        case (_DebuggerDispatcher2 || _DebuggerDispatcher()).ActionTypes.NOTIFY_THREAD_SWITCH:
