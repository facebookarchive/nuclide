...
var ThreadStore = (function () {
  ...
  _createClass(ThreadStore, [{
    ...
    value: _asyncToGenerator(function* (sourceURL, lineNumber, message) {
      ...
      var notifyThreadSwitches = yield (0, (_commonsNodePassesGK || _load_commonsNodePassesGK()).default)(GK_THREAD_SWITCH_UI, GK_TIMEOUT);
    ...
    value: function _createAlertComponentClass(message) {
      return function () {
        return (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiIcon || _load_nuclideUiIcon()).Icon, { icon: 'alert' }),
          message
        );
      };
    }
