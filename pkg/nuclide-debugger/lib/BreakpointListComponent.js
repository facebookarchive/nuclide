  ...
  _createClass(BreakpointListComponent, [{
    ...
    value: function render() {
      ...
      var renderedBreakpoints = breakpoints.map(function (breakpoint, i) {
        ...
        var label = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.basename(path) + ':' + (line + 1);
        return (_reactForAtom2 || _reactForAtom()).React.createElement(
          'div',
          { className: 'nuclide-debugger-breakpoint', key: i },
          resolved ? (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiCheckbox2 || _nuclideUiCheckbox()).Checkbox, {
            label: label,
            checked: enabled,
