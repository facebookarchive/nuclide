...
var _libAnalyticsHelper;

function _load_libAnalyticsHelper() {
  return _libAnalyticsHelper = require('../../lib/AnalyticsHelper');
}
...
var ipcRenderer = (_electron || _load_electron()).default.ipcRenderer;

(0, (_assert || _load_assert()).default)(ipcRenderer != null);
...
var NuclideBridge = (function () {
  function NuclideBridge() {
    ...
    this._unresolvedBreakpoints = new (_commonsNodeCollection || _load_commonsNodeCollection()).MultiMap();
    ...
    (_libWebInspector || _load_libWebInspector()).default.targetManager.addModelListener((_libWebInspector || _load_libWebInspector()).default.DebuggerModel, (_libWebInspector || _load_libWebInspector()).default.DebuggerModel.Events.CallFrameSelected, this._handleCallFrameSelected, this);
    ...
    (_libWebInspector || _load_libWebInspector()).default.targetManager.addModelListener((_libWebInspector || _load_libWebInspector()).default.DebuggerModel, (_libWebInspector || _load_libWebInspector()).default.DebuggerModel.Events.DebuggerResumed, this._handleDebuggerResumed, this);

    (_libWebInspector || _load_libWebInspector()).default.targetManager.addModelListener((_libWebInspector || _load_libWebInspector()).default.DebuggerModel, (_libWebInspector || _load_libWebInspector()).default.DebuggerModel.Events.DebuggerPaused, this._handleDebuggerPaused, this);

    (_libWebInspector || _load_libWebInspector()).default.targetManager.addModelListener((_libWebInspector || _load_libWebInspector()).default.DebuggerModel, (_libWebInspector || _load_libWebInspector()).default.DebuggerModel.Events.ThreadsUpdateIPC, this._handleThreadsUpdated, this);

    (_libWebInspector || _load_libWebInspector()).default.targetManager.addModelListener((_libWebInspector || _load_libWebInspector()).default.DebuggerModel, (_libWebInspector || _load_libWebInspector()).default.DebuggerModel.Events.ThreadUpdateIPC, this._handleThreadUpdated, this);

    (_libWebInspector || _load_libWebInspector()).default.workspace.addEventListener((_libWebInspector || _load_libWebInspector()).default.Workspace.Events.UISourceCodeAdded, this._handleUISourceCodeAdded, this);

    (_libWebInspector || _load_libWebInspector()).default.notifications.addEventListener((_libWebInspector || _load_libWebInspector()).default.UserMetrics.UserAction, function (event) {
      if (event.data.action === 'openSourceLink') {
        this._handleOpenSourceLocation(event);
      }
    }, this);

    (_libWebInspector || _load_libWebInspector()).default.breakpointManager.addEventListener((_libWebInspector || _load_libWebInspector()).default.BreakpointManager.Events.BreakpointAdded, this._handleBreakpointAdded, this);

    (_libWebInspector || _load_libWebInspector()).default.breakpointManager.addEventListener((_libWebInspector || _load_libWebInspector()).default.BreakpointManager.Events.BreakpointRemoved, this._handleBreakpointRemoved, this);
  ...
  _createClass(NuclideBridge, [{
    ...
    value: function _customizeWebInspector() {
      // $FlowFixMe.
      (_libWebInspector || _load_libWebInspector()).default.ObjectPropertyTreeElement._populate = function (treeElement, value, skipProto, emptyPlaceholder) {
        /**
        ...
        function callback(properties, internalProperties) {
          ...
          // $FlowFixMe.
          (_libWebInspector || _load_libWebInspector()).default.ObjectPropertyTreeElement.populateWithProperties(treeElement, properties, internalProperties, skipProto, value, emptyPlaceholder);
        }
        // $FlowFixMe.
        (_libWebInspector || _load_libWebInspector()).default.RemoteObject.loadFromObjectPerProto(value, callback);
      };

      // $FlowFixMe.
      (_libWebInspector || _load_libWebInspector()).default.ObjectPropertiesSection.prototype.update = function () {
        /**
         * @param {?Array.<!WebInspector.RemoteObjectProperty>} properties
         * @param {?Array.<!WebInspector.RemoteObjectProperty>} internalProperties
        ...
        // $FlowFixMe.
        (_libWebInspector || _load_libWebInspector()).default.RemoteObject.loadFromObject(this.object, Boolean(this.ignoreHasOwnProperty), callback.bind(this));
      };
    }
  }, {
    ...
    value: function _handleCallFrameSelected(event) {
      ...
      var uiLocation = (_libWebInspector || _load_libWebInspector()).default.debuggerWorkspaceBinding.rawLocationToUILocation(frame.location());
    ...
    value: function selectThread(threadId) {
      ...
      var target = (_libWebInspector || _load_libWebInspector()).default.targetManager.mainTarget();
      if (target != null) {
    ...
    value: function _convertFramesToIPCFrames(callFrames) {
      return callFrames.map(function (callFrame) {
        ...
        var functionName = (_libWebInspector || _load_libWebInspector()).default.beautifyFunctionName(callFrame.functionName);
        return {
          name: functionName,
          location: {
    ...
    value: function _setPauseOnException(pauseOnExceptionEnabled) {
      (_libWebInspector || _load_libWebInspector()).default.settings.pauseOnExceptionEnabled.set(pauseOnExceptionEnabled);
    }
  }, {
    key: '_setPauseOnCaughtException',
    value: function _setPauseOnCaughtException(pauseOnCaughtExceptionEnabled) {
      (_libWebInspector || _load_libWebInspector()).default.settings.pauseOnCaughtException.set(pauseOnCaughtExceptionEnabled);
    }
  }, {
    key: '_setSingleThreadStepping',
    value: function _setSingleThreadStepping(singleThreadStepping) {
      (_libWebInspector || _load_libWebInspector()).default.settings.singleThreadStepping.set(singleThreadStepping);
    }
  }, {
    ...
    value: function _triggerDebuggerAction(actionId) {
      switch (actionId) {
        ...
        case 'debugger.run-snippet':
          (_libWebInspector || _load_libWebInspector()).default.actionRegistry.execute(actionId);
          break;
        default:
    ...
    value: function _handleDebuggerPaused(event) {
      (0, (_libAnalyticsHelper || _load_libAnalyticsHelper()).endTimerTracking)();
    ...
    value: function _generateThreadSwitchNotification(message, location) {
      if (message != null && location != null) {
        var uiLocation = (_libWebInspector || _load_libWebInspector()).default.debuggerWorkspaceBinding.rawLocationToUILocation(location);
        return {
          sourceURL: uiLocation.uiSourceCode.uri(),
          lineNumber: uiLocation.lineNumber,
          message: message
    ...
    value: function _handleLoaderBreakpoint() {
      ...
      process.nextTick(function () {
        var targetManager = (_libWebInspector || _load_libWebInspector()).default != null ? (_libWebInspector || _load_libWebInspector()).default.targetManager : null;
    ...
    value: function _hasParsableExtension(sourceUrl) {
      return PARSABLE_EXTENSIONS.some(function (extension) {
        return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.extname(sourceUrl) === extension;
      });
    }
  }, {
    key: '_isFileWithNoExtension',
    value: function _isFileWithNoExtension(sourceUrl) {
      return !(_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.endsWithSeparator(sourceUrl) && (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.extname(sourceUrl) === '';
    }
  }, {
    ...
    value: function _parseBreakpointSourceIfNeeded(breakpoint) {
      ...
      if (this._hasParsableExtension(sourceUrl) || this._isFileWithNoExtension(sourceUrl)) {
        var source = (_libWebInspector || _load_libWebInspector()).default.workspace.uiSourceCodeForOriginURL(sourceUrl);
        if (source != null) {
          return;
        }
        var target = (_libWebInspector || _load_libWebInspector()).default.targetManager.mainTarget();
    ...
    value: function _addBreakpoint(breakpoint) {
      ...
      (_libWebInspector || _load_libWebInspector()).default.breakpointManager.setBreakpoint(source, lineNumber, 0, // columnNumber
      condition || '', // Condition
      true);
      // enabled
      return true;
    ...
    value: function _updateBreakpoint(breakpoint) {
      ...
      var chromeBreakpoint = (_libWebInspector || _load_libWebInspector()).default.breakpointManager.findBreakpointOnLine(source, lineNumber);
      if (chromeBreakpoint == null) {
        return false;
      }
      (0, (_assert || _load_assert()).default)(condition != null);
      chromeBreakpoint.setCondition(condition);
      (0, (_assert || _load_assert()).default)(enabled != null);
    ...
    value: function _deleteBreakpoint(breakpoint) {
      var source = (_libWebInspector || _load_libWebInspector()).default.workspace.uiSourceCodeForOriginURL(breakpoint.sourceURL);
      if (source == null) {
        return false;
      }
      var chromeBreakpoint = (_libWebInspector || _load_libWebInspector()).default.breakpointManager.findBreakpointOnLine(source, breakpoint.lineNumber);
      if (chromeBreakpoint == null) {
        return false;
      }
    ...
    value: function _continue() {
      var target = (_libWebInspector || _load_libWebInspector()).default.targetManager.mainTarget();
      if (target) {
        (0, (_libAnalyticsHelper || _load_libAnalyticsHelper()).beginTimerTracking)('nuclide-debugger-atom:continue');
    ...
    value: function _stepOver() {
      var target = (_libWebInspector || _load_libWebInspector()).default.targetManager.mainTarget();
      if (target) {
        (0, (_libAnalyticsHelper || _load_libAnalyticsHelper()).beginTimerTracking)('nuclide-debugger-atom:stepOver');
    ...
    value: function _stepInto() {
      var target = (_libWebInspector || _load_libWebInspector()).default.targetManager.mainTarget();
      if (target) {
        (0, (_libAnalyticsHelper || _load_libAnalyticsHelper()).beginTimerTracking)('nuclide-debugger-atom:stepInto');
    ...
    value: function _stepOut() {
      var target = (_libWebInspector || _load_libWebInspector()).default.targetManager.mainTarget();
      if (target) {
        (0, (_libAnalyticsHelper || _load_libAnalyticsHelper()).beginTimerTracking)('nuclide-debugger-atom:stepOut');
    ...
    value: function _handleUISourceCodeAdded(event) {
      ...
      this._unresolvedBreakpoints.get(source.uri()).forEach(function (line) {
        (_libWebInspector || _load_libWebInspector()).default.breakpointManager.setBreakpoint(source, line, 0, '', true);
      });
