...
function createCallback(tag) {
  return _asyncToGenerator(function* () {
    var lineNumber = yield (0, (_utils || _load_utils()).getLineNumberForTag)(tag);
    (0, (_commonsAtomGoToLocation || _load_commonsAtomGoToLocation()).goToLocation)(tag.file, lineNumber, 0);
  });
}
    ...
    value: _asyncToGenerator(function* (textEditor, text, range) {
      ...
      try {
        var _ret = yield* (function* () {
          ...
          var tagsDir = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.dirname((yield ctagsService.getTagsPath()));
          return {
            v: {
              range: range,
              callback: tags.map(function (tag) {
                ...
                var relpath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.relative(tagsDir, file);
