...
var getCtagsService = _asyncToGenerator(function* (directory) {
  ...
  var path = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(directory.getPath(), 'file');
...
var QuickOpenHelpers = (function () {
  ...
  _createClass(QuickOpenHelpers, null, [{
    ...
    value: function getComponentForItem(uncastedItem) {
      ...
      var path = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.relative(item.dir, item.path);
      var kind = undefined;
      var icon = undefined;
      if (item.kind != null) {
    ...
    value: _asyncToGenerator(function* (query, directory) {
      ...
      var hack = undefined;
      if ((_commonsAtomFeatureConfig2 || _commonsAtomFeatureConfig()).default.get('nuclide-ctags.disableWithHack') !== false) {
        hack = yield (0, (_nuclideHackLibHackLanguage2 || _nuclideHackLibHackLanguage()).getHackServiceForProject)(directory);
      }
