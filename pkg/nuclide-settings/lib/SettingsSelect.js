...
var SettingsSelect = (function (_React$Component) {
  ...
  _createClass(SettingsSelect, [{
    ...
    value: function render() {
      ...
      var options = (_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.getSchema(keyPath);

      var optionElements = [];
      if (options.enum) {
        options.enum.forEach(function (option, i) {
          optionElements.push((_reactForAtom || _load_reactForAtom()).React.createElement(
            'option',
            { value: option, key: i },
            option
          ));
