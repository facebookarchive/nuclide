...
var _react = _interopRequireWildcard(require('react'));var _SettingsControl;
function _load_SettingsControl() {return _SettingsControl = _interopRequireDefault(require('nuclide-commons-ui/SettingsControl'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */class SettingsCategory extends _react.Component {render() {const children = Object.keys(this.props.packages).
    sort().
    map(pkgName => {
      ...
      const elements = settingsArray.map(settingName => {
        ...
        return (
          _react.createElement(ControlGroup, { key: settingName },
      ...
      return (
        _react.createElement(ControlGroup, { key: pkgName },
          _react.createElement('section', { className: 'sub-section' },

            _react.createElement('h2', { className: 'sub-section-heading' }, pkgData.title),
            _react.createElement('div', { className: 'sub-section-body' }, elements))));



    });
    return (
      _react.createElement('section', { className: 'section settings-panel' },

        _react.createElement('h1', { className: 'block section-heading icon icon-gear' },
...
function ControlGroup(props) {
  return (
    _react.createElement('div', { className: 'control-group' },
      _react.createElement('div', { className: 'controls' }, props.children)));
