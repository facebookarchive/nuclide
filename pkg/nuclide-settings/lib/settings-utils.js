...
function getConfigValueString(keyPath) {
  var value = (_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get(keyPath);
...
function getDefaultConfigValue(keyPath) {
  ...
  return (_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get(keyPath, params);
}
