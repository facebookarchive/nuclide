'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _memoize2;function _load_memoize() {return _memoize2 = _interopRequireDefault(require('lodash/memoize'));}var _log4js;
...
function _load_nuclideAnalytics() {return _nuclideAnalytics = require('../../nuclide-analytics');}var _nuclideBuckRpc;
...
'BUCK', 'TARGETS'];const LINK_TREE_SUFFIXES = Object.freeze({ python_binary: '#link-tree', python_unittest: '#binary,link-tree' });
const logger = (0, (_log4js || _load_log4js()).getLogger)('LinkTreeManager');

class LinkTreeManager {constructor() {var _this = this;this.
    getBuckRoot = (0, (_memoize2 || _load_memoize()).default)(src => {
      return (_nuclideBuckRpc || _load_nuclideBuckRpc()).getRootForPath(src);
    });this.

    getOwner = (0, (_memoize2 || _load_memoize()).default)((() => {var _ref = (0, _asyncToGenerator.default)(function* (src) {
    ...
    getDependents = (0, (_memoize2 || _load_memoize()).default)((() => {var _ref2 = (0, _asyncToGenerator.default)(function* (buckRoot, target)

      {
        try {
          ...
          const dependents = yield (_nuclideBuckRpc || _load_nuclideBuckRpc()).queryWithAttributes(
          buckRoot,
          ...
          return new Map(
          (0, (_collection || _load_collection()).objectEntries)(dependents).
          filter(function ([dep]) {return !nonToplevel.has(dep);}).
          map(function ([dep, attrs]) {
            const buckType = String(attrs['buck.type']);if (!

            LINK_TREE_SUFFIXES.hasOwnProperty(buckType)) {throw new Error(
      ...
      });return function (_x2, _x3) {return _ref2.apply(this, arguments);};})(), (buckRoot, target) => `${buckRoot}/${target}`);this.

    getLinkTreePaths = (0, (_memoize2 || _load_memoize()).default)((() => {var _ref3 = (0, _asyncToGenerator.default)(function* (src) {
        ...
        'python.link-tree', (0, _asyncToGenerator.default)(
        function* () {
