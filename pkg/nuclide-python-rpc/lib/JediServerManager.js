  ...
  _createClass(JediServerManager, [{
    ...
    value: function getTopLevelModulePath(src) {
      ...
      if (topLevelModulePathPromise == null) {
        ...
        topLevelModulePathPromise = (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.findFurthestFile('__init__.py', (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(src), true /* stopOnMissing */
        );
    ...
    value: _asyncToGenerator(function* (src, server) {
      ...
      yield service.add_paths([(_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(topLevelModulePath)]);
    })
  }, {
    key: 'reset',
