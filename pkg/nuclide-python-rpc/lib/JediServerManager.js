...
var JediServerManager = (function () {
  ...
  _createClass(JediServerManager, [{
    ...
    value: function getLinkTreePaths(src) {
      var linkTreePathsPromise = this._cachedLinkTreePaths.get(src);
    ...
    key: 'getTopLevelModulePath',
    value: function getTopLevelModulePath(src) {
      var topLevelModulePathPromise = this._cachedTopLevelModulePaths.get(src);
      ...
      if (topLevelModulePathPromise == null) {
        ...
        topLevelModulePathPromise = (_commonsNodeFsPromise || _load_commonsNodeFsPromise()).default.findFurthestFile('__init__.py', (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.dirname(src), true /* stopOnMissing */
        );
    ...
    value: _asyncToGenerator(function* (src, server) {
      var linkTreePaths = yield this.getLinkTreePaths(src);
    ...
    value: _asyncToGenerator(function* (src, server) {
      var topLevelModulePath = yield this.getTopLevelModulePath(src);
      ...
      yield service.add_paths([(_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.dirname(topLevelModulePath)]);
    })
  }, {
    key: 'reset',
