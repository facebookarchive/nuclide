...
shortNameForAuthor = shortNameForAuthor; /**
...
const HG_EMAIL_REGEX = /\b([A-Za-z0-9._%+-]+)@[A-Za-z0-9.-]+\b/; /**
                                                                  ...
                                                                  */function shortNameForAuthor(blameName) {const match = blameName.match(HG_EMAIL_REGEX); // Index 0 will be the whole email. Index 1 is the capture group.
