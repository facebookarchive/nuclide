...
var VcsLog = (function (_React$Component) {
  ...
  function VcsLog(props) {
    ...
    for (var file of props.files) {
      var projectPath = _nuclideAtomHelpers.projects.getAtomProjectRelativePath(file);
      if (projectPath != null) {
    ...
    value: function render() {
      ...
      if (logEntries != null) {
        var _ret = (function () {
          ...
          var rows = logEntries.map(function (logEntry, index) {
            ...
            if (showDifferentialRevision) {
              (function () {
                ...
                if (url != null) {
                  ...
                  onClick = function () {
                    return _shell2.default.openExternal(url);
                  };
                } else {
                  revision = null;
                  onClick = null;
            ...
            return _reactForAtom.React.createElement(
              ...
              _reactForAtom.React.createElement(
                ...
                (0, _util.shortNameForAuthor)(logEntry.user)
              ),
              _reactForAtom.React.createElement(
                'td',
          ...
          return {
            v: _reactForAtom.React.createElement(
              'div',
