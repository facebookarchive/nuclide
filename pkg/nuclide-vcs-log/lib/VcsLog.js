...
var VcsLog = (function (_React$Component) {
  ...
  function VcsLog(props) {
    ...
    for (var file of props.files) {
      var projectPath = (0, (_commonsAtomProjects || _load_commonsAtomProjects()).getAtomProjectRelativePath)(file);
      if (projectPath != null) {
    ...
    value: function render() {
      ...
      if (logEntries != null) {
        var _ret = (function () {
            ...
            if (showDifferentialRevision) {
              (function () {
                ...
                if (url != null) {
                  ...
                  onClick = function () {
                    return (_electron || _load_electron()).shell.openExternal(url);
                  };
                } else {
                  revision = null;
                  onClick = null;
                }
                differentialCell = (_reactForAtom || _load_reactForAtom()).React.createElement(
                  'td',
          ...
          return {
            v: (_reactForAtom || _load_reactForAtom()).React.createElement(
              'div',
                ...
                (_reactForAtom || _load_reactForAtom()).React.createElement(
                  ...
                  (_reactForAtom || _load_reactForAtom()).React.createElement(
                    ...
                    (_reactForAtom || _load_reactForAtom()).React.createElement(
                      ...
                      showDifferentialRevision ? (_reactForAtom || _load_reactForAtom()).React.createElement(
                        'th',
                        { className: 'nuclide-vcs-log-header-cell' },
                        'Revision'
                      ) : null,
        ...
        return (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement(
            ...
            (_reactForAtom || _load_reactForAtom()).React.createElement('div', { className: 'loading-spinner-large inline-block' })
          )
        );
      }
    }
