'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ShowDiff = undefined;
...
function _load_AtomTextEditor() {return _AtomTextEditor = require('../../../modules/nuclide-commons-ui/AtomTextEditor');}var _renderReactRoot;
function _load_renderReactRoot() {return _renderReactRoot = require('../../../modules/nuclide-commons-ui/renderReactRoot');}var _computeDiff;
function _load_computeDiff() {return _computeDiff = require('../../commons-node/computeDiff');}var _DiffViewEditor;
function _load_DiffViewEditor() {return _DiffViewEditor = _interopRequireDefault(require('../../commons-atom/DiffViewEditor'));}var _LoadingSpinner;
...
class ShowDiff extends _react.Component {
  ...
  render() {
    return (
      _react.createElement('div', { className: NUCLIDE_VCS_LOG_DIFF_CONTAINER_CLASSNAME },
  ...
  _setupEditors() {
    ...
    this._oldDiffViewEditor = new (_DiffViewEditor || _load_DiffViewEditor()).default(
    atom.views.getView(this._oldTextEditor));

    this._newDiffViewEditor = new (_DiffViewEditor || _load_DiffViewEditor()).default(
  ...
  setupLoadingIndicator(editorElement) {
    ...
    const loadingElement = (0, (_renderReactRoot || _load_renderReactRoot()).renderReactRoot)(
    _react.createElement((_LoadingSpinner || _load_LoadingSpinner()).LoadingSpinner, { delay: 50, size: (_LoadingSpinner || _load_LoadingSpinner()).LoadingSpinnerSizes.LARGE }));
