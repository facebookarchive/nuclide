...
var _nuclideUiLibCustomPaneItem2;

function _nuclideUiLibCustomPaneItem() {
  return _nuclideUiLibCustomPaneItem2 = require('../../nuclide-ui/lib/CustomPaneItem');
}

var _VcsLog2;

function _VcsLog() {
  return _VcsLog2 = _interopRequireDefault(require('./VcsLog'));
}
...
var VcsLogPaneItem = (function (_CustomPaneItem) {
  ...
  _createClass(VcsLogPaneItem, [{
    ...
    value: function __renderPaneItem(options) {
      return (_reactForAtom2 || _reactForAtom()).React.createElement((_VcsLog2 || _VcsLog()).default, options.initialProps);
    }
  }, {
...
})((_nuclideUiLibCustomPaneItem2 || _nuclideUiLibCustomPaneItem()).CustomPaneItem);
