...
var _nuclideUiCustomPaneItem;

function _load_nuclideUiCustomPaneItem() {
  return _nuclideUiCustomPaneItem = require('../../nuclide-ui/CustomPaneItem');
}
...
var VcsLogPaneItem = (function (_CustomPaneItem) {
  ...
  _createClass(VcsLogPaneItem, [{
    ...
    value: function __renderPaneItem(options) {
      return (_reactForAtom || _load_reactForAtom()).React.createElement((_VcsLog || _load_VcsLog()).default, options.initialProps);
    }
  }, {
...
})((_nuclideUiCustomPaneItem || _load_nuclideUiCustomPaneItem()).CustomPaneItem);
