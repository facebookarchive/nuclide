...
function _load_WorkingSet() {
  return _WorkingSet = require('../lib/WorkingSet');
}

describe('WorkingSet', () => {
  describe('- Empty set', () => {
    it('contains any files', () => {
      const empty = new (_WorkingSet || _load_WorkingSet()).WorkingSet();
  ...
  describe('- Local root set', () => {
    it('contains every local file', () => {
      const root = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['/']);
  ...
  describe('- Remote root set', () => {
    it('contains every remote file', () => {
      const root = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['nuclide://aaa.bbb/']);
  ...
  it('detects properly files and dirs included in the set', () => {
    const ws = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['/aaa/bbb', '/aaa/ccc', '/ddd']);
  ...
  it('shares across similar local and remote paths', () => {
    const local = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['/aaa/bbb', '/aaa/ccc']);
    ...
    expect(local.containsFile('nuclide://some.host/aaa/bbb/file.test')).toBe(true);
    expect(local.containsFile('nuclide://some.host/aaa/ccc/file.test')).toBe(true);
  ...
  it('shares across similar different hosts', () => {
    const remote = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['nuclide://some.host/aaa/bbb', 'nuclide://some.host/aaa/ccc']);
    ...
    expect(remote.containsFile('nuclide://other.host/aaa/bbb/file.test')).toBe(true);
    expect(remote.containsFile('nuclide://other.host/aaa/ccc/file.test')).toBe(true);
  ...
  it('handles removal of one of the URIs', () => {
    const local = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['/aaa/bbb/ccc/ddd.txt', '/aaa/bbb/ccc/eee.txt']);
  ...
  it('tests by split path properly', () => {
    const mix = new (_WorkingSet || _load_WorkingSet()).WorkingSet(['/aaa/bbb', 'nuclide://some.host/ccc/ddd']);
