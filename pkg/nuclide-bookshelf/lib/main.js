...
var Activation = (function () {
  function Activation(state) {
    ...
    this._disposables = new (_atom || _load_atom()).CompositeDisposable(new (_atom || _load_atom()).Disposable(actions.complete.bind(actions)), new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(addedRepoSubscription), new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(paneStateChangeSubscription), new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(shortHeadChangeSubscription));
  }
