...
var WorkingSetNameAndSaveComponent = (function (_React$Component) {
  ...
  _createClass(WorkingSetNameAndSaveComponent, [{
    ...
    value: function render() {
      ...
      if (this.state.name === '') {
        setNameText = (_reactForAtom || _load_reactForAtom()).React.createElement(
          'atom-panel',
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        ...
        (_reactForAtom || _load_reactForAtom()).React.createElement(
          ...
          (_reactForAtom || _load_reactForAtom()).React.createElement('span', { className: 'icon icon-check nuclide-file-tree-toolbar-icon' })
        ),
        setNameText
      );
    }
