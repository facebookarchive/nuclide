...
var FileTree = (function (_React$Component) {
  ...
  _createClass(FileTree, [{
    ...
    value: function _measureHeights() {
      ...
      var node = (_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(measuredComponent);
    ...
    value: function _renderChildren() {
      ...
      if (childrenCount === 0) {
        return (_reactForAtom || _load_reactForAtom()).React.createElement((_EmptyComponent || _load_EmptyComponent()).EmptyComponent, null);
      }
      ...
      while (node != null && visibleChildren.length < amountToRender) {
        if (!node.isRoot && !chosenMeasured) {
          visibleChildren.push((_reactForAtom || _load_reactForAtom()).React.createElement((_FileTreeEntryComponent || _load_FileTreeEntryComponent()).FileTreeEntryComponent, { key: key, node: node, ref: 'measured' }));
          chosenMeasured = true;
        } else {
          visibleChildren.push((_reactForAtom || _load_reactForAtom()).React.createElement((_FileTreeEntryComponent || _load_FileTreeEntryComponent()).FileTreeEntryComponent, { key: key, node: node }));
        }
        node = node.findNext();
      ...
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        'div',
        null,
        (_reactForAtom || _load_reactForAtom()).React.createElement('div', { style: { height: topPlaceholderSize + 'px' } }),
        (_reactForAtom || _load_reactForAtom()).React.createElement(
          'ul',
          { className: 'list-tree has-collapsable-children' },
          visibleChildren
        ),
        (_reactForAtom || _load_reactForAtom()).React.createElement('div', { style: { height: bottomPlaceholderSize + 'px' } })
      );
    }
  }]);
