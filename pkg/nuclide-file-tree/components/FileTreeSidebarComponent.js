...
let FileTreeSidebarComponent = class FileTreeSidebarComponent extends _reactForAtom.React.Component {
  ...
  constructor(props) {
    ...
    this._showOpenConfigValues = (_featureConfig || _load_featureConfig()).default.observeAsStream(SHOW_OPEN_FILE_CONFIG_KEY).cache(1);
    this._showUncommittedConfigValue = (_featureConfig || _load_featureConfig()).default.observeAsStream(SHOW_UNCOMMITTED_CHANGES_CONFIG_KEY).cache(1);
