...
var FileTreeSidebarComponent = (function (_React$Component) {
  ...
  _createClass(FileTreeSidebarComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this._disposables.add(this._store.subscribe(this._processExternalUpdate), atom.project.onDidChangePaths(this._processExternalUpdate), new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default((0, (_commonsNodeStream2 || _commonsNodeStream()).toggle)(observeAllModifiedStatusChanges(), this._showOpenConfigValues).subscribe(function () {
    ...
    value: function _monitorActiveUri() {
      ...
      return new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default((0, (_commonsNodeStream2 || _commonsNodeStream()).toggle)(activeEditors, this._showOpenConfigValues).subscribe(function (editor) {
