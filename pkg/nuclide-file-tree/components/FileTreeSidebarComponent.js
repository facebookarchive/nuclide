...
var FileTreeSidebarComponent = (function (_React$Component) {
  ...
  _createClass(FileTreeSidebarComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this._disposables.add(this._store.subscribe(this._processExternalUpdate), atom.project.onDidChangePaths(this._processExternalUpdate), new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default((0, (_commonsNodeObservable || _load_commonsNodeObservable()).toggle)(observeAllModifiedStatusChanges(), this._showOpenConfigValues).subscribe(function () {
        return _this._setModifiedUris();
      })), this._monitorActiveUri(), new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(this._showOpenConfigValues.subscribe(function (showOpenFiles) {
