...
var FileDialogComponent = (function (_React$Component) {
  ...
  _createClass(FileDialogComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this._subscriptions.add(atom.commands.add((_reactForAtom || _load_reactForAtom()).ReactDOM.findDOMNode(input), {
      ...
      if (this.props.selectBasename && path != null) {
        var _default$parsePath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parsePath(path);
    ...
    value: function render() {
      ...
      for (var _name3 in this.props.additionalOptions) {
        ...
        var checkbox = (_reactForAtom || _load_reactForAtom()).React.createElement((_nuclideUiCheckbox || _load_nuclideUiCheckbox()).Checkbox, {
          key: _name3,
          checked: checked,
