  ...
  _createClass(FileTreeToolbarComponent, [{
    ...
    value: function _toggleWorkingSetEditMode() {
      if (this._store.isEditingWorkingSet()) {
        ...
        this._startEditingWorkingSet(new (_nuclideWorkingSetsCommon2 || _nuclideWorkingSetsCommon()).WorkingSet());
      }
    }
  }, {
    key: '_saveWorkingSet',
    ...
    value: function _editWorkingSet(name, uris) {
      ...
      this._startEditingWorkingSet(new (_nuclideWorkingSetsCommon2 || _nuclideWorkingSetsCommon()).WorkingSet(uris));
    }
  }, {
