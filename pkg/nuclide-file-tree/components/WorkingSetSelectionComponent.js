...
class WorkingSetSelectionComponent extends _react.Component {
  ...
  render() {
    ...
    const activeProjectSection = applicableDefinitionRows.length === 0 ? null : _react.createElement(
      'ol',
      { className: 'list-group mark-active' },
      activeProjectDefinitionRows
    );

    const applicableDefinitionsSection = _react.createElement(
      'ol',
      { className: 'list-group mark-active', style: { maxHeight: '80vh' } },
