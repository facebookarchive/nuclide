  ...
  _createClass(FileTreeActions, [{
    ...
    value: function setCwd(rootKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_CWD,
        rootKey: rootKey
      });
    }
  }, {
    ...
    value: function setRootKeys(rootKeys) {
      ...
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_ROOT_KEYS,
        rootKeys: rootKeys
      });
    ...
    value: function clearFilter() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.CLEAR_FILTER
      });
    }
  }, {
    key: 'expandNode',
    value: function expandNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.EXPAND_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function expandNodeDeep(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.EXPAND_NODE_DEEP,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function deleteSelectedNodes() {
      this._dispatcher.dispatch({ actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.DELETE_SELECTED_NODES });
    }
    ...
    value: function ensureChildNode(nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.ENSURE_CHILD_NODE,
        nodeKey: nodeKey
      });
    }
  }, {
    ...
    value: function collapseNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.COLLAPSE_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function collapseNodeDeep(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.COLLAPSE_NODE_DEEP,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function setExcludeVcsIgnoredPaths(excludeVcsIgnoredPaths) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_EXCLUDE_VCS_IGNORED_PATHS,
    ...
    value: function setHideIgnoredNames(hideIgnoredNames) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_HIDE_IGNORED_NAMES,
    ...
    value: function setIgnoredNames(ignoredNames) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_IGNORED_NAMES,
    ...
    value: function setTrackedNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_TRACKED_NODE,
        nodeKey: nodeKey,
        rootKey: rootKey
      });
    }
    ...
    value: function clearTrackedNode() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.CLEAR_TRACKED_NODE
      });
    }
  }, {
    key: 'moveToNode',
    value: function moveToNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_TO_NODE,
        nodeKey: nodeKey,
        rootKey: rootKey
      });
    }
    ...
    value: function setUsePreviewTabs(usePreviewTabs) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_USE_PREVIEW_TABS,
    ...
    value: function setUsePrefixNav(usePrefixNav) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_USE_PREFIX_NAV,
    ...
    value: function confirmNode(rootKey, nodeKey) {
      ...
      if (node.isContainer) {
        ...
        atom.workspace.open((_FileTreeHelpers2 || _FileTreeHelpers()).default.keyToPath(nodeKey), {
          activatePane: true,
          searchAllPanes: true,
          pending: true
        });
    ...
    value: function setVcsStatuses(rootKey, vcsStatuses) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_VCS_STATUSES,
        rootKey: rootKey,
    ...
    value: function invalidateRemovedFolder() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.INVALIDATE_REMOVED_FOLDER
      });
    }
    ...
    value: _asyncToGenerator(function* (rootDirectories) {
      ...
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_REPOSITORIES,
    ...
    value: function updateWorkingSet(workingSet) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_WORKING_SET,
    ...
    value: function updateOpenFilesWorkingSet(openFilesWorkingSet) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_OPEN_FILES_WORKING_SET,
    ...
    value: function updateWorkingSetsStore(workingSetsStore) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_WORKING_SETS_STORE,
    ...
    value: function startEditingWorkingSet(editedWorkingSet) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.START_EDITING_WORKING_SET,
    ...
    value: function finishEditingWorkingSet() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.FINISH_EDITING_WORKING_SET
      });
    }
  }, {
    key: 'checkNode',
    value: function checkNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.CHECK_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function uncheckNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.UNCHECK_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function setDragHoveredNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_DRAG_HOVERED_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function setSelectedNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_SELECTED_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function setFocusedNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_FOCUSED_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function addSelectedNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.ADD_SELECTED_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function unselectNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.UNSELECT_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function rangeSelectToNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.RANGE_SELECT_TO_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function rangeSelectUp() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.RANGE_SELECT_UP
      });
    }
  }, {
    key: 'rangeSelectDown',
    value: function rangeSelectDown() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.RANGE_SELECT_DOWN
      });
    }
  }, {
    key: 'unhoverNode',
    value: function unhoverNode(rootKey, nodeKey) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.UNHOVER_NODE,
        rootKey: rootKey,
        nodeKey: nodeKey
      });
    }
    ...
    value: function moveSelectionUp() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_UP
      });
    }
  }, {
    ...
    value: function moveSelectionDown() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_DOWN
      });
    }
  }, {
    ...
    value: function moveSelectionToTop() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_TO_TOP
      });
    }
  }, {
    ...
    value: function moveSelectionToBottom() {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_TO_BOTTOM
      });
    }
  }, {
    ...
    value: function setOpenFilesExpanded(openFilesExpanded) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_OPEN_FILES_EXPANDED,
    ...
    value: function setUncommittedChangesExpanded(uncommittedChangesExpanded) {
      this._dispatcher.dispatch({
        actionType: (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_UNCOMMITTED_CHANGES_EXPANDED,
    ...
    value: function _getCachedPathStatuses(repo) {
      ...
      if (asyncRepo.getType() === 'hg') {
        ...
        var StatusCodeNumber = (_nuclideHgRpc2 || _nuclideHgRpc()).hgConstants.StatusCodeNumber;
      ...
      for (var relativePath in relativeCodePaths) {
        var absolutePath = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.join(repoRoot, relativePath);
