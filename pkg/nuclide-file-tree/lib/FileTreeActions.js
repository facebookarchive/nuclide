...
var FileTreeActions = (function () {
  ...
  _createClass(FileTreeActions, [{
    ...
    value: _asyncToGenerator(function* (repo, rootKeysForRepository) {
      ...
      var debouncedChangeStatuses = (0, _nuclideCommons.debounce)(this._onDidChangeStatusesForRepository.bind(this, repo, rootKeysForRepository),
      /* wait */1000,
      /* immediate */false);
      ...
      var changeStatusesSubscriptions = new _atom.CompositeDisposable();
