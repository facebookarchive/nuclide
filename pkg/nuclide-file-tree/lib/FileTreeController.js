...
var FileTreeController = (function () {
  function FileTreeController(state) {
    ...
    this._subscriptions = new (_atom || _load_atom()).CompositeDisposable(new (_atom || _load_atom()).Disposable(function () {
    ...
    this._subscriptions.add(atom.commands.add((_FileTreeConstants || _load_FileTreeConstants()).EVENT_HANDLER_SELECTOR, _extends({
      ...
      'nuclide-file-tree:add-file': function nuclideFileTreeAddFile() {
        (_FileSystemActions || _load_FileSystemActions()).default.openAddFileDialog(_this._openAndRevealFilePath.bind(_this));
      },
      'nuclide-file-tree:add-folder': function nuclideFileTreeAddFolder() {
        (_FileSystemActions || _load_FileSystemActions()).default.openAddFolderDialog(_this._openAndRevealDirectoryPath.bind(_this));
      },
      ...
      'nuclide-file-tree:rename-selection': function nuclideFileTreeRenameSelection() {
        return (_FileSystemActions || _load_FileSystemActions()).default.openRenameDialog();
      },
      'nuclide-file-tree:duplicate-selection': function nuclideFileTreeDuplicateSelection() {
        (_FileSystemActions || _load_FileSystemActions()).default.openDuplicateDialog(_this._openAndRevealFilePath.bind(_this));
      },
  ...
  _createClass(FileTreeController, [{
    ...
    value: function setCwdApi(cwdApi) {
      ...
      if (cwdApi == null) {
        ...
        (0, (_assert || _load_assert()).default)(this._cwdApiSubscription == null);
        this._cwdApiSubscription = cwdApi.observeCwd(function (directory) {
          var path = directory == null ? null : directory.getPath();
          var rootKey = path && (_FileTreeHelpers || _load_FileTreeHelpers()).default.dirPathToKey(path);
    ...
    value: function _deleteSelection() {
      ...
      if (rootPaths.size === 0) {
        ...
        atom.confirm({
          ...
          detailedMessage: 'You are deleting:' + (_os || _load_os()).default.EOL + selectedPaths.join((_os || _load_os()).default.EOL),
          message: message
        });
      } else {
    ...
    value: function _searchInDirectory(event) {
      ...
      if (targetElement.classList.contains('nuclide-file-tree')) {
        ...
        var path = node.uri;
        if (!node.isContainer) {
          (0, (_assert || _load_assert()).default)(node.parent);
    ...
    value: function _showInFileManager() {
      ...
      (_electron || _load_electron()).shell.showItemInFolder(node.uri);
    }
  }, {
    key: '_copyFullPath',
