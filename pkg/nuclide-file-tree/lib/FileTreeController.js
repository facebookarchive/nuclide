...
function _load_goToLocation() {return _goToLocation = require('nuclide-commons-atom/go-to-location');}var _getElementFilePath;
function _load_getElementFilePath() {return _getElementFilePath = _interopRequireDefault(require('nuclide-commons-atom/getElementFilePath'));}var _removeProjectPath;
...
class FileTreeController {
  ...
  constructor(state) {
    ...
    atom.commands.add((_FileTreeConstants || _load_FileTreeConstants()).COMMANDS_SELECTOR, Object.assign({
      ...
      (_FileSystemActions || _load_FileSystemActions()).default.openPasteDialog(),
