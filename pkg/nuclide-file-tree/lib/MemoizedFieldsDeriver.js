'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.MemoizedFieldsDeriver = undefined;var _nuclideUri;
...
function _load_FileTreeHelpers() {return _FileTreeHelpers = _interopRequireDefault(require('./FileTreeHelpers'));}var _hgConstants;
function _load_hgConstants() {return _hgConstants = require('../../nuclide-hg-rpc/lib/hg-constants');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
                                                                                                                                                                                                     ...
                                                                                                                                                                                                     */ /**
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         * 
                                                                                                                                                                                                         * @format
                                                                                                                                                                                                         */class MemoizedFieldsDeriver {// These properties do not depend on the conf instance and can be calculated right away.
  ...
  constructor(uri, rootUri) {
    ...
    this._localPath = (_FileTreeHelpers || _load_FileTreeHelpers()).default.keyToPath(
    (_nuclideUri || _load_nuclideUri()).default.isRemote(uri) ? (_nuclideUri || _load_nuclideUri()).default.parse(uri).path : uri);
  ...
  store)
  {
    if (store.vcsStatuses !== conf.vcsStatuses) {
      ...
      store.vcsStatusCode =
      rootVcsStatuses.get(this._uri) || (_hgConstants || _load_hgConstants()).StatusCodeNumber.CLEAN;
    }
