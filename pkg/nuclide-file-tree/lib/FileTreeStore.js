...
var _FileTreeDispatcher4;

function _FileTreeDispatcher3() {
  return _FileTreeDispatcher4 = require('./FileTreeDispatcher');
}
...
var _FileTreeSelectionRange2;

function _FileTreeSelectionRange() {
  return _FileTreeSelectionRange2 = require('./FileTreeSelectionRange');
}
...
var DEFAULT_CONF = {
  ...
  reposByRoot: {},
  fileChanges: new (_immutable2 || _immutable()).default.Map()
};
  ...
  _createClass(FileTreeStore, [{
    ...
    value: function _onDispatch(payload) {
      switch (payload.actionType) {
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.DELETE_SELECTED_NODES:
          this._deleteSelectedNodes();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_CWD:
          this._setCwdKey(payload.rootKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_TRACKED_NODE:
          this._setTrackedNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.CLEAR_TRACKED_NODE:
          this._clearTrackedNode();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_TO_NODE:
          this._moveToNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_ROOT_KEYS:
          this._setRootKeys(payload.rootKeys);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.EXPAND_NODE:
          this._expandNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.EXPAND_NODE_DEEP:
          this._expandNodeDeep(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.COLLAPSE_NODE:
          this._collapseNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_EXCLUDE_VCS_IGNORED_PATHS:
          this._setExcludeVcsIgnoredPaths(payload.excludeVcsIgnoredPaths);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_USE_PREVIEW_TABS:
          this._setUsePreviewTabs(payload.usePreviewTabs);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_USE_PREFIX_NAV:
          this._setUsePrefixNav(payload.usePrefixNav);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.COLLAPSE_NODE_DEEP:
          this._collapseNodeDeep(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_HIDE_IGNORED_NAMES:
          this._setHideIgnoredNames(payload.hideIgnoredNames);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_IGNORED_NAMES:
          this._setIgnoredNames(payload.ignoredNames);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_VCS_STATUSES:
          this._setFileChanges(payload.rootKey, payload.vcsStatuses);
          this._setVcsStatuses(payload.rootKey, payload.vcsStatuses);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_REPOSITORIES:
          this._setRepositories(payload.repositories);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_WORKING_SET:
          this._setWorkingSet(payload.workingSet);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_OPEN_FILES_WORKING_SET:
          this._setOpenFilesWorkingSet(payload.openFilesWorkingSet);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_WORKING_SETS_STORE:
          this._setWorkingSetsStore(payload.workingSetsStore);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.START_EDITING_WORKING_SET:
          this._startEditingWorkingSet(payload.editedWorkingSet);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.FINISH_EDITING_WORKING_SET:
          this._finishEditingWorkingSet();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.CHECK_NODE:
          this._checkNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.UNCHECK_NODE:
          this._uncheckNode(payload.rootKey, payload.nodeKey);
          break;

        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_DRAG_HOVERED_NODE:
          this._setDragHoveredNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.UNHOVER_NODE:
          this._unhoverNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_SELECTED_NODE:
          this._setSelectedNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_FOCUSED_NODE:
          this._setFocusedNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.ADD_SELECTED_NODE:
          this._addSelectedNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.UNSELECT_NODE:
          this._unselectNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_UP:
          this._moveSelectionUp();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.RANGE_SELECT_TO_NODE:
          this._rangeSelectToNode(payload.rootKey, payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.RANGE_SELECT_UP:
          this._rangeSelectUp();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.RANGE_SELECT_DOWN:
          this._rangeSelectDown();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_DOWN:
          this._moveSelectionDown();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_TO_TOP:
          this._moveSelectionToTop();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.MOVE_SELECTION_TO_BOTTOM:
          this._moveSelectionToBottom();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.ENSURE_CHILD_NODE:
          this._ensureChildNode(payload.nodeKey);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.CLEAR_FILTER:
          this.clearFilter();
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_OPEN_FILES_EXPANDED:
          this._setOpenFilesExpanded(payload.openFilesExpanded);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.SET_UNCOMMITTED_CHANGES_EXPANDED:
          this._setUncommittedChangesExpanded(payload.uncommittedChangesExpanded);
          break;
        case (_FileTreeDispatcher4 || _FileTreeDispatcher3()).ActionTypes.INVALIDATE_REMOVED_FOLDER:
    ...
    */
    ...
    value: function _invalidateRemovedFolder() {
      ...
      atom.project.getPaths().forEach(function (projectPath) {
        var standardizedPath = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.ensureTrailingSeparator(projectPath);
        updatedFileChanges.set(standardizedPath, _this5._conf.fileChanges.get(standardizedPath));
      });
    ...
    value: function _setFileChanges(rootKey, vcsStatuses) {
      ...
      Object.keys(vcsStatuses).forEach(function (filePath) {
        ...
        fileChanges.set(filePath, (_nuclideHgGitBridgeLibConstants2 || _nuclideHgGitBridgeLibConstants()).HgStatusToFileChangeStatus[statusCode]);
      });
    ...
    */
    ...
    value: function _setSelectedNode(rootKey, nodeKey) {
      ...
      this._selectionRange = (_FileTreeSelectionRange2 || _FileTreeSelectionRange()).SelectionRange.ofSingleItem(new (_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeKey(rootKey, nodeKey));
    }
    ...
    value: function _refreshSelectionRange() {
      ...
      anchorNode = (_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeUtil.findSelectedNode(anchorNode);
      rangeNode = (_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeUtil.findSelectedNode(rangeNode);
      if (anchorNode == null || rangeNode == null) {
        return invalidate();
      }
      ...
      selectionRange = new (_FileTreeSelectionRange2 || _FileTreeSelectionRange()).SelectionRange((_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeKey.of(anchorNode), (_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeKey.of(rangeNode));
    ...
    value: function _rangeSelectToNode(rootKey, nodeKey) {
      ...
      this._setSelectionRange(selectionRange.withNewRange((_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeKey.of(nextRangeNode)));
    }
    ...
    value: function _rangeSelectMove(move) {
      ...
      if (isExpanding) {
        ...
        this._selectionRange = selectionRange.withNewRange((_FileTreeSelectionRange2 || _FileTreeSelectionRange()).RangeKey.of(nextNode));
    ...
    */
    ...
    value: function _ensureChildNode(nodeKey) {
      ...
      this._updateRoots(function (root) {
        ...
        var currentChild = new (_FileTreeNode2 || _FileTreeNode()).FileTreeNode({ uri: nodeKey, rootUri: rootUri }, _this16._conf);
    ...
    value: function _finishEditingWorkingSet() {
      this._updateConf(function (conf) {
        ...
        conf.editedWorkingSet = new (_nuclideWorkingSetsCommon2 || _nuclideWorkingSetsCommon()).WorkingSet();
      });
    }
  }, {
    key: '_checkNode',
