...
let FileTreeStore = exports.FileTreeStore = class FileTreeStore {
  ...
  */
  ...
  _setVcsStatuses(rootKey, vcsStatuses) {
    ...
    const enrichedVcsStatuses = _extends({}, vcsStatuses);
  ...
  */
  ...
  _rangeSelectToNode(rootKey, nodeKey) {
    ...
    const anchorIndex = data.anchorIndex;
    const rangeIndex = data.rangeIndex;
  ...
  _rangeSelectMove(move) {
    ...
    const rangeNode = data.rangeNode;
