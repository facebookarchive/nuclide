...
function _load_FileTreeHelpers2() {
...
class FileSystemActions {
  ...
  openAddFileDialogRelative(onDidConfirm) {
    ...
    if (rootNode) {
      const localPath = (_nuclideUri || _load_nuclideUri()).default.isRemote(dirPath) ? (_nuclideUri || _load_nuclideUri()).default.parse(dirPath).pathname : dirPath;

      return this._openAddFileDialogImpl(rootNode, (0, (_FileTreeHelpers2 || _load_FileTreeHelpers2()).keyToPath)(localPath), dirPath, onDidConfirm);
    }
  }
