...
var _MomoizedFieldsDeriver;

function _load_MomoizedFieldsDeriver() {
  return _MomoizedFieldsDeriver = require('./MomoizedFieldsDeriver');
}
...
var FileTreeNode = (function () {
  _createClass(FileTreeNode, null, [{
    ...
    */
    value: function childrenFromArray(children) {
      return new (_immutable || _load_immutable()).default.OrderedMap(children.map(function (child) {
  ...
  function FileTreeNode(options, conf) {
    ...
    this._deriver = _deriver || new (_MomoizedFieldsDeriver || _load_MomoizedFieldsDeriver()).MomoizedFieldsDeriver(options.uri, options.rootUri);
  ...
  _createClass(FileTreeNode, [{
    ...
    */
    ...
    value: function findDeepest(uri) {
      ...
      var childNamePath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.split((_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.relative(this.uri, uri));
    ...
    */
    ...
    key: 'calculateVisualIndex',
    value: function calculateVisualIndex() {
      var index = this.shouldBeShown ? 1 : 0;
      var prev = this.findPrevShownSibling();
      while (prev != null) {
