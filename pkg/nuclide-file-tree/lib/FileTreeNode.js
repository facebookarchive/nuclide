'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.FileTreeNode = undefined;var _MemoizedFieldsDeriver;
...
function _load_MemoizedFieldsDeriver() {return _MemoizedFieldsDeriver = require('./MemoizedFieldsDeriver');}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _immutable;
...
class FileTreeNode {
  ...
  _deriver = null)
  {
    ...
    this._deriver =
    _deriver || new (_MemoizedFieldsDeriver || _load_MemoizedFieldsDeriver()).MemoizedFieldsDeriver(options.uri, options.rootUri);
  ...
  _propsAreTheSame(props) {
    ...
    !(_immutable || _load_immutable()).is(this.children, props.children))
    {
      return false;
    }
  ...
  conf)
  {
    ...
    return new FileTreeNode(Object.assign({},
