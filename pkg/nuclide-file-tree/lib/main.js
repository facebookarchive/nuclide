...
class Activation {
  ...
  _fixContextMenuHighlight() {
    ...
    atom.contextMenu.showForEvent = function (event) {
      window.requestAnimationFrame(() => window.requestAnimationFrame(() => window.requestAnimationFrame(() => showForEvent.call(atom.contextMenu, event))));
    };
