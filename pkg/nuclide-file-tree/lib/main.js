...
function _load_createPackage() {return _createPackage = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/createPackage'));}var _event;
function _load_event() {return _event = require('../../../modules/nuclide-commons/event');}var _featureConfig;
function _load_featureConfig() {return _featureConfig = _interopRequireDefault(require('../../../modules/nuclide-commons-atom/feature-config'));}var _disablePackage;
function _load_disablePackage() {return _disablePackage = _interopRequireDefault(require('../../commons-atom/disablePackage'));}var _disablePackage2;function _load_disablePackage2() {return _disablePackage2 = require('../../commons-atom/disablePackage');}var _viewableFromReactElement;


function _load_viewableFromReactElement() {return _viewableFromReactElement = require('../../commons-atom/viewableFromReactElement');}var _observable;
function _load_observable() {return _observable = require('../../../modules/nuclide-commons/observable');}var _FileTreeSidebarComponent;
...
function _load_FileTreeSidebarComponent() {return _FileTreeSidebarComponent = _interopRequireDefault(require('../components/FileTreeSidebarComponent'));}var _FileTreeController;
function _load_FileTreeController() {return _FileTreeController = _interopRequireDefault(require('./FileTreeController'));}var _nuclideWorkingSetsCommon;
function _load_nuclideWorkingSetsCommon() {return _nuclideWorkingSetsCommon = require('../../nuclide-working-sets-common');}var _Constants;
function _load_Constants() {return _Constants = require('./Constants');}var _destroyItemWhere;
function _load_destroyItemWhere() {return _destroyItemWhere = require('../../../modules/nuclide-commons-atom/destroyItemWhere');}
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             */ /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 */const OPEN_FILES_UPDATE_DEBOUNCE_INTERVAL_MS = 150;const TERMINAL_CONTEXT_MENU_PRIORITY = 100;const DESERIALIZER_VERSION = atom.workspace.getLeftDock == null ? 1 : 2;class Activation {
  ...
  constructor(rawState) {
    ...
    (0, (_disablePackage || _load_disablePackage()).default)('tree-view', { reason: (_disablePackage2 || _load_disablePackage2()).DisabledReason.REIMPLEMENTED }),
    ...
    .delayWhen(() => (_observable || _load_observable()).macrotask).
    subscribe(item => {
      if (
      item != null &&
    ...
    this._fileTreeController = new (_FileTreeController || _load_FileTreeController()).default(
    ...
    (_featureConfig || _load_featureConfig()).default.observe(prefixKeyNavSetting, x =>
    this._setPrefixKeyNavSetting(x)),

    (_featureConfig || _load_featureConfig()).default.
    observeAsStream((_Constants || _load_Constants()).REVEAL_FILE_ON_SWITCH_SETTING).
    switchMap(shouldReveal => {
      return shouldReveal ?
    ...
    atom.config.observe(ignoredNamesSetting, x =>
    this._setIgnoredNames(x)),

    (_featureConfig || _load_featureConfig()).default.observe(hideIgnoredNamesSetting, x =>
    this._setHideIgnoredNames(x)),

    (_featureConfig || _load_featureConfig()).default.observe(hideVcsIgnoredPathsSetting, x =>
  ...
  _fixContextMenuHighlight() {
    ...
    atom.contextMenu.showForEvent = function (event) {
      const sub = (_observable || _load_observable()).nextAnimationFrame.
      repeat(3).
      last().
      subscribe(() => {
  ...
  consumeTerminal(terminal) {
    ...
    const terminalMenuSubscription = new (_UniversalDisposable || _load_UniversalDisposable()).default(
    contextMenu.addItemToShowInSection(
    {
      label: 'New Terminal Here',
      callback() {
        const node = contextMenu.getSingleSelectedNode();if (!(
        node != null)) {throw new Error('Invariant violation: "node != null"');}
        const cwd = node.isContainer ?
        node.uri :
        (_nuclideUri || _load_nuclideUri()).default.dirname(node.uri);
        terminal.open({ cwd });
      },
      shouldDisplay() {
  ...
  consumeCwdApi(cwdApi) {if (!
    this._fileTreeController) {throw new Error('Invariant violation: "this._fileTreeController"');}
    ...
    this._cwdApiSubscription = new (_UniversalDisposable || _load_UniversalDisposable()).default(() =>
  ...
  consumeWorkingSetsStore(workingSetsStore) {
    ...
    const rebuildSignals = _rxjsBundlesRxMinJs.Observable.merge(
    _rxjsBundlesRxMinJs.Observable.of(null), // None of the subscriptions below will trigger at startup.
    (0, (_event || _load_event()).observableFromSubscribeFunction)(
  ...
  _currentActiveFilePath() {
    const rawPathStream = (0, (_event || _load_event()).observableFromSubscribeFunction)(
  ...
  getContextMenuForFileTree() {if (!
    this._fileTreeController) {throw new Error('Invariant violation: "this._fileTreeController"');}
    return this._fileTreeController.getContextMenu();
  }

  getProjectSelectionManagerForFileTree() {if (!
    this._fileTreeController) {throw new Error('Invariant violation: "this._fileTreeController"');}
  ...
  _createView() {
    ...
    this._fileTreeComponent = (0, (_viewableFromReactElement || _load_viewableFromReactElement()).viewableFromReactElement)(
    _react.createElement((_FileTreeSidebarComponent || _load_FileTreeSidebarComponent()).default, null));
  ...
  _registerCommandAndOpener() {
    ...
    () => (0, (_destroyItemWhere || _load_destroyItemWhere()).destroyItemWhere)(item => item instanceof (_FileTreeSidebarComponent || _load_FileTreeSidebarComponent()).default),
    atom.commands.add('atom-workspace', 'tree-view:toggle', () => {
      atom.workspace.toggle((_Constants || _load_Constants()).WORKSPACE_VIEW_URI);
    }));

    (0, (_passesGK || _load_passesGK()).default)('nuclide_open_connect_menu_on_clean_startup').then(
    openConnectMenu => {
      if (!this._restored) {
        if (!openConnectMenu) {
