...
describe('FileTreeController', () => {
  ...
  describe('navigating with the keyboard', () => {
    const rootKey = nuclideUri.join(__dirname, '../spec/fixtures') + '/';
    const dir0key = nuclideUri.join(__dirname, '../spec/fixtures/dir0') + '/';
    const dir1Key = nuclideUri.join(__dirname, '../spec/fixtures/dir1') + '/';
    const fooTxtKey = nuclideUri.join(
      __dirname,
      '../spec/fixtures/dir1/foo.txt',
    );
    const dir2Key = nuclideUri.join(__dirname, '../spec/fixtures/dir2') + '/';
  ...
  describe('multi-selection and range-selection', () => {
    const rootKey = nuclideUri.join(__dirname, '../spec/fixtures') + '/';
    const dir0 = nuclideUri.join(__dirname, '../spec/fixtures/dir0') + '/';
    const bar = nuclideUri.join(__dirname, '../spec/fixtures/dir0/bar') + '/';
    const bar1 = nuclideUri.join(__dirname, '../spec/fixtures/dir0/bar/bar1');
    const bar2 = nuclideUri.join(__dirname, '../spec/fixtures/dir0/bar/bar2');
    const bar3 = nuclideUri.join(__dirname, '../spec/fixtures/dir0/bar/bar3');
    const foo = nuclideUri.join(__dirname, '../spec/fixtures/dir0/foo') + '/';
    const foo1 = nuclideUri.join(__dirname, '../spec/fixtures/dir0/foo/foo1');
    const foo2 = nuclideUri.join(__dirname, '../spec/fixtures/dir0/foo/foo2');
    const foo3 = nuclideUri.join(__dirname, '../spec/fixtures/dir0/foo/foo3');
    const afile = nuclideUri.join(__dirname, '../spec/fixtures/dir0/afile');
    const bfile = nuclideUri.join(__dirname, '../spec/fixtures/dir0/bfile');
    const zfile = nuclideUri.join(__dirname, '../spec/fixtures/dir0/zfile');
