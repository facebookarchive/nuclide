...
var StatusBarTile = (function (_React$Component) {
  ...
  _createClass(StatusBarTile, [{
    ...
    value: function componentDidMount() {
      ...
      var subscription = this.subscription = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subscription();
      subscription.add(this.props.results.subscribe(function (result) {
        return _this._consumeResult(result);
      }));
      subscription.add(this.props.isActive.subscribe(function (isActive) {
    ...
    value: function render() {
      return (_reactForAtom || _load_reactForAtom()).React.createElement((_StatusBarTileComponent || _load_StatusBarTileComponent()).StatusBarTileComponent, _extends({}, this.state, { onClick: this.props.onClick }));
    }
  }]);
