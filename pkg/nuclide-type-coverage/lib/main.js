...
var Activation = (function () {
  function Activation(state) {
    ...
    this._toggleEvents = new (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Subject();
    ...
    this._disposables.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(this._toggleEvents.subscribe(function () {
