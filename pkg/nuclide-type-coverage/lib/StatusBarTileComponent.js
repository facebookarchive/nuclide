  ...
  _createClass(StatusBarTileComponent, [{
    ...
    value: function render() {
      ...
      if (result != null) {
        ...
        var colorClasses = {};
        if ((_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get(COLOR_DISPLAY_SETTING)) {
          colorClasses = {
        ...
        var classes = (0, (_classnames || _load_classnames()).default)(_extends({
