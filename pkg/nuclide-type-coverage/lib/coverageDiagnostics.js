...
diagnosticProviderForResultStream = diagnosticProviderForResultStream;var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _observable;function _load_observable() {return _observable = require('../../../modules/nuclide-commons/observable');}function diagnosticProviderForResultStream(
results,
isEnabledStream)
{
...
/**
   ...
   */ /**
       ...
       * 
       * @format
       */function diagnosticsForResult(result) {if (result.kind !== 'result') {return null;}const value = result.result;if (value == null) {return null;
  }

  const editorPath = result.editor.getPath();if (!(
  editorPath != null)) {throw new Error('Invariant violation: "editorPath != null"');}
