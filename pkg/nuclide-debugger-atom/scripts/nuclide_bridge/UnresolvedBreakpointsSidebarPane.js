...
var _NuclideBridge = require('./NuclideBridge');

var _NuclideBridge2 = _interopRequireDefault(_NuclideBridge);
...
var UnresolvedBreakpointsComponent = _react2.default.createClass({
  displayName: 'UnresolvedBreakpointsComponent',

  _changeHandler: { dispose: function dispose() {} },

  componentWillMount: function componentWillMount() {
    this._changeHandler = _NuclideBridge2.default.onUnresolvedBreakpointsChanged(this._updateState);
  },
  ...
  render: function render() {
    ...
    var children = this.state.breakpoints.map(function (breakpoint) {
      var _url$parse = _url2.default.parse(breakpoint.url);

      var pathname = _url$parse.pathname;

      (0, _assert2.default)(pathname);
      var longRep = pathname + ':' + (breakpoint.line + 1);
      var shortRep = _path2.default.basename(pathname) + ':' + (breakpoint.line + 1);
    ...
    return _react2.default.createElement(
      ...
      this.state.breakpoints.length > 0 ? children : _react2.default.createElement(
        'div',
        { className: 'info' },
        'None'
      )
  ...
  _onBreakpointClick: function _onBreakpointClick(breakpoint) {
    _NuclideBridge2.default.sendOpenSourceLocation(breakpoint.url, breakpoint.line);
  },
  ...
  _getState: function _getState() {
    return {
      breakpoints: _NuclideBridge2.default.getUnresolvedBreakpointsList()
    };
  }
});
...
var UnresolvedBreakpointsSidebarPane = (function (_WebInspector$SidebarPane) {
  ...
  function UnresolvedBreakpointsSidebarPane() {
    ...
    _reactDom2.default.render(_react2.default.createElement(UnresolvedBreakpointsComponent, null), this.bodyElement);
