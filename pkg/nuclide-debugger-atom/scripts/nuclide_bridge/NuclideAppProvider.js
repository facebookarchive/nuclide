...
var _UnresolvedBreakpointsSidebarPane = require('./UnresolvedBreakpointsSidebarPane');

var _UnresolvedBreakpointsSidebarPane2 = _interopRequireDefault(_UnresolvedBreakpointsSidebarPane);
  ...
  _createClass(NuclideApp, [{
    ...
    value: function presentUI() {
      ...
      WebInspector.inspectorView.panel('sources').then(function (panel) {
        ...
        sourcesPanel.sidebarPanes.unresolvedBreakpoints = new _UnresolvedBreakpointsSidebarPane2.default();
        // Force redraw
