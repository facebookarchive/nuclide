...
var _libMultimap = require('../../lib/Multimap');

var _libMultimap2 = _interopRequireDefault(_libMultimap);
...
var NuclideBridge = (function () {
  function NuclideBridge() {
    ...
    this._unresolvedBreakpoints = new _libMultimap2.default();
    this._emitter = new _Emitter2.default();
    this._debuggerPausedCount = 0;
    this._suppressBreakpointNotification = false;

    _ipc2.default.on('command', this._handleIpcCommand.bind(this));
  ...
  _createClass(NuclideBridge, [{
    ...
    value: function _handleWindowLoad() {
      _ipc2.default.sendToHost('notification', 'ready');
    }
  }, {
    ...
    value: function _handleCallFrameSelected(event) {
      ...
      _ipc2.default.sendToHost('notification', 'CallFrameSelected', {
    ...
    value: function sendOpenSourceLocation(sourceURL, line) {
      _ipc2.default.sendToHost('notification', 'OpenSourceLocation', {
        sourceURL: sourceURL,
        lineNumber: line
      });
    }
    ...
    value: function _evaluateOnSelectedCallFrame(expression) {
      ...
      function (remoteObject, wasThrown, error) {
        _ipc2.default.sendToHost('notification', 'ExpressionEvaluationResponse', {
    ...
    value: function _handleDebuggerPaused(event) {
      ...
      _ipc2.default.sendToHost('notification', 'DebuggerPaused', {});
    ...
    value: function _handleLoaderBreakpoint() {
      ...
      _ipc2.default.sendToHost('notification', 'LoaderBreakpointResumed', {});
    }
  }, {
    key: '_handleDebuggerResumed',
    value: function _handleDebuggerResumed(event) {
      _ipc2.default.sendToHost('notification', 'DebuggerResumed', {});
    }
  }, {
    key: '_handleClearInterface',
    value: function _handleClearInterface(event) {
      _ipc2.default.sendToHost('notification', 'ClearInterface', {});
    }
  }, {
    ...
    value: function _sendBreakpointNotification(location, type) {
      if (!this._suppressBreakpointNotification) {
        _ipc2.default.sendToHost('notification', type, {
    ...
    value: function _syncBreakpoints() {
      ...
      try {
        (function () {
          ...
          _this2._unresolvedBreakpoints = new _libMultimap2.default();
