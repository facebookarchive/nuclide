...
var Bridge = (function () {
  ...
  _createClass(Bridge, [{
    ...
    value: function _evaluateOnSelectedCallFrame(expression, objectGroup) {
      return this._cachedSendCommand(this._expressionsInFlight, 'evaluateOnSelectedCallFrame', expression, objectGroup);
    }
  }, {
    ...
    key: '_syncPauseOnExceptionState',
    value: function _syncPauseOnExceptionState() {
      ...
      if (webview && !this._suppressBreakpointSync) {
        (function () {
          ...
          _this2._debuggerModel.getBreakpointStore().getAllBreakpoints().forEach(function (line, key) {
            results.push({
              sourceURL: (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.nuclideUriToUri(key),
              lineNumber: line
            });
          });
