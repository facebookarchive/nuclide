  ...
  _createClass(DebuggerStore, [{
    ...
    value: function _handlePayload(payload) {
      ...
      switch (payload.actionType) {
        case _Constants2.default.Actions.SET_PROCESS_SOCKET:
          this._processSocket = payload.data;
          break;
        case _Constants2.default.Actions.ADD_SERVICE:
          if (this._services.has(payload.data)) {
            return;
          }
          this._services.add(payload.data);
          break;
        case _Constants2.default.Actions.REMOVE_SERVICE:
          if (!this._services.has(payload.data)) {
            return;
          }
          this._services.delete(payload.data);
          break;
        case _Constants2.default.Actions.SET_ERROR:
          this._error = payload.data;
          break;
        case _Constants2.default.Actions.SET_DEBUGGER_INSTANCE:
          this._debuggerInstance = payload.data;
          break;
        case _Constants2.default.Actions.DEBUGGER_MODE_CHANGE:
          ...
          break;
        case _Constants2.default.Actions.ADD_EVALUATION_EXPRESSION_PROVIDER:
          if (this._evaluationExpressionProviders.has(payload.data)) {
            return;
          }
          this._evaluationExpressionProviders.add(payload.data);
          break;
        case _Constants2.default.Actions.REMOVE_EVALUATION_EXPRESSION_PROVIDER:
          if (!this._evaluationExpressionProviders.has(payload.data)) {
            return;
          }
