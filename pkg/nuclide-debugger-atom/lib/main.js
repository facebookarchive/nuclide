...
var Activation = (function () {
  ...
  _createDecoratedClass(Activation, [{
    ...
    value: _asyncToGenerator(function* () {
      var useRevampedUi = yield (0, _nuclideCommons.passesGKSafe)(GK_DEBUGGER_UI_REVAMP, GK_TIMEOUT);
    ...
    key: '_toggle',
    value: _asyncToGenerator(function* () {
      var passedNewUIGK = yield (0, _nuclideCommons.passesGKSafe)(GK_DEBUGGER_LAUNCH_ATTACH_UI, 0);
      if (passedNewUIGK) {
