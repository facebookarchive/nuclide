      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        ...
        (_reactForAtom2 || _reactForAtom()).React.createElement(
          ...
          (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiLibButton2 || _nuclideUiLibButton()).Button, {
            ...
            onClick: actions.triggerDebuggerAction.bind(actions, isPaused ? (_ChromeActionRegistryActions2 || _ChromeActionRegistryActions()).default.RUN : (_ChromeActionRegistryActions2 || _ChromeActionRegistryActions()).default.PAUSE)
          }),
          (_reactForAtom2 || _reactForAtom()).React.createElement((_nuclideUiLibButton2 || _nuclideUiLibButton()).Button, {
            icon: 'arrow-right',
            title: 'step over',
