  ...
  _createClass(DebuggerActions, [{
    ...
    value: function _setDebuggerMode(debuggerMode) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.DEBUGGER_MODE_CHANGE,
        data: debuggerMode
      });
    }
  }, {
    ...
    value: _asyncToGenerator(function* (debuggerInstance) {
      ...
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.SET_PROCESS_SOCKET,
        data: socketAddr
      });
    ...
    value: function _setDebuggerInstance(debuggerInstance) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.SET_DEBUGGER_INSTANCE,
    ...
    value: function addService(service) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.ADD_SERVICE,
        data: service
      });
    }
  }, {
    ...
    value: function removeService(service) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.REMOVE_SERVICE,
        data: service
      });
    }
  }, {
    ...
    value: function addDebuggerProvider(provider) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.ADD_DEBUGGER_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function removeDebuggerProvider(provider) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.REMOVE_DEBUGGER_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function addEvaluationExpressionProvider(provider) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.ADD_EVALUATION_EXPRESSION_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function removeEvaluationExpressionProvider(provider) {
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.REMOVE_EVALUATION_EXPRESSION_PROVIDER,
        data: provider
      });
    }
  }, {
    ...
    value: function setError(error) {
      ...
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.SET_ERROR,
        data: error
      });
    }
    ...
    value: function updateConnections() {
      ...
      this._dispatcher.dispatch({
        actionType: _Constants2.default.Actions.UPDATE_CONNECTIONS,
        data: connections
      });
    }
