...
var _BreakpointDisplayController = require('./BreakpointDisplayController');

var _BreakpointDisplayController2 = _interopRequireDefault(_BreakpointDisplayController);
  ...
  _createClass(BreakpointManager, [{
    ...
    value: function _handleTextEditor(editor) {
      if (!this._displayControllers.has(editor)) {
        ...
        // $FlowFixMe
        var controller = new _BreakpointDisplayController2.default(this, this._breakpointStore, editor);
