...
function renderSubsequence(seq, props) {
  return seq.length === 0 ? null : (_reactForAtom || _load_reactForAtom()).React.createElement(
    'span',
    props,
    seq
  );
...
var FileResultComponent = (function () {
  ...
  _createClass(FileResultComponent, null, [{
    ...
    value: function getComponentForItem(item, serviceName, dirName) {
      ...
      var filenameClasses = ['file', 'icon', (0, (_commonsAtomFileTypeClass || _load_commonsAtomFileTypeClass()).default)(filePath)].join(' ');
      // `data-name` is support for the "file-icons" package.
      // See: https://atom.io/packages/file-icons
      return (_reactForAtom || _load_reactForAtom()).React.createElement(
        'div',
        { className: filenameClasses, 'data-name': (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.basename(filePath) },
        pathComponents
      );
    }
  }]);
