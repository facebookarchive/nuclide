...
var SearchResultManager = (function () {
  ...
  function SearchResultManager() {
    ...
    this._debouncedCleanCache = (0, (_commonsNodeDebounce || _load_commonsNodeDebounce()).default)(function () {
    ...
    this._debouncedUpdateDirectories = (0, (_commonsNodeDebounce || _load_commonsNodeDebounce()).default)(function () {
  ...
  _createClass(SearchResultManager, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      newDirectories.forEach(function (directory) {
        ...
        var _loop = function (provider) {
          (0, (_assert || _load_assert()).default)(provider.isEligibleForDirectory != null, 'Directory provider ' + provider.getName() + ' must provide `isEligibleForDirectory()`.');
      ...
      for (var eligibility of resolvedEligibilities) {
        ...
        if (isEligible) {
          ...
          (0, (_assert || _load_assert()).default)(providersForDirectory != null, 'Providers for directory ' + directory.getPath() + ' not defined');
    ...
    value: function registerProvider(service) {
      ...
      var disposable = new (_atom || _load_atom()).CompositeDisposable();
      disposable.add(new (_atom || _load_atom()).Disposable(function () {
      ...
      if (isRenderableProvider && typeof service.getAction === 'function') {
        ...
        actionSpec[toggleAction] = function () {
          return (_QuickSelectionActions || _load_QuickSelectionActions()).default.changeActiveProvider(service.getName());
        };
    ...
    value: function _cleanCache() {
      ...
      for (var i = 0; i < entriesToRemove; i++) {
        ...
        (0, (_assert || _load_assert()).default)(firstEntryKey != null);
    ...
    key: 'executeQuery',
    value: function executeQuery(rawQuery) {
      var _this6 = this;
      ...
      var _loop3 = function (globalProvider) {
        ...
        (0, (_commonsNodePromise || _load_commonsNodePromise()).triggerAfterWait)(globalProvider.executeQuery(query), LOADING_EVENT_DELAY, loadingFn).then(function (result) {
      ...
      this._directories.forEach(function (directory) {
        ...
        var _loop4 = function (directoryProvider) {
          ...
          (0, (_commonsNodePromise || _load_commonsNodePromise()).triggerAfterWait)(directoryProvider.executeQuery(query, directory), LOADING_EVENT_DELAY, loadingFn).then(function (result) {
            (0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)(AnalyticsEvents.QUERY_SOURCE_PROVIDER, {
    ...
    value: function _getProviderByName(providerName) {
      ...
      (0, (_assert || _load_assert()).default)(dirProviderName != null, 'Provider ' + providerName + ' is not registered with quick-open.');
