...
function _load_observable() {return _observable = require('nuclide-commons/observable');}var _nuclideAnalytics;
...
function _load_promise() {return _promise = require('nuclide-commons/promise');}var _debounce;
function _load_debounce() {return _debounce = _interopRequireDefault(require('nuclide-commons/debounce'));}var _FileResultComponent;
