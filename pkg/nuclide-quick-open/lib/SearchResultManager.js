...
var _FileResultComponent2;

function _FileResultComponent() {
  return _FileResultComponent2 = _interopRequireDefault(require('./FileResultComponent'));
}
  ...
  _createClass(SearchResultManager, [{
    ...
    value: function _setUpFlux() {
      ...
      this._dispatcherToken = this._dispatcher.register(function (action) {
        switch (action.actionType) {
          case (_QuickSelectionDispatcher4 || _QuickSelectionDispatcher3()).ActionTypes.QUERY:
            _this2.executeQuery(action.query);
            break;
          case (_QuickSelectionDispatcher4 || _QuickSelectionDispatcher3()).ActionTypes.ACTIVE_PROVIDER_CHANGED:
    ...
    value: function getRendererForProvider(providerName) {
      ...
      if (!provider || !provider.getComponentForItem) {
        return (_FileResultComponent2 || _FileResultComponent()).default.getComponentForItem;
      }
