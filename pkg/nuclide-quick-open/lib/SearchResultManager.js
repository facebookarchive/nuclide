  ...
  _createClass(SearchResultManager, [{
    ...
    value: _asyncToGenerator(function* (rawQuery) {
      ...
      var _loop3 = function (globalProvider) {
        ...
        (_nuclideCommons2 || _nuclideCommons()).promises.triggerAfterWait(globalProvider.executeQuery(query), LOADING_EVENT_DELAY, loadingFn).then(function (result) {
      ...
      this._directories.forEach(function (directory) {
        ...
        var _loop4 = function (directoryProvider) {
          ...
          (_nuclideCommons2 || _nuclideCommons()).promises.triggerAfterWait(directoryProvider.executeQuery(query, directory), LOADING_EVENT_DELAY, loadingFn).then(function (result) {
            (0, (_nuclideAnalytics2 || _nuclideAnalytics()).track)(AnalyticsEvents.QUERY_SOURCE_PROVIDER, {
