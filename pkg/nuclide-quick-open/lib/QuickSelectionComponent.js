...
function _load_scrollIntoView() {
  return _scrollIntoView = require('../../../modules/nuclide-commons-ui/scrollIntoView');
}

var _Tabs;

function _load_Tabs() {
  return _Tabs = _interopRequireDefault(require('../../../modules/nuclide-commons-ui/Tabs'));
}
...
function _load_humanizeKeystroke() {
  return _humanizeKeystroke = _interopRequireDefault(require('../../../modules/nuclide-commons/humanizeKeystroke'));
}
