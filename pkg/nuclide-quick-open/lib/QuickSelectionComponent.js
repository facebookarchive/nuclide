...
var QuickSelectionComponent = (function (_React$Component) {
  ...
  _createClass(QuickSelectionComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this._subscriptions.add(searchResultManager.on(searchResultManager.PROVIDERS_CHANGED, this.handleProvidersChange), searchResultManager.on(searchResultManager.RESULTS_CHANGED, (0, (_nuclideCommons2 || _nuclideCommons()).debounce)(this.handleResultsChange, RESULTS_CHANGED_DEBOUNCE_DELAY, false)));
    ...
    value: function render() {
      ...
      return (_reactForAtom2 || _reactForAtom()).React.createElement(
        'div',
        { className: 'select-list omnisearch-modal', ref: 'modal', onClick: this.onClick },
