...
var _nuclideUiLibTabs = require('../../nuclide-ui/lib/Tabs');
...
var QuickSelectionComponent = (function (_React$Component) {
  ...
  _createClass(QuickSelectionComponent, [{
    ...
    value: function _updateQueryHandler() {
      ...
      this._debouncedQueryHandler = (0, _nuclideCommons.debounce)(function () {
    ...
    value: function _getCurrentResultContext() {
      var nonEmptyResults = (0, _searchResultHelpers.filterEmptyResults)(this.state.resultsByService);
    ...
    value: function _renderTabs() {
      ...
      return _reactForAtom.React.createElement(
        ...
        _reactForAtom.React.createElement(_nuclideUiLibTabs.Tabs, {
          tabs: tabs,
    ...
    value: function render() {
          ...
          if (showDirectories) {
            directoryLabel = _reactForAtom.React.createElement(
              ...
              _reactForAtom.React.createElement(
                ...
                (0, _nuclideRemoteUri.nuclideUriToDisplayString)(dirName)
              )
            );
          }
          return _reactForAtom.React.createElement(
            'li',
            { className: (0, _classnames2.default)({ 'list-nested-item': showDirectories }), key: dirName },
            directoryLabel,
            message,
            _reactForAtom.React.createElement(
              'ul',
      ...
      if (_nuclideCommons.object.isEmpty(this.state.resultsByService)) {
      ...
      return _reactForAtom.React.createElement(
        ...
        _reactForAtom.React.createElement(_nuclideUiLibAtomInput.AtomInput, { ref: 'queryInput', placeholderText: promptText }),
        this._renderTabs(),
        _reactForAtom.React.createElement(
          'div',
...
QuickSelectionComponent.propTypes = {
  activeProvider: _reactForAtom.React.PropTypes.shape({
    action: _reactForAtom.React.PropTypes.string.isRequired,
    debounceDelay: _reactForAtom.React.PropTypes.number.isRequired,
    name: _reactForAtom.React.PropTypes.string.isRequired,
    prompt: _reactForAtom.React.PropTypes.string.isRequired,
    title: _reactForAtom.React.PropTypes.string.isRequired
  }).isRequired,
  onProviderChange: _reactForAtom.React.PropTypes.func,
  maxScrollableAreaHeight: _reactForAtom.React.PropTypes.number
};
