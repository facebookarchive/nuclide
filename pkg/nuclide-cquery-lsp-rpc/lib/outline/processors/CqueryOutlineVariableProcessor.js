...
processVariable = processVariable;var _CqueryOutlineTokenizer;function _load_CqueryOutlineTokenizer() {return _CqueryOutlineTokenizer = require('../tokenizers/CqueryOutlineTokenizer');}var _TokenBuffer;function _load_TokenBuffer() {return _TokenBuffer = require('../tokenizers/TokenBuffer');} /**
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      */ /**
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          *  strict-local
                                                                                                                                                                                                                                                                                                          * @format
                                                                                                                                                                                                                                                                                                          */function processVariable(root, node, symbol, ranges) {new CqueryOutlineVariableProcessor(root, node, symbol, ranges).process();}class CqueryOutlineVariableProcessor {
  ...
  process() {
    ...
    const tokenized = (0, (_CqueryOutlineTokenizer || _load_CqueryOutlineTokenizer()).asNonLocalVariable)(
  ...
  _appendParams(node, tokenized) {
    if (this._isObjcFunction(node)) {
      node.tokenizedText = new (_TokenBuffer || _load_TokenBuffer()).TokenBuffer(node.tokenizedText).
