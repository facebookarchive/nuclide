...
processNonVariable = processNonVariable;var _collection;function _load_collection() {return _collection = require('../../../../../modules/nuclide-commons/collection');}var _nodes;function _load_nodes() {return _nodes = require('../nodes');} /**
                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                  */ /**
                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                      *  strict-local
                                                                                                                                                                                                                                                      * @format
                                                                                                                                                                                                                                                      */function processNonVariable(root, tokenized, node, symbol, ranges) {new CqueryOutlineNonVariableProcessor(root, tokenized, node, symbol, ranges).
  process();
}
...
class CqueryOutlineNonVariableProcessor {
  ...
  currentNode)
  {
    return (
      ...
      (0, (_collection || _load_collection()).lastFromArray)(currentNode.children).representativeName !== ancestor);
