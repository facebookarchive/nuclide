'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.SymbolRanges = undefined;var _protocol;
...
function _load_protocol() {return _protocol = require('../../../../nuclide-vscode-language-service-rpc/lib/protocol');}var _symbols;
function _load_symbols() {return _symbols = require('../symbols');}
...
/**
                                                                     ...
                                                                     */ /**
                                                                         ...
                                                                         * 
                                                                         * @format
                                                                         */class SymbolRanges {constructor() {this._functions = [];this._structuredObjects = [];this._variables = [];} // namespaces, classes, structs, etc.
  addSymbol(symbol, node) {if ((0, (_symbols || _load_symbols()).isFunction)(symbol)) {this._functions.push([symbol.location.range, node]);} else if (symbol.kind === (_protocol || _load_protocol()).SymbolKind.Variable) {this._variables.push([symbol.location.range, node]);
    } else {
