...
class CqueryLanguageServer extends (_nuclideLanguageServiceRpc || _load_nuclideLanguageServiceRpc()).MultiProjectLanguageService {
  ...
  _createCqueryLanguageClient(projectKey, enableLibclangLogs) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const lsp = new (_CqueryLanguageClient || _load_CqueryLanguageClient()).CqueryLanguageClient(_this2._logger, _this2._fileCache, host, _this2._languageId, _this2._command, ['--language-server', '--log-file', logFile], spawnOptions, projectRoot, ['.cpp', '.h', '.hpp', '.cc', '.m', 'mm'], initalizationOptions, 5 * 60 * 1000, // 5 minutes
      logFile, { id: projectKey, label: projectRoot }, projectKey, _this2._projectManager);
