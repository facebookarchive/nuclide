...
class CqueryLanguageServer extends (_nuclideLanguageServiceRpc || _load_nuclideLanguageServiceRpc()).MultiProjectLanguageService {
  ...
  _createCqueryLanguageClient(projectKey) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const lsp = new (_CqueryLanguageClient || _load_CqueryLanguageClient()).CqueryLanguageClient(_this._logger, _this._fileCache, host, _this._languageId, _this._command, ['--language-server'], // args
      {}, // spawnOptions
      project.projectRoot, ['.cpp', '.h', '.hpp', '.cc'], initalizationOptions, 5 * 60 * 1000);
  ...
  associateFileWithProject(file, project) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      _this4._processes.get(_this4._projectManager.getProjectKey(project));
    })();
  }
