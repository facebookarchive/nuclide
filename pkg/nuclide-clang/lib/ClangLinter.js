...
function _load_range() {return _range = require('nuclide-commons-atom/range');}var _log4js;
function _load_log4js() {return _log4js = require('log4js');}var _constants;
...
function _load_libclang() {return _libclang = require('./libclang');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                    ...
                                                                                                                                                                    * 
                                                                                                                                                                    * @format
                                                                                                                                                                    */const IDENTIFIER_REGEX = /[a-z0-9_]+/gi;function isValidRange(clangRange) {// Some ranges are unbounded/invalid (end with -1) or empty.
