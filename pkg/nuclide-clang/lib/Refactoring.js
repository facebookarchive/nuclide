...
var checkDiagnostics = _asyncToGenerator(function* (editor) {
  ...
  var diagnostics = yield (0, (_libclang || _load_libclang()).getDiagnostics)(editor);
...
var RefactoringHelpers = (function () {
  ...
  _createDecoratedClass(RefactoringHelpers, null, [{
    ...
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-clang:refactoringsAtPoint')],
    value: _asyncToGenerator(function* (editor, point) {
      ...
      var declInfo = yield (0, (_libclang || _load_libclang()).getDeclarationInfo)(editor, row, column);
    ...
    key: 'refactor',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-clang:refactor')],
    value: _asyncToGenerator(function* (request) {
      (0, (_assert || _load_assert()).default)(request.kind === 'rename');
      var editor = request.editor;
      var symbolAtPoint = request.symbolAtPoint;
      ...
      var startPoint = symbolAtPoint.range.start;

      // TODO(hansonw): We should disallow renames that conflict with an existing variable.
      var refs = yield (0, (_libclang || _load_libclang()).getLocalReferences)(editor, startPoint.row, startPoint.column);
      if (refs == null) {
        return null;
      }
