...
class RefactoringHelpers {
  ...
  static refactoringsAtPoint(editor, point) {
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackOperationTiming)('nuclide-clang:refactoringsAtPoint', () => RefactoringHelpers._refactoringsAtPoint(editor, point));
  }
  ...
  static refactor(request) {
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackOperationTiming)('nuclide-clang:refactor', () => RefactoringHelpers._refactor(request));
  }
