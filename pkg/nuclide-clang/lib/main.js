...
exports.consumeClangRequestSettings = consumeClangRequestSettings;
...
function consumeClangRequestSettings(provider) {
  return (0, (_libclang || _load_libclang()).registerRequestSettingsProvider)(provider);
}
