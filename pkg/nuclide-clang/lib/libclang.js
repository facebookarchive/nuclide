...
function getDefaultFlags() {
  var config = (_commonsAtomFeatureConfig || _load_commonsAtomFeatureConfig()).default.get('nuclide-clang');
...
module.exports = {
  ...
  getDiagnostics: _asyncToGenerator(function* (editor) {
    ...
    var service = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getServiceByNuclideUri)('ClangService', src);
  ...
  getDeclarationInfo: function getDeclarationInfo(editor, line, column) {
    var src = editor.getPath();
    if (src == null) {
  ...
  getLocalReferences: function getLocalReferences(editor, line, column) {
    var src = editor.getPath();
    if (src == null) {
      return Promise.resolve(null);
    }
  ...
  formatCode: _asyncToGenerator(function* (editor, range) {
    ...
    var service = (0, (_nuclideRemoteConnection || _load_nuclideRemoteConnection()).getServiceByNuclideUri)('ClangService', fileUri);
    (0, (_assert || _load_assert()).default)(service);
