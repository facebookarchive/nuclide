...
function useRTags() {
  return (_featureConfig || _load_featureConfig()).default.get('nuclide-clang.useRTags');
}
...
module.exports = {
  ...
  getDiagnostics(editor) {
    return (0, _asyncToGenerator.default)(function* () {
      ...
      return service.compile(src, contents, (yield getClangRequestSettings(src)), defaultFlags, useRTags()).refCount().toPromise();
    })();
  },
  ...
  getCompletions(editor, prefix) {
    return (0, _asyncToGenerator.default)(function* () {
      ...
      return service.getCompletions(src, editor.getText(), line, column, tokenStartColumn, prefix, (yield getClangRequestSettings(src)), defaultFlags, useRTags());
    })();
  },
