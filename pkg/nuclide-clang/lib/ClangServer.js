...
var _findClangServerArgs = _asyncToGenerator(function* () {
  ...
  if (process.platform === 'darwin') {
    var result = yield (0, (_nuclideCommons2 || _nuclideCommons()).asyncExecute)('xcode-select', ['--print-path']);
...
var ClangServer = (function () {
  ...
  _createClass(ClangServer, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      var _ref = yield (0, (_nuclideCommons2 || _nuclideCommons()).asyncExecute)('ps', ['-p', this._asyncConnection.process.pid.toString(), '-o', 'rss=']);
