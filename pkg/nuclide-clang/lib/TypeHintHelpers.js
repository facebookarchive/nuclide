...
var TypeHintHelpers = (function () {
  ...
  _createDecoratedClass(TypeHintHelpers, null, [{
    key: 'typeHint',
    decorators: [(0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-clang-atom.typeHint')],
    value: _asyncToGenerator(function* (editor, position) {
      var decl = yield (0, (_libclang || _load_libclang()).getDeclaration)(editor, position.row, position.column);
      if (decl == null) {
        return null;
      }
      var type = decl.type;
      var range = decl.extent;
