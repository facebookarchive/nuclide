...
class OutlineViewHelpers {
  static getOutline(editor) {
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-clang-atom:outline-view', async () => {
      // HACK: Since outline view and diagnostics both trigger on save, favor diagnostics.
      await (0, (_promise || _load_promise()).sleep)(0);
      const clangOutline = await (0, (_libclang || _load_libclang()).getOutline)(editor);
