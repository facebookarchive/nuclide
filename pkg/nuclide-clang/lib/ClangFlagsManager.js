...
var ClangFlagsManager = (function () {
  ...
  _createDecoratedClass(ClangFlagsManager, [{
    ...
    value: _asyncToGenerator(function* (src) {
      ...
      var dbDir = yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.findNearestFile(COMPILATION_DATABASE_FILE, (_path2 || _path()).default.dirname(src));
      if (dbDir != null) {
      ...
      try {
        yield* (function* () {
          ...
          yield Promise.all(data.map(_asyncToGenerator(function* (entry) {
            ...
            var directory = yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.realpath(entry.directory, _this._realpathCache);
            ...
            if (yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.exists(filename)) {
              var realpath = yield (_commonsNodeFsPromise2 || _commonsNodeFsPromise()).default.realpath(filename, _this._realpathCache);
