...
class CodeFormatHelpers {
  static formatEntireFile(editor, range) {
    return (0, (_nuclideAnalytics || _load_nuclideAnalytics()).trackTiming)('nuclide-clang-format.formatCode', async () => {
      try {
        return await (_libclang || _load_libclang()).default.formatCode(editor, range);
      } catch (e) {
