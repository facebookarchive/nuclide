...
function createGutterItem(messages, gutterMarkerCssClass, fixer) {
  ...
  var dispose = function dispose() {
    if (popupElement) {
      (_reactForAtom || _load_reactForAtom()).ReactDOM.unmountComponentAtNode(popupElement);
      (0, (_assert || _load_assert()).default)(popupElement.parentNode != null);
  ...
  var goToLocation = function goToLocation(path, line) {
    ...
    dispose();
    var column = 0;
    (0, (_commonsAtomGoToLocation || _load_commonsAtomGoToLocation()).goToLocation)(path, line, column);
  };
...
function showPopupFor(messages, item, goToLocation, fixer) {
  ...
  (_reactForAtom || _load_reactForAtom()).ReactDOM.render((_reactForAtom || _load_reactForAtom()).React.createElement((_DiagnosticsPopup || _load_DiagnosticsPopup()).DiagnosticsPopup, {
    left: left,
    top: top,
    messages: messages,
    fixer: trackedFixer,
