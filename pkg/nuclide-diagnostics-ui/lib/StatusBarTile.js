...
var StatusBarTile = (function () {
  ...
  _createClass(StatusBarTile, [{
    ...
    value: function consumeDiagnosticUpdates(diagnosticUpdater) {
      ...
      this._subscriptions.add(new (_commonsNodeUniversalDisposable2 || _commonsNodeUniversalDisposable()).default(diagnosticUpdater.allMessageUpdates.subscribe(this._onAllMessagesDidUpdate.bind(this, diagnosticUpdater))));
    }
  }, {
...
var StatusBarTileComponent = (function (_React$Component) {
  ...
  _createClass(StatusBarTileComponent, [{
    ...
    value: function _onClick() {
      ...
      (0, (_nuclideAnalytics2 || _nuclideAnalytics()).track)('diagnostics-show-table-from-status-bar');
    }
  }]);
