...
var _DiagnosticsPanel = require('./DiagnosticsPanel');

var _DiagnosticsPanel2 = _interopRequireDefault(_DiagnosticsPanel);
...
function createDiagnosticsPanel(diagnosticUpdater, initialHeight, initialfilterByActiveTextEditor, disableLinter) {
  ...
  var props = {
    ...
    onResize: (0, _nuclideCommons.debounce)(function () {
      (0, _assert2.default)(diagnosticsPanel);
    ...
    onDismiss: function onDismiss() {
      (0, _assert2.default)(bottomPanel);
      bottomPanel.hide();
    },
  ...
  function render() {
    ...
    if (diagnosticsNeedSorting) {
      props.diagnostics = props.diagnostics.slice().sort(_paneUtils.compareMessagesByFile);
      diagnosticsNeedSorting = false;
    }

    var component = _reactForAtom.ReactDOM.render(_reactForAtom.React.createElement(_DiagnosticsPanel2.default, props), item);
    (0, _assert2.default)(component instanceof _DiagnosticsPanel2.default);
  ...
  var resizeListener = (0, _nuclideCommons.debounce)(function () {
