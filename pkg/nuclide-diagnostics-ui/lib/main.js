...
function createPanel(diagnosticUpdater) {
  ...
  return new (_atom || _load_atom()).CompositeDisposable(panel.onDidChangeVisible(function (visible) {
    (0, (_assert || _load_assert()).default)(activationState);
...
function watchForLinter(setWarnAboutLinter) {
  ...
  return new (_atom || _load_atom()).CompositeDisposable(atom.packages.onDidActivatePackage(function (pkg) {
