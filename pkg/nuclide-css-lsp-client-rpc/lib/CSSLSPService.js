...
async function initializeLsp(projectFileNames, fileExtensions, logLevel, fileNotifier, host, initializationOptions) {
  return (0, (_nuclideVscodeLanguageServiceRpc || _load_nuclideVscodeLanguageServiceRpc()).createMultiLspLanguageService)('css', process.execPath, [require.resolve('vscode-css-languageserver-bin/cssServerMain'), '--stdio'], {
    fileNotifier,
    host,
    logCategory: 'CSS',
    logLevel,
