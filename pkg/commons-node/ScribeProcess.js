'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.__test__ = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _log4js;
...
function _load_log4js() {return _log4js = require('log4js');}var _performanceNow;
function _load_performanceNow() {return _performanceNow = _interopRequireDefault(require('../../modules/nuclide-commons/performanceNow'));}
var _os = _interopRequireDefault(require('os'));var _process;
function _load_process() {return _process = require('../../modules/nuclide-commons/process');}var _which;
function _load_which() {return _which = _interopRequireDefault(require('../../modules/nuclide-commons/which'));}var _once;
function _load_once() {return _once = _interopRequireDefault(require('./once'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                ...
                                                                                                                                                                                *  strict-local
                                                                                                                                                                                * @format
                                                                                                                                                                                */const DEFAULT_JOIN_TIMEOUT = 5000;let SCRIBE_CAT_COMMAND = 'scribe_cat'; // On Mac OS, `scribe_cat` isn't quite the same as the server-side one:
...
class ScribeProcess {
  ...
  constructor(
  scribeCategory,
  joinInterval = DEFAULT_JOIN_INTERVAL)
  {
  ...
  /**
     ...
     */
  write(message) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      try {
        ...
        (0, (_log4js || _load_log4js()).getLogger)('ScribeProcess').error(
  ...
  /**
     ...
     */
  join(timeout = DEFAULT_JOIN_TIMEOUT) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (!stdin.write(_os.default.EOL)) {
        stdin.once('drain', function () {return stdin.end();});
      } else {
        stdin.end();
      }
      return waitForExit;})();
  ...
  }}exports.default = ScribeProcess;ScribeProcess._enabled = true;ScribeProcess.isScribeCatOnPath = (0, (_once || _load_once()).default)(() => (0, (_which || _load_which()).default)(SCRIBE_CAT_COMMAND).then(cmd => cmd != null));
