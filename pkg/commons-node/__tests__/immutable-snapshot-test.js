...
describe('immutable-snapshot', () => {
  ...
  let reader;
  beforeEach(() => {
    snapshotter = new (_immutableSnapshot || _load_immutableSnapshot()).ImmutableSnapshotter();
    reader = new (_immutableSnapshot || _load_immutableSnapshot()).ImmutableSnapshotReader();
  });
  ...
  describe('List', () => {
    it('records basic mutations', () => {
      let list = (0, (_immutableSnapshot || _load_immutableSnapshot()).List)([1, 2, 3]);
      verify(list, [1, 2, 3]);
      list = list.push(4);
      list = list.push(5);
      list = list.shift();
    ...
    it('works with JS objects', () => {
      let list = (0, (_immutableSnapshot || _load_immutableSnapshot()).List)([1]);
      verify(list, [1]);
    ...
    it('continues to wrap things after an unserializable mutation', () => {
      let list = (0, (_immutableSnapshot || _load_immutableSnapshot()).List)([1, 2, 3]).sort((x, y) => y - x);
      verify(list, [3, 2, 1]);
      list = list.unshift(4);
      verify(list, [4, 3, 2, 1]);
    });
  ...
  describe('Map', () => {
    it('records basic mutations', () => {
      let map = (0, (_immutableSnapshot || _load_immutableSnapshot()).Map)([['a', 1]]);
      verify(map, { a: 1 });
      map = map.set('b', 2);
      map = map.set('a', 3);
      verify(map, { a: 3, b: 2 });
    ...
    it('serializes mutations correctly', () => {
      const a = (0, (_immutableSnapshot || _load_immutableSnapshot()).Map)([['a', 1]]);
    ...
    it('works with nested maps', () => {
      ...
      let map2 = (0, (_immutableSnapshot || _load_immutableSnapshot()).Map)();
      map = map.set('x', map2);
      verify(map, { x: {} });
      map2 = map2.set('a', 1);
      map2 = map2.set('b', 2);
    ...
    it('works with duplicated values', () => {
      let map = (0, (_immutableSnapshot || _load_immutableSnapshot()).Map)();
      const list = (0, (_immutableSnapshot || _load_immutableSnapshot()).List)([1, 2, 3]);
      map = map.set('x', list);
      map = map.set('y', list);
    ...
    it('returns an OrderedMap from sort', () => {
      let map = (0, (_immutableSnapshot || _load_immutableSnapshot()).Map)({ b: 1, a: 1 });
      map = map.sort();
      expect(map instanceof (_immutableSnapshot || _load_immutableSnapshot()).OrderedMap).toBe(true);
      verify(map, { a: 1, b: 1 });
      map = map.set('c', 2);
  ...
  describe('Record', () => {
    it('records basic mutations', () => {
      const TestRecord = (0, (_immutableSnapshot || _load_immutableSnapshot()).Record)({ a: 0, b: 0 });
