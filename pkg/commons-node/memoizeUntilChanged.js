...
function memoizeUntilChanged(func, keySelector_) {
  var compareKeys = arguments.length <= 2 || arguments[2] === undefined ? (_collection || _load_collection()).arrayEqual : arguments[2];
...
function createKeySelector() {
  var hasher = new (_Hasher || _load_Hasher()).default();
  return function (x) {
