...
var Cache = (function () {
  function Cache(factory) {
    ...
    this._entriesSubject = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
  }
  ...
  _createClass(Cache, [{
    ...
    value: function observeEntries() {
      return (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.concat((_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.from(this._values.entries()), this._entriesSubject);
    }
  }, {
    key: 'observeKeys',
