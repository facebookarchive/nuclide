...
function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('../../modules/nuclide-commons/fsPromise'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class DiskCache {
  ...
  /**
     ...
     */
  load() {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      try {
  ...
  save() {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      try {
