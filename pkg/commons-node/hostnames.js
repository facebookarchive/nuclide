...
exports.isOnDemandHostname = isOnDemandHostname;
...
function isOnDemandHostname(hostname) {
  return hostname.match(/sandcastle[0-9]+(.+).facebook.com/) != null || hostname.match(/od[0-9]+(.+).facebook.com/) != null;
}
