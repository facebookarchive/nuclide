...
function observeProcessExitMessage(process) {
  return (_rxjsBundlesRxMinJs2 || _rxjsBundlesRxMinJs()).Observable.fromEvent(process, 'exit', function (exitCode, signal) {
...
function observeProcessExit(createProcess) {
  return _createProcessStream(createProcess, false).flatMap(observeProcessExitMessage);
}
...
function exitEventToMessage(event) {
  if (event.exitCode != null) {
    ...
    (0, (_assert2 || _assert()).default)(event.signal != null);
