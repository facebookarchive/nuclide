...
var WString = (function () {
  ...
  _createClass(WString, [{
    ...
    value: function canMergeRight(i) {
      (0, (_assert || _load_assert()).default)(i < this._string.length - 1);
    ...
    value: function receive(op) {
      if (op.type === 'INS') {
        (0, (_assert || _load_assert()).default)(op.char != null);
    ...
    value: function canApplyOp(op) {
      if (op.type === 'INS') {
        ...
        (0, (_assert || _load_assert()).default)(_prev != null && _next != null);
        return this.contains(_prev) && this.contains(_next);
      } else {
        // DEL
        (0, (_assert || _load_assert()).default)(op.runs != null);
    ...
    value: function execute(op) {
      ...
      if (op.type === 'INS') {
        ...
        (0, (_assert || _load_assert()).default)(op.text);
