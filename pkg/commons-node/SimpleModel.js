...
var SimpleModel = (function () {
  function SimpleModel() {
    ...
    this._states = new (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Subject();
    ...
    this[(_symbolObservable || _load_symbolObservable()).default] = function () {
      return (_rxjsBundlesRxMinJs || _load_rxjsBundlesRxMinJs()).Observable.of(_this.state).concat(_this._states);
    };
  }
