...
var SimpleModel = (function () {
  function SimpleModel() {
    ...
    this._states = new (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Subject();
    ...
    this[(_symbolObservable2 || _symbolObservable()).default] = function () {
      return (_rxjsBundlesRxUmdMinJs2 || _rxjsBundlesRxUmdMinJs()).Observable.of(_this.state).concat(_this._states);
    };
  }
