...
function getRemoteMarshallers(hostname) {
  return {
    typeName: NUCLIDE_URI_TYPE_NAME,
    marshaller: function marshaller(remoteUri) {
      return getPath(remoteUri);
    },
    unmarshaller: function unmarshaller(path) {
      return createRemoteUri(hostname, path);
    }
  };
}

var localMarshallers = {
  typeName: NUCLIDE_URI_TYPE_NAME,
...
exports.default = {
  ...
  parsePath: parsePath,
  split: split,
  getRemoteMarshallers: getRemoteMarshallers,
  localMarshallers: localMarshallers,
