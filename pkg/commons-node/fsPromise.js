...
var glob = _asyncToGenerator(function* (pattern, options) {
  return yield new Promise(function (resolve, reject) {
    (0, (_glob || _load_glob()).default)(pattern, options, function (err, files) {
      if (err) {
        reject(err);
      } else {
        resolve(files);
...
function tempdir() {
  ...
  return new Promise(function (resolve, reject) {
    (_temp || _load_temp()).default.mkdir(prefix, function (err, dirPath) {
      if (err) {
        reject(err);
      } else {
        resolve(dirPath);
  ...
  return new Promise(function (resolve, reject) {
    (_temp || _load_temp()).default.open(options, function (err, info) {
      if (err) {
        ...
        (_fsPlus || _load_fsPlus()).default.close(info.fd, function (closeErr) {
          if (closeErr) {
            reject(closeErr);
          } else {
            resolve(info.path);
...
function exists(filePath) {
  return new Promise(function (resolve, reject) {
    (_fsPlus || _load_fsPlus()).default.exists(filePath, resolve);
  });
}function rmdir(filePath) {
  return new Promise(function (resolve, reject) {
    (0, (_rimraf || _load_rimraf()).default)(filePath, function (err) {
      if (err) {
        reject(err);
      } else {
        resolve();
  ...
  return function () {
    ...
    var method = (_fsPlus || _load_fsPlus()).default[methodName];
    return new Promise(function (resolve, reject) {
      method.apply((_fsPlus || _load_fsPlus()).default, args.concat([function (err, result) {
