...
function createCallMessage(id, method, args) {
  return {
...
function isValidResponseMessage(obj) {
  return obj.type === RESPONSE_MESSAGE_TYPE && typeof obj.id === 'number' && obj.result === undefined !== (obj.error === undefined);
}
...
var Rpc = (function () {
  ...
  _createClass(Rpc, [{
    ...
    value: function call(method, args) {
      ...
      this._index++;
      var message = createCallMessage(this._index, method, args);
    ...
    value: function _handleMessage(messageString) {
      ...
      if (error !== undefined) {
        ...
        (0, (_assert2 || _assert()).default)(result !== undefined, this._name + ' - neither result or error received in response');
        resolve(result);
      }
    }
  }, {
