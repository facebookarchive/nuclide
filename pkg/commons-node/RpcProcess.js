...
var RpcProcess = (function () {
  ...
  function RpcProcess(name, createProcess) {
    var _this = this;
  ...
  _createClass(RpcProcess, [{
    ...
    key: 'call',
    value: _asyncToGenerator(function* (method, args) {
      (0, (_assert2 || _assert()).default)(!this._disposed, this._name + ' - Attempting to call on disposed connection: ' + args);

      yield this._ensureProcess();
      (0, (_assert2 || _assert()).default)(this._process, 'process is null');
      (0, (_assert2 || _assert()).default)(this._rpc, 'rpc is null');
    ...
    value: _asyncToGenerator(function* (createProcess) {
      ...
      try {
        ...
        this._rpc = new (_Rpc2 || _Rpc()).Rpc(this._name, new (_Rpc2 || _Rpc()).StreamTransport(proc.stdin, proc.stdout));
