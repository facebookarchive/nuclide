  ...
  _createClass(RpcProcess, [{
    ...
    value: function _ensureProcess() {
      ...
      try {
        ...
        this._rpcConnection = new (_nuclideRpc2 || _nuclideRpc()).RpcConnection('client', this._serviceRegistry, new (_nuclideRpc2 || _nuclideRpc()).StreamTransport(proc.stdin, proc.stdout, this._messageLogger));
