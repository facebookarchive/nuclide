...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../modules/nuclide-commons/UniversalDisposable'));}var _lookupPreferIpV;
...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}var _RemoteConnectionConfigurationManager;
...
class RemoteConnection {
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      directories.map(function (dir, i) {
        ...
        dir,
        i === 0 ? displayTitle : '',
        promptReconnectOnFailure !== false);
