...
var RemoteConnection = (function () {
  _createClass(RemoteConnection, null, [{
    ...
    value: _asyncToGenerator(function* (config) {
      var serverConnection = yield (_ServerConnection || _load_ServerConnection()).ServerConnection.getOrCreate(config);
  ...
  _createClass(RemoteConnection, [{
    ...
    value: _asyncToGenerator(function* () {
      ...
      try {
        ...
        if (resolvedPath !== this._cwd) {
          ...
          (0, (_assert || _load_assert()).default)(this !== existingConnection);
    ...
    value: function _watchRootProjectDirectory() {
      ...
      var rootDirectoryPath = this.getPathForInitialWorkingDirectory();
      var FileWatcherService = this.getService(FILE_WATCHER_SERVICE);
      (0, (_assert || _load_assert()).default)(FileWatcherService);
      ...
      this._subscriptions.add(new (_commonsNodeUniversalDisposable || _load_commonsNodeUniversalDisposable()).default(subscription));
    }
  }, {
    key: 'close',
    ...
    value: _asyncToGenerator(function* (host, cwd, displayTitle) {
      var connectionConfig = (0, (_RemoteConnectionConfigurationManager || _load_RemoteConnectionConfigurationManager()).getConnectionConfig)(host);
      if (!connectionConfig) {
        return null;
      }
      try {
    ...
    value: function getByHostname(hostname) {
      var server = (_ServerConnection || _load_ServerConnection()).ServerConnection.getByHostname(hostname);
