...
var ServerConnection = (function () {
  ...
  _createClass(ServerConnection, [{
    ...
    value: function createFile(uri) {
      ...
      var _default$parse2 = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parse(uri);
    ...
    value: function _startRpc() {
      ...
      var client = (_nuclideRpc2 || _nuclideRpc()).RpcConnection.createRemote(socket, [(_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.getRemoteMarshallers(this.getRemoteHostname())], (_nuclideServerLibServicesConfig2 || _nuclideServerLibServicesConfig()).default);
    ...
    value: function getRemoteConnectionForUri(uri) {
      var _default$parse3 = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parse(uri);
    ...
    value: _asyncToGenerator(function* (shutdown) {
      ...
      if (shutdown) {
        ...
        (0, (_RemoteConnectionConfigurationManager2 || _RemoteConnectionConfigurationManager()).clearConnectionConfig)(this._config.host);
      }
    })
  }], [{
    ...
    value: function getForUri(uri) {
      var _default$parse4 = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parse(uri);
