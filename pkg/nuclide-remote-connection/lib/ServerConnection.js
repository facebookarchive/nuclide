...
var ServerConnection = (function () {
  ...
  _createClass(ServerConnection, [{
    ...
    value: function _startRpc() {
      ...
      var client = (_nuclideRpc2 || _nuclideRpc()).RpcConnection.createRemote(this.getRemoteHostname(), this.getPort(), socket, (0, (_nuclideServerLibServices2 || _nuclideServerLibServices()).loadServicesConfig)());
