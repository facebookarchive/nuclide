...
var ServerConnection = (function () {
  ...
  _createClass(ServerConnection, [{
    ...
    value: function _startRpc() {
      ...
      var client = (_nuclideRpc2 || _nuclideRpc()).RpcConnection.createRemote(socket, (0, (_nuclideMarshalersCommon2 || _nuclideMarshalersCommon()).getAtomSideMarshalers)(this.getRemoteHostname()), (_nuclideServerLibServicesConfig2 || _nuclideServerLibServicesConfig()).default);
