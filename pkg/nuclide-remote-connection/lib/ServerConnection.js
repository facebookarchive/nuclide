...
let ServerConnection = (_temp = _class = class ServerConnection {
  ...
  createDirectory(uri, hgRepositoryDescription) {
    ...
    if (!(entry instanceof (_RemoteDirectory || _load_RemoteDirectory()).RemoteDirectory)) {
      throw new Error('Invariant violation: "entry instanceof RemoteDirectory"');
    }
  ...
  createFile(uri) {
    ...
    if (!(entry instanceof (_RemoteFile || _load_RemoteFile()).RemoteFile)) {
      throw new Error('Invariant violation: "entry instanceof RemoteFile"');
    }
