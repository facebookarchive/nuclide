...
function _load_ReliableSocket() {
  return _ReliableSocket = require('big-dig/src/socket/ReliableSocket');
}
  ...
  _startRpc() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      if (_this2._config.version === BIG_DIG_VERSION) {
        const { bigDigClient, rpcConnection } = yield (0, (_createBigDigRpcClient || _load_createBigDigRpcClient()).default)(_this2._config);
