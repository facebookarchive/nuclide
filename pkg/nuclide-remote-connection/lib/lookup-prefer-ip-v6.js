  ...
  host)
  {
    try {
      ...
      throw e;
                                                                                                       ...
                                                                                                       *  strict
                                                                                                       * @format
                                                                                                       */function lookup(host, family) {return new Promise((resolve, reject) => {_dns.default.lookup(host, family, (error, address, resultFamily) => {if (error) {reject(error);
      } else if (address != null) {if (!(
