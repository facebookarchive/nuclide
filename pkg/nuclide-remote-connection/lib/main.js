...
exports.getArcanistBaseServiceByNuclideUri = getArcanistBaseServiceByNuclideUri;
...
function getArcanistBaseServiceByNuclideUri(uri) {
  return (0, (_nullthrows2 || _nullthrows()).default)((0, (_serviceManager2 || _serviceManager()).getServiceByNuclideUri)('ArcanistBaseService', uri));
}