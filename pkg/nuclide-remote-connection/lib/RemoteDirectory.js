...
var RemoteDirectory = (function () {
  ...
  function RemoteDirectory(server, uri, symlink, options) {
    ...
    (0, (_assert || _load_assert()).default)(protocol);
    (0, (_assert || _load_assert()).default)(host);
  ...
  _createClass(RemoteDirectory, [{
    ...
    value: function _subscribeToNativeChangeEvents() {
      ...
      var watchStream = watchDirectory(this._uri).refCount();
      this._watchSubscription = watchStream.subscribe(function (watchUpdate) {
        ...
        if ((_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.basename(_this._uri) !== '.git') {
    ...
    key: '_isRoot',
    value: function _isRoot(filePath_) {
      var filePath = filePath_;
      filePath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.normalize(filePath);
      var parts = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parsePath(filePath);
    ...
    value: function getBaseName() {
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.basename(this._localPath);
    }
  }, {
    key: 'relativize',
    value: function relativize(uri) {
      ...
      var subpath = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parse(uri).path;
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.relative(this._localPath, subpath);
    }
  }, {
    key: 'getParent',
    value: function getParent() {
      if (this.isRoot()) {
        ...
        var uri = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.createRemoteUri(this._host, (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.dirname(this._localPath));
    ...
    value: function getFile(filename) {
      var uri = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.createRemoteUri(this._host, (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(this._localPath, filename));
      return this._server.createFile(uri);
    }
  }, {
    key: 'getSubdirectory',
    value: function getSubdirectory(dir) {
      var uri = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.createRemoteUri(this._host, (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(this._localPath, dir));
      return this._server.createDirectory(uri, this._hgRepositoryDescription);
    }
  }, {
    key: 'create',
    value: _asyncToGenerator(function* () {
      (0, (_assert || _load_assert()).default)(!this._deleted, 'RemoteDirectory has been deleted');
    ...
    value: _asyncToGenerator(function* (newPath) {
      ...
      var _default$parse2 = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parse(this._uri);
    ...
    value: _asyncToGenerator(function* (callback) {
      ...
      entries.sort(function (a, b) {
        ...
        (0, (_assert || _load_assert()).default)(entry);
        var uri = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.createRemoteUri(_this3._host, (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.join(_this3._localPath, entry.file));
    ...
    value: function contains(pathToCheck) {
      ...
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.contains(this.getPath(), pathToCheck);
    }
  }, {
    key: 'off',
    value: function off() {}
