...
exports.default = (() => {
  var _ref = (0, _asyncToGenerator.default)(function* (config) {
    const bigDigClient = yield (0, (_client || _load_client()).createBigDigClient)(Object.assign({}, config, {
    ...
    return {
      bigDigClient,
      rpcConnection: (_nuclideRpc || _load_nuclideRpc()).RpcConnection.createRemote(bigDigTransport, (0, (_nuclideMarshalersAtom || _load_nuclideMarshalersAtom()).getAtomSideMarshalers)(config.host), (_servicesConfig || _load_servicesConfig()).default, { trackSampleRate: 10 }, (_config || _load_config()).SERVICE_FRAMEWORK3_PROTOCOL)
    };
  });
