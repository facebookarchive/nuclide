...
function createLocalRpcClient() {
  ...
  var serviceRegistry = new (_nuclideRpc2 || _nuclideRpc()).ServiceRegistry([(_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.localMarshallers], (_nuclideServerLibServicesConfig2 || _nuclideServerLibServicesConfig()).default);
  ...
  return (_nuclideRpc2 || _nuclideRpc()).RpcConnection.createLocal(localTransports.clientTransport, [(_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.localMarshallers], (_nuclideServerLibServicesConfig2 || _nuclideServerLibServicesConfig()).default);
}
