...
var RemoteFile = (function () {
  ...
  _createClass(RemoteFile, [{
    ...
    value: function _handleNativeRenameEvent(newPath) {
      ...
      var _default$parse = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parse(this._path);
    ...
    value: function setPath(remotePath) {
      var _default$parse2 = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parse(remotePath);
    ...
    value: function getBaseName() {
      return (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.basename(this._path);
    }
  }, {
    key: 'create',
    value: _asyncToGenerator(function* () {
    ...
    value: function getParent() {
      var _default$parse3 = (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.parse(this._path);
      ...
      (0, (_assert2 || _assert()).default)(protocol);
      (0, (_assert2 || _assert()).default)(host);
      var directoryPath = protocol + '//' + host + (_commonsNodeNuclideUri2 || _commonsNodeNuclideUri()).default.dirname(localPath);
