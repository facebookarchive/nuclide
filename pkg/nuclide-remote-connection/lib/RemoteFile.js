...
var RemoteFile = (function () {
  ...
  _createClass(RemoteFile, [{
    ...
    value: function _handleNativeRenameEvent(newPath) {
      ...
      var _default$parse = (_nuclideRemoteUri2 || _nuclideRemoteUri()).default.parse(this._path);
    ...
    value: function setPath(remotePath) {
      var _default$parse2 = (_nuclideRemoteUri2 || _nuclideRemoteUri()).default.parse(remotePath);
