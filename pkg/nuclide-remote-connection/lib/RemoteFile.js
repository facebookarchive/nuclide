'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.RemoteFile = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _UniversalDisposable;
...
function _load_passesGK() {return _passesGK = _interopRequireDefault(require('../../commons-node/passesGK'));}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../modules/nuclide-commons/nuclideUri'));}
var _crypto = _interopRequireDefault(require('crypto'));
var _atom = require('atom');var _log4js;
...
/* Mostly implements https://atom.io/docs/api/latest/File */ /**
  ...
  _checkWatchOutOfOpenDirectories() {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      const isPathInOpenDirectories = atom.project.contains(_this._path);
      if (
      !isPathInOpenDirectories && (
      yield (0, (_passesGK || _load_passesGK()).default)('nuclide_watch_warn_unmanaged_file')))
      {
        atom.notifications.addWarning(
        `Couldn't watch remote file \`${(_nuclideUri || _load_nuclideUri()).default.basename(
        _this._path)
        }\` for changes!`,
        {
          detail:
  ...
  getDigestSync() {
    ...
    // flowlint-next-line sketchy-null-string:off
    if (!this._digest) {throw new Error('Invariant violation: "this._digest"');}
    return this._digest;
  }

  getDigest() {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      // flowlint-next-line sketchy-null-string:off
      if (_this2._digest) {
      ...
      yield _this2.read();
      // flowlint-next-line sketchy-null-string:off
      if (!_this2._digest) {throw new Error('Invariant violation: "this._digest"');}
      return _this2._digest;})();
  }

  _setDigest(contents) {
    const hash = _crypto.default.createHash('sha1').update(contents || '');if (!
    hash) {throw new Error('Invariant violation: "hash"');}
  ...
  getRealPath() {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      if (_this3._realpath == null) {
        _this3._realpath = yield _this3._getFileSystemService().realpath(_this3._path);
      }if (!
      _this3._realpath) {throw new Error('Invariant violation: "this._realpath"');}
  ...
  create() {var _this4 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  delete() {var _this5 = this;return (0, _asyncToGenerator.default)(function* () {
      try {
  ...
  copy(newPath) {var _this6 = this;return (0, _asyncToGenerator.default)(function* () {
      const wasCopied = yield _this6._getFileSystemService().copy(
      _this6._path,
      newPath);
  ...
  read(flushCache) {var _this7 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  write(text) {var _this8 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  writeWithPermission(text, permission) {var _this9 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  createWriteStream() {
    ...
    // $FlowIgnore
    stream.end = cb => {if (!(
      cb instanceof Function)) {throw new Error('end() called without a callback');}
