...
var RemoteFile = (function () {
  ...
  _createClass(RemoteFile, [{
    ...
    value: function _subscribeToNativeChangeEvents() {
      ...
      var watchStream = watchFile(this._path).refCount();
    ...
    value: function _handleNativeRenameEvent(newPath) {
      ...
      var _default$parse = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parse(this._path);
    ...
    value: function getDigestSync() {
      ...
      (0, (_assert || _load_assert()).default)(this._digest);
      return this._digest;
    }
  }, {
    key: 'getDigest',
    ...
    value: function _setDigest(contents) {
      var hash = (_crypto || _load_crypto()).default.createHash('sha1').update(contents || '');
      (0, (_assert || _load_assert()).default)(hash);
    ...
    value: function setPath(remotePath) {
      var _default$parse2 = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parse(remotePath);
    ...
    value: _asyncToGenerator(function* () {
      ...
      (0, (_assert || _load_assert()).default)(this._realpath);
      return this._realpath;
    })
  }, {
    key: 'getBaseName',
    value: function getBaseName() {
      return (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.basename(this._path);
    }
  }, {
    key: 'create',
    value: _asyncToGenerator(function* () {
    ...
    value: function getParent() {
      var _default$parse3 = (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.parse(this._path);
      ...
      (0, (_assert || _load_assert()).default)(protocol);
      (0, (_assert || _load_assert()).default)(host);
      var directoryPath = protocol + '//' + host + (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.dirname(localPath);
