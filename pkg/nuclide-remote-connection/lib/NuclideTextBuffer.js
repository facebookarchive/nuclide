  ...
  _createClass(NuclideTextBuffer, [{
    ...
    value: _asyncToGenerator(function* (filePath) {
      ...
      try {
        ...
        yield (0, (_commonsAtomLoadingNotification || _load_commonsAtomLoadingNotification()).default)(file.write(toSaveContents), 'Saving ' + (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.nuclideUriToDisplayString(filePath) + '...', 500);
        /* delay */
