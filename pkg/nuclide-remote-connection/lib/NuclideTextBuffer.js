...
var NuclideTextBuffer = (function (_TextBuffer) {
  ...
  _createClass(NuclideTextBuffer, [{
    ...
    value: _asyncToGenerator(function* (filePath) {
      ...
      try {
        var file = this.file;
        (0, (_assert || _load_assert()).default)(file, 'Cannot save an null file!');
        this._pendingSaveContents = toSaveContents;
        yield (0, (_commonsAtomLoadingNotification || _load_commonsAtomLoadingNotification()).default)(file.write(toSaveContents), 'Saving ' + (_commonsNodeNuclideUri || _load_commonsNodeNuclideUri()).default.nuclideUriToDisplayString(filePath) + '...', 1000);
        /* delay */
    ...
    value: _asyncToGenerator(function* (flushCache, callback) {
      try {
        ...
        yield (_atom || _load_atom()).TextBuffer.prototype.updateCachedDiskContents.call(this, flushCache, callback);
        this._exists = true;
      } catch (e) {
        this._exists = false;
        throw e;
    ...
    value: function setTextViaDiff(newText) {
      if (this.getLineCount() > DIFF_LINE_LIMIT || (0, (_commonsNodeString || _load_commonsNodeString()).countOccurrences)(newText, '\n') > DIFF_LINE_LIMIT) {
    ...
    value: function subscribeToFile() {
      ...
      var file = this.file;
      (0, (_assert || _load_assert()).default)(file, 'Cannot subscribe to no-file');
      this.fileSubscriptions = new (_atom || _load_atom()).CompositeDisposable();
