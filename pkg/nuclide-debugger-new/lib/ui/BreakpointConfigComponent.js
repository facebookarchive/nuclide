...
class BreakpointConfigComponent extends _react.Component {
  ...
  componentDidMount() {
    (0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)((_constants || _load_constants()).AnalyticsEvents.DEBUGGER_BREAKPOINT_CONFIG_UI_SHOW, {
      fileExtension: (_nuclideUri || _load_nuclideUri()).default.extname(this.props.breakpoint.uri)
    });
    this._disposables.add(atom.commands.add('atom-workspace', 'core:cancel', this.props.onDismiss), atom.commands.add('atom-workspace', 'core:confirm', this._updateBreakpoint.bind(this)), _rxjsBundlesRxMinJs.Observable.timer(100).subscribe(() => {
  ...
  _updateBreakpoint() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      (0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)((_constants || _load_constants()).AnalyticsEvents.DEBUGGER_BREAKPOINT_UPDATE_CONDITION, {
        path: breakpoint.uri,
        line: breakpoint.line,
        condition,
      ...
      _react.createElement(
        ...
        _react.createElement(
          ...
          _react.createElement(
            ...
            ':',
            this.props.breakpoint.endLine != null ? this.props.breakpoint.endLine : this.props.breakpoint.line
          )
        ),
        _react.createElement(
          'div',
          ...
          _react.createElement((_Checkbox || _load_Checkbox()).Checkbox, {
            onChange: isChecked => {
              (0, (_nuclideAnalytics || _load_nuclideAnalytics()).track)((_constants || _load_constants()).AnalyticsEvents.DEBUGGER_BREAKPOINT_TOGGLE_ENABLED, {
                enabled: isChecked
              });
