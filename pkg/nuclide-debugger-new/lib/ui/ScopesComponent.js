...
class ScopesComponent extends _react.Component {
  ...
  componentDidMount() {
    ...
    this._disposables.add((0, (_event || _load_event()).observableFromSubscribeFunction)(model.onDidChangeCallStack.bind(model)).debounceTime(100).switchMap(() => this._getScopes()).subscribe(scopes => {
