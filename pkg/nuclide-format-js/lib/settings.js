...
var _nuclideFormatJsBase = require('../../nuclide-format-js-base');

var _nuclideFormatJsBase2 = _interopRequireDefault(_nuclideFormatJsBase);

// Nuclide package settings used to calculate the module map,
// the blacklist, and control the plugin behavior.
var createModuleMap = _nuclideFormatJsBase2.default.createModuleMap;

// We need this in array formats.
var defaultAliases = Array.from(_nuclideFormatJsBase2.default.defaultAliases);
var defaultBuiltIns = Array.from(_nuclideFormatJsBase2.default.defaultBuiltIns);
var defaultBuiltInTypes = Array.from(_nuclideFormatJsBase2.default.defaultBuiltInTypes);
...
function observeSettings(callback) {
  return _nuclideFeatureConfig2.default.observe('nuclide-format-js', function (settings) {
