  ...
  getAdditionalLogFiles() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      const err = function (msg) {
        return [{ title: path + ':hg', data: msg }];
      };
      const results = yield Promise.race([_this._service.getAdditionalLogFiles().catch(function (e) {
        return err(e.message);
      }), (0, (_promise || _load_promise()).sleep)(50000).then(function () {
        return err('no response in 50s');
      })]);
