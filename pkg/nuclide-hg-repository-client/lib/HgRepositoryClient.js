...
var _commonsNodeFsSync2;

function _commonsNodeFsSync() {
  return _commonsNodeFsSync2 = _interopRequireDefault(require('../../commons-node/fsSync'));
}
...
var HgRepositoryClient = (function () {
  function HgRepositoryClient(repoPath, hgService, options) {
    ...
    this._serializedRefreshStatusesCache = (0, (_commonsNodePromise2 || _commonsNodePromise()).serializeAsyncCall)(this._refreshStatusesOfAllFilesInCache.bind(this));
    ...
    var serializedUpdateChangedPaths = (0, (_commonsNodePromise2 || _commonsNodePromise()).serializeAsyncCall)(function () {
  ...
  _createClass(HgRepositoryClient, [{
    ...
    value: function getDirectoryStatus(directoryPath) {
      ...
      var directoryPathWithSeparator = (_commonsNodeFsSync2 || _commonsNodeFsSync()).default.ensureTrailingSeparator(directoryPath);
