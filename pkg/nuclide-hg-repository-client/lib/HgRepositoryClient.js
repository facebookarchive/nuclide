...
function _load_string() {return _string = require('nuclide-commons/string');}var _hgDiffOutputParser;
...
function _load_observable() {return _observable = require('nuclide-commons/observable');}var _RevisionsCache;
...
function _load_observePaneItemVisibility() {return _observePaneItemVisibility = _interopRequireDefault(require('nuclide-commons-atom/observePaneItemVisibility'));}var _textEditor;
function _load_textEditor() {return _textEditor = require('nuclide-commons-atom/text-editor');}var _textBuffer;
...
function _load_collection() {return _collection = require('nuclide-commons/collection');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const STATUS_DEBOUNCE_DELAY_MS = 300; /**
  ...
  options)
  {
    ...
    _rxjsBundlesRxMinJs.Observable.defer(() => {
      return _rxjsBundlesRxMinJs.Observable.fromPromise(this._service.fetchBookmarks()).timeout(
  ...
  {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      const prefix = (_nuclideUri || _load_nuclideUri()).default.isRemote(path) ?
      `${(_nuclideUri || _load_nuclideUri()).default.getHostname(path)}:` :
      '';
      const results = yield (0, (_promise || _load_promise()).timeoutAfterDeadline)(
      deadline,
      _this._service.getAdditionalLogFiles(deadline - 1000)).
