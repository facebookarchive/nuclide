...
function isEqualRevisions(revisions1, revisions2) {
  ...
  return (0, (_commonsNodeCollection2 || _commonsNodeCollection()).arrayEqual)(revisions1, revisions2, function (revision1, revision2) {
    return revision1.id === revision2.id && (0, (_commonsNodeCollection2 || _commonsNodeCollection()).arrayEqual)(revision1.tags, revision2.tags) && (0, (_commonsNodeCollection2 || _commonsNodeCollection()).arrayEqual)(revision1.bookmarks, revision2.bookmarks);
  });
}
