...
observeRemoteDebugCommands = observeRemoteDebugCommands;exports.
...
observeAttachDebugTargets = observeAttachDebugTargets;var _http = _interopRequireDefault(require('http'));var _net = _interopRequireDefault(require('net'));var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _log4js;function _load_log4js() {return _log4js = require('log4js');}var _promise;function _load_promise() {return _promise = require('nuclide-commons/promise');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             */let isServerSetup = false;const debugRequests = new _rxjsBundlesRxMinJs.Subject();const attachReady = new Map();const DEBUGGER_REGISTRY_PORT = 9615;function observeRemoteDebugCommands() {let setupStep;if (!isServerSetup) {setupStep = _rxjsBundlesRxMinJs.Observable.fromPromise(setupServer()).ignoreElements();} else {setupStep = _rxjsBundlesRxMinJs.Observable.empty();}return setupStep.concat(debugRequests).publish();}function observeAttachDebugTargets() {// Validate attach-ready values with the processes with used ports (ready to attach).
  ...
  return _rxjsBundlesRxMinJs.Observable.interval(3000).startWith(0).switchMap(() => Promise.all(Array.from(attachReady.values()).map((() => {var _ref = (0, _asyncToGenerator.default)(function* (target) {if (!(yield isPortUsed(target.port))) {attachReady.delete(target.port);}
