# Contributing to `atom-ide-debugger-python`

Run the following commands to run `atom-ide-debugger-python` from source:

```
# Clone the source
$ git clone https://github.com/facebook-atom/atom-ide-debugger-python
...
- Install [`linter-eslint`](https://atom.io/packages/linter-eslint) for ESLint integration.
  - Skip the `linter` dependency to use atom-ide-debugger-python's Diagnostics.
...
By contributing to atom-ide-debugger-python, you agree that your contributions will be licensed
