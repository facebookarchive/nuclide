...
const executableValidator_1 = require("./executableValidator");
...
function registerDebuggerTypes(serviceManager) {
    ...
    serviceManager.addSingleton(types_5.IExcutableValidator, executableValidator_1.ExcutableValidator);
}
