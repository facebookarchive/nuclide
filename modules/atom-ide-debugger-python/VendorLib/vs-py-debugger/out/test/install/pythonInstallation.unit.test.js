...
class TestContext {
    constructor(isMac) {
        ...
        this.serviceManager.addSingletonInstance(types_2.IFileSystem, TypeMoq.Mock.ofType().object);
        this.serviceManager.addSingletonInstance(types_3.IPersistentStateFactory, TypeMoq.Mock.ofType().object);
        const helper = new helpers_1.InterpreterHelper(this.serviceContainer);
        this.serviceManager.addSingletonInstance(contracts_1.IInterpreterHelper, helper);
...
//# sourceMappingURL=pythonInstallation.unit.test.js.map
