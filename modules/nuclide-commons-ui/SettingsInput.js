...
var _react = _interopRequireWildcard(require('react'));var _SettingsUtils;
function _load_SettingsUtils() {return _SettingsUtils = require('./SettingsUtils');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}
...
class SettingsInput extends _react.Component {
  ...
  constructor(props) {
    ...
    _onFocus = () => {
      ...
      const input = this._input;if (!(
      input != null)) {throw new Error('Invariant violation: "input != null"');}
    ...
    };this._ignoreInputCallback = false;}_updateInput(input, newValue) {this._ignoreInputCallback = true;input.setText(newValue);this._ignoreInputCallback = false;}
  ...
  render() {
    ...
    return (
      _react.createElement('div', null,
        ...
        _react.createElement('div', { className: 'controls' },
          _react.createElement('div', { className: 'editor-container' },
            _react.createElement('subview', null,
