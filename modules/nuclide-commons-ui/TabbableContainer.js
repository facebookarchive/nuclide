...
/**
                                                 ...
                                                 */ /**
                                                     ...
                                                     * 
                                                     * @format
                                                     */ /* eslint-env browser */class TabbableContainer extends _react.default.Component {componentDidMount() {
    const rootNode = this._rootNode;if (!(
    rootNode != null)) {throw new Error('Invariant violation: "rootNode != null"');}
    ...
    _rxjsBundlesRxMinJs.Observable.fromEvent(rootNode, 'keydown').subscribe(
    event => {
  ...
  }}exports.default = TabbableContainer;TabbableContainer.defaultProps = { contained: false, autoFocus: false };
