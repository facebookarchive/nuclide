'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.CodeSnippet = undefined;var _AtomInput;
...
class CodeSnippet extends _react.Component {
  ...
  componentDidMount() {if (!(
    this._editor != null)) {throw new Error('Invariant violation: "this._editor != null"');}
  ...
  render() {
    ...
    return (
      _react.createElement('div', { className: 'nuclide-ui-code-snippet' },
        _react.createElement('div', { className: 'nuclide-ui-code-snippet-line-number-column' },
          lineNumbers),
