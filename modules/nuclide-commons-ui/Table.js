'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.Table = undefined;exports.
...
_calculateColumnWidths = _calculateColumnWidths;exports.
...
_calculatePreferredColumnWidths = _calculatePreferredColumnWidths;var _nullthrows;function _load_nullthrows() {return _nullthrows = _interopRequireDefault(require('nullthrows'));}var _classnames;function _load_classnames() {return _classnames = _interopRequireDefault(require('classnames'));}var _react = _interopRequireWildcard(require('react'));var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _shallowequal;function _load_shallowequal() {return _shallowequal = _interopRequireDefault(require('shallowequal'));}var _Icon;function _load_Icon() {return _Icon = require('./Icon');}var _collection;function _load_collection() {return _collection = require('../nuclide-commons/collection');}var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../nuclide-commons/UniversalDisposable'));}var _observableDom;function _load_observableDom() {return _observableDom = require('./observable-dom');}var _scrollIntoView;function _load_scrollIntoView() {return _scrollIntoView = require('./scrollIntoView');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const DEFAULT_MIN_COLUMN_WIDTH = 40; /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             * @format
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             */const DefaultEmptyComponent = () => _react.createElement('div', { className: 'nuclide-ui-table-empty-message' }, 'Empty table'); // Same shape; the separate type is just used for documentation--Flow doesn't recognize a
// difference.
/**
 * Design concerns:
 *
 ...
 */class Table extends _react.Component {constructor(props) {super(props);this._resizeStarts = new _rxjsBundlesRxMinJs.Subject();this.state = { preferredColumnWidths: getInitialPreferredColumnWidths(props.columns), resizeOffset: null, tableWidth: 0, usingKeyboard: false };}shouldComponentUpdate(nextProps, nextState) {// If the state changed, we need to re-render.
    if (!(0, (_shallowequal || _load_shallowequal()).default)(nextState, this.state)) {return true;}if (!(0, (_shallowequal || _load_shallowequal()).default)(nextProps, this.props, compareCheapProps)) {return true;}if (!(0, (_collection || _load_collection()).arrayEqual)(nextProps.columns, this.props.columns, (_shallowequal || _load_shallowequal()).default)) {return true;}if (!(0, (_collection || _load_collection()).arrayEqual)(nextProps.rows, this.props.rows)) {return true;}return false;}componentDidMount() {const el = (0, (_nullthrows || _load_nullthrows()).default)(this._rootNode);this._disposables = new (_UniversalDisposable || _load_UniversalDisposable()).default( // Update the column widths when the table is resized.
    new (_observableDom || _load_observableDom()).ResizeObservable(el).startWith(null).map(() => el.offsetWidth).filter(tableWidth => tableWidth > 0).subscribe(tableWidth => {this.setState({ tableWidth });}), this._resizeStarts.switchMap(({ event: startEvent, resizerLocation }) => {const startX = startEvent.pageX;return _rxjsBundlesRxMinJs.Observable.fromEvent(document, 'mousemove').takeUntil(_rxjsBundlesRxMinJs.Observable.fromEvent(document, 'mouseup')).map(event => ({ deltaPx: event.pageX - startX, resizerLocation })).concat(_rxjsBundlesRxMinJs.Observable.of(null));}).subscribe(resizeOffset => {if (resizeOffset == null) {// Finalize the resize by updating the user's preferred column widths to account for
  ...
  const widths = {};{let remainingWidth = 1;columnOrder.forEach((columnName, i) => {const isLastColumn = i === columnOrder.length - 1;if (isLastColumn) {// Give the last column all the remaining to account for rounding issues.
        widths[columnName] = remainingWidth;} else {widths[columnName] = widthsPx[columnName] / tableWidth;remainingWidth -= widths[columnName];}});}return widths;} /**
                                                                                                                                                                      ...
                                                                                                                                                                      */function _calculatePreferredColumnWidths(options) {const { currentWidths, tableWidth, minWidths: minWidthsPx } = options;const currentWidthsPx = (0, (_collection || _load_collection()).objectMapValues)(currentWidths, w => w * tableWidth); // If any column is at its minimum width, we take that to mean that the user wants the column
  ...
  const columnsNotAtMinimum = [];for (const [columnName, widthPx] of Object.entries(currentWidthsPx)) {if (!(typeof widthPx === 'number')) {throw new Error('Invariant violation: "typeof widthPx === \'number\'"');}const minWidthPx = minWidthsPx[columnName];if (Math.floor(widthPx) <= minWidthPx) {// Keep it at its min-width.
      preferredColumnWidths[columnName] = 0;} else {remainingPx += widthPx;columnsNotAtMinimum.push([columnName, widthPx]);}} // Now distribute the widths of the other columns.
  let remainingPct = 1;columnsNotAtMinimum.forEach(([columnName, width], index) => {const isLastColumn = index === columnsNotAtMinimum.length - 1;if (isLastColumn) {// We give the last column the remaining width just to be certain they all add up to 1.
      preferredColumnWidths[columnName] = remainingPct;} else {preferredColumnWidths[columnName] = width / remainingPx;remainingPct -= preferredColumnWidths[columnName];}});return preferredColumnWidths;} /**
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             * necessary.)
                                                                                                                                                                                                             */function compareCheapProps(a, b, key) {switch (key) {case undefined: // This is a magic way of telling `shallowEqual()` to use the default comparison for the
      // props objects (inspect its members).
      return undefined;case 'rows':case 'columns': // We'll check these later iff we need to since they're more expensive.
      return true;default:return a === b;}}