...
exports.HighlightedCodeExamples = undefined;
...
class HighlightedCodeExample extends _react.Component {
  constructor(...args) {
    var _temp;
  ...
  render() {
    ...
    const AsyncMode = _react.unstable_AsyncMode;
    return _react.createElement(
      'div',
      null,
      'The code below is rendered with async React, so highlighting does not block (no matter how many lines have to be tokenized).',
