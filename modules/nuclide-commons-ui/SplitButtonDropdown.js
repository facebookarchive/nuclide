'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ButtonSizes = exports.SplitButtonDropdown = undefined;
...
function _load_ButtonGroup() {return _ButtonGroup = require('./ButtonGroup');}var _Dropdown;
function _load_Dropdown() {return _Dropdown = require('./Dropdown');}var _classnames;
...
var _electron = _interopRequireDefault(require('electron'));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                           * 
                                                                                                                                                                                                                                                                                                                                                                                                                           * @format
                                                                                                                                                                                                                                                                                                                                                                                                                           */const { remote } = _electron.default;if (!(remote != null)) {throw new Error('Invariant violation: "remote != null"');}
...
class SplitButtonDropdown extends _react.Component {
  render() {
    const {
      ...
      value } =
    this.props;
    const selectedOption = this._findSelectedOption(options) || options[0];if (!(
    selectedOption.type !== 'separator')) {throw new Error('Invariant violation: "selectedOption.type !== \'separator\'"');}
    const ButtonComponent = buttonComponent || (_Button || _load_Button()).Button;
    // $FlowFixMe(>=0.53.0) Flow suppress
    const dropdownOptions = options.map(option => Object.assign({},
    option, {
      selectedLabel: '' }));


    return (
      _react.createElement((_ButtonGroup || _load_ButtonGroup()).ButtonGroup, {
          className: (0, (_classnames || _load_classnames()).default)(className, 'nuclide-ui-split-button-dropdown') },
        _react.createElement(ButtonComponent, {
  ...
  _findSelectedOption(options) {
    ...
    return result;
  }}exports.SplitButtonDropdown = SplitButtonDropdown;exports.
