...
var _reactDom = require('react-dom');function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;} /**
  ...
  constructor(props) {
    ...
    };this._lastInternalEvent = null;this._node = null;}componentDidMount() {const node = this._node = (0, _reactDom.findDOMNode)(this);if (node == null) {return;}window.document.addEventListener('click', this._handleDocumentClick); // We use an actual DOM node (via refs) because React does not gaurnetee
    ...
    node.addEventListener('click', this._handleInternalClick);}componentWillUnmount() {window.document.removeEventListener('click', this._handleDocumentClick);if (this._node != null) {
      this._node.removeEventListener('click', this._handleInternalClick);
    }
  }

  render() {
    const _props = this.props,{ onClickOutside } = _props,passThroughProps = _objectWithoutProperties(_props, ['onClickOutside']);
