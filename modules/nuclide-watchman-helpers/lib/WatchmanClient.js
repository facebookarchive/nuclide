...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _fbWatchman;
function _load_fbWatchman() {return _fbWatchman = _interopRequireDefault(require('fb-watchman'));}var _promise;
function _load_promise() {return _promise = require('nuclide-commons/promise');}var _string;
function _load_string() {return _string = require('nuclide-commons/string');}var _path;
function _load_path() {return _path = require('./path');}var _WatchmanSubscription;
function _load_WatchmanSubscription() {return _WatchmanSubscription = _interopRequireDefault(require('./WatchmanSubscription'));}var _log4js;
...
class WatchmanClient {
  ...
  _initWatchmanClient() {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _createClientPromise() {return (0, _asyncToGenerator.default)(function* () {
      return new (_fbWatchman || _load_fbWatchman()).default.Client({
        watchmanBinaryPath: yield (0, (_path || _load_path()).getWatchmanBinaryPath)() });})();

  }

  _reconnectClient() {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _restoreSubscriptions() {var _this4 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      let numRestored = 0;
      yield Promise.all(
      watchSubscriptions.map((() => {var _ref = (0, _asyncToGenerator.default)(
        function* (subscription, index) {
          ...
          subscription.options.since = yield _this4._clock(root);
          logger.info(
          `Subscribing to ${name}: (${index + 1}/${numSubscriptions})`);

          yield _this4._subscribe(root, name, options);
          ++numRestored;
          logger.info(
  ...
  _onSubscriptionResult(response) {
    ...
    if (Array.isArray(response.files)) {
      ...
      stateEnter != null ?
      `Entering ${stateEnter}` :
      `Leaving ${(0, (_string || _load_string()).maybeToString)(stateLeave)}`;
  ...
  localDirectoryPath,
  subscriptionName = localDirectoryPath,
  subscriptionOptions)
  ...
  unwatch(entryPath) {var _this6 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _watchList() {var _this8 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _watch(directoryPath) {var _this9 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _watchProject(directoryPath) {var _this10 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _clock(directoryPath) {var _this11 = this;return (0, _asyncToGenerator.default)(function* () {
