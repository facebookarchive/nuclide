...
function _load_nodeIpc() {return _nodeIpc = _interopRequireDefault(require('node-ipc'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                        ...
                                                                                                                                                                                        * 
                                                                                                                                                                                        * @format
                                                                                                                                                                                        */let started = false; // eslint-disable-next-line rulesdir/no-unresolved
const startServer = exports.startServer = ({ serverID }) => {if (started) {throw new Error('IPC server can only be started once');}
