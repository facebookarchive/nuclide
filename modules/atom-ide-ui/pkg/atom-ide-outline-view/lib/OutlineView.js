...
class OutlineView extends _react.default.PureComponent {
...
class OutlineViewComponent extends _react.default.PureComponent {
  ...
  render() {
    ...
    switch (outline.kind) {
      ...
      case 'outline':
        return _react.default.createElement(OutlineViewCore, { outline: outline, searchEnabled: searchEnabled });
      default:
        outline;
    }
  }
 ...
 */
class OutlineViewCore extends _react.default.PureComponent {
  constructor(...args) {
    var _temp;
  ...
  render() {
    ...
    return _react.default.createElement(
      ...
      searchEnabled ? _react.default.createElement((_OutlineViewSearch || _load_OutlineViewSearch()).OutlineViewSearchComponent, {
