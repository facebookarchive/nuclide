...
class Activation {
  ...
  constructor() {
    ...
    this._editorService = new (_ActiveEditorRegistry || _load_ActiveEditorRegistry()).default((provider, editor) => provider.getOutline(editor), {}, getActiveEditorRegistryEventSources());
  }
