'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _log4js;
...
const CHANGE_TOGGLE_MS = 2500;class CodeHighlightManager {constructor() {
  ...
  _highlightEditors() {var _this = this;
    ...
    switchMap(editor => {
      ...
      const cursorPositions = (0, (_event || _load_event()).observableFromSubscribeFunction)(
      ...
      .let((0, (_observable || _load_observable()).fastDebounce)(CURSOR_DELAY_MS)).
      startWith(null) // Immediately kick off a highlight event.
      ...
      const changeEvents = (0, (_event || _load_event()).observableFromSubscribeFunction)(
      editor.onDidChange.bind(editor)).

      do(() => this._destroyMarkers()).
      share();

      const changeToggles = _rxjsBundlesRxMinJs.Observable.merge(
      _rxjsBundlesRxMinJs.Observable.of(true),
      changeEvents.mapTo(false),
      changeEvents.let((0, (_observable || _load_observable()).fastDebounce)(CHANGE_TOGGLE_MS)).mapTo(true));
      ...
      let((0, (_observable || _load_observable()).toggle)(changeToggles)).
      switchMap((() => {var _ref = (0, _asyncToGenerator.default)(function* (position) {
          return {
            editor,
