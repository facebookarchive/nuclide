...
function _load_goToLocation() {return _goToLocation = require('../../../../../nuclide-commons-atom/go-to-location');}var _CodeSnippet;
function _load_CodeSnippet() {return _CodeSnippet = require('../../../../../nuclide-commons-ui/CodeSnippet');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}} /**
...
class FileReferencesView extends _react.Component {
  ...
  render() {
    const groups = this.props.refGroups.map((group, i) => {
      ...
      if (firstRef.name && firstRef.name === lastRef.name) {
        ...
        _react.createElement('span', null,
          ' ', 'in ',
          _react.createElement('code', null, firstRef.name));
      ...
      return (
        _react.createElement('li', { key: group.startLine, className: 'find-references-ref' },
    ...
    const outerClassName = (0, (_classnames || _load_classnames()).default)('find-references-file list-nested-item', {
    ...
    return (
      _react.createElement('li', { className: `${outerClassName}` },
        _react.createElement('div', {
          ...
          _react.createElement('a', { onClick: this._onFileNameClick },
            (_nuclideUri || _load_nuclideUri()).default.relative(this.props.basePath, this.props.uri)),

          _react.createElement('span', { className: 'find-references-ref-count badge badge-small' },
            groups.length)),


        _react.createElement('ul', { className: 'find-references-refs list-tree' }, groups)));
