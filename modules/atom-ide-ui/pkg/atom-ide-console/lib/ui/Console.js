...
let createPaste = (() => {
  var _ref2 = (0, _asyncToGenerator.default)(function* (createPasteImpl, records) {
    const lines = records.filter(function (displayable) {
  ...
  return function createPaste(_x, _x2) {
