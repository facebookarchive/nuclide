...
function _load_ObservableDiagnosticUpdater() {
  return _ObservableDiagnosticUpdater = _interopRequireDefault(require('./services/ObservableDiagnosticUpdater'));
}
...
class Activation {
  ...
  provideObservableDiagnosticUpdates() {
    return new (_ObservableDiagnosticUpdater || _load_ObservableDiagnosticUpdater()).default(this._store);
  }
