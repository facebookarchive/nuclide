...
function traceElements(props) {
  ...
  return message.trace && message.trace.length ? _react.default.createElement(
    'div',
    { className: 'diagnostics-popup-trace' },
    message.trace.map((traceItem, i) => _react.default.createElement((_DiagnosticsTraceItem || _load_DiagnosticsTraceItem()).DiagnosticsTraceItem, {
      key: i,
      trace: traceItem,
