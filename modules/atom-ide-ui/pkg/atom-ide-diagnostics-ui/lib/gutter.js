...
function _applyUpdateToEditor(editor, update, diagnosticUpdater, blockDecorationContainer, openedMessageIds, setOpenMessageIds) {
  ...
  return new (_UniversalDisposable().default)(() => abortController.abort(), editor.onDidDestroy(() => {
...
function createBlockDecorations({
  ...
  return React.createElement(React.Fragment, null, Array.from(blockRowToMessages).map(([row, messages]) => {
