...
showActionsMenu;var _electron = _interopRequireDefault(require('electron'));var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _collection;function _load_collection() {return _collection = require('../../../../nuclide-commons/collection');}var _event;function _load_event() {return _event = require('../../../../nuclide-commons/event');}var _UniversalDisposable;function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../../nuclide-commons/UniversalDisposable'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const { remote } = _electron.default; /**
  ...
  take(1).
  race(_rxjsBundlesRxMinJs.Observable.of(new WeakMap()).delay(CODE_ACTIONS_TIMEOUT)).
  subscribe(codeActionsForMessage => {
    const currentWindow = remote.getCurrentWindow();
    const menu = new remote.Menu();
    const fixes = (0, (_collection || _load_collection()).arrayCompact)(
    ...
    const actions = (0, (_collection || _load_collection()).arrayFlatten)(
    messagesAtPosition.map(message => {
    ...
    const scrollView = editorView.querySelector('.scroll-view');if (!(
    scrollView != null)) {throw new Error('Invariant violation: "scrollView != null"');}
