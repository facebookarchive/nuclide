'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.DatatipManager = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let getDatatipResults = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  ...
  invoke)
  {
    ...
    const promises = filteredDatatipProviders.map((() => {var _ref6 = (0, _asyncToGenerator.default)(
      function* (provider) {
        ...
        try {
          ...
          (0, (_log4js || _load_log4js()).getLogger)('datatip').error(
  ...
  // of text content".
  if (pixelPosition.left <= 0 || horizontalDistance > editor.getDefaultCharWidth()) {return null;}return editor.bufferPositionForScreenPosition(screenPosition);}function PinnableDatatip({ datatip, editor, onPinClick }) {let action;let actionTitle;
...
class DatatipManagerForEditor {
  ...
  {_initialiseProps.call(this);
    ...
    (_featureConfig || _load_featureConfig()).default.observe('atom-ide-datatip.datatipDebounceDelay', () =>
    ...
    _rxjsBundlesRxMinJs.Observable.fromEvent(this._editorView, 'focus').subscribe(e => {
  ...
  _setStartFetchingDebounce() {
    ...
    (_featureConfig || _load_featureConfig()).default.get('atom-ide-datatip.datatipDebounceDelay'),
  ...
  _setHideIfOutsideDebounce() {
    ...
    ensurePositiveNumber(
    (_featureConfig || _load_featureConfig()).default.get(
    'atom-ide-datatip.datatipInteractedWithDebounceDelay'),
  ...
  _startFetching(getPosition) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (
      _this._blacklistedPosition &&
      data.range &&
      data.range.containsPoint(_this._blacklistedPosition))
      {
        _this._setState(DatatipState.HIDDEN);
        return;
      }
      ...
      _this._markerDisposable = mountDatatipWithMarker(
      _this._editor,
      _this._datatipElement,
      data.range,
  ...
  _fetch(position) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      _this2._setState(DatatipState.FETCHING);

      let results;
      if (
      _this2._lastPosition != null &&
      position.isEqual(_this2._lastPosition) &&
      _this2._lastResultsPromise != null)
      {
        results = _this2._lastResultsPromise;
      } else {
        _this2._lastResultsPromise = getDatatipResults(
        _this2._datatipProviders,
        _this2._editor,
        position,
        function (provider) {return provider.datatip(_this2._editor, position);});

        results = _this2._lastResultsPromise;
        _this2._lastPosition = position;
      }

      return (yield results).concat((
      yield getDatatipResults(
      _this2._modifierDatatipProviders,
      _this2._editor,
      position,
      function (provider) {return (
          provider.modifierDatatip(_this2._editor, position, _this2._heldKeys));})));})();
  ...
  {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      _react.createElement('div', null,
        datatipsAndProviders.map(function ({ datatip, provider }) {return (
            _react.createElement(PinnableDatatip, {
              datatip: datatip,
  ...
  options)
  {
    const pinnedDatatip = new (_PinnedDatatip || _load_PinnedDatatip()).PinnedDatatip(datatip, editor, Object.assign({},
    options, {
      onDispose: () => {
  ...
  }}var _initialiseProps = function () {var _this4 = this;this.
  ...
  _handlePinClicked = (editor, datatip) => {
    ...
    new (_PinnedDatatip || _load_PinnedDatatip()).PinnedDatatip(datatip, editor, {
  ...
  _toggleDatatip = e => {var _ref, _ref2;
  ...
  _copyDatatipToClipboard = (0, _asyncToGenerator.default)(function* () {var _ref3, _ref4;
    ...
    const value = markedStrings.map(function (string) {return string.value;}).join();
    if (value === '') {
      return;
    }
