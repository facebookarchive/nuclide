  ...
  if (activeSignature.parameters != null) {
    ...
    if (activeParameter != null) {
      ...
      if (activeParameter.label !== '') {
        ...
        if (idx !== -1) {
          markedStrings[0].value = (0, (_string || _load_string()).escapeMarkdown)(activeSignature.label.substr(0, idx)) + '**' + (0, (_string || _load_string()).escapeMarkdown)(activeParameter.label) + '**' + (0, (_string || _load_string()).escapeMarkdown)(activeSignature.label.substr(idx + activeParameter.label.length));
        }
      }
    }
  }
