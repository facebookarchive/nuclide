'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _lineByLine;
...
function _load_lineByLine() {return _lineByLine = _interopRequireDefault(require('line-by-line'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class SourceFileCache {
  ...
  getFileDataByPath(path) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _fillCacheFromLocalFileSystem(path) {return (0, _asyncToGenerator.default)(function* () {
      return new Promise(function (resolve, reject) {
        const lines = [];

        // LineByLineReader splits the file on the fly so we don't
        // have to read into memory first
        new (_lineByLine || _load_lineByLine()).default(path).
        on('line', function (line) {return lines.push(line);}).
        on('end', function () {return resolve(lines);}).
        on('error', function (e) {return reject(e);});
      });})();
  }

  _fillCacheWithSourceReference(
  sourceReference)
