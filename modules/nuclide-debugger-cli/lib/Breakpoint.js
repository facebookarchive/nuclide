'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _vscodeDebugprotocol;
...
class Breakpoint {
  ...
  toString() {if (!
    false) {throw new Error('Breakpoint subclasses must implement toString()');}
  }
