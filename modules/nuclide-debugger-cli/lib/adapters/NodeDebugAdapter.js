...
function _load_VSPOptionsParser() {return _VSPOptionsParser = _interopRequireDefault(require('../VSPOptionsParser'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     * 
                                                                                                                                                                                                                     * @format
                                                                                                                                                                                                                     */class NodeDebugAdapter {constructor() {this.key = (_constants || _load_constants()).VsAdapterTypes.NODE;this.type = 'node2';this.excludedOptions = new Set(['args', 'console', 'diagnosticLogging', 'externalConsole', 'noDebug',
    'outputCapture',
    'program',
    'restart',
    'trace',
    ...
    'sourceMapPathOverrides',
    {
      ...
      parseType: 'array',
      parser: _parseSourceMapPathOverrides }]]);this.




    _includedOptions = new Set(['address', 'port']);}
