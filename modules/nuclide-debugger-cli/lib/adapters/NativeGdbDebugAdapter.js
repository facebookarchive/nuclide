...
function _load_VSPOptionsParser() {return _VSPOptionsParser = _interopRequireDefault(require('../VSPOptionsParser'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     * 
                                                                                                                                                                                                                     * @format
                                                                                                                                                                                                                     */class NativeGdbDebugAdapter {constructor() {this.key = (_constants || _load_constants()).VsAdapterTypes.NATIVE_GDB;this.type = 'mi';this.excludedOptions = new Set(['arguments', 'debuggerRoot', 'diagnosticLogging', 'stopOnAttach', 'program']);this.


    extensions = new Set();this.
    customArguments = new Map();this.

    _includedOptions = new Set();}
