...
function _load_DebuggerInterface() {return _DebuggerInterface = require('./DebuggerInterface');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
  ...
  constructor(con, debug) {this.name = 'print';this.helpText = 'expr: Prints the result of an expression in the context of the current stack frame.';this.detailedHelpText = `
print expression
...
in complex ways.
  `;this._console = con;this._debugger = debug;}execute(args) {var _this = this;return (0, _asyncToGenerator.default)(function* () {const expr = args.join(' ');try {const { body: { result } } = yield _this._debugger.evaluateExpression(expr);_this._console.outputLine(result);} catch (err) {const failure = JSON.parse(err.message);_this._console.outputLine(failure.message);}})();}}exports.default = PrintCommand;