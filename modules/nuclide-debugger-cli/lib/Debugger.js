 ...
 */class Debugger {
  ...
  constructor(logger, con) {this._threads = new (_ThreadCollection || _load_ThreadCollection()).default();this._state = 'INITIALIZING';this._breakpoints = new (_BreakpointCollection || _load_BreakpointCollection()).default();this._attachMode = false;
    this._logger = logger;
    this._console = con;
  ...
  _configurationDone() {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if ((0, (_nullthrows || _load_nullthrows()).default)(_this3._capabilities).supportsConfigurationDoneRequest) {
  ...
  _onStopped(event) {var _this21 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (allThreadsStopped === true) {
        ...
        _this21._console.outputLine('stop event with no thread information.');
      }
