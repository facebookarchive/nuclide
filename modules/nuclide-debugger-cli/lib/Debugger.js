...
class Debugger {
  ...
  relaunch() {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      yield _this.createSession(adapter.adapterInfo);
  ...
  createSession(adapterInfo) {
    ...
    return (0, _asyncToGenerator.default)(function* () {
      ...
      _this18._debugSession = new (_VsDebugSession || _load_VsDebugSession()).default(process.pid.toString(), _this18._logger, adapterInfo);
