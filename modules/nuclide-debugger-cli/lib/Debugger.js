...
function _load_ContinueCommand() {return _ContinueCommand = _interopRequireDefault(require('./ContinueCommand'));}var _SourceFileCache;
 ...
 */class Debugger {
  ...
  constructor(logger, con) {this._threads = new (_ThreadCollection || _load_ThreadCollection()).default();this._state = 'INITIALIZING';this._breakpoints = new (_BreakpointCollection || _load_BreakpointCollection()).default();
    this._logger = logger;
    this._console = con;
  ...
  relaunch() {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      switch (adapter.action) {
        case 'attach':
          const attachArgs = adapter.attachArgs;if (!(
          attachArgs != null)) {throw new Error('Invariant violation: "attachArgs != null"');}
          yield _this._ensureDebugSession(true).attach(attachArgs);
          break;

        case 'launch':
          const launchArgs = adapter.launchArgs;if (!(
          launchArgs != null)) {throw new Error('Invariant violation: "launchArgs != null"');}
  ...
  _configurationDone() {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      yield session.setExceptionBreakpoints({ filters: [] });if (!(

      _this3._capabilities != null)) {throw new Error('Invariant violation: "this._capabilities != null"');}
  ...
  {var _this13 = this;return (0, _asyncToGenerator.default)(function* () {
      const debuggerBreakpoints = _this13._breakpoints.getAllEnabledBreakpointsForSource(
      path);


      const request = {
        source: { path },
        breakpoints: debuggerBreakpoints.map(function (x) {return { line: x.line };}) };
      ...
      const paired = debuggerBreakpoints.map(function (_, i) {return [
        _,
  ...
  {var _this14 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (sourceReference != null && sourceReference !== 0) {
        lines = yield _this14._sourceFiles.getFileDataBySourceReference(
        sourceReference);
  ...
  setBreakpointEnabled(index, enabled) {var _this15 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  deleteBreakpoint(index) {var _this16 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (path != null) {
        const pathBreakpoints = _this16._breakpoints.getAllEnabledBreakpointsForSource(
        path);
  ...
  createSession(adapter) {var _this18 = this;return (0, _asyncToGenerator.default)(function* () {
      _this18._console.stopInput();

      _this18._threads = new (_ThreadCollection || _load_ThreadCollection()).default();

      _this18._debugSession = new (_VsDebugSession || _load_VsDebugSession()).default(
      ...
      _this18._initializeObservers();if (!(

      _this18._debugSession != null)) {throw new Error('Invariant violation: "this._debugSession != null"');}
  ...
  _resetAllBreakpoints() {var _this19 = this;return (0, _asyncToGenerator.default)(function* () {
      const session = _this19._ensureDebugSession();

      const sourceBreakpoints = _this19._breakpoints.getAllEnabledBreakpointsByPath();

      yield Promise.all(
      Array.from(sourceBreakpoints).map((() => {var _ref8 = (0, _asyncToGenerator.default)(function* ([path, breakpointLines]) {
          ...
          for (const breakpointOut of breakpointsOut) {
            ...
            const breakpoint = breakpointLines.find(function (_) {return _.line === line;});
            if (breakpoint != null) {
  ...
  closeSession() {var _this20 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _onStopped(event) {var _this21 = this;return (0, _asyncToGenerator.default)(function* () {
      const {
      ...
      if (firstStop) {
        if (threadId != null) {
          ...
          const firstStopped = _this21._threads.firstStoppedThread();if (!(
          firstStopped != null)) {throw new Error('Invariant violation: "firstStopped != null"');}
          _this21._threads.setFocusThread(firstStopped);
        }

        const topOfStack = yield _this21._getTopOfStackSourceInfo(
        (0, (_nullthrows || _load_nullthrows()).default)(_this21._threads.focusThreadId));
  ...
  _cacheThreads() {var _this22 = this;return (0, _asyncToGenerator.default)(function* () {if (!(

      _this22._debugSession != null)) {throw new Error(
  ...
  _getSourceByReference(sourceReference) {var _this24 = this;return (0, _asyncToGenerator.default)(function* () {
      const {
        body: { content } } =
      yield _this24._ensureDebugSession().source({
        sourceReference });
