...
function _load_vscodeDebugprotocol() {return _vscodeDebugprotocol = _interopRequireWildcard(require('vscode-debugprotocol'));}var _DebuggerInterface;



function _load_DebuggerInterface() {return _DebuggerInterface = require('./DebuggerInterface');}var _Format;
function _load_Format() {return _Format = _interopRequireDefault(require('./Format'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class ListCommand {
  ...
  constructor(con, debug) {this.name = 'list';this.helpText = "[line | source[:line] | @[:line]]: list source file contents. '@' may be used to refer to the source at the current stack frame.";this.detailedHelpText = `
...
current location in the ouput. Otherwise, listing will begin at the given line number.
  `;this._source = {};this._nextLine = 1;this._sourceIsStackFrame = false;this._stackFrameLine = 0;this._console = con;this._debugger = debug;}execute(args) {var _this = this;return (0, _asyncToGenerator.default)(function* () {let ref;switch (args.length) {case 0:if (_this._sourceIsEmpty()) {ref = yield _this._parseSourcePath('@');} else {ref = { source: _this._previousSource(), line: _this._nextLine };}break;
        case 1:
  ...
  _parseSourcePath(sourceRef) {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (match != null) {
        ...
        if (_this2._sourceIsStackFrame) {
          ...
          if (lineStr == null) {
            ...
            line = Math.max(
            1,
            _this2._stackFrameLine - Math.floor(ListCommand._linesToPrint / 2));
  ...
  _printSourceLines(ref) {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
      let sourceLines;

      try {
        sourceLines = yield _this3._debugger.getSourceLines(
        ref.source,
        ref.line,
      ...
      for (const sourceLine of sourceLines) {
        ...
        _this3._console.outputLine(
        `${(0, (_Format || _load_Format()).default)(String(lineNumber), maxLength)}${sep}   ${sourceLine}`);
  ...
  _sourceIsEmpty() {
    return (
      ...
      this._source.sourceReference === 0));
                                    ...
                                    * 
                                    * @format
                                    */ListCommand._formatError = "Format is 'list [source[:line]]'.";ListCommand._linesToPrint = 25;