...
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                           ...
                                                                                                                                                           * @format
                                                                                                                                                           */class CommandLine {
  constructor(dispatcher) {this._inputStopped = false;this._shouldPrompt = false;this._lastLine = '';this._onSIGINT = new _rxjsBundlesRxMinJs.Subject();
  ...
  _executeCommand(line) {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      if (line !== '') {
