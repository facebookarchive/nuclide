'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.Breakpoint = undefined;var _HandleMap;
...
function _load_HandleMap() {return _HandleMap = _interopRequireDefault(require('./HandleMap'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class Breakpoint {
  ...
  setVerified() {
    this._verified = true;
                                      ...
                                      * 
                                      * @format
                                      */class Breakpoints {constructor() {this._breakpoints = new (_HandleMap || _load_HandleMap()).default();}addBreakpoint(bkpt) {
