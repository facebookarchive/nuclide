 ...
 * 
 * @format
 */class SimpleReader extends (_messageReader || _load_messageReader()).AbstractMessageReader {constructor(subscribe) {super();
...
/**
      ...
      */
class ExperimentalMessageRouter {constructor() {this.
    _curSocketID = 1;this.
    _sockets = new Map();this.
  ...
  createConnection(socket, config) {
    ...
    connection.listen();
    return connection;
  }}exports.default = ExperimentalMessageRouter;