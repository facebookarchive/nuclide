...
var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _ExperimentalMessageRouter;
...
function _load_ExperimentalPackage() {return _ExperimentalPackage = require('./ExperimentalPackage');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                     ...
                                                                                                                                                                                                     * 
                                                                                                                                                                                                     * @format
                                                                                                                                                                                                     */function getExposedSockets(packages,
messageRouter)
{
...
class AtomPackageRunner {
  ...
  activate() {
    ...
    ...this._packages.map(params => {
      const pkg = (0, (_ExperimentalPackage || _load_ExperimentalPackage()).activateExperimentalPackage)(params, this._messageRouter);
      return () => {
        if (pkg.dispose != null) {
          pkg.dispose();
        }
