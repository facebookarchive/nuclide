'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.killUnixProcessTree = exports.loggedCalls = exports.ProcessLoggingEvent = exports.ProcessTimeoutError = exports.MaxBufferExceededError = exports.ProcessSystemError = exports.ProcessExitError = exports.memoryUsagePerPid = exports.psTree = exports.getChildrenOfProcess = exports.getOriginalEnvironment = exports.LOG_CATEGORY = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let getOriginalEnvironment = exports.getOriginalEnvironment = (() => {var _ref6 = (0, _asyncToGenerator.default)(
  ...
  function* () {
    ...
    return cachedOriginalEnvironment;
  });return function getOriginalEnvironment() {return _ref6.apply(this, arguments);};})();

/**
                                                                                            * Returns a string suitable for including in displayed error messages.
                                                                                            */let getChildrenOfProcess = exports.getChildrenOfProcess = (() => {var _ref7 = (0, _asyncToGenerator.default)(
  ...
  processId)
  {
    ...
    return processes.filter(function (processInfo) {return processInfo.parentPid === processId;});
  });return function getChildrenOfProcess(_x) {return _ref7.apply(this, arguments);};})();

/**
                                                                                            * Get a list of descendants, sorted by increasing depth (including the one with the provided pid).
                                                                                            */let getDescendantsOfProcess = (() => {var _ref8 = (0, _asyncToGenerator.default)(
  function* (
  pid)
  {
    const processes = yield psTree();
    ...
    return descendants;
  });return function getDescendantsOfProcess(_x2) {return _ref8.apply(this, arguments);};})();let psTree = exports.psTree = (() => {var _ref9 = (0, _asyncToGenerator.default)(

  function* () {
    if (isWindowsPlatform()) {
      return psTreeWindows();
    }
    const [commands, withArgs] = yield Promise.all([
    runCommand('ps', ['-A', '-o', 'ppid,pid,comm']).toPromise(),
    runCommand('ps', ['-A', '-ww', '-o', 'pid,args']).toPromise()]);


    return parsePsOutput(commands, withArgs);
  });return function psTree() {return _ref9.apply(this, arguments);};})();let psTreeWindows = (() => {var _ref10 = (0, _asyncToGenerator.default)(

  function* () {
    const stdout = yield runCommand('wmic.exe', [
    'PROCESS',
    'GET',
    'ParentProcessId,ProcessId,Name']).
    toPromise();
    return parsePsOutput(stdout);
  });return function psTreeWindows() {return _ref10.apply(this, arguments);};})();
...
let memoryUsagePerPid = exports.memoryUsagePerPid = (() => {var _ref11 = (0, _asyncToGenerator.default)(function* (
  pids)
  {
    const usage = new Map();
    if (pids.length >= 1) {
      try {
        const stdout = yield runCommand('ps', [
        '-p',
        pids.join(','),
        '-o',
        'pid=',
        ...
        stdout.split('\n').forEach(function (line) {
          ...
          if (parts.length === 2) {
            const [pid, rss] = parts.map(function (x) {return parseInt(x, 10);});
            usage.set(pid, rss);
          }
        });
      } catch (err) {
    ...
    return usage;
  });return function memoryUsagePerPid(_x3) {return _ref11.apply(this, arguments);};})();

/**
                                                                                           * Add no-op error handlers to the process's streams so that Node doesn't throw them.
                                                                                           */let _killProcess = (() => {var _ref12 = (0, _asyncToGenerator.default)(
  ...
  });return function _killProcess(_x4, _x5) {return _ref12.apply(this, arguments);};})();let killUnixProcessTree = exports.killUnixProcessTree = (() => {var _ref13 = (0, _asyncToGenerator.default)(
...
const logger = (0, (_log4js || _load_log4js()).getLogger)(LOG_CATEGORY); /**
                                                                          ...
                                                                          */function runCommand(command, args = [], options = {}, rest) {return runCommandDetailed(command, args, options).map(event => event.stdout);} /**
                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                         *   });
                                                                                                                                                                                                                         * ```
                                                                                                                                                                                                                         */function observeProcess(command, args, options) {return spawn(command, args, options).flatMap(proc => getOutputStream(proc, options));} /**
                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    */function runCommandDetailed(command, args = [], options = {}, rest) {var _ref;const maxBuffer = ((_ref = options) != null ? _ref.maxBuffer : _ref) || DEFAULT_MAX_BUFFER;return observeProcess(command, args, Object.assign({}, options, { maxBuffer })).catch(error => {// Catch ProcessExitErrors so that we can add stdout to them.
    if (error instanceof ProcessExitError) {return _rxjsBundlesRxMinJs.Observable.of({ kind: 'process-exit-error', error });}throw error;}).reduce((acc, event) => {switch (event.kind) {case 'stdout':return Object.assign({}, acc, { stdout: acc.stdout + event.data });case 'stderr':return Object.assign({}, acc, { stderr: acc.stderr + event.data });case 'exit':return Object.assign({}, acc, { exitCode: event.exitCode });case 'process-exit-error':const { error } = event;throw new ProcessExitError(error.exitCode, error.signal, error.process, acc.stderr, acc.stdout);default:event.kind;throw new Error(`Invalid event kind: ${event.kind}`);}}, { stdout: '', stderr: '', exitCode: null });} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */function observeProcessRaw(command, args, options) {return spawn(command, args, options).flatMap(proc => getOutputStream(proc, Object.assign({}, options, { splitByLines: false })));} //
// # Lower-level APIs
//
 ...
 *   });
 * ```
 */function spawn(command, args, options) {return createProcessStream('spawn', command, args, options);} /**
                                                                                                          * Identical to `spawn()` (above), but uses `child_process.fork()` to create the process.
                                                                                                          */function fork(modulePath, args, options) {return createProcessStream('fork', modulePath, args, options);} /**
                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                       */function getOutputStream(proc, options, rest) {var _ref2, _ref3, _ref4, _ref5;const chunk = ((_ref2 = options) != null ? _ref2.splitByLines : _ref2) === false ? x => x : (_observable || _load_observable()).splitStream;const maxBuffer = (_ref3 = options) != null ? _ref3.maxBuffer : _ref3;const isExitError = ((_ref4 = options) != null ? _ref4.isExitError : _ref4) || isExitErrorDefault;const exitErrorBufferSize = ((_ref5 = options) != null ? _ref5.exitErrorBufferSize : _ref5) || 2000;return _rxjsBundlesRxMinJs.Observable.defer(() => {const stdoutEvents = chunk(limitBufferSize((0, (_stream || _load_stream()).observeStream)(proc.stdout), maxBuffer, 'stdout')).map(data => ({ kind: 'stdout', data }));const stderrEvents = chunk(limitBufferSize((0, (_stream || _load_stream()).observeStream)(proc.stderr), maxBuffer, 'stderr')).map(data => ({ kind: 'stderr', data })).share(); // Accumulate the first `exitErrorBufferSize` bytes of stderr so that we can give feedback about
    // about exit errors (then stop so we don't fill up memory with it).
    const accumulatedStderr = stderrEvents.scan((acc, event) => (acc + event.data).slice(0, exitErrorBufferSize), '').startWith('').let((0, (_observable || _load_observable()).takeWhileInclusive)(acc => acc.length < exitErrorBufferSize)); // We need to start listening for the exit event immediately, but defer emitting it until the
    // (buffered) output streams end.
    const closeEvents = _rxjsBundlesRxMinJs.Observable.fromEvent(proc, // We listen to the "close" event instead of "exit" because we want to get all of the stdout
    // and stderr.
    'close', (exitCode, signal) => ({ kind: 'exit', exitCode, signal })).filter(isRealExit).take(1).withLatestFrom(accumulatedStderr).map(([event, stderr]) => {if (isExitError(event)) {throw new ProcessExitError(event.exitCode, event.signal, proc, stderr);}return event;}).publishReplay();const exitSub = closeEvents.connect();return _rxjsBundlesRxMinJs.Observable.merge(stdoutEvents, stderrEvents).concat(closeEvents).let((0, (_observable || _load_observable()).takeWhileInclusive)(event => event.kind !== 'error' && event.kind !== 'exit')).finally(() => {exitSub.unsubscribe();});});} //
 ...
 */function scriptifyCommand(command, args = [], options) {if (process.platform === 'darwin') {// On OS X, script takes the program to run and its arguments as varargs at the end.
    return ['script', ['-q', '/dev/null', command].concat(args), options];} else {// On Linux, script takes the command to run as the -c parameter so we have to combine all of
    // the arguments into a single string.
    const joined = (0, (_string || _load_string()).shellQuote)([command, ...args]); // flowlint-next-line sketchy-null-mixed:off
    const opts = options || {}; // flowlint-next-line sketchy-null-mixed:off
    const env = opts.env || {};return ['script', ['-q', '/dev/null', '-c', joined], // `script` will use `SHELL`, but shells have different behaviors with regard to escaping. To
    ...
    Object.assign({}, opts, { env: Object.assign({}, env, { SHELL: '/bin/bash' }) })];}} /**
                                                                                          ...
                                                                                          */function killProcess(proc, killTree) {_killProcess(proc, killTree).then(() => {}, error => {logger.error(`Killing process ${proc.pid} failed`, error);});} /**
                                                                                                                                                                                                                                                        * Kill the process with the provided pid.
                                                                                                                                                                                                                                                        */function killPid(pid) {try {process.kill(pid);} catch (err) {if (err.code !== 'ESRCH') {throw err;}}} // If provided, read the original environment from NUCLIDE_ORIGINAL_ENV.
// This should contain the base64-encoded output of `env -0`.
let cachedOriginalEnvironment = null;function exitEventToMessage(event) {if (event.exitCode != null) {return `exit code ${event.exitCode}`;} else {if (!(event.signal != null)) {throw new Error('Invariant violation: "event.signal != null"');}return `signal ${event.signal}`;}}function parsePsOutput(psOutput, argsOutput) {// Remove the first header line.
  const lines = psOutput.trim().split(/\n|\r\n/).slice(1);let withArgs = new Map();if (argsOutput != null) {withArgs = new Map(argsOutput.trim().split(/\n|\r\n/).slice(1).map(line => {const columns = line.trim().split(/\s+/);const pid = parseInt(columns[0], 10);const command = columns.slice(1).join(' ');return [pid, command];}));}return lines.map(line => {const columns = line.trim().split(/\s+/);const [parentPid, pidStr] = columns;const pid = parseInt(pidStr, 10);const command = columns.slice(2).join(' ');const commandWithArgs = withArgs.get(pid);return { command, parentPid: parseInt(parentPid, 10), pid, commandWithArgs: commandWithArgs == null ? command : commandWithArgs };});}function preventStreamsFromThrowing(proc) {return new (_UniversalDisposable || _load_UniversalDisposable()).default(getStreamErrorEvents(proc).subscribe());} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */function logStreamErrors(proc, command, args, options) {return new (_UniversalDisposable || _load_UniversalDisposable()).default(getStreamErrorEvents(proc).do(([err, streamName]) => {logger.error(`stream error on stream ${streamName} with command:`, command, args, options, 'error:', err);}).subscribe());} //
// Types
//
 ...
 */class ProcessExitError extends Error {constructor(exitCode, signal, proc, stderr, stdout) {// $FlowIssue: This isn't typed in the Flow node type defs
    const { spawnargs } = proc;const argsAndCommand = spawnargs[0] === process.execPath ? spawnargs.slice(1) : spawnargs;const [command, ...args] = argsAndCommand;super(`"${command}" failed with ${exitEventToMessage({ exitCode, signal })}\n\n${stderr}\n\n${argsAndCommand.join(' ')}`);this.name = 'ProcessExitError';this.exitCode = exitCode;this.signal = signal;this.stderr = stderr;this.stdout = stdout;this.command = command;this.args = args;this.process = proc;}}exports.ProcessExitError = ProcessExitError; /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */class ProcessSystemError extends Error {constructor(err, proc) {super(err.message);this.name = 'ProcessSystemError';this.errno = err.errno;this.code = err.code;this.path = err.path;this.syscall = err.syscall;this.process = proc;}}exports.ProcessSystemError = ProcessSystemError;class MaxBufferExceededError extends Error {constructor(streamName) {super(`${streamName} maxBuffer exceeded`);this.name = 'MaxBufferExceededError';}}exports.MaxBufferExceededError = MaxBufferExceededError;class ProcessTimeoutError extends Error {constructor(timeout, proc) {// $FlowIssue: This isn't typed in the Flow node type defs
    const { spawnargs } = proc;const commandName = spawnargs[0] === process.execPath ? spawnargs[1] : spawnargs[0];super(`"${commandName}" timed out after ${timeout}ms`);this.name = 'ProcessTimeoutError';}}exports.ProcessTimeoutError = ProcessTimeoutError; //
// Internal Stuff
//
...
const DEFAULT_MAX_BUFFER = 100 * 1024 * 1024;const MAX_LOGGED_CALLS = 100;const NUM_PRESERVED_HISTORY_CALLS = 50;const noopDisposable = { dispose: () => {} };const whenShellEnvironmentLoaded = typeof atom !== 'undefined' && !atom.inSpecMode() ? atom.whenShellEnvironmentLoaded.bind(atom) : cb => {cb();return noopDisposable;}; /**
                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                        */class ProcessLoggingEvent {constructor(command, duration) {this.command = command;this.duration = duration; // log4js uses util.inspect to convert log arguments to strings.
    // Note: computed property methods aren't supported by Flow yet.
    this[_util.default.inspect.custom] = () => {return `${this.duration}ms: ${this.command}`;};}}exports.ProcessLoggingEvent = ProcessLoggingEvent;const loggedCalls = exports.loggedCalls = [];function logCall(duration, command, args) {// Trim the history once in a while, to avoid doing expensive array
  // manipulation all the time after we reached the end of the history
  if (loggedCalls.length > MAX_LOGGED_CALLS) {loggedCalls.splice(0, loggedCalls.length - NUM_PRESERVED_HISTORY_CALLS, { command: '... history stripped ...', duration: 0, time: new Date() });}const fullCommand = (0, (_string || _load_string()).shellQuote)([command, ...args]);loggedCalls.push({ command: fullCommand, duration, time: new Date() });logger.info(new ProcessLoggingEvent(fullCommand, duration));} /**
                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                         */function createProcessStream(type = 'spawn', commandOrModulePath, args = [], options = {}) {const inputOption = options.input;let input;if (inputOption != null) {input = typeof inputOption === 'string' ? _rxjsBundlesRxMinJs.Observable.of(inputOption) : inputOption;}return (0, (_event || _load_event()).observableFromSubscribeFunction)(whenShellEnvironmentLoaded).take(1).switchMap(() => {const { dontLogInNuclide, killTreeWhenDone, timeout } = options; // flowlint-next-line sketchy-null-number:off
    const enforceTimeout = timeout ? x => x.timeoutWith(timeout, _rxjsBundlesRxMinJs.Observable.throw(new ProcessTimeoutError(timeout, proc))) : x => x;const proc = _child_process.default[type]((_nuclideUri || _load_nuclideUri()).default.expandHomeDir(commandOrModulePath), args, // $FlowFixMe: child_process$spawnOpts and child_process$forkOpts have incompatible stdio types.
    ...
    const errors = _rxjsBundlesRxMinJs.Observable.fromEvent(proc, 'error').flatMap(_rxjsBundlesRxMinJs.Observable.throw).publish();errors.connect();const exitEvents = _rxjsBundlesRxMinJs.Observable.fromEvent(proc, 'exit', (exitCode, signal) => ({ kind: 'exit', exitCode, signal })).filter(isRealExit).take(1);if (dontLogInNuclide !== true) {// Log the completion of the process. Note that we intentionally don't merge this with the
      ...
      const now = (0, (_performanceNow || _load_performanceNow()).default)();_rxjsBundlesRxMinJs.Observable.fromEvent(proc, 'close').do(() => {logCall(Math.round((0, (_performanceNow || _load_performanceNow()).default)() - now), commandOrModulePath, args);}).subscribe();}let finished = false;return enforceTimeout(_rxjsBundlesRxMinJs.Observable.using( // Log stream errors, but only for as long as you're subscribed to the process observable.
    () => logStreamErrors(proc, commandOrModulePath, args, options), () => _rxjsBundlesRxMinJs.Observable.merge( // Node [delays the emission of process errors][1] by a tick in order to give
    ...
    input == null ? _rxjsBundlesRxMinJs.Observable.empty() : input.do({ next: str => {proc.stdin.write(str);}, complete: () => {proc.stdin.end();} }).ignoreElements()).takeUntil(errors).takeUntil(exitEvents).do({ error: () => {finished = true;}, complete: () => {finished = true;} })).catch(err => {// Since this utility errors *before* emitting the process, add the process to the error
      // so that users can get whatever info they need off of it.
      if (err instanceof Error && err.name === 'Error' && 'errno' in err) {throw new ProcessSystemError(err, proc);}throw err;}).finally(() => {// flowlint-next-line sketchy-null-mixed:off
      if (!proc.wasKilled && !finished) {killProcess(proc, Boolean(killTreeWhenDone));}});});}function isRealExit(event) {// An exit signal from SIGUSR1 doesn't actually exit the process, so skip that.
  return event.signal !== 'SIGUSR1';}function killWindowsProcessTree(pid) {return new Promise((resolve, reject) => {_child_process.default.exec(`taskkill /pid ${pid} /T /F`, error => {if (error == null) {reject(error);} else {resolve();}});});}function isExitErrorDefault(exit) {return exit.exitCode !== 0;}function isWindowsPlatform() {return (/^win/.test(process.platform));}function limitBufferSize(stream, maxBuffer, streamName) {if (maxBuffer == null) {return stream;}return _rxjsBundlesRxMinJs.Observable.defer(() => {let totalSize = 0;return stream.do(data => {totalSize += data.length;if (totalSize > maxBuffer) {throw new MaxBufferExceededError(streamName);}});});} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    */function getStreamErrorEvents(proc) {const streams = [['stdin', proc.stdin], ['stdout', proc.stdout], ['stderr', proc.stderr]];return _rxjsBundlesRxMinJs.Observable.merge(...streams.map(([name, stream]) => stream == null ? _rxjsBundlesRxMinJs.Observable.empty() : _rxjsBundlesRxMinJs.Observable.fromEvent(stream, 'error').map(err => [err, name])));}