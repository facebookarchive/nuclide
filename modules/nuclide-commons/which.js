...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('./nuclideUri'));}var _process;
...
function sanitizePathForWindows(path) {
  ...
  });function which(_x) {return _ref.apply(this, arguments);}return which;})();