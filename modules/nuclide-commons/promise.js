...
/**
                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                          */let triggerAfterWait = exports.triggerAfterWait = (() => {var _ref = (0, _asyncToGenerator.default)(
  function* (
  promise,
  milliSeconds,
  timeoutFn,
  ...
  });return function triggerAfterWait(_x, _x2, _x3, _x4) {return _ref.apply(this, arguments);};})();
...
/**
                                                                                                          ...
                                                                                                          */let retryLimit = exports.retryLimit = (() => {var _ref2 = (0, _asyncToGenerator.default)(
  function* (
  retryFunction,
  validationFunction,
  maximumTries,
  ...
  });return function retryLimit(_x5, _x6, _x7) {return _ref2.apply(this, arguments);};})();
...
/**
                                                                                                 ...
                                                                                                 */let asyncFilter = exports.asyncFilter = (() => {var _ref5 = (0, _asyncToGenerator.default)(
  function* (
  array,
  filterFunction,
  limit)
  {
    ...
    yield asyncLimit(array, limit || array.length, (() => {var _ref6 = (0, _asyncToGenerator.default)(function* (item) {
        if (yield filterFunction(item)) {
          filteredList.push(item);
        }
      });return function (_x12) {return _ref6.apply(this, arguments);};})());
    return filteredList;
  });return function asyncFilter(_x9, _x10, _x11) {return _ref5.apply(this, arguments);};})();let asyncObjFilter = exports.asyncObjFilter = (() => {var _ref7 = (0, _asyncToGenerator.default)(
  ...
  limit)
  {
    ...
    const filteredObj = {};
    // flowlint-next-line sketchy-null-number:off
    yield asyncLimit(keys, limit || keys.length, (() => {var _ref8 = (0, _asyncToGenerator.default)(function* (key) {
        const item = obj[key];
        if (yield filterFunction(item, key)) {
          filteredObj[key] = item;
        }
      });return function (_x16) {return _ref8.apply(this, arguments);};})());
    return filteredObj;
  });return function asyncObjFilter(_x13, _x14, _x15) {return _ref7.apply(this, arguments);};})();
...
/**
                                                                                                    ...
                                                                                                    *   boolean.
                                                                                                    * @param limit the configurable number of parallel async operations.
                                                                                                    */let asyncSome = exports.asyncSome = (() => {var _ref9 = (0, _asyncToGenerator.default)(
  function* (
  array,
  someFunction,
  limit)
  {
    let resolved = false;
    // flowlint-next-line sketchy-null-number:off
    yield asyncLimit(array, limit || array.length, (() => {var _ref10 = (0, _asyncToGenerator.default)(function* (item) {
        if (resolved) {
      ...
      });return function (_x20) {return _ref10.apply(this, arguments);};})());
    return resolved;
  });return function asyncSome(_x17, _x18, _x19) {return _ref9.apply(this, arguments);};})();

/**
                                                                                               * Check if an object is Promise by testing if it has a `then` function property.
                                                                                               */exports.sleep = sleep;exports.nextTick = nextTick;exports.timeoutPromise = timeoutPromise;exports.createDeadline = createDeadline;exports.timeoutAfterDeadline = timeoutAfterDeadline;exports.serializeAsyncCall = serializeAsyncCall;exports.asyncFind = asyncFind;exports.denodeify = denodeify;exports.asyncLimit = asyncLimit;exports.
isPromise = isPromise;exports.
...
delayTime = delayTime;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                     ...
                                                                                                                     */ /**
                                                                                                                         ...
                                                                                                                         * 
                                                                                                                         * @format
                                                                                                                         */class RequestSerializer {constructor() {this._lastDispatchedOp = 0;this._lastFinishedOp = 0;this._latestPromise = new Promise((resolve, reject) => {this._waitResolve = resolve;});}run(promise) {var _this = this;return (0, _asyncToGenerator.default)(function* () {const thisOp = _this._lastDispatchedOp + 1;_this._lastDispatchedOp = thisOp;_this._latestPromise = promise;_this._waitResolve();const result = yield promise;if (_this._lastFinishedOp < thisOp) {_this._lastFinishedOp = thisOp;return { status: 'success', result };} else {return { status: 'outdated' };}})();} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       * Returns a Promise that resolves to the last result of `run`,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       * as soon as there are no more outstanding `run` calls.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */waitForLatestResult() {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {let lastPromise = null;let result = null;while (lastPromise !== _this2._latestPromise) {lastPromise = _this2._latestPromise; // Wait for the current last know promise to resolve, or a next run have started.
        // eslint-disable-next-line no-await-in-loop
        result = yield new Promise(function (resolve, reject) {_this2._waitResolve = resolve;_this2._latestPromise.then(resolve);});}return result;})();}isRunInProgress() {return this._lastDispatchedOp > this._lastFinishedOp;}}exports.RequestSerializer = RequestSerializer; /*
                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                   */function sleep(milliSeconds) {return new Promise(resolve => {setTimeout(resolve, milliSeconds);});}function nextTick() {return new Promise(resolve => {process.nextTick(resolve);});}class TimedOutError extends Error {constructor(milliseconds) {super(`Timed out after ${String(milliseconds)} ms`);this.timeout = milliseconds;}}exports.TimedOutError = TimedOutError; /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */function timeoutPromise(promise, milliseconds) {return new Promise((resolve, reject) => {let timeout = setTimeout(() => {timeout = null;reject(new TimedOutError(milliseconds)); // This gives useless error.stack results.
      // We could capture the stack pre-emptively at the start
      // of this method if we wanted useful ones.
    }, milliseconds);promise.then(value => {if (timeout != null) {clearTimeout(timeout);}resolve(value);}).catch(value => {if (timeout != null) {clearTimeout(timeout);}reject(value);});});} // An DeadlineRequest parameter to an async method is a way of *requesting* that
...
function createDeadline(delay) {return Date.now() + delay;}function timeoutAfterDeadline(deadline, promise) {const delay = deadline - Date.now();return timeoutPromise(promise, delay < 0 ? 0 : delay);}function serializeAsyncCall(asyncFun) {let scheduledCall = null;let pendingCall = null;const startAsyncCall = () => {const resultPromise = asyncFun();pendingCall = resultPromise.then(() => pendingCall = null, () => pendingCall = null);return resultPromise;};const callNext = () => {scheduledCall = null;return startAsyncCall();};const scheduleNextCall = () => {if (scheduledCall == null) {if (!pendingCall) {throw new Error('pendingCall must not be null!');}scheduledCall = pendingCall.then(callNext, callNext);}return scheduledCall;};return () => {if (pendingCall == null) {return startAsyncCall();} else {return scheduleNextCall();}};} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */class Deferred {constructor() {this.promise = new Promise((resolve, reject) => {this.resolve = resolve;this.reject = reject;});}}exports.Deferred = Deferred; /**
    ...
    items = items.slice();const numItems = items.length;const next = (() => {var _ref3 = (0, _asyncToGenerator.default)(function* (index) {if (index === numItems) {resolve(null);return;}const item = items[index];const result = yield test.call(thisArg, item);if (result != null) {resolve(result);} else {next(index + 1);}});return function next(_x8) {return _ref3.apply(this, arguments);};})();next(0);});}function denodeify(f) {return function (...args) {return new Promise((resolve, reject) => {function callback(error, result) {if (error) {reject(error);} else {resolve(result);}}f.apply(this, args.concat([callback]));});};} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     */function asyncLimit(array, limit, mappingFunction) {const result = new Array(array.length);let parallelPromises = 0;let index = 0;let parallelLimit = Math.min(limit, array.length) || 1;return new Promise((resolve, reject) => {const runPromise = (() => {var _ref4 = (0, _asyncToGenerator.default)(function* () {if (index === array.length) {if (parallelPromises === 0) {resolve(result);}return;}++parallelPromises;const i = index++;try {result[i] = yield mappingFunction(array[i]);} catch (e) {reject(e);}--parallelPromises;runPromise();});return function runPromise() {return _ref4.apply(this, arguments);};})();while (parallelLimit--) {runPromise();}});}function isPromise(object) {return Boolean(object) && typeof object === 'object' && typeof object.then === 'function';} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */function lastly(promise, fn) {return promise.then(ret => {return Promise.resolve(fn()).then(() => ret);}, err => {return Promise.resolve(fn()).then(() => Promise.reject(err));});} /**
