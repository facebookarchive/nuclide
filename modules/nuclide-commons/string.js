'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.ELLIPSIS_CHAR = exports.URL_REGEX = undefined;exports.
...
stringifyError = stringifyError;exports.
...
maybeToString = maybeToString;exports.
...
relativeDate = relativeDate;exports.
...
countOccurrences = countOccurrences;exports.
...
shellQuote = shellQuote;exports.



removeCommonPrefix = removeCommonPrefix;exports.
...
removeCommonSuffix = removeCommonSuffix;exports.
...
getMatchRanges = getMatchRanges;exports.
...
escapeMarkdown = escapeMarkdown;var _shellQuote;function _load_shellQuote() {return _shellQuote = require('./_shell-quote');} /**
                                                                                                                               ...
                                                                                                                               * 
                                                                                                                               * @format
                                                                                                                               */function stringifyError(error) {return `name: ${error.name}, message: ${error.message}, stack: ${error.stack}.`;} // As of Flow v0.28, Flow does not alllow implicit string coercion of null or undefined. Use this to
// make it explicit.
function maybeToString(str) {// We don't want to encourage the use of this function directly because it coerces anything to a
  ...
  if (!reference) {reference = new Date().getTime();}if (reference instanceof Date) {reference = reference.getTime();}const delta = reference - input;const formats = useShortVariant ? shortFormats : longFormats;for (const [limit, relativeFormat, remainder] of formats) {if (delta < limit) {if (typeof remainder === 'number') {return Math.round(delta / remainder) + (useShortVariant ? '' : ' ') + relativeFormat;} else {return relativeFormat;}}}throw new Error('This should never be reached.');} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */function countOccurrences(haystack, char) {if (!(char.length === 1)) {throw new Error('char must be a string of length 1');}let count = 0;const code = char.charCodeAt(0);for (let i = 0; i < haystack.length; i++) {if (haystack.charCodeAt(i) === code) {count++;}}return count;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */function shellParse(str, env) {const result = (0, (_shellQuote || _load_shellQuote()).parse)(str, env);for (let i = 0; i < result.length; i++) {if (typeof result[i] !== 'string') {if (result[i].op != null) {throw new Error(`Unexpected operator "${result[i].op}" provided to shellParse`);} else {throw new Error(`Unexpected comment "${result[i].comment}" provided to shellParse`);}}}return result;} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        * Technically you can pass in { operator: string } here,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        * but we don't use that in most APIs.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */function shellQuote(args) {return (0, (_shellQuote || _load_shellQuote()).quote)(args);}function removeCommonPrefix(a, b) {let i = 0;while (a[i] === b[i] && i < a.length && i < b.length) {i++;}return [a.substring(i), b.substring(i)];}function removeCommonSuffix(a, b) {let i = 0;while (a[a.length - 1 - i] === b[b.length - 1 - i] && i < a.length && i < b.length) {i++;}return [a.substring(0, a.length - i), b.substring(0, b.length - i)];}function shorten(str, maxLength, suffix) {return str.length < maxLength ? str : str.slice(0, maxLength) + (suffix || '');} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * Like String.split, but only splits once.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            */function splitOnce(str, separator) {const index = str.indexOf(separator);return index === -1 ? [str, null] : [str.slice(0, index), str.slice(index + separator.length)];} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         * Indents each line by the specified number of characters.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         */function indent(str, level = 2, char = ' ') {return str.replace(/^([^\n])/gm, char.repeat(level) + '$1');}function pluralize(noun, count) {return count === 1 ? noun : noun + 's';}function capitalize(str) {return str.length === 0 ? str : str.charAt(0).toUpperCase().concat(str.slice(1));} /**
...
const URL_REGEX = exports.URL_REGEX = /(https?:\/\/(?:www\.)?[-\w@:%.+~#=]{2,256}\.[a-z]{2,6}\b[-\w@:%+.~#?&/=!]*|www\.[-\w@:%.+~#=]{2,256}\.[a-z]{2,6}\b[-\w@:%+.~#?&/=!]*)/;const ELLIPSIS_CHAR = exports.ELLIPSIS_CHAR = '\u2026';