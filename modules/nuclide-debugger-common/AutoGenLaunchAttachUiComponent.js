...
class AutoGenLaunchAttachUiComponent extends _react.Component {
  ...
  constructor(props) {
    ...
    this._handleDebugButtonClick = async () => {
      ...
      const values = {};
      [booleanValues, enumValues, stringValues, stringArrayValues, objectValues, numberValues, processTableValues, jsonValues, deviceAndPackageValues, deviceAndProcessValues].forEach(map => {
