'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.Session = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _OCamlDebugProxy;
...
function _load_OCamlDebugProxy() {return _OCamlDebugProxy = require('./OCamlDebugProxy');}var _nuclideUri;
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../nuclide-commons/nuclideUri'));}
var _url = _interopRequireDefault(require('url'));var _vscodeDebugadapter;
function _load_vscodeDebugadapter() {return _vscodeDebugadapter = require('vscode-debugadapter');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 * 
                                                                                                                                                                                                 * @format
                                                                                                                                                                                                 */function uriToModuleName(uri) {const pathname = uri.startsWith('file://') ? _url.default.parse(uri).pathname : uri;if (!(pathname != null && pathname !== '')) {throw new Error('Invariant violation: "pathname != null && pathname !== \'\'"');}const fileName = (_nuclideUri || _load_nuclideUri()).default.basename(pathname).replace(/\.[^.]+$/, '');return fileName.charAt(0).toUpperCase() + fileName.substr(1);}function extractList(text,
prefix,
keepLines,
empty,
f)
...
class Lock {
  ...
  enter() {var _this = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      _this._inner = new Promise(function (resolve) {
        _this._expected++;
        e = function () {return resolve(_this._expected);};
      });
      return { exitLock: function () {return e();} };})();
  }}
...
class Session {
  ...
  getStack() {var _this2 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  stepOut() {var _this3 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  evaluate(frameId, expr) {var _this4 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _step(command) {var _this5 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  {var _this6 = this;return (0, _asyncToGenerator.default)(function* () {
      ...
      if (uri == null || shortname == null) {
        (_vscodeDebugadapter || _load_vscodeDebugadapter()).logger.error(
      ...
      if (existingBreakpoints) {
        yield Promise.all(
        existingBreakpoints.map(_this6.deleteBreakpoint.bind(_this6)));

      }

      _this6._shortNamesToPaths.set(shortname, uri);
      const breakpointsPromise = breakpoints.map((() => {var _ref2 = (0, _asyncToGenerator.default)(function* (bp) {return (
            _this6._pauseAndLock((0, _asyncToGenerator.default)(function* () {
  ...
  deleteBreakpoint(breakpoint) {var _this7 = this;
  ...
  pause() {var _this8 = this;return (0, _asyncToGenerator.default)(function* () {
      if (_this8._paused) {
        return true;
      }
  ...
  _runWithLock(f) {var _this9 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  _pauseAndLock(f) {var _this10 = this;return (0, _asyncToGenerator.default)(function* () {
  ...
  {return (0, _asyncToGenerator.default)(function* () {
      ...
      const ocamlDebug = new (_OCamlDebugProxy || _load_OCamlDebugProxy()).OCamlDebugProxy(
      command,
      debuggerArguments,
      function (result) {
