'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.THREAD_ID = undefined;var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _vscodeDebugadapter;
...
function _load_vscodeDebugadapter() {return _vscodeDebugadapter = require('vscode-debugadapter');}var _vscodeDebugprotocol;
...
function _load_vscodeDebugprotocol() {return _vscodeDebugprotocol = _interopRequireWildcard(require('vscode-debugprotocol'));}var _Session;
function _load_Session() {return _Session = require('./Session');}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class OCamlDebugSession extends (_vscodeDebugadapter || _load_vscodeDebugadapter()).LoggingDebugSession {
  ...
  constructor() {
    ...
    this._started = false;this.setDebuggerLinesStartAt1(true);
  ...
  fn)
  {
    fn().catch(error => {
      ...
      this.sendEvent(
      new (_vscodeDebugadapter || _load_vscodeDebugadapter()).OutputEvent(
  ...
  {var _this = this;
    this._catchAsyncRequestError(response, (0, _asyncToGenerator.default)(function* () {
      ...
      _this._session = yield (_Session || _load_Session()).Session.start(
      config,
      function (breakPointId) {return _this._handleBreakpointHitEvent(breakPointId);},
      function (error) {return _this._handleProgramExitedEvent(error);});

      _this._breakAfterStart = config.breakAfterStart;

      // Now send the initialized event as we're ready to process breakpoint requests
      _this.sendEvent(new (_vscodeDebugadapter || _load_vscodeDebugadapter()).InitializedEvent());
  ...
  {var _this2 = this;
    this._catchAsyncRequestError(response, (0, _asyncToGenerator.default)(function* () {
      const breakpoints = yield _this2._session.setBreakpointsByUri(
      args.breakpoints || [],
      args.source.path,
      args.source.name);
  ...
  {var _this7 = this;
    this._catchAsyncRequestError(response, (0, _asyncToGenerator.default)(function* () {
      const result = yield _this7._session.evaluate(
      args.frameId,
      args.expression);
